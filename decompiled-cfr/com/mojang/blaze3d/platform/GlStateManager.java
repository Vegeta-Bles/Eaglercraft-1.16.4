...
public class GlStateManager {
    ...
    private static final CapabilityTracker[] LIGHT_ENABLE = (CapabilityTracker[])IntStream.range(0, 8).mapToObj(n -> new CapabilityTracker(16384 + n)).toArray(CapabilityTracker[]::new);
    ...
    private static final class_4493.class_5518 field_26839 = new class_4493.class_5518(null);
    ...
    public static void method_31317(int n, int n2, int n3, int n4) {
        RenderSystem.assertThread(RenderSystem::isOnRenderThreadOrInit);
    ...
    public static void setupLevelDiffuseLighting(Vector3f vector3f, Vector3f vector3f2, Matrix4f matrix4f) {
        ...
        _snowman = new Vector4f(vector3f2);
        _snowman.transform(matrix4f);
        GlStateManager.light(16385, 4611, GlStateManager.getBuffer(_snowman.getX(), _snowman.getY(), _snowman.getZ(), 0.0f));
    ...
    public static void texGenMode(TexCoord coord, int mode) {
        ...
        if (mode != texGenCoordState.mode) {
            ...
            GL11.glTexGeni((int)texGenCoordState.coord, (int)9472, (int)mode);
        }
    }
    ...
    public static void method_30498(int[] nArray) {
        RenderSystem.assertThread(RenderSystem::isOnRenderThreadOrInit);
    ...
    public static void method_30499(int[] nArray2) {
        int[] nArray2;
        RenderSystem.assertThread(RenderSystem::isOnRenderThreadOrInit);
        for (Texture2DState texture2DState : TEXTURES) {
            for (int n : nArray2) {
                if (texture2DState.boundTexture != n) continue;
                texture2DState.boundTexture = -1;
            }
        }
    ...
    static {
        TEXTURES = (Texture2DState[])IntStream.range(0, 12).mapToObj(n -> new Texture2DState()).toArray(Texture2DState[]::new);
        modelShadeMode = 7425;
