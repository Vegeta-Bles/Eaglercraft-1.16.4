...
extends AbstractCriterion<Conditions> {
    ...
    public Conditions conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended extended, AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
        ...
        ItemPredicate _snowman2 = ItemPredicate.fromJson(jsonObject.get("item"));
        NumberRange.IntRange _snowman3 = NumberRange.IntRange.fromJson(jsonObject.get("num_bees_inside"));
        return new Conditions(extended, block, _snowman2, _snowman3);
    }
