...
extends AbstractCriterion<Conditions> {
    ...
    public Conditions conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended extended, AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
        ...
        _snowman = EntityPredicate.Extended.getInJson(jsonObject, "partner", advancementEntityPredicateDeserializer);
        _snowman = EntityPredicate.Extended.getInJson(jsonObject, "child", advancementEntityPredicateDeserializer);
        return new Conditions(extended, extended2, _snowman, _snowman);
    }
    ...
    public void trigger(ServerPlayerEntity serverPlayerEntity, AnimalEntity animalEntity, AnimalEntity animalEntity2, @Nullable PassiveEntity passiveEntity) {
        ...
        _snowman = EntityPredicate.createAdvancementEntityLootContext(serverPlayerEntity, animalEntity2);
        _snowman = passiveEntity != null ? EntityPredicate.createAdvancementEntityLootContext(serverPlayerEntity, passiveEntity) : null;
        this.test(serverPlayerEntity, conditions -> conditions.matches(lootContext, _snowman, _snowman));
    }
