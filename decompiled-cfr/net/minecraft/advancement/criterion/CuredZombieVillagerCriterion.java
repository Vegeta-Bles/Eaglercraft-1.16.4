...
extends AbstractCriterion<Conditions> {
    ...
    public Conditions conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended extended, AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
        ...
        _snowman = EntityPredicate.Extended.getInJson(jsonObject, "villager", advancementEntityPredicateDeserializer);
        return new Conditions(extended, extended2, _snowman);
    }
    ...
    public void trigger(ServerPlayerEntity player, ZombieEntity zombie, VillagerEntity villager) {
        ...
        _snowman = EntityPredicate.createAdvancementEntityLootContext(player, villager);
        this.test(player, conditions -> conditions.matches(lootContext, _snowman));
    }
