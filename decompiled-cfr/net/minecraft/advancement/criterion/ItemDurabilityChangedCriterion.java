...
extends AbstractCriterion<Conditions> {
    ...
    public Conditions conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended extended, AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
        ...
        NumberRange.IntRange _snowman2 = NumberRange.IntRange.fromJson(jsonObject.get("durability"));
        NumberRange.IntRange _snowman3 = NumberRange.IntRange.fromJson(jsonObject.get("delta"));
        return new Conditions(extended, itemPredicate, _snowman2, _snowman3);
    }
