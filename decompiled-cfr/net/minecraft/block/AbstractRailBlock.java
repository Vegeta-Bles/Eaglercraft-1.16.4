...
extends Block {
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        Direction _snowman2 = ctx.getPlayerFacing();
        boolean _snowman3 = _snowman2 == Direction.EAST || _snowman2 == Direction.WEST;
        return (BlockState)blockState.with(this.getShapeProperty(), _snowman3 ? RailShape.EAST_WEST : RailShape.NORTH_SOUTH);
    }
