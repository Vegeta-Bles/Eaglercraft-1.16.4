...
extends AbstractFurnaceBlock {
    ...
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, Random random) {
        ...
        if (random.nextDouble() < 0.1) {
            world.playSound(d, _snowman, _snowman, SoundEvents.BLOCK_BLASTFURNACE_FIRE_CRACKLE, SoundCategory.BLOCKS, 1.0f, 1.0f, false);
        }
        ...
        _snowman = random.nextDouble() * 9.0 / 16.0;
