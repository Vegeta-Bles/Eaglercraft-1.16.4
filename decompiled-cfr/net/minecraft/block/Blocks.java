...
public class Blocks {
    ...
    public static final Block STONE = Blocks.register("stone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.STONE).requiresTool().strength(1.5f, 6.0f)));
    public static final Block GRANITE = Blocks.register("granite", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.DIRT).requiresTool().strength(1.5f, 6.0f)));
    public static final Block POLISHED_GRANITE = Blocks.register("polished_granite", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.DIRT).requiresTool().strength(1.5f, 6.0f)));
    public static final Block DIORITE = Blocks.register("diorite", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.QUARTZ).requiresTool().strength(1.5f, 6.0f)));
    public static final Block POLISHED_DIORITE = Blocks.register("polished_diorite", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.QUARTZ).requiresTool().strength(1.5f, 6.0f)));
    public static final Block ANDESITE = Blocks.register("andesite", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.STONE).requiresTool().strength(1.5f, 6.0f)));
    public static final Block POLISHED_ANDESITE = Blocks.register("polished_andesite", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.STONE).requiresTool().strength(1.5f, 6.0f)));
    ...
    public static final Block DIRT = Blocks.register("dirt", new Block(AbstractBlock.Settings.of(Material.SOIL, MaterialColor.DIRT).strength(0.5f).sounds(BlockSoundGroup.GRAVEL)));
    public static final Block COARSE_DIRT = Blocks.register("coarse_dirt", new Block(AbstractBlock.Settings.of(Material.SOIL, MaterialColor.DIRT).strength(0.5f).sounds(BlockSoundGroup.GRAVEL)));
    public static final Block PODZOL = Blocks.register("podzol", new SnowyBlock(AbstractBlock.Settings.of(Material.SOIL, MaterialColor.SPRUCE).strength(0.5f).sounds(BlockSoundGroup.GRAVEL)));
    ...
    public static final Block SAND = Blocks.register("sand", new SandBlock(14406560, AbstractBlock.Settings.of(Material.AGGREGATE, MaterialColor.SAND).strength(0.5f).sounds(BlockSoundGroup.SAND)));
    public static final Block RED_SAND = Blocks.register("red_sand", new SandBlock(11098145, AbstractBlock.Settings.of(Material.AGGREGATE, MaterialColor.ORANGE).strength(0.5f).sounds(BlockSoundGroup.SAND)));
    public static final Block GRAVEL = Blocks.register("gravel", new GravelBlock(AbstractBlock.Settings.of(Material.AGGREGATE, MaterialColor.STONE).strength(0.6f).sounds(BlockSoundGroup.GRAVEL)));
    ...
    public static final Block COAL_ORE = Blocks.register("coal_ore", new OreBlock(AbstractBlock.Settings.of(Material.STONE).requiresTool().strength(3.0f, 3.0f)));
    public static final Block NETHER_GOLD_ORE = Blocks.register("nether_gold_ore", new OreBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.NETHER).requiresTool().strength(3.0f, 3.0f).sounds(BlockSoundGroup.NETHER_GOLD_ORE)));
    ...
    public static final Block LAPIS_ORE = Blocks.register("lapis_ore", new OreBlock(AbstractBlock.Settings.of(Material.STONE).requiresTool().strength(3.0f, 3.0f)));
    public static final Block LAPIS_BLOCK = Blocks.register("lapis_block", new Block(AbstractBlock.Settings.of(Material.METAL, MaterialColor.LAPIS).requiresTool().strength(3.0f, 3.0f)));
    ...
    public static final Block SANDSTONE = Blocks.register("sandstone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.SAND).requiresTool().strength(0.8f)));
    public static final Block CHISELED_SANDSTONE = Blocks.register("chiseled_sandstone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.SAND).requiresTool().strength(0.8f)));
    public static final Block CUT_SANDSTONE = Blocks.register("cut_sandstone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.SAND).requiresTool().strength(0.8f)));
    ...
    public static final Block POWERED_RAIL = Blocks.register("powered_rail", new PoweredRailBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.7f).sounds(BlockSoundGroup.METAL)));
    public static final Block DETECTOR_RAIL = Blocks.register("detector_rail", new DetectorRailBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.7f).sounds(BlockSoundGroup.METAL)));
    ...
    public static final Block TALL_SEAGRASS = Blocks.register("tall_seagrass", new TallSeagrassBlock(AbstractBlock.Settings.of(Material.REPLACEABLE_UNDERWATER_PLANT).noCollision().breakInstantly().sounds(BlockSoundGroup.WET_GRASS)));
    ...
    public static final Block BROWN_MUSHROOM = Blocks.register("brown_mushroom", new MushroomPlantBlock(AbstractBlock.Settings.of(Material.PLANT, MaterialColor.BROWN).noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.GRASS).luminance(state -> 1).postProcess(Blocks::always)));
    ...
    public static final Block GOLD_BLOCK = Blocks.register("gold_block", new Block(AbstractBlock.Settings.of(Material.METAL, MaterialColor.GOLD).requiresTool().strength(3.0f, 6.0f).sounds(BlockSoundGroup.METAL)));
    public static final Block IRON_BLOCK = Blocks.register("iron_block", new Block(AbstractBlock.Settings.of(Material.METAL, MaterialColor.IRON).requiresTool().strength(5.0f, 6.0f).sounds(BlockSoundGroup.METAL)));
    public static final Block BRICKS = Blocks.register("bricks", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.RED).requiresTool().strength(2.0f, 6.0f)));
    ...
    public static final Block OBSIDIAN = Blocks.register("obsidian", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK).requiresTool().strength(50.0f, 1200.0f)));
    public static final Block TORCH = Blocks.register("torch", new TorchBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().breakInstantly().luminance(state -> 14).sounds(BlockSoundGroup.WOOD), ParticleTypes.FLAME));
    public static final Block WALL_TORCH = Blocks.register("wall_torch", new WallTorchBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().breakInstantly().luminance(state -> 14).sounds(BlockSoundGroup.WOOD).dropsLike(TORCH), ParticleTypes.FLAME));
    public static final Block FIRE = Blocks.register("fire", new FireBlock(AbstractBlock.Settings.of(Material.FIRE, MaterialColor.LAVA).noCollision().breakInstantly().luminance(state -> 15).sounds(BlockSoundGroup.WOOL)));
    public static final Block SOUL_FIRE = Blocks.register("soul_fire", new SoulFireBlock(AbstractBlock.Settings.of(Material.FIRE, MaterialColor.LIGHT_BLUE).noCollision().breakInstantly().luminance(state -> 10).sounds(BlockSoundGroup.WOOL)));
    ...
    public static final Block REDSTONE_WIRE = Blocks.register("redstone_wire", new RedstoneWireBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().breakInstantly()));
    public static final Block DIAMOND_ORE = Blocks.register("diamond_ore", new OreBlock(AbstractBlock.Settings.of(Material.STONE).requiresTool().strength(3.0f, 3.0f)));
    public static final Block DIAMOND_BLOCK = Blocks.register("diamond_block", new Block(AbstractBlock.Settings.of(Material.METAL, MaterialColor.DIAMOND).requiresTool().strength(5.0f, 6.0f).sounds(BlockSoundGroup.METAL)));
    ...
    public static final Block FURNACE = Blocks.register("furnace", new FurnaceBlock(AbstractBlock.Settings.of(Material.STONE).requiresTool().strength(3.5f).luminance(Blocks.createLightLevelFromBlockState(13))));
    ...
    public static final Block LADDER = Blocks.register("ladder", new LadderBlock(AbstractBlock.Settings.of(Material.SUPPORTED).strength(0.4f).sounds(BlockSoundGroup.LADDER).nonOpaque()));
    public static final Block RAIL = Blocks.register("rail", new RailBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.7f).sounds(BlockSoundGroup.METAL)));
    ...
    public static final Block LEVER = Blocks.register("lever", new LeverBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    ...
    public static final Block IRON_DOOR = Blocks.register("iron_door", new DoorBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.IRON).requiresTool().strength(5.0f).sounds(BlockSoundGroup.METAL).nonOpaque()));
    ...
    public static final Block REDSTONE_ORE = Blocks.register("redstone_ore", new RedstoneOreBlock(AbstractBlock.Settings.of(Material.STONE).requiresTool().ticksRandomly().luminance(Blocks.createLightLevelFromBlockState(9)).strength(3.0f, 3.0f)));
    public static final Block REDSTONE_TORCH = Blocks.register("redstone_torch", new RedstoneTorchBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().breakInstantly().luminance(Blocks.createLightLevelFromBlockState(7)).sounds(BlockSoundGroup.WOOD)));
    public static final Block REDSTONE_WALL_TORCH = Blocks.register("redstone_wall_torch", new WallRedstoneTorchBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().breakInstantly().luminance(Blocks.createLightLevelFromBlockState(7)).sounds(BlockSoundGroup.WOOD).dropsLike(REDSTONE_TORCH)));
    public static final Block STONE_BUTTON = Blocks.register("stone_button", new StoneButtonBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.5f)));
    ...
    public static final Block PUMPKIN = Blocks.register("pumpkin", new PumpkinBlock(AbstractBlock.Settings.of(Material.GOURD, MaterialColor.ORANGE).strength(1.0f).sounds(BlockSoundGroup.WOOD)));
    public static final Block NETHERRACK = Blocks.register("netherrack", new NetherrackBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.NETHER).requiresTool().strength(0.4f).sounds(BlockSoundGroup.NETHERRACK)));
    public static final Block SOUL_SAND = Blocks.register("soul_sand", new SoulSandBlock(AbstractBlock.Settings.of(Material.AGGREGATE, MaterialColor.BROWN).strength(0.5f).velocityMultiplier(0.4f).sounds(BlockSoundGroup.SOUL_SAND).allowsSpawning(Blocks::always).solidBlock(Blocks::always).blockVision(Blocks::always).suffocates(Blocks::always)));
    public static final Block SOUL_SOIL = Blocks.register("soul_soil", new Block(AbstractBlock.Settings.of(Material.SOIL, MaterialColor.BROWN).strength(0.5f).sounds(BlockSoundGroup.SOUL_SOIL)));
    public static final Block BASALT = Blocks.register("basalt", new PillarBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK).requiresTool().strength(1.25f, 4.2f).sounds(BlockSoundGroup.BASALT)));
    public static final Block POLISHED_BASALT = Blocks.register("polished_basalt", new PillarBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK).requiresTool().strength(1.25f, 4.2f).sounds(BlockSoundGroup.BASALT)));
    public static final Block SOUL_TORCH = Blocks.register("soul_torch", new TorchBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().breakInstantly().luminance(state -> 10).sounds(BlockSoundGroup.WOOD), ParticleTypes.SOUL_FIRE_FLAME));
    public static final Block SOUL_WALL_TORCH = Blocks.register("soul_wall_torch", new WallTorchBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().breakInstantly().luminance(state -> 10).sounds(BlockSoundGroup.WOOD).dropsLike(SOUL_TORCH), ParticleTypes.SOUL_FIRE_FLAME));
    public static final Block GLOWSTONE = Blocks.register("glowstone", new Block(AbstractBlock.Settings.of(Material.GLASS, MaterialColor.SAND).strength(0.3f).sounds(BlockSoundGroup.GLASS).luminance(state -> 15)));
    ...
    public static final Block CARVED_PUMPKIN = Blocks.register("carved_pumpkin", new CarvedPumpkinBlock(AbstractBlock.Settings.of(Material.GOURD, MaterialColor.ORANGE).strength(1.0f).sounds(BlockSoundGroup.WOOD).allowsSpawning(Blocks::always)));
    public static final Block JACK_O_LANTERN = Blocks.register("jack_o_lantern", new CarvedPumpkinBlock(AbstractBlock.Settings.of(Material.GOURD, MaterialColor.ORANGE).strength(1.0f).sounds(BlockSoundGroup.WOOD).luminance(state -> 15).allowsSpawning(Blocks::always)));
    ...
    public static final Block REPEATER = Blocks.register("repeater", new RepeaterBlock(AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().sounds(BlockSoundGroup.WOOD)));
    ...
    public static final Block INFESTED_STONE = Blocks.register("infested_stone", new InfestedBlock(STONE, AbstractBlock.Settings.of(Material.ORGANIC_PRODUCT).strength(0.0f, 0.75f)));
    public static final Block INFESTED_COBBLESTONE = Blocks.register("infested_cobblestone", new InfestedBlock(COBBLESTONE, AbstractBlock.Settings.of(Material.ORGANIC_PRODUCT).strength(0.0f, 0.75f)));
    public static final Block INFESTED_STONE_BRICKS = Blocks.register("infested_stone_bricks", new InfestedBlock(STONE_BRICKS, AbstractBlock.Settings.of(Material.ORGANIC_PRODUCT).strength(0.0f, 0.75f)));
    public static final Block INFESTED_MOSSY_STONE_BRICKS = Blocks.register("infested_mossy_stone_bricks", new InfestedBlock(MOSSY_STONE_BRICKS, AbstractBlock.Settings.of(Material.ORGANIC_PRODUCT).strength(0.0f, 0.75f)));
    public static final Block INFESTED_CRACKED_STONE_BRICKS = Blocks.register("infested_cracked_stone_bricks", new InfestedBlock(CRACKED_STONE_BRICKS, AbstractBlock.Settings.of(Material.ORGANIC_PRODUCT).strength(0.0f, 0.75f)));
    public static final Block INFESTED_CHISELED_STONE_BRICKS = Blocks.register("infested_chiseled_stone_bricks", new InfestedBlock(CHISELED_STONE_BRICKS, AbstractBlock.Settings.of(Material.ORGANIC_PRODUCT).strength(0.0f, 0.75f)));
    ...
    public static final Block IRON_BARS = Blocks.register("iron_bars", new PaneBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.CLEAR).requiresTool().strength(5.0f, 6.0f).sounds(BlockSoundGroup.METAL).nonOpaque()));
    public static final Block CHAIN = Blocks.register("chain", new ChainBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.CLEAR).requiresTool().strength(5.0f, 6.0f).sounds(BlockSoundGroup.CHAIN).nonOpaque()));
    ...
    public static final Block MELON = Blocks.register("melon", new MelonBlock(AbstractBlock.Settings.of(Material.GOURD, MaterialColor.LIME).strength(1.0f).sounds(BlockSoundGroup.WOOD)));
    ...
    public static final Block MYCELIUM = Blocks.register("mycelium", new MyceliumBlock(AbstractBlock.Settings.of(Material.SOLID_ORGANIC, MaterialColor.PURPLE).ticksRandomly().strength(0.6f).sounds(BlockSoundGroup.GRASS)));
    ...
    public static final Block NETHER_BRICKS = Blocks.register("nether_bricks", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.NETHER).requiresTool().strength(2.0f, 6.0f).sounds(BlockSoundGroup.NETHER_BRICKS)));
    public static final Block NETHER_BRICK_FENCE = Blocks.register("nether_brick_fence", new FenceBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.NETHER).requiresTool().strength(2.0f, 6.0f).sounds(BlockSoundGroup.NETHER_BRICKS)));
    ...
    public static final Block ENCHANTING_TABLE = Blocks.register("enchanting_table", new EnchantingTableBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.RED).requiresTool().strength(5.0f, 1200.0f)));
    ...
    public static final Block CAULDRON = Blocks.register("cauldron", new CauldronBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.STONE).requiresTool().strength(2.0f).nonOpaque()));
    public static final Block END_PORTAL = Blocks.register("end_portal", new EndPortalBlock(AbstractBlock.Settings.of(Material.PORTAL, MaterialColor.BLACK).noCollision().luminance(state -> 15).strength(-1.0f, 3600000.0f).dropsNothing()));
    public static final Block END_PORTAL_FRAME = Blocks.register("end_portal_frame", new EndPortalFrameBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GREEN).sounds(BlockSoundGroup.GLASS).luminance(state -> 1).strength(-1.0f, 3600000.0f).dropsNothing()));
    public static final Block END_STONE = Blocks.register("end_stone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.SAND).requiresTool().strength(3.0f, 9.0f)));
    public static final Block DRAGON_EGG = Blocks.register("dragon_egg", new DragonEggBlock(AbstractBlock.Settings.of(Material.EGG, MaterialColor.BLACK).strength(3.0f, 9.0f).luminance(state -> 1).nonOpaque()));
    public static final Block REDSTONE_LAMP = Blocks.register("redstone_lamp", new RedstoneLampBlock(AbstractBlock.Settings.of(Material.REDSTONE_LAMP).luminance(Blocks.createLightLevelFromBlockState(15)).strength(0.3f).sounds(BlockSoundGroup.GLASS).allowsSpawning(Blocks::always)));
    ...
    public static final Block EMERALD_ORE = Blocks.register("emerald_ore", new OreBlock(AbstractBlock.Settings.of(Material.STONE).requiresTool().strength(3.0f, 3.0f)));
    ...
    public static final Block TRIPWIRE_HOOK = Blocks.register("tripwire_hook", new TripwireHookBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision()));
    public static final Block TRIPWIRE = Blocks.register("tripwire", new TripwireBlock((TripwireHookBlock)TRIPWIRE_HOOK, AbstractBlock.Settings.of(Material.SUPPORTED).noCollision()));
    public static final Block EMERALD_BLOCK = Blocks.register("emerald_block", new Block(AbstractBlock.Settings.of(Material.METAL, MaterialColor.EMERALD).requiresTool().strength(5.0f, 6.0f).sounds(BlockSoundGroup.METAL)));
    ...
    public static final Block COMMAND_BLOCK = Blocks.register("command_block", new CommandBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.BROWN).requiresTool().strength(-1.0f, 3600000.0f).dropsNothing()));
    public static final Block BEACON = Blocks.register("beacon", new BeaconBlock(AbstractBlock.Settings.of(Material.GLASS, MaterialColor.DIAMOND).strength(3.0f).luminance(state -> 15).nonOpaque().solidBlock(Blocks::never)));
    ...
    public static final Block FLOWER_POT = Blocks.register("flower_pot", new FlowerPotBlock(AIR, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_OAK_SAPLING = Blocks.register("potted_oak_sapling", new FlowerPotBlock(OAK_SAPLING, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_SPRUCE_SAPLING = Blocks.register("potted_spruce_sapling", new FlowerPotBlock(SPRUCE_SAPLING, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_BIRCH_SAPLING = Blocks.register("potted_birch_sapling", new FlowerPotBlock(BIRCH_SAPLING, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_JUNGLE_SAPLING = Blocks.register("potted_jungle_sapling", new FlowerPotBlock(JUNGLE_SAPLING, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_ACACIA_SAPLING = Blocks.register("potted_acacia_sapling", new FlowerPotBlock(ACACIA_SAPLING, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_DARK_OAK_SAPLING = Blocks.register("potted_dark_oak_sapling", new FlowerPotBlock(DARK_OAK_SAPLING, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_FERN = Blocks.register("potted_fern", new FlowerPotBlock(FERN, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_DANDELION = Blocks.register("potted_dandelion", new FlowerPotBlock(DANDELION, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_POPPY = Blocks.register("potted_poppy", new FlowerPotBlock(POPPY, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_BLUE_ORCHID = Blocks.register("potted_blue_orchid", new FlowerPotBlock(BLUE_ORCHID, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_ALLIUM = Blocks.register("potted_allium", new FlowerPotBlock(ALLIUM, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_AZURE_BLUET = Blocks.register("potted_azure_bluet", new FlowerPotBlock(AZURE_BLUET, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_RED_TULIP = Blocks.register("potted_red_tulip", new FlowerPotBlock(RED_TULIP, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_ORANGE_TULIP = Blocks.register("potted_orange_tulip", new FlowerPotBlock(ORANGE_TULIP, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_WHITE_TULIP = Blocks.register("potted_white_tulip", new FlowerPotBlock(WHITE_TULIP, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_PINK_TULIP = Blocks.register("potted_pink_tulip", new FlowerPotBlock(PINK_TULIP, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_OXEYE_DAISY = Blocks.register("potted_oxeye_daisy", new FlowerPotBlock(OXEYE_DAISY, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_CORNFLOWER = Blocks.register("potted_cornflower", new FlowerPotBlock(CORNFLOWER, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_LILY_OF_THE_VALLEY = Blocks.register("potted_lily_of_the_valley", new FlowerPotBlock(LILY_OF_THE_VALLEY, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_WITHER_ROSE = Blocks.register("potted_wither_rose", new FlowerPotBlock(WITHER_ROSE, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_RED_MUSHROOM = Blocks.register("potted_red_mushroom", new FlowerPotBlock(RED_MUSHROOM, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_BROWN_MUSHROOM = Blocks.register("potted_brown_mushroom", new FlowerPotBlock(BROWN_MUSHROOM, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_DEAD_BUSH = Blocks.register("potted_dead_bush", new FlowerPotBlock(DEAD_BUSH, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    public static final Block POTTED_CACTUS = Blocks.register("potted_cactus", new FlowerPotBlock(CACTUS, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    ...
    public static final Block OAK_BUTTON = Blocks.register("oak_button", new WoodenButtonBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    public static final Block SPRUCE_BUTTON = Blocks.register("spruce_button", new WoodenButtonBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    public static final Block BIRCH_BUTTON = Blocks.register("birch_button", new WoodenButtonBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    public static final Block JUNGLE_BUTTON = Blocks.register("jungle_button", new WoodenButtonBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    public static final Block ACACIA_BUTTON = Blocks.register("acacia_button", new WoodenButtonBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    public static final Block DARK_OAK_BUTTON = Blocks.register("dark_oak_button", new WoodenButtonBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    public static final Block SKELETON_SKULL = Blocks.register("skeleton_skull", new SkullBlock(SkullBlock.Type.SKELETON, AbstractBlock.Settings.of(Material.SUPPORTED).strength(1.0f)));
    public static final Block SKELETON_WALL_SKULL = Blocks.register("skeleton_wall_skull", new WallSkullBlock(SkullBlock.Type.SKELETON, AbstractBlock.Settings.of(Material.SUPPORTED).strength(1.0f).dropsLike(SKELETON_SKULL)));
    public static final Block WITHER_SKELETON_SKULL = Blocks.register("wither_skeleton_skull", new WitherSkullBlock(AbstractBlock.Settings.of(Material.SUPPORTED).strength(1.0f)));
    public static final Block WITHER_SKELETON_WALL_SKULL = Blocks.register("wither_skeleton_wall_skull", new WallWitherSkullBlock(AbstractBlock.Settings.of(Material.SUPPORTED).strength(1.0f).dropsLike(WITHER_SKELETON_SKULL)));
    public static final Block ZOMBIE_HEAD = Blocks.register("zombie_head", new SkullBlock(SkullBlock.Type.ZOMBIE, AbstractBlock.Settings.of(Material.SUPPORTED).strength(1.0f)));
    public static final Block ZOMBIE_WALL_HEAD = Blocks.register("zombie_wall_head", new WallSkullBlock(SkullBlock.Type.ZOMBIE, AbstractBlock.Settings.of(Material.SUPPORTED).strength(1.0f).dropsLike(ZOMBIE_HEAD)));
    public static final Block PLAYER_HEAD = Blocks.register("player_head", new PlayerSkullBlock(AbstractBlock.Settings.of(Material.SUPPORTED).strength(1.0f)));
    public static final Block PLAYER_WALL_HEAD = Blocks.register("player_wall_head", new WallPlayerSkullBlock(AbstractBlock.Settings.of(Material.SUPPORTED).strength(1.0f).dropsLike(PLAYER_HEAD)));
    public static final Block CREEPER_HEAD = Blocks.register("creeper_head", new SkullBlock(SkullBlock.Type.CREEPER, AbstractBlock.Settings.of(Material.SUPPORTED).strength(1.0f)));
    public static final Block CREEPER_WALL_HEAD = Blocks.register("creeper_wall_head", new WallSkullBlock(SkullBlock.Type.CREEPER, AbstractBlock.Settings.of(Material.SUPPORTED).strength(1.0f).dropsLike(CREEPER_HEAD)));
    public static final Block DRAGON_HEAD = Blocks.register("dragon_head", new SkullBlock(SkullBlock.Type.DRAGON, AbstractBlock.Settings.of(Material.SUPPORTED).strength(1.0f)));
    public static final Block DRAGON_WALL_HEAD = Blocks.register("dragon_wall_head", new WallSkullBlock(SkullBlock.Type.DRAGON, AbstractBlock.Settings.of(Material.SUPPORTED).strength(1.0f).dropsLike(DRAGON_HEAD)));
    public static final Block ANVIL = Blocks.register("anvil", new AnvilBlock(AbstractBlock.Settings.of(Material.REPAIR_STATION, MaterialColor.IRON).requiresTool().strength(5.0f, 1200.0f).sounds(BlockSoundGroup.ANVIL)));
    public static final Block CHIPPED_ANVIL = Blocks.register("chipped_anvil", new AnvilBlock(AbstractBlock.Settings.of(Material.REPAIR_STATION, MaterialColor.IRON).requiresTool().strength(5.0f, 1200.0f).sounds(BlockSoundGroup.ANVIL)));
    public static final Block DAMAGED_ANVIL = Blocks.register("damaged_anvil", new AnvilBlock(AbstractBlock.Settings.of(Material.REPAIR_STATION, MaterialColor.IRON).requiresTool().strength(5.0f, 1200.0f).sounds(BlockSoundGroup.ANVIL)));
    ...
    public static final Block LIGHT_WEIGHTED_PRESSURE_PLATE = Blocks.register("light_weighted_pressure_plate", new WeightedPressurePlateBlock(15, AbstractBlock.Settings.of(Material.METAL, MaterialColor.GOLD).requiresTool().noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    ...
    public static final Block COMPARATOR = Blocks.register("comparator", new ComparatorBlock(AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().sounds(BlockSoundGroup.WOOD)));
    ...
    public static final Block REDSTONE_BLOCK = Blocks.register("redstone_block", new RedstoneBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.LAVA).requiresTool().strength(5.0f, 6.0f).sounds(BlockSoundGroup.METAL).solidBlock(Blocks::never)));
    public static final Block NETHER_QUARTZ_ORE = Blocks.register("nether_quartz_ore", new OreBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.NETHER).requiresTool().strength(3.0f, 3.0f).sounds(BlockSoundGroup.NETHER_ORE)));
    public static final Block HOPPER = Blocks.register("hopper", new HopperBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.STONE).requiresTool().strength(3.0f, 4.8f).sounds(BlockSoundGroup.METAL).nonOpaque()));
    public static final Block QUARTZ_BLOCK = Blocks.register("quartz_block", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.QUARTZ).requiresTool().strength(0.8f)));
    public static final Block CHISELED_QUARTZ_BLOCK = Blocks.register("chiseled_quartz_block", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.QUARTZ).requiresTool().strength(0.8f)));
    public static final Block QUARTZ_PILLAR = Blocks.register("quartz_pillar", new PillarBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.QUARTZ).requiresTool().strength(0.8f)));
    ...
    public static final Block ACTIVATOR_RAIL = Blocks.register("activator_rail", new PoweredRailBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.7f).sounds(BlockSoundGroup.METAL)));
    ...
    public static final Block WHITE_TERRACOTTA = Blocks.register("white_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.WHITE_TERRACOTTA).requiresTool().strength(1.25f, 4.2f)));
    public static final Block ORANGE_TERRACOTTA = Blocks.register("orange_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.ORANGE_TERRACOTTA).requiresTool().strength(1.25f, 4.2f)));
    public static final Block MAGENTA_TERRACOTTA = Blocks.register("magenta_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.MAGENTA_TERRACOTTA).requiresTool().strength(1.25f, 4.2f)));
    public static final Block LIGHT_BLUE_TERRACOTTA = Blocks.register("light_blue_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.LIGHT_BLUE_TERRACOTTA).requiresTool().strength(1.25f, 4.2f)));
    public static final Block YELLOW_TERRACOTTA = Blocks.register("yellow_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.YELLOW_TERRACOTTA).requiresTool().strength(1.25f, 4.2f)));
    public static final Block LIME_TERRACOTTA = Blocks.register("lime_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.LIME_TERRACOTTA).requiresTool().strength(1.25f, 4.2f)));
    public static final Block PINK_TERRACOTTA = Blocks.register("pink_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.PINK_TERRACOTTA).requiresTool().strength(1.25f, 4.2f)));
    public static final Block GRAY_TERRACOTTA = Blocks.register("gray_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY_TERRACOTTA).requiresTool().strength(1.25f, 4.2f)));
    public static final Block LIGHT_GRAY_TERRACOTTA = Blocks.register("light_gray_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.LIGHT_GRAY_TERRACOTTA).requiresTool().strength(1.25f, 4.2f)));
    public static final Block CYAN_TERRACOTTA = Blocks.register("cyan_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.CYAN_TERRACOTTA).requiresTool().strength(1.25f, 4.2f)));
    public static final Block PURPLE_TERRACOTTA = Blocks.register("purple_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.PURPLE_TERRACOTTA).requiresTool().strength(1.25f, 4.2f)));
    public static final Block BLUE_TERRACOTTA = Blocks.register("blue_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLUE_TERRACOTTA).requiresTool().strength(1.25f, 4.2f)));
    public static final Block BROWN_TERRACOTTA = Blocks.register("brown_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BROWN_TERRACOTTA).requiresTool().strength(1.25f, 4.2f)));
    public static final Block GREEN_TERRACOTTA = Blocks.register("green_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GREEN_TERRACOTTA).requiresTool().strength(1.25f, 4.2f)));
    public static final Block RED_TERRACOTTA = Blocks.register("red_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.RED_TERRACOTTA).requiresTool().strength(1.25f, 4.2f)));
    public static final Block BLACK_TERRACOTTA = Blocks.register("black_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK_TERRACOTTA).requiresTool().strength(1.25f, 4.2f)));
    ...
    public static final Block SLIME_BLOCK = Blocks.register("slime_block", new SlimeBlock(AbstractBlock.Settings.of(Material.ORGANIC_PRODUCT, MaterialColor.GRASS).slipperiness(0.8f).sounds(BlockSoundGroup.SLIME).nonOpaque()));
    ...
    public static final Block PRISMARINE = Blocks.register("prismarine", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.CYAN).requiresTool().strength(1.5f, 6.0f)));
    public static final Block PRISMARINE_BRICKS = Blocks.register("prismarine_bricks", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.DIAMOND).requiresTool().strength(1.5f, 6.0f)));
    public static final Block DARK_PRISMARINE = Blocks.register("dark_prismarine", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.DIAMOND).requiresTool().strength(1.5f, 6.0f)));
    ...
    public static final Block PRISMARINE_SLAB = Blocks.register("prismarine_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.CYAN).requiresTool().strength(1.5f, 6.0f)));
    public static final Block PRISMARINE_BRICK_SLAB = Blocks.register("prismarine_brick_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.DIAMOND).requiresTool().strength(1.5f, 6.0f)));
    public static final Block DARK_PRISMARINE_SLAB = Blocks.register("dark_prismarine_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.DIAMOND).requiresTool().strength(1.5f, 6.0f)));
    public static final Block SEA_LANTERN = Blocks.register("sea_lantern", new Block(AbstractBlock.Settings.of(Material.GLASS, MaterialColor.QUARTZ).strength(0.3f).sounds(BlockSoundGroup.GLASS).luminance(state -> 15)));
    public static final Block HAY_BLOCK = Blocks.register("hay_block", new HayBlock(AbstractBlock.Settings.of(Material.SOLID_ORGANIC, MaterialColor.YELLOW).strength(0.5f).sounds(BlockSoundGroup.GRASS)));
    ...
    public static final Block TERRACOTTA = Blocks.register("terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.ORANGE).requiresTool().strength(1.25f, 4.2f)));
    public static final Block COAL_BLOCK = Blocks.register("coal_block", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK).requiresTool().strength(5.0f, 6.0f)));
    ...
    public static final Block RED_SANDSTONE = Blocks.register("red_sandstone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.ORANGE).requiresTool().strength(0.8f)));
    public static final Block CHISELED_RED_SANDSTONE = Blocks.register("chiseled_red_sandstone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.ORANGE).requiresTool().strength(0.8f)));
    public static final Block CUT_RED_SANDSTONE = Blocks.register("cut_red_sandstone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.ORANGE).requiresTool().strength(0.8f)));
    ...
    public static final Block STONE_SLAB = Blocks.register("stone_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.STONE).requiresTool().strength(2.0f, 6.0f)));
    public static final Block SMOOTH_STONE_SLAB = Blocks.register("smooth_stone_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.STONE).requiresTool().strength(2.0f, 6.0f)));
    public static final Block SANDSTONE_SLAB = Blocks.register("sandstone_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.SAND).requiresTool().strength(2.0f, 6.0f)));
    public static final Block CUT_SANDSTONE_SLAB = Blocks.register("cut_sandstone_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.SAND).requiresTool().strength(2.0f, 6.0f)));
    public static final Block PETRIFIED_OAK_SLAB = Blocks.register("petrified_oak_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.WOOD).requiresTool().strength(2.0f, 6.0f)));
    public static final Block COBBLESTONE_SLAB = Blocks.register("cobblestone_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.STONE).requiresTool().strength(2.0f, 6.0f)));
    public static final Block BRICK_SLAB = Blocks.register("brick_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.RED).requiresTool().strength(2.0f, 6.0f)));
    public static final Block STONE_BRICK_SLAB = Blocks.register("stone_brick_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.STONE).requiresTool().strength(2.0f, 6.0f)));
    public static final Block NETHER_BRICK_SLAB = Blocks.register("nether_brick_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.NETHER).requiresTool().strength(2.0f, 6.0f).sounds(BlockSoundGroup.NETHER_BRICKS)));
    public static final Block QUARTZ_SLAB = Blocks.register("quartz_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.QUARTZ).requiresTool().strength(2.0f, 6.0f)));
    public static final Block RED_SANDSTONE_SLAB = Blocks.register("red_sandstone_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.ORANGE).requiresTool().strength(2.0f, 6.0f)));
    public static final Block CUT_RED_SANDSTONE_SLAB = Blocks.register("cut_red_sandstone_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.ORANGE).requiresTool().strength(2.0f, 6.0f)));
    public static final Block PURPUR_SLAB = Blocks.register("purpur_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.MAGENTA).requiresTool().strength(2.0f, 6.0f)));
    public static final Block SMOOTH_STONE = Blocks.register("smooth_stone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.STONE).requiresTool().strength(2.0f, 6.0f)));
    public static final Block SMOOTH_SANDSTONE = Blocks.register("smooth_sandstone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.SAND).requiresTool().strength(2.0f, 6.0f)));
    public static final Block SMOOTH_QUARTZ = Blocks.register("smooth_quartz", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.QUARTZ).requiresTool().strength(2.0f, 6.0f)));
    public static final Block SMOOTH_RED_SANDSTONE = Blocks.register("smooth_red_sandstone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.ORANGE).requiresTool().strength(2.0f, 6.0f)));
    ...
    public static final Block END_ROD = Blocks.register("end_rod", new EndRodBlock(AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().luminance(state -> 14).sounds(BlockSoundGroup.WOOD).nonOpaque()));
    ...
    public static final Block PURPUR_BLOCK = Blocks.register("purpur_block", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.MAGENTA).requiresTool().strength(1.5f, 6.0f)));
    public static final Block PURPUR_PILLAR = Blocks.register("purpur_pillar", new PillarBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.MAGENTA).requiresTool().strength(1.5f, 6.0f)));
    ...
    public static final Block END_STONE_BRICKS = Blocks.register("end_stone_bricks", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.SAND).requiresTool().strength(3.0f, 9.0f)));
    ...
    public static final Block GRASS_PATH = Blocks.register("grass_path", new GrassPathBlock(AbstractBlock.Settings.of(Material.SOIL).strength(0.65f).sounds(BlockSoundGroup.GRASS).blockVision(Blocks::always).suffocates(Blocks::always)));
    public static final Block END_GATEWAY = Blocks.register("end_gateway", new EndGatewayBlock(AbstractBlock.Settings.of(Material.PORTAL, MaterialColor.BLACK).noCollision().luminance(state -> 15).strength(-1.0f, 3600000.0f).dropsNothing()));
    public static final Block REPEATING_COMMAND_BLOCK = Blocks.register("repeating_command_block", new CommandBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.PURPLE).requiresTool().strength(-1.0f, 3600000.0f).dropsNothing()));
    public static final Block CHAIN_COMMAND_BLOCK = Blocks.register("chain_command_block", new CommandBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.GREEN).requiresTool().strength(-1.0f, 3600000.0f).dropsNothing()));
    ...
    public static final Block MAGMA_BLOCK = Blocks.register("magma_block", new MagmaBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.NETHER).requiresTool().luminance(state -> 3).ticksRandomly().strength(0.5f).allowsSpawning((state, world, pos, entityType) -> entityType.isFireImmune()).postProcess(Blocks::always).emissiveLighting(Blocks::always)));
    public static final Block NETHER_WART_BLOCK = Blocks.register("nether_wart_block", new Block(AbstractBlock.Settings.of(Material.SOLID_ORGANIC, MaterialColor.RED).strength(1.0f).sounds(BlockSoundGroup.WART_BLOCK)));
    public static final Block RED_NETHER_BRICKS = Blocks.register("red_nether_bricks", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.NETHER).requiresTool().strength(2.0f, 6.0f).sounds(BlockSoundGroup.NETHER_BRICKS)));
    public static final Block BONE_BLOCK = Blocks.register("bone_block", new PillarBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.SAND).requiresTool().strength(2.0f).sounds(BlockSoundGroup.BONE)));
    ...
    public static final Block DRIED_KELP_BLOCK = Blocks.register("dried_kelp_block", new Block(AbstractBlock.Settings.of(Material.SOLID_ORGANIC, MaterialColor.GREEN).strength(0.5f, 2.5f).sounds(BlockSoundGroup.GRASS)));
    ...
    public static final Block DEAD_TUBE_CORAL_BLOCK = Blocks.register("dead_tube_coral_block", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).requiresTool().strength(1.5f, 6.0f)));
    public static final Block DEAD_BRAIN_CORAL_BLOCK = Blocks.register("dead_brain_coral_block", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).requiresTool().strength(1.5f, 6.0f)));
    public static final Block DEAD_BUBBLE_CORAL_BLOCK = Blocks.register("dead_bubble_coral_block", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).requiresTool().strength(1.5f, 6.0f)));
    public static final Block DEAD_FIRE_CORAL_BLOCK = Blocks.register("dead_fire_coral_block", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).requiresTool().strength(1.5f, 6.0f)));
    public static final Block DEAD_HORN_CORAL_BLOCK = Blocks.register("dead_horn_coral_block", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).requiresTool().strength(1.5f, 6.0f)));
    public static final Block TUBE_CORAL_BLOCK = Blocks.register("tube_coral_block", new CoralBlockBlock(DEAD_TUBE_CORAL_BLOCK, AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLUE).requiresTool().strength(1.5f, 6.0f).sounds(BlockSoundGroup.CORAL)));
    public static final Block BRAIN_CORAL_BLOCK = Blocks.register("brain_coral_block", new CoralBlockBlock(DEAD_BRAIN_CORAL_BLOCK, AbstractBlock.Settings.of(Material.STONE, MaterialColor.PINK).requiresTool().strength(1.5f, 6.0f).sounds(BlockSoundGroup.CORAL)));
    public static final Block BUBBLE_CORAL_BLOCK = Blocks.register("bubble_coral_block", new CoralBlockBlock(DEAD_BUBBLE_CORAL_BLOCK, AbstractBlock.Settings.of(Material.STONE, MaterialColor.PURPLE).requiresTool().strength(1.5f, 6.0f).sounds(BlockSoundGroup.CORAL)));
    public static final Block FIRE_CORAL_BLOCK = Blocks.register("fire_coral_block", new CoralBlockBlock(DEAD_FIRE_CORAL_BLOCK, AbstractBlock.Settings.of(Material.STONE, MaterialColor.RED).requiresTool().strength(1.5f, 6.0f).sounds(BlockSoundGroup.CORAL)));
    public static final Block HORN_CORAL_BLOCK = Blocks.register("horn_coral_block", new CoralBlockBlock(DEAD_HORN_CORAL_BLOCK, AbstractBlock.Settings.of(Material.STONE, MaterialColor.YELLOW).requiresTool().strength(1.5f, 6.0f).sounds(BlockSoundGroup.CORAL)));
    public static final Block DEAD_TUBE_CORAL = Blocks.register("dead_tube_coral", new DeadCoralBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).requiresTool().noCollision().breakInstantly()));
    public static final Block DEAD_BRAIN_CORAL = Blocks.register("dead_brain_coral", new DeadCoralBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).requiresTool().noCollision().breakInstantly()));
    public static final Block DEAD_BUBBLE_CORAL = Blocks.register("dead_bubble_coral", new DeadCoralBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).requiresTool().noCollision().breakInstantly()));
    public static final Block DEAD_FIRE_CORAL = Blocks.register("dead_fire_coral", new DeadCoralBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).requiresTool().noCollision().breakInstantly()));
    public static final Block DEAD_HORN_CORAL = Blocks.register("dead_horn_coral", new DeadCoralBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).requiresTool().noCollision().breakInstantly()));
    ...
    public static final Block DEAD_TUBE_CORAL_FAN = Blocks.register("dead_tube_coral_fan", new DeadCoralFanBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).requiresTool().noCollision().breakInstantly()));
    public static final Block DEAD_BRAIN_CORAL_FAN = Blocks.register("dead_brain_coral_fan", new DeadCoralFanBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).requiresTool().noCollision().breakInstantly()));
    public static final Block DEAD_BUBBLE_CORAL_FAN = Blocks.register("dead_bubble_coral_fan", new DeadCoralFanBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).requiresTool().noCollision().breakInstantly()));
    public static final Block DEAD_FIRE_CORAL_FAN = Blocks.register("dead_fire_coral_fan", new DeadCoralFanBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).requiresTool().noCollision().breakInstantly()));
    public static final Block DEAD_HORN_CORAL_FAN = Blocks.register("dead_horn_coral_fan", new DeadCoralFanBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).requiresTool().noCollision().breakInstantly()));
    ...
    public static final Block DEAD_TUBE_CORAL_WALL_FAN = Blocks.register("dead_tube_coral_wall_fan", new DeadCoralWallFanBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).requiresTool().noCollision().breakInstantly().dropsLike(DEAD_TUBE_CORAL_FAN)));
    public static final Block DEAD_BRAIN_CORAL_WALL_FAN = Blocks.register("dead_brain_coral_wall_fan", new DeadCoralWallFanBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).requiresTool().noCollision().breakInstantly().dropsLike(DEAD_BRAIN_CORAL_FAN)));
    public static final Block DEAD_BUBBLE_CORAL_WALL_FAN = Blocks.register("dead_bubble_coral_wall_fan", new DeadCoralWallFanBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).requiresTool().noCollision().breakInstantly().dropsLike(DEAD_BUBBLE_CORAL_FAN)));
    public static final Block DEAD_FIRE_CORAL_WALL_FAN = Blocks.register("dead_fire_coral_wall_fan", new DeadCoralWallFanBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).requiresTool().noCollision().breakInstantly().dropsLike(DEAD_FIRE_CORAL_FAN)));
    public static final Block DEAD_HORN_CORAL_WALL_FAN = Blocks.register("dead_horn_coral_wall_fan", new DeadCoralWallFanBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).requiresTool().noCollision().breakInstantly().dropsLike(DEAD_HORN_CORAL_FAN)));
    ...
    public static final Block SEA_PICKLE = Blocks.register("sea_pickle", new SeaPickleBlock(AbstractBlock.Settings.of(Material.UNDERWATER_PLANT, MaterialColor.GREEN).luminance(state -> SeaPickleBlock.isDry(state) ? 0 : 3 + 3 * state.get(SeaPickleBlock.PICKLES)).sounds(BlockSoundGroup.SLIME).nonOpaque()));
    ...
    public static final Block CONDUIT = Blocks.register("conduit", new ConduitBlock(AbstractBlock.Settings.of(Material.GLASS, MaterialColor.DIAMOND).strength(3.0f).luminance(state -> 15).nonOpaque()));
    ...
    public static final Block POTTED_BAMBOO = Blocks.register("potted_bamboo", new FlowerPotBlock(BAMBOO, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    ...
    public static final Block SCAFFOLDING = Blocks.register("scaffolding", new ScaffoldingBlock(AbstractBlock.Settings.of(Material.SUPPORTED, MaterialColor.SAND).noCollision().sounds(BlockSoundGroup.SCAFFOLDING).dynamicBounds()));
    ...
    public static final Block SMOKER = Blocks.register("smoker", new SmokerBlock(AbstractBlock.Settings.of(Material.STONE).requiresTool().strength(3.5f).luminance(Blocks.createLightLevelFromBlockState(13))));
    public static final Block BLAST_FURNACE = Blocks.register("blast_furnace", new BlastFurnaceBlock(AbstractBlock.Settings.of(Material.STONE).requiresTool().strength(3.5f).luminance(Blocks.createLightLevelFromBlockState(13))));
    ...
    public static final Block GRINDSTONE = Blocks.register("grindstone", new GrindstoneBlock(AbstractBlock.Settings.of(Material.REPAIR_STATION, MaterialColor.IRON).requiresTool().strength(2.0f, 6.0f).sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block BELL = Blocks.register("bell", new BellBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.GOLD).requiresTool().strength(5.0f).sounds(BlockSoundGroup.ANVIL)));
    ...
    public static final Block CAMPFIRE = Blocks.register("campfire", new CampfireBlock(true, 1, AbstractBlock.Settings.of(Material.WOOD, MaterialColor.SPRUCE).strength(2.0f).sounds(BlockSoundGroup.WOOD).luminance(Blocks.createLightLevelFromBlockState(15)).nonOpaque()));
    public static final Block SOUL_CAMPFIRE = Blocks.register("soul_campfire", new CampfireBlock(false, 2, AbstractBlock.Settings.of(Material.WOOD, MaterialColor.SPRUCE).strength(2.0f).sounds(BlockSoundGroup.WOOD).luminance(Blocks.createLightLevelFromBlockState(10)).nonOpaque()));
    ...
    public static final Block WARPED_STEM = Blocks.register("warped_stem", Blocks.createNetherStemBlock(MaterialColor.field_25706));
    public static final Block STRIPPED_WARPED_STEM = Blocks.register("stripped_warped_stem", Blocks.createNetherStemBlock(MaterialColor.field_25706));
    public static final Block WARPED_HYPHAE = Blocks.register("warped_hyphae", new PillarBlock(AbstractBlock.Settings.of(Material.NETHER_WOOD, MaterialColor.field_25707).strength(2.0f).sounds(BlockSoundGroup.NETHER_STEM)));
    public static final Block STRIPPED_WARPED_HYPHAE = Blocks.register("stripped_warped_hyphae", new PillarBlock(AbstractBlock.Settings.of(Material.NETHER_WOOD, MaterialColor.field_25707).strength(2.0f).sounds(BlockSoundGroup.NETHER_STEM)));
    public static final Block WARPED_NYLIUM = Blocks.register("warped_nylium", new NyliumBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.field_25705).requiresTool().strength(0.4f).sounds(BlockSoundGroup.NYLIUM).ticksRandomly()));
    public static final Block WARPED_FUNGUS = Blocks.register("warped_fungus", new FungusBlock(AbstractBlock.Settings.of(Material.PLANT, MaterialColor.CYAN).breakInstantly().noCollision().sounds(BlockSoundGroup.FUNGUS), () -> ConfiguredFeatures.WARPED_FUNGI_PLANTED));
    public static final Block WARPED_WART_BLOCK = Blocks.register("warped_wart_block", new Block(AbstractBlock.Settings.of(Material.SOLID_ORGANIC, MaterialColor.field_25708).strength(1.0f).sounds(BlockSoundGroup.WART_BLOCK)));
    public static final Block WARPED_ROOTS = Blocks.register("warped_roots", new RootsBlock(AbstractBlock.Settings.of(Material.NETHER_SHOOTS, MaterialColor.CYAN).noCollision().breakInstantly().sounds(BlockSoundGroup.ROOTS)));
    public static final Block NETHER_SPROUTS = Blocks.register("nether_sprouts", new SproutsBlock(AbstractBlock.Settings.of(Material.NETHER_SHOOTS, MaterialColor.CYAN).noCollision().breakInstantly().sounds(BlockSoundGroup.NETHER_SPROUTS)));
    public static final Block CRIMSON_STEM = Blocks.register("crimson_stem", Blocks.createNetherStemBlock(MaterialColor.field_25703));
    public static final Block STRIPPED_CRIMSON_STEM = Blocks.register("stripped_crimson_stem", Blocks.createNetherStemBlock(MaterialColor.field_25703));
    public static final Block CRIMSON_HYPHAE = Blocks.register("crimson_hyphae", new PillarBlock(AbstractBlock.Settings.of(Material.NETHER_WOOD, MaterialColor.field_25704).strength(2.0f).sounds(BlockSoundGroup.NETHER_STEM)));
    public static final Block STRIPPED_CRIMSON_HYPHAE = Blocks.register("stripped_crimson_hyphae", new PillarBlock(AbstractBlock.Settings.of(Material.NETHER_WOOD, MaterialColor.field_25704).strength(2.0f).sounds(BlockSoundGroup.NETHER_STEM)));
    public static final Block CRIMSON_NYLIUM = Blocks.register("crimson_nylium", new NyliumBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.field_25702).requiresTool().strength(0.4f).sounds(BlockSoundGroup.NYLIUM).ticksRandomly()));
    public static final Block CRIMSON_FUNGUS = Blocks.register("crimson_fungus", new FungusBlock(AbstractBlock.Settings.of(Material.PLANT, MaterialColor.NETHER).breakInstantly().noCollision().sounds(BlockSoundGroup.FUNGUS), () -> ConfiguredFeatures.CRIMSON_FUNGI_PLANTED));
    public static final Block SHROOMLIGHT = Blocks.register("shroomlight", new Block(AbstractBlock.Settings.of(Material.SOLID_ORGANIC, MaterialColor.RED).strength(1.0f).sounds(BlockSoundGroup.SHROOMLIGHT).luminance(state -> 15)));
    public static final Block WEEPING_VINES = Blocks.register("weeping_vines", new WeepingVinesBlock(AbstractBlock.Settings.of(Material.PLANT, MaterialColor.NETHER).ticksRandomly().noCollision().breakInstantly().sounds(BlockSoundGroup.WEEPING_VINES)));
    public static final Block WEEPING_VINES_PLANT = Blocks.register("weeping_vines_plant", new WeepingVinesPlantBlock(AbstractBlock.Settings.of(Material.PLANT, MaterialColor.NETHER).noCollision().breakInstantly().sounds(BlockSoundGroup.WEEPING_VINES)));
    public static final Block TWISTING_VINES = Blocks.register("twisting_vines", new TwistingVinesBlock(AbstractBlock.Settings.of(Material.PLANT, MaterialColor.CYAN).ticksRandomly().noCollision().breakInstantly().sounds(BlockSoundGroup.WEEPING_VINES)));
    public static final Block TWISTING_VINES_PLANT = Blocks.register("twisting_vines_plant", new TwistingVinesPlantBlock(AbstractBlock.Settings.of(Material.PLANT, MaterialColor.CYAN).noCollision().breakInstantly().sounds(BlockSoundGroup.WEEPING_VINES)));
    public static final Block CRIMSON_ROOTS = Blocks.register("crimson_roots", new RootsBlock(AbstractBlock.Settings.of(Material.NETHER_SHOOTS, MaterialColor.NETHER).noCollision().breakInstantly().sounds(BlockSoundGroup.ROOTS)));
    public static final Block CRIMSON_PLANKS = Blocks.register("crimson_planks", new Block(AbstractBlock.Settings.of(Material.NETHER_WOOD, MaterialColor.field_25703).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)));
    public static final Block WARPED_PLANKS = Blocks.register("warped_planks", new Block(AbstractBlock.Settings.of(Material.NETHER_WOOD, MaterialColor.field_25706).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)));
    public static final Block CRIMSON_SLAB = Blocks.register("crimson_slab", new SlabBlock(AbstractBlock.Settings.of(Material.NETHER_WOOD, CRIMSON_PLANKS.getDefaultMaterialColor()).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)));
    public static final Block WARPED_SLAB = Blocks.register("warped_slab", new SlabBlock(AbstractBlock.Settings.of(Material.NETHER_WOOD, WARPED_PLANKS.getDefaultMaterialColor()).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)));
    public static final Block CRIMSON_PRESSURE_PLATE = Blocks.register("crimson_pressure_plate", new PressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, AbstractBlock.Settings.of(Material.NETHER_WOOD, CRIMSON_PLANKS.getDefaultMaterialColor()).noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    public static final Block WARPED_PRESSURE_PLATE = Blocks.register("warped_pressure_plate", new PressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, AbstractBlock.Settings.of(Material.NETHER_WOOD, WARPED_PLANKS.getDefaultMaterialColor()).noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    public static final Block CRIMSON_FENCE = Blocks.register("crimson_fence", new FenceBlock(AbstractBlock.Settings.of(Material.NETHER_WOOD, CRIMSON_PLANKS.getDefaultMaterialColor()).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)));
    public static final Block WARPED_FENCE = Blocks.register("warped_fence", new FenceBlock(AbstractBlock.Settings.of(Material.NETHER_WOOD, WARPED_PLANKS.getDefaultMaterialColor()).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)));
    public static final Block CRIMSON_TRAPDOOR = Blocks.register("crimson_trapdoor", new TrapdoorBlock(AbstractBlock.Settings.of(Material.NETHER_WOOD, CRIMSON_PLANKS.getDefaultMaterialColor()).strength(3.0f).sounds(BlockSoundGroup.WOOD).nonOpaque().allowsSpawning(Blocks::never)));
    public static final Block WARPED_TRAPDOOR = Blocks.register("warped_trapdoor", new TrapdoorBlock(AbstractBlock.Settings.of(Material.NETHER_WOOD, WARPED_PLANKS.getDefaultMaterialColor()).strength(3.0f).sounds(BlockSoundGroup.WOOD).nonOpaque().allowsSpawning(Blocks::never)));
    public static final Block CRIMSON_FENCE_GATE = Blocks.register("crimson_fence_gate", new FenceGateBlock(AbstractBlock.Settings.of(Material.NETHER_WOOD, CRIMSON_PLANKS.getDefaultMaterialColor()).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)));
    public static final Block WARPED_FENCE_GATE = Blocks.register("warped_fence_gate", new FenceGateBlock(AbstractBlock.Settings.of(Material.NETHER_WOOD, WARPED_PLANKS.getDefaultMaterialColor()).strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD)));
    ...
    public static final Block CRIMSON_BUTTON = Blocks.register("crimson_button", new WoodenButtonBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    public static final Block WARPED_BUTTON = Blocks.register("warped_button", new WoodenButtonBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    ...
    public static final Block CRIMSON_SIGN = Blocks.register("crimson_sign", new SignBlock(AbstractBlock.Settings.of(Material.NETHER_WOOD, CRIMSON_PLANKS.getDefaultMaterialColor()).noCollision().strength(1.0f).sounds(BlockSoundGroup.WOOD), SignType.CRIMSON));
    public static final Block WARPED_SIGN = Blocks.register("warped_sign", new SignBlock(AbstractBlock.Settings.of(Material.NETHER_WOOD, WARPED_PLANKS.getDefaultMaterialColor()).noCollision().strength(1.0f).sounds(BlockSoundGroup.WOOD), SignType.WARPED));
    public static final Block CRIMSON_WALL_SIGN = Blocks.register("crimson_wall_sign", new WallSignBlock(AbstractBlock.Settings.of(Material.NETHER_WOOD, CRIMSON_PLANKS.getDefaultMaterialColor()).noCollision().strength(1.0f).sounds(BlockSoundGroup.WOOD).dropsLike(CRIMSON_SIGN), SignType.CRIMSON));
    public static final Block WARPED_WALL_SIGN = Blocks.register("warped_wall_sign", new WallSignBlock(AbstractBlock.Settings.of(Material.NETHER_WOOD, WARPED_PLANKS.getDefaultMaterialColor()).noCollision().strength(1.0f).sounds(BlockSoundGroup.WOOD).dropsLike(WARPED_SIGN), SignType.WARPED));
    public static final Block STRUCTURE_BLOCK = Blocks.register("structure_block", new StructureBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.LIGHT_GRAY).requiresTool().strength(-1.0f, 3600000.0f).dropsNothing()));
    public static final Block JIGSAW = Blocks.register("jigsaw", new JigsawBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.LIGHT_GRAY).requiresTool().strength(-1.0f, 3600000.0f).dropsNothing()));
    ...
    public static final Block TARGET = Blocks.register("target", new TargetBlock(AbstractBlock.Settings.of(Material.SOLID_ORGANIC, MaterialColor.QUARTZ).strength(0.5f).sounds(BlockSoundGroup.GRASS)));
    ...
    public static final Block HONEY_BLOCK = Blocks.register("honey_block", new HoneyBlock(AbstractBlock.Settings.of(Material.ORGANIC_PRODUCT, MaterialColor.ORANGE).velocityMultiplier(0.4f).jumpVelocityMultiplier(0.5f).nonOpaque().sounds(BlockSoundGroup.HONEY)));
    public static final Block HONEYCOMB_BLOCK = Blocks.register("honeycomb_block", new Block(AbstractBlock.Settings.of(Material.ORGANIC_PRODUCT, MaterialColor.ORANGE).strength(0.6f).sounds(BlockSoundGroup.CORAL)));
    public static final Block NETHERITE_BLOCK = Blocks.register("netherite_block", new Block(AbstractBlock.Settings.of(Material.METAL, MaterialColor.BLACK).requiresTool().strength(50.0f, 1200.0f).sounds(BlockSoundGroup.NETHERITE)));
    public static final Block ANCIENT_DEBRIS = Blocks.register("ancient_debris", new Block(AbstractBlock.Settings.of(Material.METAL, MaterialColor.BLACK).requiresTool().strength(30.0f, 1200.0f).sounds(BlockSoundGroup.ANCIENT_DEBRIS)));
    public static final Block CRYING_OBSIDIAN = Blocks.register("crying_obsidian", new CryingObsidianBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK).requiresTool().strength(50.0f, 1200.0f).luminance(state -> 10)));
    public static final Block RESPAWN_ANCHOR = Blocks.register("respawn_anchor", new RespawnAnchorBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK).requiresTool().strength(50.0f, 1200.0f).luminance(state -> RespawnAnchorBlock.getLightLevel(state, 15))));
    ...
    public static final Block POTTED_WARPED_ROOTS = Blocks.register("potted_warped_roots", new FlowerPotBlock(WARPED_ROOTS, AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
    ...
    public static final Block BLACKSTONE = Blocks.register("blackstone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK).requiresTool().strength(1.5f, 6.0f)));
    ...
    public static final Block POLISHED_BLACKSTONE_PRESSURE_PLATE = Blocks.register("polished_blackstone_pressure_plate", new PressurePlateBlock(PressurePlateBlock.ActivationRule.MOBS, AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK).requiresTool().noCollision().strength(0.5f)));
    public static final Block POLISHED_BLACKSTONE_BUTTON = Blocks.register("polished_blackstone_button", new StoneButtonBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.5f)));
    ...
    public static final Block CHISELED_NETHER_BRICKS = Blocks.register("chiseled_nether_bricks", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.NETHER).requiresTool().strength(2.0f, 6.0f).sounds(BlockSoundGroup.NETHER_BRICKS)));
    public static final Block CRACKED_NETHER_BRICKS = Blocks.register("cracked_nether_bricks", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.NETHER).requiresTool().strength(2.0f, 6.0f).sounds(BlockSoundGroup.NETHER_BRICKS)));
    ...
    private static BedBlock createBedBlock(DyeColor color) {
        return new BedBlock(color, AbstractBlock.Settings.of(Material.WOOL, blockState -> blockState.get(BedBlock.PART) == BedPart.FOOT ? color.getMaterialColor() : MaterialColor.WEB).sounds(BlockSoundGroup.WOOD).strength(0.2f).nonOpaque());
    }
    ...
    private static ShulkerBoxBlock createShulkerBoxBlock(DyeColor color, AbstractBlock.Settings settings) {
        AbstractBlock.ContextPredicate contextPredicate = (blockState, blockView, blockPos) -> {
            ...
            ShulkerBoxBlockEntity _snowman2 = (ShulkerBoxBlockEntity)blockEntity;
            return _snowman2.suffocates();
        };
