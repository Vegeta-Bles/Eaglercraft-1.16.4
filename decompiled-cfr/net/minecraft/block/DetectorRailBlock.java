...
extends AbstractRailBlock {
    ...
    private void updatePoweredStatus(World world, BlockPos pos, BlockState state) {
        ...
        bl = false;
        List<AbstractMinecartEntity> _snowman2 = this.getCarts(world, pos, AbstractMinecartEntity.class, null);
    ...
    protected void updateNearbyRails(World world, BlockPos pos, BlockState state, boolean unpowering) {
        ...
        List<BlockPos> _snowman2 = railPlacementHelper.getNeighbors();
    ...
    public int getComparatorOutput(BlockState state, World world, BlockPos pos) {
        if (state.get(POWERED).booleanValue()) {
            ...
            List<AbstractMinecartEntity> _snowman2 = this.getCarts(world, pos, AbstractMinecartEntity.class, EntityPredicates.VALID_INVENTORIES);
            if (!_snowman2.isEmpty()) {
                return ScreenHandler.calculateComparatorOutput((Inventory)((Object)_snowman2.get(0)));
            }
        }
        return 0;
    }
