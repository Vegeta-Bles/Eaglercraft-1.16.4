...
extends HorizontalFacingBlock {
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        boolean _snowman3 = world.isReceivingRedstonePower(_snowman2);
        Direction _snowman4 = ctx.getPlayerFacing();
        Direction.Axis _snowman5 = _snowman4.getAxis();
        boolean _snowman6 = _snowman5 == Direction.Axis.Z && (this.isWall(world.getBlockState(_snowman2.west())) || this.isWall(world.getBlockState(_snowman2.east()))) || _snowman5 == Direction.Axis.X && (this.isWall(world.getBlockState(_snowman2.north())) || this.isWall(world.getBlockState(_snowman2.south())));
        return (BlockState)((BlockState)((BlockState)((BlockState)this.getDefaultState().with(FACING, _snowman4)).with(OPEN, _snowman3)).with(POWERED, _snowman3)).with(IN_WALL, _snowman6);
    }
