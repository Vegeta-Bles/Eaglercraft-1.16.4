...
extends Block {
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        return (BlockState)((BlockState)((BlockState)((BlockState)((BlockState)((BlockState)this.getDefaultState().with(DOWN, this != world.getBlockState(_snowman2.down()).getBlock())).with(UP, this != world.getBlockState(_snowman2.up()).getBlock())).with(NORTH, this != world.getBlockState(_snowman2.north()).getBlock())).with(EAST, this != world.getBlockState(_snowman2.east()).getBlock())).with(SOUTH, this != world.getBlockState(_snowman2.south()).getBlock())).with(WEST, this != world.getBlockState(_snowman2.west()).getBlock());
    }
