...
extends Block {
    ...
    public boolean onSyncedBlockEvent(BlockState state, World world, BlockPos pos, int type, int data) {
        int n = state.get(NOTE);
        float _snowman2 = (float)Math.pow(2.0, (double)(n - 12) / 12.0);
        world.playSound(null, pos, state.get(INSTRUMENT).getSound(), SoundCategory.RECORDS, 3.0f, _snowman2);
        world.addParticle(ParticleTypes.NOTE, (double)pos.getX() + 0.5, (double)pos.getY() + 1.2, (double)pos.getZ() + 0.5, (double)n / 24.0, 0.0, 0.0);
        return true;
    }
