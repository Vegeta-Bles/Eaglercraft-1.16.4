...
FluidFillable {
    ...
    public void grow(ServerWorld world, Random random, BlockPos pos, BlockState state) {
        ...
        _snowman = (BlockState)blockState.with(TallSeagrassBlock.HALF, DoubleBlockHalf.UPPER);
        BlockPos _snowman2 = pos.up();
        if (world.getBlockState(_snowman2).isOf(Blocks.WATER)) {
            world.setBlockState(pos, blockState, 2);
            world.setBlockState(_snowman2, _snowman, 2);
        }
    }
