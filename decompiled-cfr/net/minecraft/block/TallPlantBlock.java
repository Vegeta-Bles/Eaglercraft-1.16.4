...
extends PlantBlock {
    ...
    protected static void onBreakInCreative(World world, BlockPos pos, BlockState state, PlayerEntity player) {
        DoubleBlockHalf doubleBlockHalf = state.get(HALF);
        if (doubleBlockHalf == DoubleBlockHalf.UPPER && (_snowman = world.getBlockState(_snowman = pos.down())).getBlock() == state.getBlock() && _snowman.get(HALF) == DoubleBlockHalf.LOWER) {
