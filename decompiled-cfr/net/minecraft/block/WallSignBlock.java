...
extends AbstractSignBlock {
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        BlockPos _snowman4 = ctx.getBlockPos();
        for (Direction direction : _snowman = ctx.getPlacementDirections()) {
            if (!direction.getAxis().isHorizontal() || !(blockState = (BlockState)blockState.with(FACING, _snowman = direction.getOpposite())).canPlaceAt(_snowman3, _snowman4)) continue;
