...
extends FlowerBlock {
    ...
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, Random random) {
        ...
        Vec3d _snowman2 = voxelShape.getBoundingBox().getCenter();
        double _snowman3 = (double)pos.getX() + _snowman2.x;
        double _snowman4 = (double)pos.getZ() + _snowman2.z;
        for (int i = 0; i < 3; ++i) {
            if (!random.nextBoolean()) continue;
            world.addParticle(ParticleTypes.SMOKE, _snowman3 + random.nextDouble() / 5.0, (double)pos.getY() + (0.5 - random.nextDouble()), _snowman4 + random.nextDouble() / 5.0, 0.0, 0.0, 0.0);
        }
    }
