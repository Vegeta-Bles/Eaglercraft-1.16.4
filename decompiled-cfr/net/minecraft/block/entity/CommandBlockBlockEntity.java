...
extends BlockEntity {
    ...
    private final CommandBlockExecutor commandExecutor = new CommandBlockExecutor(this){
        final /* synthetic */ CommandBlockBlockEntity field_11921;
        {
            this.field_11921 = commandBlockBlockEntity;
        }

        public void setCommand(String command) {
            super.setCommand(command);
            this.field_11921.markDirty();
        }

        public ServerWorld getWorld() {
            return (ServerWorld)this.field_11921.world;
        }

        public void markDirty() {
            BlockState blockState = this.field_11921.world.getBlockState(this.field_11921.pos);
            this.getWorld().updateListeners(this.field_11921.pos, blockState, blockState, 3);
        }

        public Vec3d getPos() {
            return Vec3d.ofCenter(this.field_11921.pos);
        }

        public ServerCommandSource getSource() {
            return new ServerCommandSource(this, Vec3d.ofCenter(this.field_11921.pos), Vec2f.ZERO, this.getWorld(), 2, this.getCustomName().getString(), this.getCustomName(), this.getWorld().getServer(), null);
        }
    };
    ...
    public boolean updateConditionMet() {
        ...
        if (this.isConditionalCommandBlock()) {
            ...
            this.conditionMet = this.world.getBlockState(blockPos).getBlock() instanceof CommandBlock ? (_snowman = this.world.getBlockEntity(blockPos)) instanceof CommandBlockBlockEntity && ((CommandBlockBlockEntity)_snowman).getCommandExecutor().getSuccessCount() > 0 : false;
        }
        return this.conditionMet;
    }
