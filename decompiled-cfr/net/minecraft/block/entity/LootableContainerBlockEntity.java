...
extends LockableContainerBlockEntity {
    ...
    public void checkLootInteraction(@Nullable PlayerEntity player) {
        if (this.lootTableId != null && this.world.getServer() != null) {
            ...
            LootContext.Builder _snowman2 = new LootContext.Builder((ServerWorld)this.world).parameter(LootContextParameters.ORIGIN, Vec3d.ofCenter(this.pos)).random(this.lootTableSeed);
            if (player != null) {
    ...
    public ScreenHandler createMenu(int n, PlayerInventory playerInventory, PlayerEntity playerEntity) {
        if (this.checkUnlocked(playerEntity)) {
            ...
            return this.createScreenHandler(n, playerInventory);
        }
        return null;
    }
}
