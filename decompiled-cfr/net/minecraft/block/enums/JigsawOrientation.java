...
public enum JigsawOrientation implements StringIdentifiable
{
    ...
    public static JigsawOrientation byDirections(Direction facing, Direction rotation) {
        int n = JigsawOrientation.getIndex(rotation, facing);
        return (JigsawOrientation)BY_INDEX.get(n);
    }
    ...
    static {
        ...
        for (JigsawOrientation jigsawOrientation : JigsawOrientation.values()) {
            BY_INDEX.put(JigsawOrientation.getIndex(jigsawOrientation.rotation, jigsawOrientation.facing), (Object)jigsawOrientation);
        }
    }
}
