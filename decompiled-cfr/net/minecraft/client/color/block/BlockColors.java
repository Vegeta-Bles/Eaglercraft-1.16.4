...
public class BlockColors {
    ...
    public static BlockColors create() {
        ...
        blockColors.registerColorProvider((state, world, pos, tintIndex) -> {
            int n = state.get(StemBlock.AGE);
            _snowman = n * 32;
            _snowman = 255 - n * 8;
            _snowman = n * 4;
            return _snowman << 16 | _snowman << 8 | _snowman;
    ...
    public int getColor(BlockState state, World world, BlockPos pos) {
        ...
        MaterialColor _snowman2 = state.getTopMaterialColor(world, pos);
        return _snowman2 != null ? _snowman2.color : -1;
    }
