...
public class BiomeColors {
    ...
    public static final ColorResolver FOLIAGE_COLOR = (biome, d, d2) -> biome.getFoliageColor();
    public static final ColorResolver WATER_COLOR = (biome, d, d2) -> biome.getWaterColor();
