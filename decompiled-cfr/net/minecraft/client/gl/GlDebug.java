...
public class GlDebug {
    ...
    private static void info(int source, int type, int id, int severity, int n, long l, long l2) {
        LOGGER.info("OpenGL debug message, id={}, source={}, type={}, severity={}, message={}", (Object)id, (Object)GlDebug.getSource(source), (Object)GlDebug.getType(type), (Object)GlDebug.getSeverity(severity), (Object)GLDebugMessageCallback.getMessage((int)n, (long)l));
    }
