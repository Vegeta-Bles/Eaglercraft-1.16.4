...
extends Screen {
    ...
    public void resize(MinecraftClient client, int width, int height) {
        ...
        _snowman = this.serverNameField.getText();
        this.init(client, width, height);
        this.addressField.setText(string);
        this.serverNameField.setText(_snowman);
    }
    ...
    private void updateButtonActiveState() {
        String string = this.addressField.getText();
        boolean _snowman2 = !string.isEmpty() && string.split(":").length > 0 && string.indexOf(32) == -1;
        this.buttonAdd.active = _snowman2 && !this.serverNameField.getText().isEmpty();
    }
