...
extends Screen {
    ...
    protected void init() {
        ...
        this.chatField = new TextFieldWidget(this, this.textRenderer, 4, this.height - 12, this.width - 4, 12, (Text)new TranslatableText("chat.editBox")){
            final /* synthetic */ ChatScreen field_21631;
            {
                this.field_21631 = chatScreen;
                super(textRenderer, n, n2, n3, n4, text);
            }

            protected MutableText getNarrationMessage() {
                return super.getNarrationMessage().append(ChatScreen.method_23961(this.field_21631).method_23958());
            }
        };
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if (button == 0) {
            ...
            Style _snowman2 = chatHud.getText(mouseX, mouseY);
            if (_snowman2 != null && this.handleTextClick(_snowman2)) {
                return true;
            }
        }
    ...
    public void setChatFromHistory(int n) {
        _snowman = this.messageHistorySize + n;
        _snowman = this.client.inGameHud.getChatHud().getMessageHistory().size();
        if ((_snowman = MathHelper.clamp(_snowman, 0, _snowman)) == this.messageHistorySize) {
            return;
        }
        if (_snowman == _snowman) {
            this.messageHistorySize = _snowman;
            this.chatField.setText(this.field_2389);
            return;
        }
        if (this.messageHistorySize == _snowman) {
            this.field_2389 = this.chatField.getText();
        }
        this.chatField.setText(this.client.inGameHud.getChatHud().getMessageHistory().get(_snowman));
    ...
    static /* synthetic */ CommandSuggestor method_23961(ChatScreen chatScreen) {
        return chatScreen.commandSuggestor;
    }
}
