    ...
    extends AlwaysSelectedEntryListWidget<BuffetBiomeItem> {
        ...
        extends AlwaysSelectedEntryListWidget.Entry<BuffetBiomeItem> {
            ...
            public BuffetBiomeItem(Biome biome) {
                ...
                String _snowman2 = "biome." + identifier.getNamespace() + "." + identifier.getPath();
                this.field_26536 = Language.getInstance().hasTranslation(_snowman2) ? new TranslatableText(_snowman2) : new LiteralText(identifier.toString());
            }
