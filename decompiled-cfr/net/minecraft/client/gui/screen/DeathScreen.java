...
extends Screen {
    ...
    private Style getTextComponentUnderMouse(int mouseX) {
        ...
        int n = this.client.textRenderer.getWidth(this.message);
        _snowman = this.width / 2 - n / 2;
        _snowman = this.width / 2 + n / 2;
        if (mouseX < _snowman || mouseX > _snowman) {
            return null;
        }
        return this.client.textRenderer.getTextHandler().getStyleAt(this.message, mouseX - _snowman);
    }
