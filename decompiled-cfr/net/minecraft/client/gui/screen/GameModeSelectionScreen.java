...
extends Screen {
    ...
    private net.minecraft.world.GameMode method_30106() {
        ...
        _snowman = MinecraftClient.getInstance().interactionManager.getPreviousGameMode();
        if (_snowman == net.minecraft.world.GameMode.NOT_SET) {
            _snowman = gameMode == net.minecraft.world.GameMode.CREATIVE ? net.minecraft.world.GameMode.SURVIVAL : net.minecraft.world.GameMode.CREATIVE;
        }
        return _snowman;
    }
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        _snowman = this.height / 2 - 30 - 27;
        GameModeSelectionScreen.drawTexture(matrices, n, _snowman, 0.0f, 0.0f, 125, 75, 128, 128);
        matrices.pop();
        ...
        boolean _snowman2 = this.lastMouseX == mouseX && this.lastMouseY == mouseY;
        for (ButtonWidget buttonWidget : this.gameModeButtons) {
            ...
            if (_snowman2 || !buttonWidget.isHovered()) continue;
    ...
    private static void apply(MinecraftClient client, Optional<GameMode> gameMode) {
        ...
        GameMode _snowman2 = gameMode.get();
        if (optional.isPresent() && client.player.hasPermissionLevel(2) && _snowman2 != optional.get()) {
            client.player.sendChatMessage(_snowman2.getCommand());
        }
    }
