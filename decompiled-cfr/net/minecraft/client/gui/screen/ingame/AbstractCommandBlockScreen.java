...
extends Screen {
    ...
    protected void init() {
        ...
        this.toggleTrackingOutputButton = this.addButton(new ButtonWidget(this.width / 2 + 150 - 20, this.getTrackOutputButtonHeight(), 20, 20, new LiteralText("O"), buttonWidget -> {
            _snowman.shouldTrackOutput(!(_snowman = this.getCommandExecutor()).isTrackingOutput());
            this.updateTrackedOutput();
        }));
        this.consoleCommandTextField = new TextFieldWidget(this, this.textRenderer, this.width / 2 - 150, 50, 300, 20, (Text)new TranslatableText("advMode.command")){
            final /* synthetic */ AbstractCommandBlockScreen field_21632;
            {
                this.field_21632 = abstractCommandBlockScreen;
                super(textRenderer, n, n2, n3, n4, text);
            }

            protected MutableText getNarrationMessage() {
                return super.getNarrationMessage().append(AbstractCommandBlockScreen.method_23962(this.field_21632).method_23958());
            }
        };
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        if (!this.previousOutputTextField.getText().isEmpty()) {
            AbstractCommandBlockScreen.drawTextWithShadow(matrices, this.textRenderer, field_26558, this.width / 2 - 150, (n += 5 * this.textRenderer.fontHeight + 1 + this.getTrackOutputButtonHeight() - 135) + 4, 0xA0A0A0);
    ...
    static /* synthetic */ CommandSuggestor method_23962(AbstractCommandBlockScreen abstractCommandBlockScreen) {
        return abstractCommandBlockScreen.commandSuggestor;
    }
}
