...
implements RecipeBookProvider {
    ...
    protected void drawBackground(MatrixStack matrices, float delta, int mouseX, int mouseY) {
        ...
        if (((AbstractFurnaceScreenHandler)this.handler).isBurning()) {
            _snowman = ((AbstractFurnaceScreenHandler)this.handler).getFuelProgress();
            this.drawTexture(matrices, n + 56, _snowman + 36 + 12 - _snowman, 176, 12 - _snowman, 14, _snowman + 1);
        }
        _snowman = ((AbstractFurnaceScreenHandler)this.handler).getCookProgress();
        this.drawTexture(matrices, n + 79, _snowman + 34, 176, 14, _snowman + 1, 16);
    }
