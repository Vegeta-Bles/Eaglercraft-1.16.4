...
implements ScreenHandlerProvider<LecternScreenHandler> {
    ...
    private final ScreenHandlerListener listener = new ScreenHandlerListener(this){
        final /* synthetic */ LecternScreen field_17424;
        {
            this.field_17424 = lecternScreen;
        }

        public void onHandlerRegistered(ScreenHandler handler, DefaultedList<ItemStack> stacks) {
            LecternScreen.method_17568(this.field_17424);
        }
        ...
        public void onPropertyUpdate(ScreenHandler handler, int property, int value) {
            if (property == 0) {
                LecternScreen.method_17570(this.field_17424);
            }
        }
    };
    ...
    static /* synthetic */ void method_17568(LecternScreen lecternScreen) {
        lecternScreen.updatePageProvider();
    }

    static /* synthetic */ void method_17570(LecternScreen lecternScreen) {
        lecternScreen.updatePage();
    }
}
