...
extends Screen {
    ...
    protected void init() {
        ...
        this.inputName = new TextFieldWidget(this, this.textRenderer, this.width / 2 - 152, 40, 300, 20, (Text)new TranslatableText("structure_block.structure_name")){
            final /* synthetic */ StructureBlockScreen field_3023;
            {
                this.field_3023 = structureBlockScreen;
                super(textRenderer, n, n2, n3, n4, text);
            }

            public boolean charTyped(char chr, int keyCode) {
                if (!StructureBlockScreen.method_16017(this.field_3023, this.getText(), chr, this.getCursor())) {
                    return false;
                }
        ...
        _snowman = this.structureBlock.getSize();
        ...
        this.inputSizeX.setText(Integer.toString(_snowman.getX()));
        ...
        this.inputSizeY.setText(Integer.toString(_snowman.getY()));
        ...
        this.inputSizeZ.setText(Integer.toString(_snowman.getZ()));
    ...
    public void resize(MinecraftClient client, int width, int height) {
        ...
        _snowman = this.inputPosX.getText();
        _snowman = this.inputPosY.getText();
        _snowman = this.inputPosZ.getText();
        _snowman = this.inputSizeX.getText();
        _snowman = this.inputSizeY.getText();
        _snowman = this.inputSizeZ.getText();
        _snowman = this.inputIntegrity.getText();
        _snowman = this.inputSeed.getText();
        _snowman = this.inputMetadata.getText();
        this.init(client, width, height);
        this.inputName.setText(string);
        this.inputPosX.setText(_snowman);
        this.inputPosY.setText(_snowman);
        this.inputPosZ.setText(_snowman);
        this.inputSizeX.setText(_snowman);
        this.inputSizeY.setText(_snowman);
        this.inputSizeZ.setText(_snowman);
        this.inputIntegrity.setText(_snowman);
        this.inputSeed.setText(_snowman);
        this.inputMetadata.setText(_snowman);
    }
    ...
    private boolean method_2516(StructureBlockBlockEntity.Action action) {
        ...
        _snowman = new BlockPos(this.parseInt(this.inputSizeX.getText()), this.parseInt(this.inputSizeY.getText()), this.parseInt(this.inputSizeZ.getText()));
        float _snowman2 = this.parseFloat(this.inputIntegrity.getText());
        long _snowman3 = this.parseLong(this.inputSeed.getText());
        this.client.getNetworkHandler().sendPacket(new UpdateStructureBlockC2SPacket(this.structureBlock.getPos(), action, this.structureBlock.getMode(), this.inputName.getText(), blockPos, _snowman, this.structureBlock.getMirror(), this.structureBlock.getRotation(), this.inputMetadata.getText(), this.structureBlock.shouldIgnoreEntities(), this.structureBlock.shouldShowAir(), this.structureBlock.shouldShowBoundingBox(), _snowman2, _snowman3));
        return true;
    }
    ...
    static /* synthetic */ boolean method_16017(StructureBlockScreen structureBlockScreen, String string, char c, int n) {
        return structureBlockScreen.isValidCharacterForName(string, c, n);
    }
}
