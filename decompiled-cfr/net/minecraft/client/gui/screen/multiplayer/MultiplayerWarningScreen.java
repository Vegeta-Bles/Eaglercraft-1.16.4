...
extends Screen {
    ...
    protected void init() {
        ...
        int n = (this.lines.method_30887() + 1) * this.textRenderer.fontHeight * 2;
        this.addButton(new ButtonWidget(this.width / 2 - 155, 100 + n, 150, 20, ScreenTexts.PROCEED, buttonWidget -> {
        ...
        this.addButton(new ButtonWidget(this.width / 2 - 155 + 160, 100 + n, 150, 20, ScreenTexts.BACK, buttonWidget -> this.client.openScreen(this.parent)));
        this.checkbox = new CheckboxWidget(this.width / 2 - 155 + 80, 76 + n, 150, 20, CHECK_MESSAGE, false);
