...
extends ElementListWidget.Entry<SocialInteractionsPlayerListEntry> {
    ...
    public SocialInteractionsPlayerListEntry(MinecraftClient client, SocialInteractionsScreen parent, UUID uuid, String name, Supplier<Identifier> supplier) {
        ...
        if (!client.player.getGameProfile().getId().equals(uuid) && !socialInteractionsManager.isPlayerBlocked(uuid)) {
            this.hideButton = new TexturedButtonWidget(this, 0, 0, 20, 20, 0, 38, 20, SocialInteractionsScreen.SOCIAL_INTERACTIONS_TEXTURE, 256, 256, buttonWidget -> {
            ...
            }, (buttonWidget, matrixStack, n, n2) -> {
                this.field_26864 += client.getLastFrameDuration();
                if (this.field_26864 >= 10.0f) {
                    parent.method_31354(() -> SocialInteractionsPlayerListEntry.method_31328(parent, matrixStack, this.hideTooltip, n, n2));
                }
            }, new TranslatableText("gui.socialInteractions.hide")){
                final /* synthetic */ SocialInteractionsPlayerListEntry field_26910;
                {
                    this.field_26910 = socialInteractionsPlayerListEntry;
                    super(n, n2, n3, n4, n5, n6, n7, identifier, n8, n9, pressAction, tooltipSupplier, text);
                }

                protected MutableText getNarrationMessage() {
                    return SocialInteractionsPlayerListEntry.method_31388(this.field_26910, super.getNarrationMessage());
                }
            };
            this.showButton = new TexturedButtonWidget(this, 0, 0, 20, 20, 20, 38, 20, SocialInteractionsScreen.SOCIAL_INTERACTIONS_TEXTURE, 256, 256, buttonWidget -> {
                ...
                this.field_26864 += client.getLastFrameDuration();
                if (this.field_26864 >= 10.0f) {
                    parent.method_31354(() -> SocialInteractionsPlayerListEntry.method_31328(parent, matrixStack, this.showTooltip, n, n2));
                }
            }, new TranslatableText("gui.socialInteractions.show")){
                final /* synthetic */ SocialInteractionsPlayerListEntry field_26911;
                {
                    this.field_26911 = socialInteractionsPlayerListEntry;
                    super(n, n2, n3, n4, n5, n6, n7, identifier, n8, n9, pressAction, tooltipSupplier, text);
                }

                protected MutableText getNarrationMessage() {
                    return SocialInteractionsPlayerListEntry.method_31388(this.field_26911, super.getNarrationMessage());
                }
            };
            this.showButton.visible = socialInteractionsManager.isPlayerHidden(uuid);
            this.hideButton.visible = !this.showButton.visible;
            this.buttons = ImmutableList.of((Object)this.hideButton, (Object)this.showButton);
        } else {
    ...
    public void render(MatrixStack matrices, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
        int n = x + 4;
        _snowman = y + (entryHeight - 24) / 2;
        _snowman = n + 24 + 4;
        Text _snowman2 = this.method_31390();
        if (_snowman2 == LiteralText.EMPTY) {
            DrawableHelper.fill(matrices, x, y, x + entryWidth, y + entryHeight, field_26851);
            _snowman = y + (entryHeight - this.client.textRenderer.fontHeight) / 2;
        } else {
            DrawableHelper.fill(matrices, x, y, x + entryWidth, y + entryHeight, field_26852);
            _snowman = y + (entryHeight - (this.client.textRenderer.fontHeight + this.client.textRenderer.fontHeight)) / 2;
            this.client.textRenderer.draw(matrices, _snowman2, (float)_snowman, (float)(_snowman + 12), field_26903);
        }
        this.client.getTextureManager().bindTexture(this.field_26904.get());
        DrawableHelper.drawTexture(matrices, n, _snowman, 24, 24, 8.0f, 8.0f, 8, 8, 64, 64);
        RenderSystem.enableBlend();
        DrawableHelper.drawTexture(matrices, n, _snowman, 24, 24, 40.0f, 8.0f, 8, 8, 64, 64);
        RenderSystem.disableBlend();
        this.client.textRenderer.draw(matrices, this.name, (float)_snowman, (float)_snowman, field_26853);
        if (this.field_26859) {
            DrawableHelper.fill(matrices, n, _snowman, n + 24, _snowman + 24, field_26850);
        }
    ...
    private Text method_31390() {
        ...
        _snowman = this.client.getSocialInteractionsManager().isPlayerBlocked(this.uuid);
        if (_snowman && this.field_26859) {
            return field_26909;
        }
    ...
    private static void method_31328(SocialInteractionsScreen socialInteractionsScreen, MatrixStack matrixStack, List<OrderedText> list, int n, int n2) {
        socialInteractionsScreen.renderOrderedTooltip(matrixStack, list, n, n2);
        socialInteractionsScreen.method_31354(null);
    }

    static /* synthetic */ MutableText method_31388(SocialInteractionsPlayerListEntry socialInteractionsPlayerListEntry, MutableText mutableText) {
        return socialInteractionsPlayerListEntry.method_31389(mutableText);
    }
}
