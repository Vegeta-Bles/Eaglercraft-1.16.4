...
extends ElementListWidget<SocialInteractionsPlayerListEntry> {
    ...
    public void method_31393(Collection<UUID> collection, double d2) {
        double d2;
        this.players.clear();
        for (UUID uUID : collection) {
            ...
            this.players.add(new SocialInteractionsPlayerListEntry(this.minecraftClient, this.parent, playerListEntry.getProfile().getId(), playerListEntry.getProfile().getName(), playerListEntry::getSkinTexture));
        }
        this.method_31349();
    ...
    public void method_31345(PlayerListEntry playerListEntry, SocialInteractionsScreen.Tab tab2) {
        SocialInteractionsScreen.Tab tab2;
        ...
        if ((tab2 == SocialInteractionsScreen.Tab.ALL || this.minecraftClient.getSocialInteractionsManager().method_31391(uUID)) && (Strings.isNullOrEmpty((String)this.currentSearch) || playerListEntry.getProfile().getName().toLowerCase(Locale.ROOT).contains(this.currentSearch))) {
            SocialInteractionsPlayerListEntry socialInteractionsPlayerListEntry = new SocialInteractionsPlayerListEntry(this.minecraftClient, this.parent, playerListEntry.getProfile().getId(), playerListEntry.getProfile().getName(), playerListEntry::getSkinTexture);
