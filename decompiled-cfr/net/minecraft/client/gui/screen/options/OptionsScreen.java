...
extends Screen {
    ...
    protected void init() {
        ...
        for (Option option : OPTIONS) {
            ...
            _snowman = this.height / 6 - 12 + 24 * (n >> 1);
            this.addButton(option.createButton(this.client.options, n2, _snowman, 150));
            ++n;
        }
        if (this.client.world != null) {
            this.difficulty = this.client.world.getDifficulty();
            this.difficultyButton = this.addButton(new ButtonWidget(this.width / 2 - 155 + n % 2 * 160, this.height / 6 - 12 + 24 * (n >> 1), 150, 20, this.getDifficultyButtonText(this.difficulty), button -> {
            ...
            this.addButton(new OptionButtonWidget(this.width / 2 - 155 + n % 2 * 160, this.height / 6 - 12 + 24 * (n >> 1), 150, 20, Option.REALMS_NOTIFICATIONS, Option.REALMS_NOTIFICATIONS.getDisplayString(this.settings), button -> {
    ...
    private void refreshResourcePacks(ResourcePackManager resourcePackManager) {
        ImmutableList immutableList = ImmutableList.copyOf(this.settings.resourcePacks);
        ...
        this.settings.write();
        ImmutableList immutableList2 = ImmutableList.copyOf(this.settings.resourcePacks);
