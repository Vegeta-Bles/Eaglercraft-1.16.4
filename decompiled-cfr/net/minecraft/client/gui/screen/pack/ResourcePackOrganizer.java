...
public class ResourcePackOrganizer {
    ...
    implements Pack {
        ...
        protected void move(int offset) {
            ...
            int _snowman2 = list.indexOf(this.profile);
            list.remove(_snowman2);
            list.add(_snowman2 + offset, this.profile);
            ResourcePackOrganizer.this.updateCallback.run();
        }
        ...
        public boolean canMoveTowardStart() {
            List<ResourcePackProfile> list = this.getCurrentList();
            int _snowman2 = list.indexOf(this.profile);
            return _snowman2 > 0 && !list.get(_snowman2 - 1).isPinned();
        }
        ...
        public boolean canMoveTowardEnd() {
            List<ResourcePackProfile> list = this.getCurrentList();
            int _snowman2 = list.indexOf(this.profile);
            return _snowman2 >= 0 && _snowman2 < list.size() - 1 && !list.get(_snowman2 + 1).isPinned();
        }
