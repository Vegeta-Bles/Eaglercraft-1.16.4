...
extends Screen {
    ...
    public static CreateWorldScreen method_31130(@Nullable Screen screen) {
        ...
        return new CreateWorldScreen(screen, DataPackSettings.SAFE_MODE, new MoreOptionsDialog(impl, GeneratorOptions.getDefaultOptions(impl.get(Registry.DIMENSION_TYPE_KEY), impl.get(Registry.BIOME_KEY), impl.get(Registry.NOISE_SETTINGS_WORLDGEN)), Optional.of(GeneratorType.DEFAULT), OptionalLong.empty()));
    }
    ...
    protected void init() {
        ...
        this.levelNameField = new TextFieldWidget(this, this.textRenderer, this.width / 2 - 100, 60, 200, 20, (Text)new TranslatableText("selectWorld.enterName")){
            final /* synthetic */ CreateWorldScreen field_21337;
            {
                this.field_21337 = createWorldScreen;
                super(textRenderer, n, n2, n3, n4, text);
            }

            protected MutableText getNarrationMessage() {
                return super.getNarrationMessage().append(". ").append(new TranslatableText("selectWorld.resultFolder")).append(" ").append(CreateWorldScreen.method_23488(this.field_21337));
            }
        };
        ...
        _snowman = this.width / 2 + 5;
        this.gameModeSwitchButton = this.addButton(new ButtonWidget(this, n, 100, 150, 20, LiteralText.EMPTY, buttonWidget -> {
            ...
            final /* synthetic */ CreateWorldScreen field_21338;
            {
                this.field_21338 = createWorldScreen;
                super(n, n2, n3, n4, text, pressAction);
            }

            public Text getMessage() {
                return new TranslatableText("options.generic_value", CreateWorldScreen.method_30508(), new TranslatableText("selectWorld.gameMode." + Mode.method_22366(CreateWorldScreen.method_23489(this.field_21338))));
            }

            protected MutableText getNarrationMessage() {
                return super.getNarrationMessage().append(". ").append(CreateWorldScreen.method_23492(this.field_21338)).append(" ").append(CreateWorldScreen.method_23490(this.field_21338));
            }
        });
        this.difficultyButton = this.addButton(new ButtonWidget(this, _snowman, 100, 150, 20, new TranslatableText("options.difficulty"), button -> {
            this.field_24290 = this.field_24289 = this.field_24289.cycle();
            button.queueNarration(250);
        }){
            final /* synthetic */ CreateWorldScreen field_24291;
            {
                this.field_24291 = createWorldScreen;
                super(n, n2, n3, n4, text, pressAction);
            }

            public Text getMessage() {
                return new TranslatableText("options.difficulty").append(": ").append(CreateWorldScreen.method_27617(this.field_24291).getTranslatableName());
            }
        });
        this.enableCheatsButton = this.addButton(new ButtonWidget(this, n, 151, 150, 20, new TranslatableText("selectWorld.allowCommands"), button -> {
            this.tweakedCheats = true;
            this.cheatsEnabled = !this.cheatsEnabled;
            button.queueNarration(250);
        }){
            final /* synthetic */ CreateWorldScreen field_21339;
            {
                this.field_21339 = createWorldScreen;
                super(n, n2, n3, n4, text, pressAction);
            }

            public Text getMessage() {
                return ScreenTexts.composeToggleText(super.getMessage(), CreateWorldScreen.method_23494(this.field_21339) && !this.field_21339.hardcore);
            }
        ...
        this.dataPacksButton = this.addButton(new ButtonWidget(_snowman, 151, 150, 20, new TranslatableText("selectWorld.dataPacks"), button -> this.method_29694()));
        this.gameRulesButton = this.addButton(new ButtonWidget(n, 185, 150, 20, new TranslatableText("selectWorld.gameRules"), button -> this.client.openScreen(new EditGameRulesScreen(this.gameRules.copy(), optional -> {
        ...
        this.moreOptionsButton = this.addButton(new ButtonWidget(_snowman, 185, 150, 20, new TranslatableText("selectWorld.moreWorldOptions"), buttonWidget -> this.toggleMoreOptions()));
        this.createLevelButton = this.addButton(new ButtonWidget(n, this.height - 28, 150, 20, new TranslatableText("selectWorld.create"), buttonWidget -> this.createLevel()));
        this.createLevelButton.active = !this.levelName.isEmpty();
        this.addButton(new ButtonWidget(_snowman, this.height - 28, 150, 20, ScreenTexts.CANCEL, buttonWidget -> this.method_30297()));
    ...
    private void createLevel() {
        ...
        if (generatorOptions.isDebugWorld()) {
            ...
            _snowman2 = new LevelInfo(this.levelNameField.getText().trim(), GameMode.SPECTATOR, false, Difficulty.PEACEFUL, true, gameRules, DataPackSettings.SAFE_MODE);
        } else {
            _snowman2 = new LevelInfo(this.levelNameField.getText().trim(), this.currentMode.defaultGameMode, this.hardcore, this.field_24290, this.cheatsEnabled && !this.hardcore, this.gameRules, this.field_25479);
        }
        this.client.method_29607(this.saveDirectoryName, _snowman2, this.moreOptionsDialog.method_29700(), generatorOptions);
    }
    ...
    private void setMoreOptionsOpen(boolean moreOptionsOpen) {
        ...
        boolean bl = this.difficultyButton.visible = !this.moreOptionsOpen;
    ...
    private void method_29682(ResourcePackManager resourcePackManager) {
        ImmutableList immutableList = ImmutableList.copyOf(resourcePackManager.getEnabledNames());
        List _snowman2 = (List)resourcePackManager.getNames().stream().filter(arg_0 -> CreateWorldScreen.method_29983((List)immutableList, arg_0)).collect(ImmutableList.toImmutableList());
        DataPackSettings _snowman3 = new DataPackSettings((List<String>)immutableList, _snowman2);
        if (immutableList.equals(this.field_25479.getEnabled())) {
            this.field_25479 = _snowman3;
            return;
        }
        ...
        ServerResourceManager.reload(resourcePackManager.createResourcePacks(), CommandManager.RegistrationEnvironment.INTEGRATED, 2, Util.getMainWorkerExecutor(), this.client).handle((serverResourceManager, throwable) -> {
            if (throwable != null) {
                ...
                this.client.send(() -> {
                    this.field_25479 = _snowman3;
                    this.moreOptionsDialog.method_31132((ServerResourceManager)serverResourceManager);
    ...
    public static Path method_29685(Path path, MinecraftClient minecraftClient) {
        ...
        try (Stream<Path> stream = Files.walk(path, new FileVisitOption[0]);){
            stream.filter(path2 -> !path2.equals(path)).forEach(path2 -> {
                Path path3;
                _snowman = (Path)mutableObject.getValue();
                if (_snowman == null) {
                    try {
                        _snowman = Files.createTempDirectory("mcworld-", new FileAttribute[0]);
                    }
                    catch (IOException iOException) {
                        field_25480.warn("Failed to create temporary dir");
                        throw new WorldCreationException(iOException);
                    }
                    mutableObject.setValue((Object)_snowman);
                }
                CreateWorldScreen.method_29687(path, _snowman, path2);
            });
        }
        catch (IOException | WorldCreationException exception) {
    ...
    static /* synthetic */ String method_23488(CreateWorldScreen createWorldScreen) {
        return createWorldScreen.saveDirectoryName;
    }

    static /* synthetic */ Text method_30508() {
        return field_25898;
    }

    static /* synthetic */ Mode method_23489(CreateWorldScreen createWorldScreen) {
        return createWorldScreen.currentMode;
    }

    static /* synthetic */ Text method_23490(CreateWorldScreen createWorldScreen) {
        return createWorldScreen.secondGameModeDescriptionLine;
    }

    static /* synthetic */ Text method_23492(CreateWorldScreen createWorldScreen) {
        return createWorldScreen.firstGameModeDescriptionLine;
    }

    static /* synthetic */ Difficulty method_27617(CreateWorldScreen createWorldScreen) {
        return createWorldScreen.field_24290;
    }

    static /* synthetic */ boolean method_23494(CreateWorldScreen createWorldScreen) {
        return createWorldScreen.cheatsEnabled;
    }
