...
extends Screen {
        ...
        public RuleListWidget(final GameRules gameRules) {
            ...
            GameRules.accept(new GameRules.Visitor(){
                ...
                private <T extends GameRules.Rule<T>> void createRuleWidget(GameRules.Key<T> key, RuleWidgetFactory<T> widgetFactory) {
                    String _snowman9;
                    ImmutableList _snowman8;
                    TranslatableText translatableText = new TranslatableText(key.getTranslationKey());
                    MutableText _snowman2 = new LiteralText(key.getName()).formatted(Formatting.YELLOW);
                    T _snowman3 = gameRules.get(key);
                    String _snowman4 = ((GameRules.Rule)_snowman3).serialize();
                    MutableText _snowman5 = new TranslatableText("editGamerule.default", new LiteralText(_snowman4)).formatted(Formatting.GRAY);
                    String _snowman6 = key.getTranslationKey() + ".description";
                    if (I18n.hasTranslation(_snowman6)) {
                        ImmutableList.Builder builder = ImmutableList.builder().add((Object)_snowman2.asOrderedText());
                        TranslatableText _snowman7 = new TranslatableText(_snowman6);
                        EditGameRulesScreen.this.textRenderer.wrapLines(_snowman7, 150).forEach(arg_0 -> ((ImmutableList.Builder)builder).add(arg_0));
                        _snowman8 = builder.add((Object)_snowman5.asOrderedText()).build();
                        _snowman9 = _snowman7.getString() + "\n" + _snowman5.getString();
                    } else {
                        _snowman8 = ImmutableList.of((Object)_snowman2.asOrderedText(), (Object)_snowman5.asOrderedText());
                        _snowman9 = _snowman5.getString();
                    }
                    hashMap.computeIfAbsent(key.getCategory(), category -> Maps.newHashMap()).put(key, widgetFactory.create(translatableText, (List<OrderedText>)_snowman8, _snowman9, _snowman3));
                }
            });
    ...
    extends NamedRuleWidget {
        ...
        public BooleanRuleWidget(Text name, List<OrderedText> description, String ruleName, GameRules.BooleanRule booleanRule) {
            super(description, name);
            this.toggleButton = new ButtonWidget(this, 10, 5, 44, 20, ScreenTexts.getToggleText(booleanRule.get()), buttonWidget -> {
                boolean bl = !booleanRule.get();
                booleanRule.set(bl, null);
                buttonWidget.setMessage(ScreenTexts.getToggleText(booleanRule.get()));
            }, EditGameRulesScreen.this, name, booleanRule, ruleName){
                final /* synthetic */ EditGameRulesScreen field_24302;
                final /* synthetic */ Text field_25627;
                final /* synthetic */ GameRules.BooleanRule field_25628;
                final /* synthetic */ String field_24303;
                final /* synthetic */ BooleanRuleWidget field_24304;
                {
                    this.field_24304 = booleanRuleWidget;
                    this.field_24302 = editGameRulesScreen;
                    this.field_25627 = text2;
                    this.field_25628 = booleanRule;
                    this.field_24303 = string;
                    super(n, n2, n3, n4, text, pressAction);
                }

                protected MutableText getNarrationMessage() {
                    return ScreenTexts.composeToggleText(this.field_25627, this.field_25628.get()).append("\n").append(this.field_24303);
                }
            };
