...
extends Screen {
    ...
    protected void init() {
        ...
        this.addButton(new ButtonWidget(this.width / 2 - 100, this.height / 4 + 72 + 5, 200, 20, new TranslatableText("selectWorld.edit.backupFolder"), buttonWidget -> {
            ...
            Path _snowman2 = levelStorage.getBackupsDirectory();
            try {
            ...
            Util.getOperatingSystem().open(_snowman2.toFile());
        }));
        ...
        this.addButton(new ButtonWidget(this.width / 2 - 100, this.height / 4 + 120 + 5, 200, 20, new TranslatableText("selectWorld.edit.export_worldgen_settings"), buttonWidget -> {
            DataResult _snowman3;
            Object object;
            DynamicRegistryManager.Impl impl = DynamicRegistryManager.create();
            try {
                object = this.client.method_29604(impl, MinecraftClient::method_29598, (Function4<LevelStorage.Session, DynamicRegistryManager.Impl, ResourceManager, DataPackSettings, SaveProperties>)((Function4)MinecraftClient::createSaveProperties), false, this.field_23777);
                Throwable throwable = null;
                try {
                    RegistryReadingOps registryReadingOps = RegistryReadingOps.of(JsonOps.INSTANCE, impl);
                    DataResult _snowman2 = GeneratorOptions.CODEC.encodeStart(registryReadingOps, (Object)((MinecraftClient.IntegratedResourceManager)object).getSaveProperties().getGeneratorOptions());
                    _snowman3 = _snowman2.flatMap(jsonElement -> {
                    ...
                    if (object != null) {
                        if (throwable != null) {
                            try {
                                ((MinecraftClient.IntegratedResourceManager)object).close();
                            }
                ...
                _snowman3 = DataResult.error((String)"Could not parse level data!");
            }
            object = new LiteralText((String)_snowman3.get().map(Function.identity(), DataResult.PartialResult::message));
            TranslatableText _snowman4 = new TranslatableText(_snowman3.result().isPresent() ? "selectWorld.edit.export_worldgen_settings.success" : "selectWorld.edit.export_worldgen_settings.failure");
            _snowman3.error().ifPresent(partialResult -> LOGGER.error("Error exporting world settings: {}", partialResult));
            this.client.getToastManager().add(SystemToast.create(this.client, SystemToast.Type.WORLD_GEN_SETTINGS_TRANSFER, _snowman4, (Text)object));
        }));
        ...
        LevelSummary _snowman2 = this.field_23777.getLevelSummary();
        String _snowman3 = _snowman2 == null ? "" : _snowman2.getDisplayName();
        ...
        this.levelNameTextField.setText(_snowman3);
    ...
    public static boolean backupLevel(LevelStorage.Session session) {
        ...
        if (_snowman2 != null) {
            TranslatableText translatableText = new TranslatableText("selectWorld.edit.backupFailed");
            LiteralText _snowman4 = new LiteralText(_snowman2.getMessage());
            MinecraftClient.getInstance().getToastManager().add(new SystemToast(SystemToast.Type.WORLD_BACKUP, translatableText, _snowman4));
            return false;
        }
        _snowman = new TranslatableText("selectWorld.edit.backupCreated", session.getDirectoryName());
        _snowman = new TranslatableText("selectWorld.edit.backupSize", MathHelper.ceil((double)l / 1048576.0));
        MinecraftClient.getInstance().getToastManager().add(new SystemToast(SystemToast.Type.WORLD_BACKUP, _snowman, _snowman));
        return true;
    }
