...
implements CommandSource {
    ...
    public CompletableFuture<Suggestions> getCompletions(CommandContext<CommandSource> context, SuggestionsBuilder builder) {
        ...
        int n = ++this.completionId;
        this.networkHandler.sendPacket(new RequestCommandCompletionsC2SPacket(n, context.getInput()));
    ...
    public Collection<CommandSource.RelativePosition> getBlockPositionSuggestions() {
        ...
        return Collections.singleton(new CommandSource.RelativePosition(ClientCommandSource.format(_snowman2.getX()), ClientCommandSource.format(_snowman2.getY()), ClientCommandSource.format(_snowman2.getZ())));
    }
    ...
    public Collection<CommandSource.RelativePosition> getPositionSuggestions() {
        ...
        Vec3d _snowman2 = hitResult.getPos();
        return Collections.singleton(new CommandSource.RelativePosition(ClientCommandSource.format(_snowman2.x), ClientCommandSource.format(_snowman2.y), ClientCommandSource.format(_snowman2.z)));
    }
