...
public class SocialInteractionsManager {
    ...
    public void method_31337(PlayerListEntry playerListEntry) {
        ...
        if ((_snowman = this.client.currentScreen) instanceof SocialInteractionsScreen) {
            SocialInteractionsScreen socialInteractionsScreen = (SocialInteractionsScreen)_snowman;
