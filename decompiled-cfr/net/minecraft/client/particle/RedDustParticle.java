...
extends SpriteBillboardParticle {
    ...
    private RedDustParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, DustParticleEffect dustParticleEffect, SpriteProvider spriteProvider) {
        ...
        int _snowman2 = (int)(8.0 / (Math.random() * 0.8 + 0.2));
        this.maxAge = (int)Math.max((float)_snowman2 * dustParticleEffect.getScale(), 1.0f);
    ...
    implements ParticleFactory<DustParticleEffect> {
        ...
        @Override
        public Particle createParticle(DustParticleEffect dustParticleEffect, ClientWorld clientWorld, double d, double d2, double d3, double d4, double d5, double d6) {
            return new RedDustParticle(clientWorld, d, d2, d3, d4, d5, d6, dustParticleEffect, this.spriteProvider);
        }
    }
}
