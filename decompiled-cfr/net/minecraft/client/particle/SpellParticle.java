...
extends SpriteBillboardParticle {
    ...
    implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double d2, double d3, double d4, double d5, double d6) {
            return new SpellParticle(clientWorld, d, d2, d3, d4, d5, d6, this.field_17872);
        }
    }
    ...
    implements ParticleFactory<DefaultParticleType> {
        ...
        @Override
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double d2, double d3, double d4, double d5, double d6) {
            SpellParticle spellParticle = new SpellParticle(clientWorld, d, d2, d3, d4, d5, d6, this.field_17875);
            float _snowman2 = clientWorld.random.nextFloat() * 0.5f + 0.35f;
            spellParticle.setColor(1.0f * _snowman2, 0.0f * _snowman2, 1.0f * _snowman2);
    ...
    implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double d2, double d3, double d4, double d5, double d6) {
            ...
            spellParticle.setColorAlpha(0.15f);
    ...
    implements ParticleFactory<DefaultParticleType> {
        ...
        @Override
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double d2, double d3, double d4, double d5, double d6) {
            SpellParticle spellParticle = new SpellParticle(clientWorld, d, d2, d3, d4, d5, d6, this.field_17873);
            spellParticle.setColor((float)d4, (float)d5, (float)d6);
            return spellParticle;
        }
    }
