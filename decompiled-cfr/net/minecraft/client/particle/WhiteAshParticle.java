...
extends AscendingParticle {
    ...
    implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double d2, double d3, double d4, double d5, double d6) {
            ...
            double _snowman2 = (double)random.nextFloat() * -1.9 * (double)random.nextFloat() * 0.1;
            double _snowman3 = (double)random.nextFloat() * -0.5 * (double)random.nextFloat() * 0.1 * 5.0;
            double _snowman4 = (double)random.nextFloat() * -1.9 * (double)random.nextFloat() * 0.1;
            return new WhiteAshParticle(clientWorld, d, d2, d3, _snowman2, _snowman3, _snowman4, 1.0f, this.spriteProvider);
        }
    }
}
