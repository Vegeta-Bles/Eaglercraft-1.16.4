...
extends RealmsScreenWithCallback {
    ...
    public RealmsResetWorldScreen(Screen parent, RealmsServer realmsServer, Text text, Text text2, int n, Text text3, Runnable runnable, Runnable runnable2) {
    ...
    public void init() {
        ...
        new Thread(this, "Realms-reset-world-fetcher"){
            final /* synthetic */ RealmsResetWorldScreen field_20021;
            {
                this.field_20021 = realmsResetWorldScreen;
                super(string);
            }
            ...
            public void run() {
                ...
                try {
                    ...
                    _snowman = realmsClient.fetchWorldTemplates(1, 10, RealmsServer.WorldType.ADVENTUREMAP);
                    _snowman = realmsClient.fetchWorldTemplates(1, 10, RealmsServer.WorldType.EXPERIENCE);
                    _snowman = realmsClient.fetchWorldTemplates(1, 10, RealmsServer.WorldType.INSPIRATION);
                    RealmsResetWorldScreen.method_25205(this.field_20021).execute(() -> {
                        RealmsResetWorldScreen.method_21375(this.field_20021, worldTemplatePaginatedList);
                        RealmsResetWorldScreen.method_21383(this.field_20021, _snowman);
                        RealmsResetWorldScreen.method_21386(this.field_20021, _snowman);
                        RealmsResetWorldScreen.method_21388(this.field_20021, _snowman);
                    });
                }
                catch (RealmsServiceException realmsServiceException) {
                    RealmsResetWorldScreen.method_21368().error("Couldn't fetch templates in reset world", (Throwable)realmsServiceException);
                }
            }
        }.start();
        ...
        this.addButton(new FrameButton(this.frame(2), RealmsResetWorldScreen.row(0) + 10, new TranslatableText("mco.reset.world.upload"), UPLOAD_TEXTURE, buttonWidget -> {
            RealmsSelectFileToUploadScreen realmsSelectFileToUploadScreen = new RealmsSelectFileToUploadScreen(this.serverData.id, this.slot != -1 ? this.slot : this.serverData.activeSlot, this, this.field_22712);
            this.client.openScreen(realmsSelectFileToUploadScreen);
        }));
    ...
    private void drawFrame(MatrixStack matrixStack, int x, int y, Text text, Identifier identifier, boolean bl, boolean bl2) {
        ...
        int n = bl ? 0xA0A0A0 : 0xFFFFFF;
        RealmsResetWorldScreen.drawCenteredText(matrixStack, this.textRenderer, text, x + 30, y, n);
    }
    ...
    private void method_25207(@Nullable String string, @Nullable WorldTemplate worldTemplate, int n, boolean bl) {
        this.client.openScreen(new RealmsLongRunningMcoTaskScreen(this.parent, new ResettingWorldTask(string, worldTemplate, n, bl, this.serverData.id, this.field_20501, this.field_22711)));
    }
    ...
    static /* synthetic */ MinecraftClient method_25205(RealmsResetWorldScreen realmsResetWorldScreen) {
        return realmsResetWorldScreen.client;
    }

    static /* synthetic */ Logger method_21368() {
        return LOGGER;
    }

    static /* synthetic */ WorldTemplatePaginatedList method_21375(RealmsResetWorldScreen realmsResetWorldScreen, WorldTemplatePaginatedList worldTemplatePaginatedList) {
        realmsResetWorldScreen.field_20495 = worldTemplatePaginatedList;
        return realmsResetWorldScreen.field_20495;
    }

    static /* synthetic */ WorldTemplatePaginatedList method_21383(RealmsResetWorldScreen realmsResetWorldScreen, WorldTemplatePaginatedList worldTemplatePaginatedList) {
        realmsResetWorldScreen.field_20496 = worldTemplatePaginatedList;
        return realmsResetWorldScreen.field_20496;
    }

    static /* synthetic */ WorldTemplatePaginatedList method_21386(RealmsResetWorldScreen realmsResetWorldScreen, WorldTemplatePaginatedList worldTemplatePaginatedList) {
        realmsResetWorldScreen.field_20497 = worldTemplatePaginatedList;
        return realmsResetWorldScreen.field_20497;
    }

    static /* synthetic */ WorldTemplatePaginatedList method_21388(RealmsResetWorldScreen realmsResetWorldScreen, WorldTemplatePaginatedList worldTemplatePaginatedList) {
        realmsResetWorldScreen.field_20498 = worldTemplatePaginatedList;
        return realmsResetWorldScreen.field_20498;
    }
