...
extends RealmsScreen {
    ...
    extends AlwaysSelectedEntryListWidget.Entry<WorldListEntry> {
        ...
        protected void renderItem(MatrixStack matrixStack, LevelSummary levelSummary, int n, int n2, int n3) {
            String string = this.field_26509.isEmpty() ? worldLang + " " + (n + 1) : this.field_26509;
            RealmsSelectFileToUploadScreen.this.textRenderer.draw(matrixStack, string, (float)(n2 + 2), (float)(n3 + 1), 0xFFFFFF);
            RealmsSelectFileToUploadScreen.this.textRenderer.draw(matrixStack, this.field_26510, (float)(n2 + 2), (float)(n3 + 12), 0x808080);
            RealmsSelectFileToUploadScreen.this.textRenderer.draw(matrixStack, this.field_26511, (float)(n2 + 2), (float)(n3 + 12 + 10), 0x808080);
        }
    }
    ...
    extends RealmsObjectSelectionList<WorldListEntry> {
        ...
        public void setSelected(int index) {
            ...
            if (index != -1) {
                ...
                String _snowman2 = I18n.translate("narrator.select.list.position", index + 1, RealmsSelectFileToUploadScreen.this.levelList.size());
                String _snowman3 = Realms.joinNarrations(Arrays.asList(levelSummary.getDisplayName(), RealmsSelectFileToUploadScreen.method_21404(levelSummary), RealmsSelectFileToUploadScreen.method_21400(levelSummary).getString(), _snowman2));
                Realms.narrateNow(I18n.translate("narrator.select", _snowman3));
            }
        }
