...
extends RealmsScreen {
    ...
    public void init() {
        ...
        if (this.worldType == RealmsServer.WorldType.NORMAL) {
            ...
            TranslatableText translatableText = this.worldType == RealmsServer.WorldType.ADVENTUREMAP ? new TranslatableText("mco.configure.world.edit.subscreen.adventuremap") : (this.worldType == RealmsServer.WorldType.INSPIRATION ? new TranslatableText("mco.configure.world.edit.subscreen.inspiration") : new TranslatableText("mco.configure.world.edit.subscreen.experience"));
            this.toastMessage = new RealmsLabel(translatableText, this.width / 2, 26, 0xFF0000);
            this.pvp = true;
