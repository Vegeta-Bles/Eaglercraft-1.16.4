...
public abstract class RenderPhase {
    ...
    private static void setupGlintTexturing(float scale) {
        ...
        float _snowman2 = (float)(l % 110000L) / 110000.0f;
        float _snowman3 = (float)(l % 30000L) / 30000.0f;
        RenderSystem.translatef(-_snowman2, _snowman3, 0.0f);
    ...
    extends RenderPhase {
        ...
        public DepthTest(String string, int n) {
            super("depth_test", () -> {
                if (n != 519) {
