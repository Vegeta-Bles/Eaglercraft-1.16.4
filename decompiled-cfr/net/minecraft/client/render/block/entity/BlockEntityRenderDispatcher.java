...
public class BlockEntityRenderDispatcher {
    ...
    private static <T extends BlockEntity> void render(BlockEntityRenderer<T> renderer, T blockEntity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers) {
        ...
        int _snowman2 = world != null ? WorldRenderer.getLightmapCoordinates(world, blockEntity.getPos()) : 0xF000F0;
        renderer.render(blockEntity, tickDelta, matrices, vertexConsumers, _snowman2, OverlayTexture.DEFAULT_UV);
    }
    ...
    private static void runReported(BlockEntity blockEntity, Runnable runnable) {
        try {
            ...
            CrashReportSection _snowman2 = crashReport.addElement("Block Entity Details");
            blockEntity.populateCrashReport(_snowman2);
