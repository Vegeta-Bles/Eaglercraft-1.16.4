...
implements DebugRenderer.Renderer {
    ...
    private static void method_23123(String string, BlockPos blockPos, int n) {
        double d = (double)blockPos.getX() + 0.5;
        _snowman = (double)blockPos.getY() + 1.3;
        _snowman = (double)blockPos.getZ() + 0.5;
        DebugRenderer.drawString(string, d, _snowman, _snowman, n, 0.04f, true, 0.0f, true);
    }
