...
extends EntityRenderer<LeashKnotEntity> {
    ...
    @Override
    public void render(LeashKnotEntity leashKnotEntity, float f, float f2, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int n) {
        matrixStack.push();
        ...
        matrixStack.pop();
        super.render(leashKnotEntity, f, f2, matrixStack, vertexConsumerProvider, n);
    }
