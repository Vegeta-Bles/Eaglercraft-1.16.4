...
extends FeatureRenderer<EndermanEntity, EndermanEntityModel<EndermanEntity>> {
    ...
    @Override
    public void render(MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int n, EndermanEntity endermanEntity, float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        MinecraftClient.getInstance().getBlockRenderManager().renderBlockAsEntity(blockState, matrixStack, vertexConsumerProvider, n, OverlayTexture.DEFAULT_UV);
        matrixStack.pop();
    }
}
