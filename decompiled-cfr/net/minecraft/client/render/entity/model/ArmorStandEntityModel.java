...
extends ArmorStandArmorEntityModel {
    ...
    @Override
    public void animateModel(ArmorStandEntity armorStandEntity, float f, float f2, float f3) {
        this.plate.pitch = 0.0f;
        this.plate.yaw = (float)Math.PI / 180 * -MathHelper.lerpAngleDegrees(f3, armorStandEntity.prevYaw, armorStandEntity.yaw);
    ...
    public void setArmAngle(Arm arm, MatrixStack matrices) {
        ...
        boolean _snowman2 = modelPart.visible;
        modelPart.visible = true;
        super.setArmAngle(arm, matrices);
        modelPart.visible = _snowman2;
    }
}
