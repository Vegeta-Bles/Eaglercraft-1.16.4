...
extends CompositeEntityModel<ParrotEntity> {
    ...
    @Override
    public void setAngles(ParrotEntity parrotEntity, float f, float f2, float f3, float f4, float f5) {
        this.setAngles(ParrotEntityModel.getPose(parrotEntity), parrotEntity.age, f, f2, f3, f4, f5);
    }

    @Override
    public void animateModel(ParrotEntity parrotEntity, float f, float f2, float f3) {
    ...
    private void setAngles(Pose pose, int danceAngle, float limbAngle, float limbDistance, float age, float headYaw, float headPitch) {
        ...
        switch (pose) {
            ...
            case PARTY: {
                ...
                _snowman = MathHelper.sin(danceAngle);
                this.head.pivotX = f;
            ...
            default: {
                float f = age * 0.3f;
                this.head.pivotY = 15.69f + f;
                this.tail.pitch = 1.015f + MathHelper.cos(limbAngle * 0.6662f) * 0.3f * limbDistance;
                this.tail.pivotY = 21.07f + f;
                this.torso.pivotY = 16.5f + f;
                this.leftWing.roll = -0.0873f - age;
                this.leftWing.pivotY = 16.94f + f;
                this.rightWing.roll = 0.0873f + age;
                this.rightWing.pivotY = 16.94f + f;
                this.leftLeg.pivotY = 22.0f + f;
                this.rightLeg.pivotY = 22.0f + f;
            }
        }
    }
