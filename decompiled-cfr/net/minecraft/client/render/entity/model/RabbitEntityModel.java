...
extends EntityModel<T> {
    ...
    public void render(MatrixStack matrices, VertexConsumer vertices, int light, int overlay, float red, float green, float blue, float alpha) {
        if (this.child) {
            ...
            ImmutableList.of((Object)this.head, (Object)this.leftEar, (Object)this.rightEar, (Object)this.nose).forEach(modelPart -> modelPart.render(matrices, vertices, light, overlay, red, green, blue, alpha));
            matrices.pop();
            matrices.push();
            matrices.scale(0.4f, 0.4f, 0.4f);
            matrices.translate(0.0, 2.25, 0.0);
            ImmutableList.of((Object)this.leftFoot, (Object)this.rightFoot, (Object)this.leftBackLeg, (Object)this.rightBackLeg, (Object)this.torso, (Object)this.leftFrontLeg, (Object)this.rightFrontLeg, (Object)this.tail).forEach(modelPart -> modelPart.render(matrices, vertices, light, overlay, red, green, blue, alpha));
            matrices.pop();
        } else {
            matrices.push();
    ...
    public void setAngles(T t, float f, float f2, float f3, float f4, float f5) {
        _snowman = f3 - (float)((RabbitEntity)t).age;
        this.nose.pitch = f5 * ((float)Math.PI / 180);
        this.head.pitch = f5 * ((float)Math.PI / 180);
        this.rightEar.pitch = f5 * ((float)Math.PI / 180);
        this.leftEar.pitch = f5 * ((float)Math.PI / 180);
        this.nose.yaw = f4 * ((float)Math.PI / 180);
        this.head.yaw = f4 * ((float)Math.PI / 180);
        this.rightEar.yaw = this.nose.yaw - 0.2617994f;
        this.leftEar.yaw = this.nose.yaw + 0.2617994f;
        this.field_3531 = MathHelper.sin(((RabbitEntity)t).getJumpProgress(_snowman) * (float)Math.PI);
    ...
    public void animateModel(T t, float f, float f2, float f3) {
        ...
        this.field_3531 = MathHelper.sin(((RabbitEntity)t).getJumpProgress(f3) * (float)Math.PI);
    }
}
