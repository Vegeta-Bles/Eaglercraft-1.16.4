...
extends CompositeEntityModel<T> {
    ...
    public void setAngles(T entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        ...
        _snowman = -(MathHelper.cos(limbAngle * 0.6662f * 2.0f + 0.0f) * 0.4f) * limbDistance;
        _snowman = -(MathHelper.cos(limbAngle * 0.6662f * 2.0f + (float)Math.PI) * 0.4f) * limbDistance;
        _snowman = -(MathHelper.cos(limbAngle * 0.6662f * 2.0f + 1.5707964f) * 0.4f) * limbDistance;
        _snowman = -(MathHelper.cos(limbAngle * 0.6662f * 2.0f + 4.712389f) * 0.4f) * limbDistance;
        _snowman = Math.abs(MathHelper.sin(limbAngle * 0.6662f + 0.0f) * 0.4f) * limbDistance;
        _snowman = Math.abs(MathHelper.sin(limbAngle * 0.6662f + (float)Math.PI) * 0.4f) * limbDistance;
        _snowman = Math.abs(MathHelper.sin(limbAngle * 0.6662f + 1.5707964f) * 0.4f) * limbDistance;
        _snowman = Math.abs(MathHelper.sin(limbAngle * 0.6662f + 4.712389f) * 0.4f) * limbDistance;
        this.rightBackLeg.yaw += _snowman;
        this.leftBackLeg.yaw += -_snowman;
        this.rightBackMiddleLeg.yaw += _snowman;
        this.leftBackMiddleLeg.yaw += -_snowman;
        this.rightFrontMiddleLeg.yaw += _snowman;
        this.leftFrontMiddleLeg.yaw += -_snowman;
        this.rightFrontLeg.yaw += _snowman;
        this.leftFrontLeg.yaw += -_snowman;
        this.rightBackLeg.roll += _snowman;
        this.leftBackLeg.roll += -_snowman;
        this.rightBackMiddleLeg.roll += _snowman;
        this.leftBackMiddleLeg.roll += -_snowman;
        this.rightFrontMiddleLeg.roll += _snowman;
        this.leftFrontMiddleLeg.roll += -_snowman;
        this.rightFrontLeg.roll += _snowman;
        this.leftFrontLeg.roll += -_snowman;
    }
}
