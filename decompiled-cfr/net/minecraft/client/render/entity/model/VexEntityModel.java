...
extends BipedEntityModel<VexEntity> {
    ...
    protected Iterable<ModelPart> getBodyParts() {
        return Iterables.concat(super.getBodyParts(), (Iterable)ImmutableList.of((Object)this.rightWing, (Object)this.leftWing));
    }

    @Override
    public void setAngles(VexEntity vexEntity, float f, float f2, float f3, float f4, float f5) {
        super.setAngles(vexEntity, f, f2, f3, f4, f5);
        ...
        this.rightWing.yaw = 0.47123894f + MathHelper.cos(f3 * 0.8f) * (float)Math.PI * 0.05f;
