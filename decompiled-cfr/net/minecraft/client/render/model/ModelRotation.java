...
public enum ModelRotation implements ModelBakeSettings
{
    ...
    private ModelRotation(int x, int y) {
        ...
        DirectionTransformation _snowman2 = DirectionTransformation.IDENTITY;
        for (n2 = 0; n2 < y; n2 += 90) {
            _snowman2 = _snowman2.prepend(DirectionTransformation.ROT_90_Y_NEG);
        }
        for (n2 = 0; n2 < x; n2 += 90) {
            _snowman2 = _snowman2.prepend(DirectionTransformation.ROT_90_X_NEG);
        }
        this.rotation = new AffineTransformation(null, quaternion, null, null);
        this.directionTransformation = _snowman2;
    }
