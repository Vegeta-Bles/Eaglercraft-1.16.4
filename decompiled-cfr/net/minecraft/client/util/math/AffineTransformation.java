...
public final class AffineTransformation {
    ...
    private static final AffineTransformation IDENTITY = Util.make(() -> {
        ...
        AffineTransformation _snowman2 = new AffineTransformation(matrix4f);
        _snowman2.getRotation2();
        return _snowman2;
    });
    ...
    private void init() {
        if (!this.initialized) {
            ...
            Triple<Quaternion, Vector3f, Quaternion> _snowman2 = ((Matrix3f)pair.getFirst()).decomposeLinearTransformation();
            this.translation = (Vector3f)pair.getSecond();
            this.rotation2 = (Quaternion)_snowman2.getLeft();
            this.scale = (Vector3f)_snowman2.getMiddle();
            this.rotation1 = (Quaternion)_snowman2.getRight();
            this.initialized = true;
        }
    }
    ...
    public static Pair<Matrix3f, Vector3f> getLinearTransformationAndTranslationFromAffine(Matrix4f affineTransform) {
        ...
        Matrix3f _snowman2 = new Matrix3f(affineTransform);
        return Pair.of((Object)_snowman2, (Object)vector3f);
    }
