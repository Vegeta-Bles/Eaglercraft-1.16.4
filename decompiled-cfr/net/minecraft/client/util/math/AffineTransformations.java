...
public class AffineTransformations {
    ...
    public static AffineTransformation uvLock(AffineTransformation affineTransformation, Direction direction, Supplier<String> supplier) {
        ...
        AffineTransformation _snowman2 = affineTransformation.invert();
        if (_snowman2 == null) {
            LOGGER.warn(supplier.get());
            return new AffineTransformation(null, null, new Vector3f(0.0f, 0.0f, 0.0f), null);
        }
        AffineTransformation _snowman3 = INVERTED_DIRECTION_ROTATIONS.get(direction).multiply(_snowman2).multiply(DIRECTION_ROTATIONS.get(direction2));
        return AffineTransformations.setupUvLock(_snowman3);
    }
}
