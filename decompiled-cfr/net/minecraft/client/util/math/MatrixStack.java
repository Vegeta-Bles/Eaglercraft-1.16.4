...
public class MatrixStack {
    private final Deque<Entry> stack = Util.make(Queues.newArrayDeque(), arrayDeque -> {
        ...
        Matrix3f _snowman2 = new Matrix3f();
        _snowman2.loadIdentity();
        arrayDeque.add(new Entry(matrix4f, _snowman2));
    });
    ...
    public void scale(float x, float y, float z) {
        ...
        float _snowman2 = 1.0f / x;
        float _snowman3 = 1.0f / y;
        float _snowman4 = 1.0f / z;
        float _snowman5 = MathHelper.fastInverseCbrt(_snowman2 * _snowman3 * _snowman4);
        entry.normalMatrix.multiply(Matrix3f.scale(_snowman5 * _snowman2, _snowman5 * _snowman3, _snowman5 * _snowman4));
    }
