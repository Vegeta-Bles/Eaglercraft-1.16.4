...
public final class Vector3f {
    ...
    public void cross(Vector3f vector) {
        ...
        _snowman = this.y;
        _snowman = this.z;
        _snowman = vector.getX();
        _snowman = vector.getY();
        _snowman = vector.getZ();
        this.x = _snowman * _snowman - _snowman * _snowman;
        this.y = _snowman * _snowman - f * _snowman;
        this.z = f * _snowman - _snowman * _snowman;
    }
    ...
    public void transform(Matrix3f matrix3f) {
        ...
        _snowman = this.y;
        _snowman = this.z;
        this.x = matrix3f.a00 * f + matrix3f.a01 * _snowman + matrix3f.a02 * _snowman;
        this.y = matrix3f.a10 * f + matrix3f.a11 * _snowman + matrix3f.a12 * _snowman;
        this.z = matrix3f.a20 * f + matrix3f.a21 * _snowman + matrix3f.a22 * _snowman;
    }
