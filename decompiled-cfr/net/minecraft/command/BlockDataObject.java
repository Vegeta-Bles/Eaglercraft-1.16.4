...
implements DataCommandObject {
    ...
    public static final Function<String, DataCommand.ObjectType> TYPE_FACTORY = string -> new DataCommand.ObjectType((String)string){
        ...
        public DataCommandObject getObject(CommandContext<ServerCommandSource> context) throws CommandSyntaxException {
            ...
            BlockEntity _snowman2 = ((ServerCommandSource)context.getSource()).getWorld().getBlockEntity(blockPos);
            if (_snowman2 == null) {
                throw BlockDataObject.method_13877().create();
            }
            return new BlockDataObject(_snowman2, blockPos);
        }
    ...
    static /* synthetic */ SimpleCommandExceptionType method_13877() {
        return INVALID_BLOCK_EXCEPTION;
    }
}
