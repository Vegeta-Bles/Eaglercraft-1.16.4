...
implements DataCommandObject {
    ...
    public static final Function<String, DataCommand.ObjectType> TYPE_FACTORY = string -> new DataCommand.ObjectType((String)string){
        ...
        public DataCommandObject getObject(CommandContext<ServerCommandSource> context) {
            return new StorageDataObject(StorageDataObject.method_22839(context), IdentifierArgumentType.getIdentifier(context, this.field_20859));
        }
        ...
        public ArgumentBuilder<ServerCommandSource, ?> addArgumentsToBuilder(ArgumentBuilder<ServerCommandSource, ?> argument, Function<ArgumentBuilder<ServerCommandSource, ?>, ArgumentBuilder<ServerCommandSource, ?>> argumentAdder) {
            return argument.then(CommandManager.literal("storage").then(argumentAdder.apply((ArgumentBuilder<ServerCommandSource, ?>)CommandManager.argument(this.field_20859, IdentifierArgumentType.identifier()).suggests(StorageDataObject.method_22843()))));
        }
    };
    ...
    static /* synthetic */ DataCommandStorage method_22839(CommandContext commandContext) {
        return StorageDataObject.of((CommandContext<ServerCommandSource>)commandContext);
    }

    static /* synthetic */ SuggestionProvider method_22843() {
