...
implements ArgumentType<Identifier> {
    ...
    public static ServerWorld getDimensionArgument(CommandContext<ServerCommandSource> context, String name) throws CommandSyntaxException {
        ...
        RegistryKey<World> _snowman2 = RegistryKey.of(Registry.DIMENSION, identifier);
        ServerWorld _snowman3 = ((ServerCommandSource)context.getSource()).getMinecraftServer().getWorld(_snowman2);
        if (_snowman3 == null) {
