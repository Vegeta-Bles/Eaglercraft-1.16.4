...
implements ArgumentType<EntityAnchor> {
    ...
    public EntityAnchor parse(StringReader stringReader) throws CommandSyntaxException {
        ...
        EntityAnchor _snowman3 = EntityAnchor.fromId(_snowman2);
        if (_snowman3 == null) {
            stringReader.setCursor(n);
            throw INVALID_ANCHOR_EXCEPTION.createWithContext((ImmutableStringReader)stringReader, (Object)_snowman2);
        }
        return _snowman3;
    }
