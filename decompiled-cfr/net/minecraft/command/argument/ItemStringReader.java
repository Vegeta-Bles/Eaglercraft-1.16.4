...
public class ItemStringReader {
    ...
    public void readItem() throws CommandSyntaxException {
        ...
        Identifier _snowman2 = Identifier.fromCommandInput(this.reader);
        this.item = Registry.ITEM.getOrEmpty(_snowman2).orElseThrow(() -> {
            this.reader.setCursor(n);
            return ID_INVALID_EXCEPTION.createWithContext((ImmutableStringReader)this.reader, (Object)_snowman2.toString());
        });
    }
