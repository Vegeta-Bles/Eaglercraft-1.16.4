...
implements ArgumentType<ParticleEffect> {
    ...
    public static ParticleEffect readParameters(StringReader reader) throws CommandSyntaxException {
        ...
        ParticleType<?> _snowman2 = Registry.PARTICLE_TYPE.getOrEmpty(identifier).orElseThrow(() -> UNKNOWN_PARTICLE_EXCEPTION.create((Object)identifier));
        return ParticleArgumentType.readParameters(reader, _snowman2);
    }
