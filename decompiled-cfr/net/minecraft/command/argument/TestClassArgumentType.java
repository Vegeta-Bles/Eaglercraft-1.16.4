...
implements ArgumentType<String> {
    ...
    public String parse(StringReader stringReader) throws CommandSyntaxException {
        ...
        LiteralText _snowman2 = new LiteralText("No such test class: " + string);
        throw new CommandSyntaxException((CommandExceptionType)new SimpleCommandExceptionType((Message)_snowman2), (Message)_snowman2);
    }
