...
public class BlockStateModelGenerator {
    ...
    private void registerMirrorable(Block block) {
        ...
        _snowman = TexturedModel.CUBE_MIRRORED_ALL.upload(block, this.modelCollector);
        this.blockStateCollector.accept(BlockStateModelGenerator.createBlockStateWithTwoModelAndRandomInversion(block, identifier, _snowman));
    }
    ...
    private void registerAxisRotated(Block block, TexturedModel.Factory verticalModelFactory, TexturedModel.Factory horizontalModelFactory) {
        ...
        _snowman = horizontalModelFactory.upload(block, this.modelCollector);
        this.blockStateCollector.accept(BlockStateModelGenerator.createAxisRotatedBlockState(block, identifier, _snowman));
    }
    ...
    private void registerDoor(Block doorBlock) {
        ...
        Identifier _snowman2 = Models.DOOR_BOTTOM.upload(doorBlock, texture, this.modelCollector);
        Identifier _snowman3 = Models.DOOR_BOTTOM_RH.upload(doorBlock, texture, this.modelCollector);
        Identifier _snowman4 = Models.DOOR_TOP.upload(doorBlock, texture, this.modelCollector);
        Identifier _snowman5 = Models.DOOR_TOP_RH.upload(doorBlock, texture, this.modelCollector);
        this.registerItemModel(doorBlock.asItem());
        this.blockStateCollector.accept(BlockStateModelGenerator.createDoorBlockState(doorBlock, _snowman2, _snowman3, _snowman4, _snowman5));
    }

    private void registerOrientableTrapdoor(Block trapdoorBlock) {
        Texture texture = Texture.texture(trapdoorBlock);
        Identifier _snowman2 = Models.TEMPLATE_ORIENTABLE_TRAPDOOR_TOP.upload(trapdoorBlock, texture, this.modelCollector);
        Identifier _snowman3 = Models.TEMPLATE_ORIENTABLE_TRAPDOOR_BOTTOM.upload(trapdoorBlock, texture, this.modelCollector);
        Identifier _snowman4 = Models.TEMPLATE_ORIENTABLE_TRAPDOOR_OPEN.upload(trapdoorBlock, texture, this.modelCollector);
        this.blockStateCollector.accept(BlockStateModelGenerator.createOrientableTrapdoorBlockState(trapdoorBlock, _snowman2, _snowman3, _snowman4));
        this.registerParentedItemModel(trapdoorBlock, _snowman3);
    }

    private void registerTrapdoor(Block trapdoorBlock) {
        Texture texture = Texture.texture(trapdoorBlock);
        Identifier _snowman2 = Models.TEMPLATE_TRAPDOOR_TOP.upload(trapdoorBlock, texture, this.modelCollector);
        Identifier _snowman3 = Models.TEMPLATE_TRAPDOOR_BOTTOM.upload(trapdoorBlock, texture, this.modelCollector);
        Identifier _snowman4 = Models.TEMPLATE_TRAPDOOR_OPEN.upload(trapdoorBlock, texture, this.modelCollector);
        this.blockStateCollector.accept(BlockStateModelGenerator.createTrapdoorBlockState(trapdoorBlock, _snowman2, _snowman3, _snowman4));
        this.registerParentedItemModel(trapdoorBlock, _snowman3);
    }
    ...
    private void registerFlowerPotPlant(Block plantBlock, Block flowerPotBlock, TintType tintType) {
        ...
        Identifier _snowman2 = tintType.getFlowerPotCrossModel().upload(flowerPotBlock, texture, this.modelCollector);
        this.blockStateCollector.accept(BlockStateModelGenerator.createSingletonBlockState(flowerPotBlock, _snowman2));
    }
    ...
    private void registerCoralFan(Block coralFanBlock, Block coralWallFanBlock) {
        ...
        Identifier _snowman2 = texturedModel.upload(coralFanBlock, this.modelCollector);
        this.blockStateCollector.accept(BlockStateModelGenerator.createSingletonBlockState(coralFanBlock, _snowman2));
        Identifier _snowman3 = Models.CORAL_WALL_FAN.upload(coralWallFanBlock, texturedModel.getTexture(), this.modelCollector);
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(coralWallFanBlock, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman3)).coordinate(BlockStateModelGenerator.createNorthDefaultHorizontalRotationStates()));
    ...
    private void registerGourd(Block stemBlock, Block attachedStemBlock) {
        ...
        _snowman = Texture.stemAndUpper(stemBlock, attachedStemBlock);
        Identifier _snowman2 = Models.STEM_FRUIT.upload(attachedStemBlock, _snowman, this.modelCollector);
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(attachedStemBlock, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman2)).coordinate(BlockStateVariantMap.create(Properties.HORIZONTAL_FACING).register(Direction.WEST, BlockStateVariant.create()).register(Direction.SOUTH, BlockStateVariant.create().put(VariantSettings.Y, VariantSettings.Rotation.R270)).register(Direction.NORTH, BlockStateVariant.create().put(VariantSettings.Y, VariantSettings.Rotation.R90)).register(Direction.EAST, BlockStateVariant.create().put(VariantSettings.Y, VariantSettings.Rotation.R180))));
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(stemBlock).coordinate(BlockStateVariantMap.create(Properties.AGE_7).register(n -> BlockStateVariant.create().put(VariantSettings.MODEL, Models.STEM_GROWTH_STAGES[n].upload(stemBlock, texture, this.modelCollector)))));
    }
    ...
    private void registerDoubleBlock(Block doubleBlock, TintType tintType) {
        ...
        _snowman = this.createSubModel(doubleBlock, "_bottom", tintType.getCrossModel(), Texture::cross);
        this.registerDoubleBlock(doubleBlock, identifier, _snowman);
    }
    ...
    private void registerSunflower() {
        ...
        _snowman = this.createSubModel(Blocks.SUNFLOWER, "_bottom", TintType.NOT_TINTED.getCrossModel(), Texture::cross);
        this.registerDoubleBlock(Blocks.SUNFLOWER, identifier, _snowman);
    }
    ...
    private void registerTallSeagrass() {
        ...
        _snowman = this.createSubModel(Blocks.TALL_SEAGRASS, "_bottom", Models.TEMPLATE_SEAGRASS, Texture::texture);
        this.registerDoubleBlock(Blocks.TALL_SEAGRASS, identifier, _snowman);
    }
    ...
    private void registerTurnableRail(Block rail) {
        ...
        _snowman = Texture.rail(Texture.getSubId(rail, "_corner"));
        Identifier _snowman2 = Models.RAIL_FLAT.upload(rail, texture, this.modelCollector);
        Identifier _snowman3 = Models.RAIL_CURVED.upload(rail, _snowman, this.modelCollector);
        Identifier _snowman4 = Models.TEMPLATE_RAIL_RAISED_NE.upload(rail, texture, this.modelCollector);
        Identifier _snowman5 = Models.TEMPLATE_RAIL_RAISED_SW.upload(rail, texture, this.modelCollector);
        this.registerItemModel(rail);
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(rail).coordinate(BlockStateVariantMap.create(Properties.RAIL_SHAPE).register(RailShape.NORTH_SOUTH, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman2)).register(RailShape.EAST_WEST, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman2).put(VariantSettings.Y, VariantSettings.Rotation.R90)).register(RailShape.ASCENDING_EAST, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman4).put(VariantSettings.Y, VariantSettings.Rotation.R90)).register(RailShape.ASCENDING_WEST, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman5).put(VariantSettings.Y, VariantSettings.Rotation.R90)).register(RailShape.ASCENDING_NORTH, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman4)).register(RailShape.ASCENDING_SOUTH, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman5)).register(RailShape.SOUTH_EAST, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman3)).register(RailShape.SOUTH_WEST, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman3).put(VariantSettings.Y, VariantSettings.Rotation.R90)).register(RailShape.NORTH_WEST, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman3).put(VariantSettings.Y, VariantSettings.Rotation.R180)).register(RailShape.NORTH_EAST, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman3).put(VariantSettings.Y, VariantSettings.Rotation.R270))));
    }

    private void registerStraightRail(Block rail) {
        Identifier identifier = this.createSubModel(rail, "", Models.RAIL_FLAT, Texture::rail);
        _snowman = this.createSubModel(rail, "", Models.TEMPLATE_RAIL_RAISED_NE, Texture::rail);
        _snowman = this.createSubModel(rail, "", Models.TEMPLATE_RAIL_RAISED_SW, Texture::rail);
        _snowman = this.createSubModel(rail, "_on", Models.RAIL_FLAT, Texture::rail);
        _snowman = this.createSubModel(rail, "_on", Models.TEMPLATE_RAIL_RAISED_NE, Texture::rail);
        _snowman = this.createSubModel(rail, "_on", Models.TEMPLATE_RAIL_RAISED_SW, Texture::rail);
        BlockStateVariantMap _snowman2 = BlockStateVariantMap.create(Properties.POWERED, Properties.STRAIGHT_RAIL_SHAPE).register((bl, railShape) -> {
            switch (railShape) {
                case NORTH_SOUTH: {
                    return BlockStateVariant.create().put(VariantSettings.MODEL, bl != false ? _snowman : identifier);
                }
                case EAST_WEST: {
                    return BlockStateVariant.create().put(VariantSettings.MODEL, bl != false ? _snowman : identifier).put(VariantSettings.Y, VariantSettings.Rotation.R90);
                }
                case ASCENDING_EAST: {
                    return BlockStateVariant.create().put(VariantSettings.MODEL, bl != false ? _snowman : _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R90);
                }
                case ASCENDING_WEST: {
                    return BlockStateVariant.create().put(VariantSettings.MODEL, bl != false ? _snowman : _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R90);
                }
                case ASCENDING_NORTH: {
                    return BlockStateVariant.create().put(VariantSettings.MODEL, bl != false ? _snowman : _snowman);
                }
        ...
        this.registerItemModel(rail);
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(rail).coordinate(_snowman2));
    }
    ...
    private void registerGlassPane(Block glass, Block glassPane) {
        ...
        Identifier _snowman2 = Models.TEMPLATE_GLASS_PANE_POST.upload(glassPane, texture, this.modelCollector);
        Identifier _snowman3 = Models.TEMPLATE_GLASS_PANE_SIDE.upload(glassPane, texture, this.modelCollector);
        Identifier _snowman4 = Models.TEMPLATE_GLASS_PANE_SIDE_ALT.upload(glassPane, texture, this.modelCollector);
        Identifier _snowman5 = Models.TEMPLATE_GLASS_PANE_NOSIDE.upload(glassPane, texture, this.modelCollector);
        Identifier _snowman6 = Models.TEMPLATE_GLASS_PANE_NOSIDE_ALT.upload(glassPane, texture, this.modelCollector);
        Item _snowman7 = glassPane.asItem();
        Models.GENERATED.upload(ModelIds.getItemModelId(_snowman7), Texture.layer0(glass), this.modelCollector);
        this.blockStateCollector.accept(MultipartBlockStateSupplier.create(glassPane).with(BlockStateVariant.create().put(VariantSettings.MODEL, _snowman2)).with((When)When.create().set(Properties.NORTH, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman3)).with((When)When.create().set(Properties.EAST, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman3).put(VariantSettings.Y, VariantSettings.Rotation.R90)).with((When)When.create().set(Properties.SOUTH, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman4)).with((When)When.create().set(Properties.WEST, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman4).put(VariantSettings.Y, VariantSettings.Rotation.R90)).with((When)When.create().set(Properties.NORTH, false), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman5)).with((When)When.create().set(Properties.EAST, false), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman6)).with((When)When.create().set(Properties.SOUTH, false), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman6).put(VariantSettings.Y, VariantSettings.Rotation.R90)).with((When)When.create().set(Properties.WEST, false), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman5).put(VariantSettings.Y, VariantSettings.Rotation.R270)));
    }

    private void registerCommandBlock(Block commandBlock) {
        Texture texture = Texture.sideFrontBack(commandBlock);
        Identifier _snowman2 = Models.TEMPLATE_COMMAND_BLOCK.upload(commandBlock, texture, this.modelCollector);
        Identifier _snowman3 = this.createSubModel(commandBlock, "_conditional", Models.TEMPLATE_COMMAND_BLOCK, identifier -> texture.copyAndAdd(TextureKey.SIDE, (Identifier)identifier));
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(commandBlock).coordinate(BlockStateModelGenerator.createBooleanModelMap(Properties.CONDITIONAL, _snowman3, _snowman2)).coordinate(BlockStateModelGenerator.createNorthDefaultRotationStates()));
    }
    ...
    private List<BlockStateVariant> getBambooBlockStateVariants(int age) {
        ...
        return IntStream.range(1, 5).mapToObj(n -> BlockStateVariant.create().put(VariantSettings.MODEL, ModelIds.getBlockSubModelId(Blocks.BAMBOO, n + string))).collect(Collectors.toList());
    }
    ...
    private static <T extends Comparable<T>> BlockStateVariantMap createValueFencedModelMap(Property<T> property, T fence, Identifier higherOrEqualModelId, Identifier lowerModelId) {
        ...
        _snowman = BlockStateVariant.create().put(VariantSettings.MODEL, lowerModelId);
        return BlockStateVariantMap.create(property).register(comparable2 -> {
            boolean bl = comparable2.compareTo(fence) >= 0;
            return bl ? blockStateVariant : _snowman;
        });
    }

    private void registerBeehive(Block beehive, Function<Block, Texture> textureGetter) {
        Texture texture = textureGetter.apply(beehive).inherit(TextureKey.SIDE, TextureKey.PARTICLE);
        _snowman = texture.copyAndAdd(TextureKey.FRONT, Texture.getSubId(beehive, "_front_honey"));
        Identifier _snowman2 = Models.ORIENTABLE_WITH_BOTTOM.upload(beehive, texture, this.modelCollector);
        Identifier _snowman3 = Models.ORIENTABLE_WITH_BOTTOM.upload(beehive, "_honey", _snowman, this.modelCollector);
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(beehive).coordinate(BlockStateModelGenerator.createNorthDefaultHorizontalRotationStates()).coordinate(BlockStateModelGenerator.createValueFencedModelMap(Properties.HONEY_LEVEL, 5, _snowman3, _snowman2)));
    }
    ...
    private void registerCrop(Block crop, Property<Integer> ageProperty, int ... ageTextureIndices) {
        ...
        BlockStateVariantMap _snowman2 = BlockStateVariantMap.create(ageProperty).register(arg_0 -> this.method_25589(ageTextureIndices, (Int2ObjectMap)int2ObjectOpenHashMap, crop, arg_0));
        this.registerItemModel(crop.asItem());
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(crop).coordinate(_snowman2));
    }

    private void registerBell() {
        Identifier identifier = ModelIds.getBlockSubModelId(Blocks.BELL, "_floor");
        _snowman = ModelIds.getBlockSubModelId(Blocks.BELL, "_ceiling");
        _snowman = ModelIds.getBlockSubModelId(Blocks.BELL, "_wall");
        _snowman = ModelIds.getBlockSubModelId(Blocks.BELL, "_between_walls");
        this.registerItemModel(Items.BELL);
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.BELL).coordinate(BlockStateVariantMap.create(Properties.HORIZONTAL_FACING, Properties.ATTACHMENT).register(Direction.NORTH, Attachment.FLOOR, BlockStateVariant.create().put(VariantSettings.MODEL, identifier)).register(Direction.SOUTH, Attachment.FLOOR, BlockStateVariant.create().put(VariantSettings.MODEL, identifier).put(VariantSettings.Y, VariantSettings.Rotation.R180)).register(Direction.EAST, Attachment.FLOOR, BlockStateVariant.create().put(VariantSettings.MODEL, identifier).put(VariantSettings.Y, VariantSettings.Rotation.R90)).register(Direction.WEST, Attachment.FLOOR, BlockStateVariant.create().put(VariantSettings.MODEL, identifier).put(VariantSettings.Y, VariantSettings.Rotation.R270)).register(Direction.NORTH, Attachment.CEILING, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman)).register(Direction.SOUTH, Attachment.CEILING, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R180)).register(Direction.EAST, Attachment.CEILING, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R90)).register(Direction.WEST, Attachment.CEILING, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R270)).register(Direction.NORTH, Attachment.SINGLE_WALL, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R270)).register(Direction.SOUTH, Attachment.SINGLE_WALL, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R90)).register(Direction.EAST, Attachment.SINGLE_WALL, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman)).register(Direction.WEST, Attachment.SINGLE_WALL, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R180)).register(Direction.SOUTH, Attachment.DOUBLE_WALL, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R90)).register(Direction.NORTH, Attachment.DOUBLE_WALL, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R270)).register(Direction.EAST, Attachment.DOUBLE_WALL, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman)).register(Direction.WEST, Attachment.DOUBLE_WALL, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R180))));
    }
    ...
    private void registerCooker(Block cooker, TexturedModel.Factory modelFactory) {
        ...
        _snowman = Texture.getSubId(cooker, "_front_on");
        _snowman = modelFactory.get(cooker).texture(texture -> texture.put(TextureKey.FRONT, _snowman)).upload(cooker, "_on", this.modelCollector);
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(cooker).coordinate(BlockStateModelGenerator.createBooleanModelMap(Properties.LIT, _snowman, identifier)).coordinate(BlockStateModelGenerator.createNorthDefaultHorizontalRotationStates()));
    }

    private void method_27166(Block ... blockArray) {
    ...
    private void registerBookshelf() {
        ...
        Identifier _snowman2 = Models.CUBE_COLUMN.upload(Blocks.BOOKSHELF, texture, this.modelCollector);
        this.blockStateCollector.accept(BlockStateModelGenerator.createSingletonBlockState(Blocks.BOOKSHELF, _snowman2));
    }
    ...
    private void registerSmoothStone() {
        ...
        _snowman = Texture.sideEnd(Texture.getSubId(Blocks.SMOOTH_STONE_SLAB, "_side"), texture.getTexture(TextureKey.TOP));
        Identifier _snowman2 = Models.SLAB.upload(Blocks.SMOOTH_STONE_SLAB, _snowman, this.modelCollector);
        Identifier _snowman3 = Models.SLAB_TOP.upload(Blocks.SMOOTH_STONE_SLAB, _snowman, this.modelCollector);
        Identifier _snowman4 = Models.CUBE_COLUMN.uploadWithoutVariant(Blocks.SMOOTH_STONE_SLAB, "_double", _snowman, this.modelCollector);
        this.blockStateCollector.accept(BlockStateModelGenerator.createSlabBlockState(Blocks.SMOOTH_STONE_SLAB, _snowman2, _snowman3, _snowman4));
        this.blockStateCollector.accept(BlockStateModelGenerator.createSingletonBlockState(Blocks.SMOOTH_STONE, Models.CUBE_ALL.upload(Blocks.SMOOTH_STONE, texture, this.modelCollector)));
    }
    ...
    private void registerMushroomBlock(Block mushroomBlock) {
        ...
        _snowman = ModelIds.getMinecraftNamespacedBlock("mushroom_block_inside");
        this.blockStateCollector.accept(MultipartBlockStateSupplier.create(mushroomBlock).with((When)When.create().set(Properties.NORTH, true), BlockStateVariant.create().put(VariantSettings.MODEL, identifier)).with((When)When.create().set(Properties.EAST, true), BlockStateVariant.create().put(VariantSettings.MODEL, identifier).put(VariantSettings.Y, VariantSettings.Rotation.R90).put(VariantSettings.UVLOCK, true)).with((When)When.create().set(Properties.SOUTH, true), BlockStateVariant.create().put(VariantSettings.MODEL, identifier).put(VariantSettings.Y, VariantSettings.Rotation.R180).put(VariantSettings.UVLOCK, true)).with((When)When.create().set(Properties.WEST, true), BlockStateVariant.create().put(VariantSettings.MODEL, identifier).put(VariantSettings.Y, VariantSettings.Rotation.R270).put(VariantSettings.UVLOCK, true)).with((When)When.create().set(Properties.UP, true), BlockStateVariant.create().put(VariantSettings.MODEL, identifier).put(VariantSettings.X, VariantSettings.Rotation.R270).put(VariantSettings.UVLOCK, true)).with((When)When.create().set(Properties.DOWN, true), BlockStateVariant.create().put(VariantSettings.MODEL, identifier).put(VariantSettings.X, VariantSettings.Rotation.R90).put(VariantSettings.UVLOCK, true)).with((When)When.create().set(Properties.NORTH, false), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman)).with((When)When.create().set(Properties.EAST, false), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R90).put(VariantSettings.UVLOCK, false)).with((When)When.create().set(Properties.SOUTH, false), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R180).put(VariantSettings.UVLOCK, false)).with((When)When.create().set(Properties.WEST, false), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R270).put(VariantSettings.UVLOCK, false)).with((When)When.create().set(Properties.UP, false), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.X, VariantSettings.Rotation.R270).put(VariantSettings.UVLOCK, false)).with((When)When.create().set(Properties.DOWN, false), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.X, VariantSettings.Rotation.R90).put(VariantSettings.UVLOCK, false)));
    ...
    private void registerCartographyTable() {
        Texture texture = new Texture().put(TextureKey.PARTICLE, Texture.getSubId(Blocks.CARTOGRAPHY_TABLE, "_side3")).put(TextureKey.DOWN, Texture.getId(Blocks.DARK_OAK_PLANKS)).put(TextureKey.UP, Texture.getSubId(Blocks.CARTOGRAPHY_TABLE, "_top")).put(TextureKey.NORTH, Texture.getSubId(Blocks.CARTOGRAPHY_TABLE, "_side3")).put(TextureKey.EAST, Texture.getSubId(Blocks.CARTOGRAPHY_TABLE, "_side3")).put(TextureKey.SOUTH, Texture.getSubId(Blocks.CARTOGRAPHY_TABLE, "_side1")).put(TextureKey.WEST, Texture.getSubId(Blocks.CARTOGRAPHY_TABLE, "_side2"));
        this.blockStateCollector.accept(BlockStateModelGenerator.createSingletonBlockState(Blocks.CARTOGRAPHY_TABLE, Models.CUBE.upload(Blocks.CARTOGRAPHY_TABLE, texture, this.modelCollector)));
    }

    private void registerSmithingTable() {
        Texture texture = new Texture().put(TextureKey.PARTICLE, Texture.getSubId(Blocks.SMITHING_TABLE, "_front")).put(TextureKey.DOWN, Texture.getSubId(Blocks.SMITHING_TABLE, "_bottom")).put(TextureKey.UP, Texture.getSubId(Blocks.SMITHING_TABLE, "_top")).put(TextureKey.NORTH, Texture.getSubId(Blocks.SMITHING_TABLE, "_front")).put(TextureKey.SOUTH, Texture.getSubId(Blocks.SMITHING_TABLE, "_front")).put(TextureKey.EAST, Texture.getSubId(Blocks.SMITHING_TABLE, "_side")).put(TextureKey.WEST, Texture.getSubId(Blocks.SMITHING_TABLE, "_side"));
        this.blockStateCollector.accept(BlockStateModelGenerator.createSingletonBlockState(Blocks.SMITHING_TABLE, Models.CUBE.upload(Blocks.SMITHING_TABLE, texture, this.modelCollector)));
    }
    ...
    private void registerCubeWithCustomTexture(Block block, Block otherTextureSource, BiFunction<Block, Block, Texture> textureFactory) {
        Texture texture = textureFactory.apply(block, otherTextureSource);
        this.blockStateCollector.accept(BlockStateModelGenerator.createSingletonBlockState(block, Models.CUBE.upload(block, texture, this.modelCollector)));
    }
    ...
    private void registerChorusFlower() {
        ...
        Identifier _snowman2 = Models.TEMPLATE_CHORUS_FLOWER.upload(Blocks.CHORUS_FLOWER, texture, this.modelCollector);
        Identifier _snowman3 = this.createSubModel(Blocks.CHORUS_FLOWER, "_dead", Models.TEMPLATE_CHORUS_FLOWER, identifier -> texture.copyAndAdd(TextureKey.TEXTURE, (Identifier)identifier));
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.CHORUS_FLOWER).coordinate(BlockStateModelGenerator.createValueFencedModelMap(Properties.AGE_5, 5, _snowman3, _snowman2)));
    }

    private void registerFurnaceLikeOrientable(Block block) {
        Texture texture = new Texture().put(TextureKey.TOP, Texture.getSubId(Blocks.FURNACE, "_top")).put(TextureKey.SIDE, Texture.getSubId(Blocks.FURNACE, "_side")).put(TextureKey.FRONT, Texture.getSubId(block, "_front"));
        _snowman = new Texture().put(TextureKey.SIDE, Texture.getSubId(Blocks.FURNACE, "_top")).put(TextureKey.FRONT, Texture.getSubId(block, "_front_vertical"));
        Identifier _snowman2 = Models.ORIENTABLE.upload(block, texture, this.modelCollector);
        Identifier _snowman3 = Models.ORIENTABLE_VERTICAL.upload(block, _snowman, this.modelCollector);
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(block).coordinate(BlockStateVariantMap.create(Properties.FACING).register(Direction.DOWN, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman3).put(VariantSettings.X, VariantSettings.Rotation.R180)).register(Direction.UP, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman3)).register(Direction.NORTH, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman2)).register(Direction.EAST, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman2).put(VariantSettings.Y, VariantSettings.Rotation.R90)).register(Direction.SOUTH, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman2).put(VariantSettings.Y, VariantSettings.Rotation.R180)).register(Direction.WEST, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman2).put(VariantSettings.Y, VariantSettings.Rotation.R270))));
    }

    private void registerEndPortalFrame() {
        Identifier identifier = ModelIds.getBlockModelId(Blocks.END_PORTAL_FRAME);
        _snowman = ModelIds.getBlockSubModelId(Blocks.END_PORTAL_FRAME, "_filled");
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.END_PORTAL_FRAME).coordinate(BlockStateVariantMap.create(Properties.EYE).register((Boolean)false, BlockStateVariant.create().put(VariantSettings.MODEL, identifier)).register((Boolean)true, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman))).coordinate(BlockStateModelGenerator.createSouthDefaultHorizontalRotationStates()));
    }

    private void registerChorusPlant() {
        Identifier identifier = ModelIds.getBlockSubModelId(Blocks.CHORUS_PLANT, "_side");
        _snowman = ModelIds.getBlockSubModelId(Blocks.CHORUS_PLANT, "_noside");
        _snowman = ModelIds.getBlockSubModelId(Blocks.CHORUS_PLANT, "_noside1");
        _snowman = ModelIds.getBlockSubModelId(Blocks.CHORUS_PLANT, "_noside2");
        _snowman = ModelIds.getBlockSubModelId(Blocks.CHORUS_PLANT, "_noside3");
        this.blockStateCollector.accept(MultipartBlockStateSupplier.create(Blocks.CHORUS_PLANT).with((When)When.create().set(Properties.NORTH, true), BlockStateVariant.create().put(VariantSettings.MODEL, identifier)).with((When)When.create().set(Properties.EAST, true), BlockStateVariant.create().put(VariantSettings.MODEL, identifier).put(VariantSettings.Y, VariantSettings.Rotation.R90).put(VariantSettings.UVLOCK, true)).with((When)When.create().set(Properties.SOUTH, true), BlockStateVariant.create().put(VariantSettings.MODEL, identifier).put(VariantSettings.Y, VariantSettings.Rotation.R180).put(VariantSettings.UVLOCK, true)).with((When)When.create().set(Properties.WEST, true), BlockStateVariant.create().put(VariantSettings.MODEL, identifier).put(VariantSettings.Y, VariantSettings.Rotation.R270).put(VariantSettings.UVLOCK, true)).with((When)When.create().set(Properties.UP, true), BlockStateVariant.create().put(VariantSettings.MODEL, identifier).put(VariantSettings.X, VariantSettings.Rotation.R270).put(VariantSettings.UVLOCK, true)).with((When)When.create().set(Properties.DOWN, true), BlockStateVariant.create().put(VariantSettings.MODEL, identifier).put(VariantSettings.X, VariantSettings.Rotation.R90).put(VariantSettings.UVLOCK, true)).with((When)When.create().set(Properties.NORTH, false), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.WEIGHT, 2), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman)).with((When)When.create().set(Properties.EAST, false), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R90).put(VariantSettings.UVLOCK, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R90).put(VariantSettings.UVLOCK, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R90).put(VariantSettings.UVLOCK, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.WEIGHT, 2).put(VariantSettings.Y, VariantSettings.Rotation.R90).put(VariantSettings.UVLOCK, true)).with((When)When.create().set(Properties.SOUTH, false), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R180).put(VariantSettings.UVLOCK, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R180).put(VariantSettings.UVLOCK, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.WEIGHT, 2).put(VariantSettings.Y, VariantSettings.Rotation.R180).put(VariantSettings.UVLOCK, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R180).put(VariantSettings.UVLOCK, true)).with((When)When.create().set(Properties.WEST, false), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R270).put(VariantSettings.UVLOCK, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.WEIGHT, 2).put(VariantSettings.Y, VariantSettings.Rotation.R270).put(VariantSettings.UVLOCK, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R270).put(VariantSettings.UVLOCK, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R270).put(VariantSettings.UVLOCK, true)).with((When)When.create().set(Properties.UP, false), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.WEIGHT, 2).put(VariantSettings.X, VariantSettings.Rotation.R270).put(VariantSettings.UVLOCK, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.X, VariantSettings.Rotation.R270).put(VariantSettings.UVLOCK, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.X, VariantSettings.Rotation.R270).put(VariantSettings.UVLOCK, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.X, VariantSettings.Rotation.R270).put(VariantSettings.UVLOCK, true)).with((When)When.create().set(Properties.DOWN, false), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.X, VariantSettings.Rotation.R90).put(VariantSettings.UVLOCK, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.X, VariantSettings.Rotation.R90).put(VariantSettings.UVLOCK, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.X, VariantSettings.Rotation.R90).put(VariantSettings.UVLOCK, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.WEIGHT, 2).put(VariantSettings.X, VariantSettings.Rotation.R90).put(VariantSettings.UVLOCK, true)));
    }
    ...
    private void registerDaylightDetector() {
        ...
        Texture _snowman2 = new Texture().put(TextureKey.TOP, Texture.getSubId(Blocks.DAYLIGHT_DETECTOR, "_top")).put(TextureKey.SIDE, identifier);
        Texture _snowman3 = new Texture().put(TextureKey.TOP, Texture.getSubId(Blocks.DAYLIGHT_DETECTOR, "_inverted_top")).put(TextureKey.SIDE, identifier);
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.DAYLIGHT_DETECTOR).coordinate(BlockStateVariantMap.create(Properties.INVERTED).register((Boolean)false, BlockStateVariant.create().put(VariantSettings.MODEL, Models.TEMPLATE_DAYLIGHT_DETECTOR.upload(Blocks.DAYLIGHT_DETECTOR, _snowman2, this.modelCollector))).register((Boolean)true, BlockStateVariant.create().put(VariantSettings.MODEL, Models.TEMPLATE_DAYLIGHT_DETECTOR.upload(ModelIds.getBlockSubModelId(Blocks.DAYLIGHT_DETECTOR, "_inverted"), _snowman3, this.modelCollector)))));
    }
    ...
    private void registerFarmland() {
        ...
        _snowman = new Texture().put(TextureKey.DIRT, Texture.getId(Blocks.DIRT)).put(TextureKey.TOP, Texture.getSubId(Blocks.FARMLAND, "_moist"));
        Identifier _snowman2 = Models.TEMPLATE_FARMLAND.upload(Blocks.FARMLAND, texture, this.modelCollector);
        Identifier _snowman3 = Models.TEMPLATE_FARMLAND.upload(Texture.getSubId(Blocks.FARMLAND, "_moist"), _snowman, this.modelCollector);
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.FARMLAND).coordinate(BlockStateModelGenerator.createValueFencedModelMap(Properties.MOISTURE, 7, _snowman3, _snowman2)));
    }
    ...
    private List<Identifier> getFireFloorModels(Block texture) {
        ...
        _snowman = Models.TEMPLATE_FIRE_FLOOR.upload(ModelIds.getBlockSubModelId(texture, "_floor1"), Texture.fire1(texture), this.modelCollector);
        return ImmutableList.of((Object)identifier, (Object)_snowman);
    }
    ...
    private List<Identifier> getFireSideModels(Block texture) {
        ...
        _snowman = Models.TEMPLATE_FIRE_SIDE.upload(ModelIds.getBlockSubModelId(texture, "_side1"), Texture.fire1(texture), this.modelCollector);
        _snowman = Models.TEMPLATE_FIRE_SIDE_ALT.upload(ModelIds.getBlockSubModelId(texture, "_side_alt0"), Texture.fire0(texture), this.modelCollector);
        _snowman = Models.TEMPLATE_FIRE_SIDE_ALT.upload(ModelIds.getBlockSubModelId(texture, "_side_alt1"), Texture.fire1(texture), this.modelCollector);
        return ImmutableList.of((Object)identifier, (Object)_snowman, (Object)_snowman, (Object)_snowman);
    }
    ...
    private List<Identifier> getFireUpModels(Block texture) {
        ...
        _snowman = Models.TEMPLATE_FIRE_UP.upload(ModelIds.getBlockSubModelId(texture, "_up1"), Texture.fire1(texture), this.modelCollector);
        _snowman = Models.TEMPLATE_FIRE_UP_ALT.upload(ModelIds.getBlockSubModelId(texture, "_up_alt0"), Texture.fire0(texture), this.modelCollector);
        _snowman = Models.TEMPLATE_FIRE_UP_ALT.upload(ModelIds.getBlockSubModelId(texture, "_up_alt1"), Texture.fire1(texture), this.modelCollector);
        return ImmutableList.of((Object)identifier, (Object)_snowman, (Object)_snowman, (Object)_snowman);
    }
    ...
    private void registerFire() {
        When.PropertyCondition propertyCondition = When.create().set(Properties.NORTH, false).set(Properties.EAST, false).set(Properties.SOUTH, false).set(Properties.WEST, false).set(Properties.UP, false);
        List<Identifier> _snowman2 = this.getFireFloorModels(Blocks.FIRE);
        List<Identifier> _snowman3 = this.getFireSideModels(Blocks.FIRE);
        List<Identifier> _snowman4 = this.getFireUpModels(Blocks.FIRE);
        this.blockStateCollector.accept(MultipartBlockStateSupplier.create(Blocks.FIRE).with((When)propertyCondition, BlockStateModelGenerator.buildBlockStateVariants(_snowman2, blockStateVariant -> blockStateVariant)).with(When.anyOf(When.create().set(Properties.NORTH, true), propertyCondition), BlockStateModelGenerator.buildBlockStateVariants(_snowman3, blockStateVariant -> blockStateVariant)).with(When.anyOf(When.create().set(Properties.EAST, true), propertyCondition), BlockStateModelGenerator.buildBlockStateVariants(_snowman3, blockStateVariant -> blockStateVariant.put(VariantSettings.Y, VariantSettings.Rotation.R90))).with(When.anyOf(When.create().set(Properties.SOUTH, true), propertyCondition), BlockStateModelGenerator.buildBlockStateVariants(_snowman3, blockStateVariant -> blockStateVariant.put(VariantSettings.Y, VariantSettings.Rotation.R180))).with(When.anyOf(When.create().set(Properties.WEST, true), propertyCondition), BlockStateModelGenerator.buildBlockStateVariants(_snowman3, blockStateVariant -> blockStateVariant.put(VariantSettings.Y, VariantSettings.Rotation.R270))).with((When)When.create().set(Properties.UP, true), BlockStateModelGenerator.buildBlockStateVariants(_snowman4, blockStateVariant -> blockStateVariant)));
    }

    private void registerSoulFire() {
        List<Identifier> list = this.getFireFloorModels(Blocks.SOUL_FIRE);
        _snowman = this.getFireSideModels(Blocks.SOUL_FIRE);
        this.blockStateCollector.accept(MultipartBlockStateSupplier.create(Blocks.SOUL_FIRE).with(BlockStateModelGenerator.buildBlockStateVariants(list, blockStateVariant -> blockStateVariant)).with(BlockStateModelGenerator.buildBlockStateVariants(_snowman, blockStateVariant -> blockStateVariant)).with(BlockStateModelGenerator.buildBlockStateVariants(_snowman, blockStateVariant -> blockStateVariant.put(VariantSettings.Y, VariantSettings.Rotation.R90))).with(BlockStateModelGenerator.buildBlockStateVariants(_snowman, blockStateVariant -> blockStateVariant.put(VariantSettings.Y, VariantSettings.Rotation.R180))).with(BlockStateModelGenerator.buildBlockStateVariants(_snowman, blockStateVariant -> blockStateVariant.put(VariantSettings.Y, VariantSettings.Rotation.R270))));
    }
    ...
    private void registerLantern(Block lantern) {
        ...
        _snowman = TexturedModel.TEMPLATE_HANGING_LANTERN.upload(lantern, this.modelCollector);
        this.registerItemModel(lantern.asItem());
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(lantern).coordinate(BlockStateModelGenerator.createBooleanModelMap(Properties.HANGING, _snowman, identifier)));
    }
    ...
    private void registerTopSoils() {
        ...
        Texture _snowman2 = new Texture().put(TextureKey.BOTTOM, identifier).inherit(TextureKey.BOTTOM, TextureKey.PARTICLE).put(TextureKey.TOP, Texture.getSubId(Blocks.GRASS_BLOCK, "_top")).put(TextureKey.SIDE, Texture.getSubId(Blocks.GRASS_BLOCK, "_snow"));
        BlockStateVariant _snowman3 = BlockStateVariant.create().put(VariantSettings.MODEL, Models.CUBE_BOTTOM_TOP.upload(Blocks.GRASS_BLOCK, "_snow", _snowman2, this.modelCollector));
        this.registerTopSoil(Blocks.GRASS_BLOCK, ModelIds.getBlockModelId(Blocks.GRASS_BLOCK), _snowman3);
        _snowman = TexturedModel.CUBE_BOTTOM_TOP.get(Blocks.MYCELIUM).texture(texture -> texture.put(TextureKey.BOTTOM, identifier)).upload(Blocks.MYCELIUM, this.modelCollector);
        this.registerTopSoil(Blocks.MYCELIUM, _snowman, _snowman3);
        _snowman = TexturedModel.CUBE_BOTTOM_TOP.get(Blocks.PODZOL).texture(texture -> texture.put(TextureKey.BOTTOM, identifier)).upload(Blocks.PODZOL, this.modelCollector);
        this.registerTopSoil(Blocks.PODZOL, _snowman, _snowman3);
    }
    ...
    private void registerPressurePlate(Block pressurePlate, Block textureSource) {
        ...
        Identifier _snowman2 = Models.PRESSURE_PLATE_UP.upload(pressurePlate, texture, this.modelCollector);
        Identifier _snowman3 = Models.PRESSURE_PLATE_DOWN.upload(pressurePlate, texture, this.modelCollector);
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(pressurePlate).coordinate(BlockStateModelGenerator.createValueFencedModelMap(Properties.POWER, 1, _snowman3, _snowman2)));
    }

    private void registerHopper() {
        Identifier identifier = ModelIds.getBlockModelId(Blocks.HOPPER);
        _snowman = ModelIds.getBlockSubModelId(Blocks.HOPPER, "_side");
        this.registerItemModel(Items.HOPPER);
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.HOPPER).coordinate(BlockStateVariantMap.create(Properties.HOPPER_FACING).register(Direction.DOWN, BlockStateVariant.create().put(VariantSettings.MODEL, identifier)).register(Direction.NORTH, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman)).register(Direction.EAST, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R90)).register(Direction.SOUTH, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R180)).register(Direction.WEST, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R270))));
    }
    ...
    private void registerIronBars() {
        ...
        _snowman = ModelIds.getBlockSubModelId(Blocks.IRON_BARS, "_post");
        _snowman = ModelIds.getBlockSubModelId(Blocks.IRON_BARS, "_cap");
        _snowman = ModelIds.getBlockSubModelId(Blocks.IRON_BARS, "_cap_alt");
        _snowman = ModelIds.getBlockSubModelId(Blocks.IRON_BARS, "_side");
        _snowman = ModelIds.getBlockSubModelId(Blocks.IRON_BARS, "_side_alt");
        this.blockStateCollector.accept(MultipartBlockStateSupplier.create(Blocks.IRON_BARS).with(BlockStateVariant.create().put(VariantSettings.MODEL, identifier)).with((When)When.create().set(Properties.NORTH, false).set(Properties.EAST, false).set(Properties.SOUTH, false).set(Properties.WEST, false), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman)).with((When)When.create().set(Properties.NORTH, true).set(Properties.EAST, false).set(Properties.SOUTH, false).set(Properties.WEST, false), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman)).with((When)When.create().set(Properties.NORTH, false).set(Properties.EAST, true).set(Properties.SOUTH, false).set(Properties.WEST, false), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R90)).with((When)When.create().set(Properties.NORTH, false).set(Properties.EAST, false).set(Properties.SOUTH, true).set(Properties.WEST, false), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman)).with((When)When.create().set(Properties.NORTH, false).set(Properties.EAST, false).set(Properties.SOUTH, false).set(Properties.WEST, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R90)).with((When)When.create().set(Properties.NORTH, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman)).with((When)When.create().set(Properties.EAST, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R90)).with((When)When.create().set(Properties.SOUTH, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman)).with((When)When.create().set(Properties.WEST, true), BlockStateVariant.create().put(VariantSettings.MODEL, _snowman).put(VariantSettings.Y, VariantSettings.Rotation.R90)));
    ...
    private void registerObserver() {
        ...
        _snowman = ModelIds.getBlockSubModelId(Blocks.OBSERVER, "_on");
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.OBSERVER).coordinate(BlockStateModelGenerator.createBooleanModelMap(Properties.POWERED, _snowman, identifier)).coordinate(BlockStateModelGenerator.createNorthDefaultRotationStates()));
    }

    private void registerPistons() {
        Texture texture = new Texture().put(TextureKey.BOTTOM, Texture.getSubId(Blocks.PISTON, "_bottom")).put(TextureKey.SIDE, Texture.getSubId(Blocks.PISTON, "_side"));
        Identifier _snowman2 = Texture.getSubId(Blocks.PISTON, "_top_sticky");
        Identifier _snowman3 = Texture.getSubId(Blocks.PISTON, "_top");
        _snowman = texture.copyAndAdd(TextureKey.PLATFORM, _snowman2);
        _snowman = texture.copyAndAdd(TextureKey.PLATFORM, _snowman3);
        Identifier _snowman4 = ModelIds.getBlockSubModelId(Blocks.PISTON, "_base");
        this.registerPiston(Blocks.PISTON, _snowman4, _snowman);
        this.registerPiston(Blocks.STICKY_PISTON, _snowman4, _snowman);
        Identifier _snowman5 = Models.CUBE_BOTTOM_TOP.upload(Blocks.PISTON, "_inventory", texture.copyAndAdd(TextureKey.TOP, _snowman3), this.modelCollector);
        Identifier _snowman6 = Models.CUBE_BOTTOM_TOP.upload(Blocks.STICKY_PISTON, "_inventory", texture.copyAndAdd(TextureKey.TOP, _snowman2), this.modelCollector);
        this.registerParentedItemModel(Blocks.PISTON, _snowman5);
        this.registerParentedItemModel(Blocks.STICKY_PISTON, _snowman6);
    }
    ...
    private void registerPistonHead() {
        Texture texture = new Texture().put(TextureKey.UNSTICKY, Texture.getSubId(Blocks.PISTON, "_top")).put(TextureKey.SIDE, Texture.getSubId(Blocks.PISTON, "_side"));
        _snowman = texture.copyAndAdd(TextureKey.PLATFORM, Texture.getSubId(Blocks.PISTON, "_top_sticky"));
        _snowman = texture.copyAndAdd(TextureKey.PLATFORM, Texture.getSubId(Blocks.PISTON, "_top"));
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.PISTON_HEAD).coordinate(BlockStateVariantMap.create(Properties.SHORT, Properties.PISTON_TYPE).register((Boolean)false, PistonType.DEFAULT, BlockStateVariant.create().put(VariantSettings.MODEL, Models.TEMPLATE_PISTON_HEAD.upload(Blocks.PISTON, "_head", _snowman, this.modelCollector))).register((Boolean)false, PistonType.STICKY, BlockStateVariant.create().put(VariantSettings.MODEL, Models.TEMPLATE_PISTON_HEAD.upload(Blocks.PISTON, "_head_sticky", _snowman, this.modelCollector))).register((Boolean)true, PistonType.DEFAULT, BlockStateVariant.create().put(VariantSettings.MODEL, Models.TEMPLATE_PISTON_HEAD_SHORT.upload(Blocks.PISTON, "_head_short", _snowman, this.modelCollector))).register((Boolean)true, PistonType.STICKY, BlockStateVariant.create().put(VariantSettings.MODEL, Models.TEMPLATE_PISTON_HEAD_SHORT.upload(Blocks.PISTON, "_head_short_sticky", _snowman, this.modelCollector)))).coordinate(BlockStateModelGenerator.createNorthDefaultRotationStates()));
    }

    private void registerScaffolding() {
        Identifier identifier = ModelIds.getBlockSubModelId(Blocks.SCAFFOLDING, "_stable");
        _snowman = ModelIds.getBlockSubModelId(Blocks.SCAFFOLDING, "_unstable");
        this.registerParentedItemModel(Blocks.SCAFFOLDING, identifier);
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.SCAFFOLDING).coordinate(BlockStateModelGenerator.createBooleanModelMap(Properties.BOTTOM, _snowman, identifier)));
    }
    ...
    private void registerRedstoneLamp() {
        ...
        _snowman = this.createSubModel(Blocks.REDSTONE_LAMP, "_on", Models.CUBE_ALL, Texture::all);
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.REDSTONE_LAMP).coordinate(BlockStateModelGenerator.createBooleanModelMap(Properties.LIT, _snowman, identifier)));
    }

    private void registerTorch(Block torch, Block wallTorch) {
        Texture texture = Texture.torch(torch);
        this.blockStateCollector.accept(BlockStateModelGenerator.createSingletonBlockState(torch, Models.TEMPLATE_TORCH.upload(torch, texture, this.modelCollector)));
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(wallTorch, BlockStateVariant.create().put(VariantSettings.MODEL, Models.TEMPLATE_TORCH_WALL.upload(wallTorch, texture, this.modelCollector))).coordinate(BlockStateModelGenerator.createEastDefaultHorizontalRotationStates()));
    ...
    private void registerRedstoneTorch() {
        ...
        _snowman = Texture.torch(Texture.getSubId(Blocks.REDSTONE_TORCH, "_off"));
        Identifier _snowman2 = Models.TEMPLATE_TORCH.upload(Blocks.REDSTONE_TORCH, texture, this.modelCollector);
        Identifier _snowman3 = Models.TEMPLATE_TORCH.upload(Blocks.REDSTONE_TORCH, "_off", _snowman, this.modelCollector);
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.REDSTONE_TORCH).coordinate(BlockStateModelGenerator.createBooleanModelMap(Properties.LIT, _snowman2, _snowman3)));
        Identifier _snowman4 = Models.TEMPLATE_TORCH_WALL.upload(Blocks.REDSTONE_WALL_TORCH, texture, this.modelCollector);
        Identifier _snowman5 = Models.TEMPLATE_TORCH_WALL.upload(Blocks.REDSTONE_WALL_TORCH, "_off", _snowman, this.modelCollector);
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.REDSTONE_WALL_TORCH).coordinate(BlockStateModelGenerator.createBooleanModelMap(Properties.LIT, _snowman4, _snowman5)).coordinate(BlockStateModelGenerator.createEastDefaultHorizontalRotationStates()));
    ...
    private void registerRepeater() {
        ...
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.REPEATER).coordinate(BlockStateVariantMap.create(Properties.DELAY, Properties.LOCKED, Properties.POWERED).register((n, bl, bl2) -> {
    ...
    private void registerSnows() {
        ...
        Identifier _snowman2 = Models.CUBE_ALL.upload(Blocks.SNOW_BLOCK, texture, this.modelCollector);
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.SNOW).coordinate(BlockStateVariantMap.create(Properties.LAYERS).register(n -> BlockStateVariant.create().put(VariantSettings.MODEL, n < 8 ? ModelIds.getBlockSubModelId(Blocks.SNOW, "_height" + n * 2) : _snowman2))));
        this.registerParentedItemModel(Blocks.SNOW, ModelIds.getBlockSubModelId(Blocks.SNOW, "_height2"));
        this.blockStateCollector.accept(BlockStateModelGenerator.createSingletonBlockState(Blocks.SNOW_BLOCK, _snowman2));
    }
    ...
    private void registerStructureBlock() {
        ...
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.STRUCTURE_BLOCK).coordinate(BlockStateVariantMap.create(Properties.STRUCTURE_BLOCK_MODE).register(structureBlockMode -> BlockStateVariant.create().put(VariantSettings.MODEL, this.createSubModel(Blocks.STRUCTURE_BLOCK, "_" + structureBlockMode.asString(), Models.CUBE_ALL, Texture::all)))));
    }

    private void registerSweetBerryBush() {
        this.registerItemModel(Items.SWEET_BERRIES);
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.SWEET_BERRY_BUSH).coordinate(BlockStateVariantMap.create(Properties.AGE_3).register(n -> BlockStateVariant.create().put(VariantSettings.MODEL, this.createSubModel(Blocks.SWEET_BERRY_BUSH, "_stage" + n, Models.CROSS, Texture::cross)))));
    }
    ...
    private void registerTripwireHook() {
        ...
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.TRIPWIRE_HOOK).coordinate(BlockStateVariantMap.create(Properties.ATTACHED, Properties.POWERED).register((bl, bl2) -> BlockStateVariant.create().put(VariantSettings.MODEL, Texture.getSubId(Blocks.TRIPWIRE_HOOK, (bl != false ? "_attached" : "") + (bl2 != false ? "_on" : ""))))).coordinate(BlockStateModelGenerator.createNorthDefaultHorizontalRotationStates()));
    }
    ...
    private void registerTurtleEgg() {
        ...
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.TURTLE_EGG).coordinate(BlockStateVariantMap.create(Properties.EGGS, Properties.HATCH).registerVariants((n, n2) -> Arrays.asList(BlockStateModelGenerator.createModelVariantWithRandomHorizontalRotations(this.getTurtleEggModel((Integer)n, (Integer)n2))))));
    }
    ...
    private void registerInfestedStone() {
        ...
        _snowman = ModelIds.getBlockSubModelId(Blocks.STONE, "_mirrored");
        this.blockStateCollector.accept(BlockStateModelGenerator.createBlockStateWithTwoModelAndRandomInversion(Blocks.INFESTED_STONE, identifier, _snowman));
    ...
    private void registerRoots(Block root, Block pottedRoot) {
        ...
        Identifier _snowman2 = TintType.NOT_TINTED.getFlowerPotCrossModel().upload(pottedRoot, texture, this.modelCollector);
        this.blockStateCollector.accept(BlockStateModelGenerator.createSingletonBlockState(pottedRoot, _snowman2));
    }

    private void registerRespawnAnchor() {
        Identifier identifier = Texture.getSubId(Blocks.RESPAWN_ANCHOR, "_bottom");
        _snowman = Texture.getSubId(Blocks.RESPAWN_ANCHOR, "_top_off");
        _snowman = Texture.getSubId(Blocks.RESPAWN_ANCHOR, "_top");
        Identifier[] _snowman2 = new Identifier[5];
        for (int i = 0; i < 5; ++i) {
            Texture texture = new Texture().put(TextureKey.BOTTOM, identifier).put(TextureKey.TOP, i == 0 ? _snowman : _snowman).put(TextureKey.SIDE, Texture.getSubId(Blocks.RESPAWN_ANCHOR, "_side" + i));
            _snowman2[i] = Models.CUBE_BOTTOM_TOP.upload(Blocks.RESPAWN_ANCHOR, "_" + i, texture, this.modelCollector);
        }
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.RESPAWN_ANCHOR).coordinate(BlockStateVariantMap.create(Properties.CHARGES).register(n -> BlockStateVariant.create().put(VariantSettings.MODEL, _snowman2[n]))));
        this.registerParentedItemModel(Items.RESPAWN_ANCHOR, _snowman2[0]);
    }
    ...
    private void registerJigsaw() {
        ...
        _snowman = Texture.getSubId(Blocks.JIGSAW, "_bottom");
        _snowman = Texture.getSubId(Blocks.JIGSAW, "_side");
        _snowman = Texture.getSubId(Blocks.JIGSAW, "_lock");
        Texture _snowman2 = new Texture().put(TextureKey.DOWN, _snowman).put(TextureKey.WEST, _snowman).put(TextureKey.EAST, _snowman).put(TextureKey.PARTICLE, identifier).put(TextureKey.NORTH, identifier).put(TextureKey.SOUTH, _snowman).put(TextureKey.UP, _snowman);
        _snowman = Models.CUBE_DIRECTIONAL.upload(Blocks.JIGSAW, _snowman2, this.modelCollector);
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.JIGSAW, BlockStateVariant.create().put(VariantSettings.MODEL, _snowman)).coordinate(BlockStateVariantMap.create(Properties.ORIENTATION).register(jigsawOrientation -> this.addJigsawOrientationToVariant((JigsawOrientation)jigsawOrientation, BlockStateVariant.create()))));
    }
    ...
    public void register() {
        ...
        this.registerTexturePool(Texture.all(Blocks.STONE)).base(texture -> {
            ...
            _snowman = Models.CUBE_MIRRORED_ALL.upload(Blocks.STONE, (Texture)texture, this.modelCollector);
            this.blockStateCollector.accept(BlockStateModelGenerator.createBlockStateWithTwoModelAndRandomInversion(Blocks.STONE, identifier, _snowman));
            return identifier;
    ...
    private /* synthetic */ BlockStateVariant method_25589(int[] nArray, Int2ObjectMap int2ObjectMap, Block block, Integer n) {
        int n3 = nArray[n];
        Identifier _snowman2 = (Identifier)int2ObjectMap.computeIfAbsent(n3, n2 -> this.createSubModel(block, "_stage" + n3, Models.CROP, Texture::crop));
        return BlockStateVariant.create().put(VariantSettings.MODEL, _snowman2);
    }
    ...
    class LogTexturePool {
        ...
        public LogTexturePool wood(Block woodBlock) {
            ...
            Identifier _snowman2 = Models.CUBE_COLUMN.upload(woodBlock, texture, (BiConsumer<Identifier, Supplier<JsonElement>>)BlockStateModelGenerator.this.modelCollector);
            BlockStateModelGenerator.this.blockStateCollector.accept(BlockStateModelGenerator.createAxisRotatedBlockState(woodBlock, _snowman2));
            return this;
        }
        ...
        public LogTexturePool log(Block logBlock) {
            ...
            _snowman = Models.CUBE_COLUMN_HORIZONTAL.upload(logBlock, this.texture, (BiConsumer<Identifier, Supplier<JsonElement>>)BlockStateModelGenerator.this.modelCollector);
            BlockStateModelGenerator.this.blockStateCollector.accept(BlockStateModelGenerator.createAxisRotatedBlockState(logBlock, identifier, _snowman));
            return this;
        }
    }
    ...
    class BlockTexturePool {
        ...
        public BlockTexturePool button(Block buttonBlock) {
            ...
            _snowman = Models.BUTTON_PRESSED.upload(buttonBlock, this.texture, (BiConsumer<Identifier, Supplier<JsonElement>>)BlockStateModelGenerator.this.modelCollector);
            BlockStateModelGenerator.this.blockStateCollector.accept(BlockStateModelGenerator.createButtonBlockState(buttonBlock, identifier, _snowman));
            _snowman = Models.BUTTON_INVENTORY.upload(buttonBlock, this.texture, (BiConsumer<Identifier, Supplier<JsonElement>>)BlockStateModelGenerator.this.modelCollector);
            BlockStateModelGenerator.this.registerParentedItemModel(buttonBlock, _snowman);
            return this;
        }
        ...
        public BlockTexturePool wall(Block wallBlock) {
            ...
            _snowman = Models.TEMPLATE_WALL_SIDE.upload(wallBlock, this.texture, (BiConsumer<Identifier, Supplier<JsonElement>>)BlockStateModelGenerator.this.modelCollector);
            _snowman = Models.TEMPLATE_WALL_SIDE_TALL.upload(wallBlock, this.texture, (BiConsumer<Identifier, Supplier<JsonElement>>)BlockStateModelGenerator.this.modelCollector);
            BlockStateModelGenerator.this.blockStateCollector.accept(BlockStateModelGenerator.createWallBlockState(wallBlock, identifier, _snowman, _snowman));
            _snowman = Models.WALL_INVENTORY.upload(wallBlock, this.texture, (BiConsumer<Identifier, Supplier<JsonElement>>)BlockStateModelGenerator.this.modelCollector);
            BlockStateModelGenerator.this.registerParentedItemModel(wallBlock, _snowman);
            return this;
        }
        ...
        public BlockTexturePool fence(Block fenceBlock) {
            ...
            _snowman = Models.FENCE_SIDE.upload(fenceBlock, this.texture, (BiConsumer<Identifier, Supplier<JsonElement>>)BlockStateModelGenerator.this.modelCollector);
            BlockStateModelGenerator.this.blockStateCollector.accept(BlockStateModelGenerator.createFenceBlockState(fenceBlock, identifier, _snowman));
            _snowman = Models.FENCE_INVENTORY.upload(fenceBlock, this.texture, (BiConsumer<Identifier, Supplier<JsonElement>>)BlockStateModelGenerator.this.modelCollector);
            BlockStateModelGenerator.this.registerParentedItemModel(fenceBlock, _snowman);
            return this;
        }
        ...
        public BlockTexturePool fenceGate(Block fenceGateBlock) {
            ...
            _snowman = Models.TEMPLATE_FENCE_GATE.upload(fenceGateBlock, this.texture, (BiConsumer<Identifier, Supplier<JsonElement>>)BlockStateModelGenerator.this.modelCollector);
            _snowman = Models.TEMPLATE_FENCE_GATE_WALL_OPEN.upload(fenceGateBlock, this.texture, (BiConsumer<Identifier, Supplier<JsonElement>>)BlockStateModelGenerator.this.modelCollector);
            _snowman = Models.TEMPLATE_FENCE_GATE_WALL.upload(fenceGateBlock, this.texture, (BiConsumer<Identifier, Supplier<JsonElement>>)BlockStateModelGenerator.this.modelCollector);
            BlockStateModelGenerator.this.blockStateCollector.accept(BlockStateModelGenerator.createFenceGateBlockState(fenceGateBlock, identifier, _snowman, _snowman, _snowman));
            return this;
        }
        ...
        public BlockTexturePool pressurePlate(Block pressurePlateBlock) {
            ...
            _snowman = Models.PRESSURE_PLATE_DOWN.upload(pressurePlateBlock, this.texture, (BiConsumer<Identifier, Supplier<JsonElement>>)BlockStateModelGenerator.this.modelCollector);
            BlockStateModelGenerator.this.blockStateCollector.accept(BlockStateModelGenerator.createPressurePlateBlockState(pressurePlateBlock, identifier, _snowman));
            return this;
        }
        ...
        public BlockTexturePool slab(Block slabBlock) {
            ...
            _snowman = Models.SLAB_TOP.upload(slabBlock, this.texture, (BiConsumer<Identifier, Supplier<JsonElement>>)BlockStateModelGenerator.this.modelCollector);
            BlockStateModelGenerator.this.blockStateCollector.accept(BlockStateModelGenerator.createSlabBlockState(slabBlock, identifier, _snowman, this.baseModelId));
            return this;
        }
        ...
        public BlockTexturePool stairs(Block stairsBlock) {
            ...
            _snowman = Models.STAIRS.upload(stairsBlock, this.texture, (BiConsumer<Identifier, Supplier<JsonElement>>)BlockStateModelGenerator.this.modelCollector);
            _snowman = Models.OUTER_STAIRS.upload(stairsBlock, this.texture, (BiConsumer<Identifier, Supplier<JsonElement>>)BlockStateModelGenerator.this.modelCollector);
            BlockStateModelGenerator.this.blockStateCollector.accept(BlockStateModelGenerator.createStairsBlockState(stairsBlock, identifier, _snowman, _snowman));
            return this;
        }
    }
}
