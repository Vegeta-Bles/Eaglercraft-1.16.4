...
public abstract class BlockStateVariantMap {
    ...
    private void checkAllPropertyDefinitions() {
        ...
        Stream<PropertiesMap> _snowman2 = Stream.of(PropertiesMap.empty());
        for (Property<?> property : list) {
            _snowman2 = _snowman2.flatMap(propertiesMap -> property.stream().map(propertiesMap::method_25819));
        }
        List list2 = _snowman2.filter(propertiesMap -> !this.variants.containsKey(propertiesMap)).collect(Collectors.toList());
        if (!list2.isEmpty()) {
    ...
    extends BlockStateVariantMap {
        ...
        public QuintupleProperty<T1, T2, T3, T4, T5> register(T1 T1, T2 T2, T3 T3, T4 T4, T5 T5, List<BlockStateVariant> list) {
            PropertiesMap propertiesMap = PropertiesMap.method_25821(this.first.createValue(T1), this.second.createValue(T2), this.third.createValue(T3), this.fourth.createValue(T4), this.fifth.createValue(T5));
        ...
        public QuintupleProperty<T1, T2, T3, T4, T5> register(T1 T1, T2 T2, T3 T3, T4 T4, T5 T5, BlockStateVariant blockStateVariant) {
            return this.register(T1, T2, T3, T4, T5, Collections.singletonList(blockStateVariant));
        }
    }
    ...
    extends BlockStateVariantMap {
        ...
        public QuadrupleProperty<T1, T2, T3, T4> register(T1 T1, T2 T2, T3 T3, T4 T4, List<BlockStateVariant> list) {
            PropertiesMap propertiesMap = PropertiesMap.method_25821(this.first.createValue(T1), this.second.createValue(T2), this.third.createValue(T3), this.fourth.createValue(T4));
            this.register(propertiesMap, list);
            return this;
        }

        public QuadrupleProperty<T1, T2, T3, T4> register(T1 T1, T2 T2, T3 T3, T4 T4, BlockStateVariant blockStateVariant) {
            return this.register(T1, T2, T3, T4, Collections.singletonList(blockStateVariant));
        }
    }
    ...
    extends BlockStateVariantMap {
        ...
        public TripleProperty<T1, T2, T3> register(T1 T1, T2 T2, T3 T3, List<BlockStateVariant> list) {
            PropertiesMap propertiesMap = PropertiesMap.method_25821(this.first.createValue(T1), this.second.createValue(T2), this.third.createValue(T3));
            this.register(propertiesMap, list);
            return this;
        }

        public TripleProperty<T1, T2, T3> register(T1 T1, T2 T2, T3 T3, BlockStateVariant blockStateVariant) {
            return this.register(T1, T2, T3, Collections.singletonList(blockStateVariant));
        }
    ...
    extends BlockStateVariantMap {
        ...
        public DoubleProperty<T1, T2> register(T1 T1, T2 T2, List<BlockStateVariant> list) {
            PropertiesMap propertiesMap = PropertiesMap.method_25821(this.first.createValue(T1), this.second.createValue(T2));
            this.register(propertiesMap, list);
            return this;
        }

        public DoubleProperty<T1, T2> register(T1 T1, T2 T2, BlockStateVariant blockStateVariant) {
            return this.register(T1, T2, Collections.singletonList(blockStateVariant));
        }
