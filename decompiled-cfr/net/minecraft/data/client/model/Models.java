...
public class Models {
    ...
    public static final Model[] STEM_GROWTH_STAGES = (Model[])IntStream.range(0, 8).mapToObj(n -> Models.block("stem_growth" + n, "_stage" + n, TextureKey.STEM)).toArray(Model[]::new);
