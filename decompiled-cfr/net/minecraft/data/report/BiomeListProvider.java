...
implements DataProvider {
    ...
    public void run(DataCache cache) {
        ...
        for (Map.Entry<RegistryKey<Biome>, Biome> entry : BuiltinRegistries.BIOME.getEntries()) {
            ...
            Biome _snowman2 = entry.getValue();
            Function _snowman3 = JsonOps.INSTANCE.withEncoder(Biome.REGISTRY_CODEC);
            try {
                Optional optional = ((DataResult)_snowman3.apply(() -> _snowman2)).result();
