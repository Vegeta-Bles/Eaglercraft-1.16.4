...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        ...
        _snowman = Advancement.Task.create().parent(_snowman).display(Items.ENDER_PEARL, (Text)new TranslatableText("advancements.end.enter_end_gateway.title"), (Text)new TranslatableText("advancements.end.enter_end_gateway.description"), null, AdvancementFrame.TASK, true, true, false).criterion("entered_end_gateway", EnterBlockCriterion.Conditions.block(Blocks.END_GATEWAY)).build(consumer, "end/enter_end_gateway");
        Advancement.Task.create().parent(_snowman).display(Items.END_CRYSTAL, (Text)new TranslatableText("advancements.end.respawn_dragon.title"), (Text)new TranslatableText("advancements.end.respawn_dragon.description"), null, AdvancementFrame.GOAL, true, true, false).criterion("summoned_dragon", SummonedEntityCriterion.Conditions.create(EntityPredicate.Builder.create().type(EntityType.ENDER_DRAGON))).build(consumer, "end/respawn_dragon");
        _snowman = Advancement.Task.create().parent(_snowman).display(Blocks.PURPUR_BLOCK, (Text)new TranslatableText("advancements.end.find_end_city.title"), (Text)new TranslatableText("advancements.end.find_end_city.description"), null, AdvancementFrame.TASK, true, true, false).criterion("in_city", LocationArrivalCriterion.Conditions.create(LocationPredicate.feature(StructureFeature.END_CITY))).build(consumer, "end/find_end_city");
        Advancement.Task.create().parent(_snowman).display(Items.DRAGON_BREATH, (Text)new TranslatableText("advancements.end.dragon_breath.title"), (Text)new TranslatableText("advancements.end.dragon_breath.description"), null, AdvancementFrame.GOAL, true, true, false).criterion("dragon_breath", InventoryChangedCriterion.Conditions.items(Items.DRAGON_BREATH)).build(consumer, "end/dragon_breath");
        Advancement.Task.create().parent(_snowman).display(Items.SHULKER_SHELL, (Text)new TranslatableText("advancements.end.levitate.title"), (Text)new TranslatableText("advancements.end.levitate.description"), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(50)).criterion("levitated", LevitationCriterion.Conditions.create(DistancePredicate.y(NumberRange.FloatRange.atLeast(50.0f)))).build(consumer, "end/levitate");
        Advancement.Task.create().parent(_snowman).display(Items.ELYTRA, (Text)new TranslatableText("advancements.end.elytra.title"), (Text)new TranslatableText("advancements.end.elytra.description"), null, AdvancementFrame.GOAL, true, true, false).criterion("elytra", InventoryChangedCriterion.Conditions.items(Items.ELYTRA)).build(consumer, "end/elytra");
        Advancement.Task.create().parent(_snowman).display(Blocks.DRAGON_EGG, (Text)new TranslatableText("advancements.end.dragon_egg.title"), (Text)new TranslatableText("advancements.end.dragon_egg.description"), null, AdvancementFrame.GOAL, true, true, false).criterion("dragon_egg", InventoryChangedCriterion.Conditions.items(Blocks.DRAGON_EGG)).build(consumer, "end/dragon_egg");
    }
