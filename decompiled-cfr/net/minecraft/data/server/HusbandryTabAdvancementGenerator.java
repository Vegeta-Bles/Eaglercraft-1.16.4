...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        ...
        _snowman = Advancement.Task.create().parent(advancement).display(Items.WHEAT, (Text)new TranslatableText("advancements.husbandry.plant_seed.title"), (Text)new TranslatableText("advancements.husbandry.plant_seed.description"), null, AdvancementFrame.TASK, true, true, false).criteriaMerger(CriterionMerger.OR).criterion("wheat", PlacedBlockCriterion.Conditions.block(Blocks.WHEAT)).criterion("pumpkin_stem", PlacedBlockCriterion.Conditions.block(Blocks.PUMPKIN_STEM)).criterion("melon_stem", PlacedBlockCriterion.Conditions.block(Blocks.MELON_STEM)).criterion("beetroots", PlacedBlockCriterion.Conditions.block(Blocks.BEETROOTS)).criterion("nether_wart", PlacedBlockCriterion.Conditions.block(Blocks.NETHER_WART)).build(consumer, "husbandry/plant_seed");
        _snowman = Advancement.Task.create().parent(advancement).display(Items.WHEAT, (Text)new TranslatableText("advancements.husbandry.breed_an_animal.title"), (Text)new TranslatableText("advancements.husbandry.breed_an_animal.description"), null, AdvancementFrame.TASK, true, true, false).criteriaMerger(CriterionMerger.OR).criterion("bred", BredAnimalsCriterion.Conditions.any()).build(consumer, "husbandry/breed_an_animal");
        this.requireFoodItemsEaten(Advancement.Task.create()).parent(_snowman).display(Items.APPLE, (Text)new TranslatableText("advancements.husbandry.balanced_diet.title"), (Text)new TranslatableText("advancements.husbandry.balanced_diet.description"), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).build(consumer, "husbandry/balanced_diet");
        Advancement.Task.create().parent(_snowman).display(Items.NETHERITE_HOE, (Text)new TranslatableText("advancements.husbandry.netherite_hoe.title"), (Text)new TranslatableText("advancements.husbandry.netherite_hoe.description"), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).criterion("netherite_hoe", InventoryChangedCriterion.Conditions.items(Items.NETHERITE_HOE)).build(consumer, "husbandry/obtain_netherite_hoe");
        ...
        this.requireListedAnimalsBred(Advancement.Task.create()).parent(_snowman).display(Items.GOLDEN_CARROT, (Text)new TranslatableText("advancements.husbandry.breed_all_animals.title"), (Text)new TranslatableText("advancements.husbandry.breed_all_animals.description"), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).build(consumer, "husbandry/bred_all_animals");
        _snowman = this.requireListedFishCaught(Advancement.Task.create()).parent(advancement).criteriaMerger(CriterionMerger.OR).display(Items.FISHING_ROD, (Text)new TranslatableText("advancements.husbandry.fishy_business.title"), (Text)new TranslatableText("advancements.husbandry.fishy_business.description"), null, AdvancementFrame.TASK, true, true, false).build(consumer, "husbandry/fishy_business");
        this.requireListedFishBucketsFilled(Advancement.Task.create()).parent(_snowman).criteriaMerger(CriterionMerger.OR).display(Items.PUFFERFISH_BUCKET, (Text)new TranslatableText("advancements.husbandry.tactical_fishing.title"), (Text)new TranslatableText("advancements.husbandry.tactical_fishing.description"), null, AdvancementFrame.TASK, true, true, false).build(consumer, "husbandry/tactical_fishing");
        this.requireAllCatsTamed(Advancement.Task.create()).parent(_snowman).display(Items.COD, (Text)new TranslatableText("advancements.husbandry.complete_catalogue.title"), (Text)new TranslatableText("advancements.husbandry.complete_catalogue.description"), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(50)).build(consumer, "husbandry/complete_catalogue");
        Advancement.Task.create().parent(advancement).criterion("safely_harvest_honey", ItemUsedOnBlockCriterion.Conditions.create(LocationPredicate.Builder.create().block(BlockPredicate.Builder.create().method_29233(BlockTags.BEEHIVES).build()).smokey(true), ItemPredicate.Builder.create().item(Items.GLASS_BOTTLE))).display(Items.HONEY_BOTTLE, (Text)new TranslatableText("advancements.husbandry.safely_harvest_honey.title"), (Text)new TranslatableText("advancements.husbandry.safely_harvest_honey.description"), null, AdvancementFrame.TASK, true, true, false).build(consumer, "husbandry/safely_harvest_honey");
    ...
    private Advancement.Task requireFoodItemsEaten(Advancement.Task task2) {
        Advancement.Task task2;
        for (Item item : FOOD_ITEMS) {
            task2.criterion(Registry.ITEM.getId(item).getPath(), ConsumeItemCriterion.Conditions.item(item));
        }
        return task2;
    }

    private Advancement.Task requireListedAnimalsBred(Advancement.Task task2) {
        Advancement.Task task2;
        for (EntityType<?> entityType : BREEDABLE_ANIMALS) {
            task2.criterion(EntityType.getId(entityType).toString(), BredAnimalsCriterion.Conditions.create(EntityPredicate.Builder.create().type(entityType)));
        }
        task2.criterion(EntityType.getId(EntityType.TURTLE).toString(), BredAnimalsCriterion.Conditions.method_29918(EntityPredicate.Builder.create().type(EntityType.TURTLE).build(), EntityPredicate.Builder.create().type(EntityType.TURTLE).build(), EntityPredicate.ANY));
        return task2;
    }

    private Advancement.Task requireListedFishBucketsFilled(Advancement.Task task2) {
        Advancement.Task task2;
        for (Item item : FISH_BUCKET_ITEMS) {
            task2.criterion(Registry.ITEM.getId(item).getPath(), FilledBucketCriterion.Conditions.create(ItemPredicate.Builder.create().item(item).build()));
        }
        return task2;
    }

    private Advancement.Task requireListedFishCaught(Advancement.Task task2) {
        Advancement.Task task2;
        for (Item item : FISH_ITEMS) {
            task2.criterion(Registry.ITEM.getId(item).getPath(), FishingRodHookedCriterion.Conditions.create(ItemPredicate.ANY, EntityPredicate.ANY, ItemPredicate.Builder.create().item(item).build()));
        }
        return task2;
    }

    private Advancement.Task requireAllCatsTamed(Advancement.Task task) {
        CatEntity.TEXTURES.forEach((n, identifier) -> task.criterion(identifier.getPath(), TameAnimalCriterion.Conditions.create(EntityPredicate.Builder.create().type((Identifier)identifier).build())));
        return task;
    }
