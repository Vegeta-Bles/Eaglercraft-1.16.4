...
public class CookingRecipeJsonFactory {
    ...
    public void offerTo(Consumer<RecipeJsonProvider> exporter, String recipeIdStr) {
        Identifier identifier = new Identifier(recipeIdStr);
        _snowman = Registry.ITEM.getId(this.result);
        if (identifier.equals(_snowman)) {
            throw new IllegalStateException("Recipe " + identifier + " should remove its 'save' argument");
        }
