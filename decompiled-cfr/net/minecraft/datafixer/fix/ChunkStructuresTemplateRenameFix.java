...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        OpticFinder _snowman2 = type.findField("Children");
        return this.fixTypeEverywhereTyped("ChunkStructuresTemplateRenameFix", type, typed -> typed.updateTyped(_snowman2, typed2 -> typed2.update(DSL.remainderFinder(), dynamic -> this.method_15671((Dynamic<?>)((Dynamic)typed.get(DSL.remainderFinder())), (Dynamic<?>)dynamic))));
    }

    private Dynamic<?> method_15671(Dynamic<?> dynamic, Dynamic<?> dynamic22) {
        Dynamic dynamic22;
        String string = dynamic.get("id").asString("");
        if (structures.containsKey((Object)string) && ((String)(_snowman = (Pair)structures.get((Object)string)).getFirst()).equals(dynamic22.get("id").asString(""))) {
            _snowman = dynamic22.get("Template").asString("");
            dynamic22 = dynamic22.set("Template", dynamic22.createString((String)((ImmutableMap)_snowman.getSecond()).getOrDefault((Object)_snowman, (Object)_snowman)));
        }
        return dynamic22;
    }
}
