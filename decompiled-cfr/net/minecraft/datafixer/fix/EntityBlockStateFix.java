...
extends DataFix {
    private static final Map<String, Integer> BLOCK_NAME_TO_ID = (Map)DataFixUtils.make((Object)Maps.newHashMap(), hashMap -> {
    ...
    public static int getNumericalBlockId(String blockId) {
        Integer n = BLOCK_NAME_TO_ID.get(blockId);
        return n == null ? 0 : n;
    }
    ...
    public TypeRewriteRule makeRule() {
        ...
        Function<Typed, Typed> _snowman2 = typed -> this.mergeIdAndData((Typed<?>)typed, "DisplayTile", "DisplayData", "DisplayState");
        Function<Typed, Typed> _snowman3 = typed -> this.mergeIdAndData((Typed<?>)typed, "inTile", "inData", "inBlockState");
        Type _snowman4 = DSL.and((Type)DSL.optional((Type)DSL.field((String)"inTile", (Type)DSL.named((String)TypeReferences.BLOCK_NAME.typeName(), (Type)DSL.or((Type)DSL.intType(), IdentifierNormalizingSchema.getIdentifierType())))), (Type)DSL.remainderType());
        Function<Typed, Typed> _snowman5 = typed -> typed.update(_snowman4.finder(), DSL.remainderType(), Pair::getSecond);
        return this.fixTypeEverywhereTyped("EntityBlockStateFix", schema.getType(TypeReferences.ENTITY), _snowman.getType(TypeReferences.ENTITY), typed2 -> {
            ...
            typed2 = this.useFunction((Typed<?>)typed2, "minecraft:arrow", (Function<Typed<?>, Typed<?>>)_snowman3);
            typed2 = this.useFunction((Typed<?>)typed2, "minecraft:spectral_arrow", (Function<Typed<?>, Typed<?>>)_snowman3);
            typed2 = this.useFunction((Typed<?>)typed2, "minecraft:egg", (Function<Typed<?>, Typed<?>>)_snowman5);
            typed2 = this.useFunction((Typed<?>)typed2, "minecraft:ender_pearl", (Function<Typed<?>, Typed<?>>)_snowman5);
            typed2 = this.useFunction((Typed<?>)typed2, "minecraft:fireball", (Function<Typed<?>, Typed<?>>)_snowman5);
            typed2 = this.useFunction((Typed<?>)typed2, "minecraft:potion", (Function<Typed<?>, Typed<?>>)_snowman5);
            typed2 = this.useFunction((Typed<?>)typed2, "minecraft:small_fireball", (Function<Typed<?>, Typed<?>>)_snowman5);
            typed2 = this.useFunction((Typed<?>)typed2, "minecraft:snowball", (Function<Typed<?>, Typed<?>>)_snowman5);
            typed2 = this.useFunction((Typed<?>)typed2, "minecraft:wither_skull", (Function<Typed<?>, Typed<?>>)_snowman5);
            typed2 = this.useFunction((Typed<?>)typed2, "minecraft:xp_bottle", (Function<Typed<?>, Typed<?>>)_snowman5);
            typed2 = this.useFunction((Typed<?>)typed2, "minecraft:commandblock_minecart", (Function<Typed<?>, Typed<?>>)_snowman2);
            typed2 = this.useFunction((Typed<?>)typed2, "minecraft:minecart", (Function<Typed<?>, Typed<?>>)_snowman2);
            typed2 = this.useFunction((Typed<?>)typed2, "minecraft:chest_minecart", (Function<Typed<?>, Typed<?>>)_snowman2);
            typed2 = this.useFunction((Typed<?>)typed2, "minecraft:furnace_minecart", (Function<Typed<?>, Typed<?>>)_snowman2);
            typed2 = this.useFunction((Typed<?>)typed2, "minecraft:tnt_minecart", (Function<Typed<?>, Typed<?>>)_snowman2);
            typed2 = this.useFunction((Typed<?>)typed2, "minecraft:hopper_minecart", (Function<Typed<?>, Typed<?>>)_snowman2);
            typed2 = this.useFunction((Typed<?>)typed2, "minecraft:spawner_minecart", (Function<Typed<?>, Typed<?>>)_snowman2);
            return typed2;
        });
    }
    ...
    private Typed<?> method_15695(Typed<?> typed) {
        ...
        _snowman = DSL.optional((Type)DSL.field((String)"BlockState", (Type)DSL.named((String)TypeReferences.BLOCK_STATE.typeName(), (Type)DSL.remainderType())));
        Dynamic _snowman2 = (Dynamic)typed.get(DSL.remainderFinder());
        return typed.update(type.finder(), _snowman, either -> {
            int n = (Integer)either.map(pair -> (Integer)((Either)pair.getSecond()).map(n -> n, EntityBlockStateFix::getNumericalBlockId), unit -> {
                Optional optional = _snowman2.get("TileID").asNumber().result();
                return optional.map(Number::intValue).orElseGet(() -> _snowman2.get("Tile").asByte((byte)0) & 0xFF);
            });
            _snowman = _snowman2.get("Data").asInt(0) & 0xF;
            return Either.left((Object)Pair.of((Object)TypeReferences.BLOCK_STATE.typeName(), BlockStateFlattening.lookupState(n << 4 | _snowman)));
        }).set(DSL.remainderFinder(), (Object)_snowman2.remove("Data").remove("TileID").remove("Tile"));
    }

    private Typed<?> mergeIdAndData(Typed<?> typed, String oldIdKey, String oldDataKey, String newStateKey) {
        Tag.TagType tagType = DSL.field((String)oldIdKey, (Type)DSL.named((String)TypeReferences.BLOCK_NAME.typeName(), (Type)DSL.or((Type)DSL.intType(), IdentifierNormalizingSchema.getIdentifierType())));
        _snowman = DSL.field((String)newStateKey, (Type)DSL.named((String)TypeReferences.BLOCK_STATE.typeName(), (Type)DSL.remainderType()));
        Dynamic _snowman2 = (Dynamic)typed.getOrCreate(DSL.remainderFinder());
        return typed.update(tagType.finder(), (Type)_snowman, pair -> {
            int n2 = (Integer)((Either)pair.getSecond()).map(n -> n, EntityBlockStateFix::getNumericalBlockId);
            _snowman = _snowman2.get(oldDataKey).asInt(0) & 0xF;
            return Pair.of((Object)TypeReferences.BLOCK_STATE.typeName(), BlockStateFlattening.lookupState(n2 << 4 | _snowman));
        }).set(DSL.remainderFinder(), (Object)_snowman2.remove(oldDataKey));
    }
    ...
    private Typed<?> useFunction(Typed<?> typed, String entityId, Function<Typed<?>, Typed<?>> function) {
        ...
        _snowman = this.getOutputSchema().getChoiceType(TypeReferences.ENTITY, entityId);
        return typed.updateTyped(DSL.namedChoice((String)entityId, (Type)type), _snowman, function);
    }
}
