...
extends DataFix {
    ...
    private Dynamic<?> moveFlatOwnerMostLeastToArray(Dynamic<?> dynamic) {
        ...
        _snowman = dynamic.get("OwnerUUIDLeast").asLong(0L);
        return this.insertOwnerUuidArray(dynamic, l, _snowman).remove("OwnerUUIDMost").remove("OwnerUUIDLeast");
    }

    private Dynamic<?> moveNestedOwnerMostLeastToArray(Dynamic<?> dynamic) {
        OptionalDynamic optionalDynamic = dynamic.get("Owner");
        long _snowman2 = optionalDynamic.get("OwnerUUIDMost").asLong(0L);
        long _snowman3 = optionalDynamic.get("OwnerUUIDLeast").asLong(0L);
        return this.insertOwnerUuidArray(dynamic, _snowman2, _snowman3).remove("Owner");
    }
    ...
    private Dynamic<?> moveOwnerToArray(Dynamic<?> dynamic) {
        String string = "owner";
        OptionalDynamic _snowman2 = dynamic.get("owner");
        long _snowman3 = _snowman2.get("M").asLong(0L);
        long _snowman4 = _snowman2.get("L").asLong(0L);
        return this.insertOwnerUuidArray(dynamic, _snowman3, _snowman4).remove("owner");
    }
    ...
    private Typed<?> update(Typed<?> typed2, String string, Function<Dynamic<?>, Dynamic<?>> function) {
        ...
        _snowman = this.getOutputSchema().getChoiceType(TypeReferences.ENTITY, string);
        return typed2.updateTyped(DSL.namedChoice((String)string, (Type)type), _snowman, typed -> typed.update(DSL.remainderFinder(), function));
    }
}
