...
extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        _snowman = this.getOutputSchema().getType(TypeReferences.STRUCTURE_FEATURE);
        return this.writeFixAndRead("IglooMetadataRemovalFix", type, _snowman, IglooMetadataRemovalFix::removeMetadata);
    }
