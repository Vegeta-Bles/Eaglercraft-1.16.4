...
extends DataFix {
    private static final Int2ObjectMap<String> NUMERICAL_ID_TO_STRING_ID_MAP = (Int2ObjectMap)DataFixUtils.make((Object)new Int2ObjectOpenHashMap(), int2ObjectOpenHashMap -> {
    ...
    public TypeRewriteRule makeRule() {
        ...
        _snowman = DSL.named((String)TypeReferences.ITEM_NAME.typeName(), IdentifierNormalizingSchema.getIdentifierType());
        OpticFinder _snowman2 = DSL.fieldFinder((String)"id", (Type)type);
        return this.fixTypeEverywhereTyped("ItemIdFix", this.getInputSchema().getType(TypeReferences.ITEM_STACK), this.getOutputSchema().getType(TypeReferences.ITEM_STACK), typed -> typed.update(_snowman2, _snowman, either -> (Pair)either.map(n -> Pair.of((Object)TypeReferences.ITEM_NAME.typeName(), (Object)ItemIdFix.fromId(n)), pair -> pair)));
    }
}
