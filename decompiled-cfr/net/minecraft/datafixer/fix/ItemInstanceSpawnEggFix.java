...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        OpticFinder _snowman3 = DSL.fieldFinder((String)"id", IdentifierNormalizingSchema.getIdentifierType());
        OpticFinder _snowman4 = type.findField("tag");
        OpticFinder _snowman5 = _snowman4.type().findField("EntityTag");
        return this.fixTypeEverywhereTyped("ItemInstanceSpawnEggFix", type, typed -> {
            Optional optional = typed.getOptional(_snowman2);
            if (optional.isPresent() && Objects.equals(((Pair)optional.get()).getSecond(), "minecraft:spawn_egg") && (_snowman = (_snowman = (_snowman = typed.getOrCreateTyped(_snowman4)).getOrCreateTyped(_snowman5)).getOptional(_snowman3)).isPresent()) {
                return typed.set(_snowman2, (Object)Pair.of((Object)TypeReferences.ITEM_NAME.typeName(), (Object)ENTITY_SPAWN_EGGS.getOrDefault(_snowman.get(), "minecraft:pig_spawn_egg")));
            }
            return typed;
        });
    }
