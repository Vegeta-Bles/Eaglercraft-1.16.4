...
extends DataFix {
    private static final Map<String, String> FLATTENING_MAP = (Map)DataFixUtils.make((Object)Maps.newHashMap(), hashMap -> {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", type, typed -> {
            ...
            Typed _snowman2 = typed;
            Dynamic _snowman3 = (Dynamic)typed.get(DSL.remainderFinder());
            int _snowman4 = _snowman3.get("Damage").asInt(0);
            String _snowman5 = ItemInstanceTheFlatteningFix.getItem((String)((Pair)optional.get()).getSecond(), _snowman4);
            if (_snowman5 != null) {
                _snowman2 = _snowman2.set(_snowman2, (Object)Pair.of((Object)TypeReferences.ITEM_NAME.typeName(), (Object)_snowman5));
            }
            if (DAMAGEABLE_ITEMS.contains(((Pair)optional.get()).getSecond())) {
                Typed typed2 = typed.getOrCreateTyped(_snowman3);
                Dynamic _snowman6 = (Dynamic)typed2.get(DSL.remainderFinder());
                _snowman6 = _snowman6.set("Damage", _snowman6.createInt(_snowman4));
                _snowman2 = _snowman2.set(_snowman3, typed2.set(DSL.remainderFinder(), (Object)_snowman6));
            }
            _snowman2 = _snowman2.set(DSL.remainderFinder(), (Object)_snowman3.remove("Damage"));
            return _snowman2;
        });
    }
