...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemWaterPotionFix", type, typed -> {
            ...
            if (optional.isPresent() && ("minecraft:potion".equals(_snowman = (String)((Pair)optional.get()).getSecond()) || "minecraft:splash_potion".equals(_snowman) || "minecraft:lingering_potion".equals(_snowman) || "minecraft:tipped_arrow".equals(_snowman))) {
                Typed typed2 = typed.getOrCreateTyped(_snowman3);
                Dynamic _snowman2 = (Dynamic)typed2.get(DSL.remainderFinder());
                if (!_snowman2.get("Potion").asString().result().isPresent()) {
                    _snowman2 = _snowman2.set("Potion", _snowman2.createString("minecraft:water"));
                }
                return typed.set(_snowman3, typed2.set(DSL.remainderFinder(), (Object)_snowman2));
            }
            return typed;
        });
    }
