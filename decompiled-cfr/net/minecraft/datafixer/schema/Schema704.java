...
extends Schema {
    ...
    protected static final Hook.HookFunction field_5745 = new Hook.HookFunction(){
        ...
        public <T> T apply(DynamicOps<T> dynamicOps, T t) {
            return Schema99.method_5359(new Dynamic(dynamicOps, t), Schema704.BLOCK_RENAMES, "ArmorStand");
        }
    };
    ...
    public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema schema) {
        ...
        Schema704.method_5296(schema, hashMap, "minecraft:furnace");
        Schema704.method_5296(schema, hashMap, "minecraft:chest");
        ...
        Schema704.method_5296(schema, hashMap, "minecraft:dispenser");
        Schema704.method_5296(schema, hashMap, "minecraft:dropper");
        ...
        Schema704.method_5296(schema, hashMap, "minecraft:brewing_stand");
        ...
        Schema704.method_5296(schema, hashMap, "minecraft:hopper");
        schema.registerSimple((Map)hashMap, "minecraft:comparator");
        schema.register((Map)hashMap, "minecraft:flower_pot", string -> DSL.optionalFields((String)"Item", (TypeTemplate)DSL.or((TypeTemplate)DSL.constType((Type)DSL.intType()), (TypeTemplate)TypeReferences.ITEM_NAME.in(schema))));
