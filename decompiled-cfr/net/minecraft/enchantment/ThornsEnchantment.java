...
extends Enchantment {
    ...
    public void onUserDamaged(LivingEntity user, Entity attacker, int level) {
        ...
        Map.Entry<EquipmentSlot, ItemStack> _snowman2 = EnchantmentHelper.chooseEquipmentWith(Enchantments.THORNS, user);
        if (ThornsEnchantment.shouldDamageAttacker(level, random)) {
            ...
            if (_snowman2 != null) {
                _snowman2.getValue().damage(2, user, livingEntity -> livingEntity.sendEquipmentBreakStatus((EquipmentSlot)((Object)((Object)_snowman2.getKey()))));
            }
        }
    }
