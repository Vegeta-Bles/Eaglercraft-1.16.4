...
extends Task<PathAwareEntity> {
    ...
    private boolean isWalkTargetPresentAndFar(PathAwareEntity pathAwareEntity) {
        ...
        Vec3d _snowman2 = walkTarget.getLookTarget().getPos().subtract(pathAwareEntity.getPos());
        return _snowman2.dotProduct(_snowman = this.getPos(pathAwareEntity).subtract(pathAwareEntity.getPos())) < 0.0;
    }
