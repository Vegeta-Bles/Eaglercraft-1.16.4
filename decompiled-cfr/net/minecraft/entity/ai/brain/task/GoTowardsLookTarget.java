...
extends Task<LivingEntity> {
    ...
    protected void run(ServerWorld world, LivingEntity entity, long time) {
        ...
        LookTarget _snowman2 = brain.getOptionalMemory(MemoryModuleType.LOOK_TARGET).get();
        brain.remember(MemoryModuleType.WALK_TARGET, new WalkTarget(_snowman2, this.speed, this.completionRange));
    }
}
