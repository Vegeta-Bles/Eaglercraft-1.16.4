...
extends Task<E> {
    ...
    public WalkToNearestVisibleWantedItemTask(float f, boolean bl, int n) {
        this(livingEntity -> true, f, bl, n);
    }

    public WalkToNearestVisibleWantedItemTask(Predicate<E> startCondition, float f, boolean requiresWalkTarget, int n) {
