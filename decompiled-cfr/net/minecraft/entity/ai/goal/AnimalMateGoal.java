...
extends Goal {
    ...
    private AnimalEntity findMate() {
        ...
        AnimalEntity _snowman3 = null;
        for (AnimalEntity animalEntity : list) {
            if (!this.animal.canBreedWith(animalEntity) || !(this.animal.squaredDistanceTo(animalEntity) < _snowman2)) continue;
            _snowman3 = animalEntity;
            _snowman2 = this.animal.squaredDistanceTo(animalEntity);
        }
        return _snowman3;
    }
