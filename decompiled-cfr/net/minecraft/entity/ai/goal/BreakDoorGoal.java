...
extends DoorInteractGoal {
    ...
    public void tick() {
        ...
        ++this.breakProgress;
        int n = (int)((float)this.breakProgress / (float)this.getMaxProgress() * 10.0f);
        if (n != this.prevBreakProgress) {
            this.mob.world.setBlockBreakingInfo(this.mob.getEntityId(), this.doorPos, n);
            this.prevBreakProgress = n;
        }
