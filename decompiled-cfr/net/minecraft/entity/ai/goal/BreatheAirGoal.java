...
extends Goal {
    ...
    private void moveToAir() {
        ...
        Vec3i _snowman2 = null;
        for (BlockPos blockPos : iterable) {
            if (!this.isAirPos(this.mob.world, blockPos)) continue;
            _snowman2 = blockPos;
            break;
        }
        if (_snowman2 == null) {
            _snowman2 = new BlockPos(this.mob.getX(), this.mob.getY() + 8.0, this.mob.getZ());
        }
        this.mob.getNavigation().startMovingTo(_snowman2.getX(), _snowman2.getY() + 1, _snowman2.getZ(), 1.0);
    }
