...
extends Goal {
    ...
    protected Vec3d locateShadedPos() {
        ...
        for (int i = 0; i < 10; ++i) {
            BlockPos blockPos = _snowman2.add(random.nextInt(20) - 10, random.nextInt(6) - 3, random.nextInt(20) - 10);
            if (this.world.isSkyVisible(blockPos) || !(this.mob.getPathfindingFavor(blockPos) < 0.0f)) continue;
