...
extends Goal {
    ...
    public boolean canStart() {
        ...
        List<SchoolingFishEntity> _snowman2 = this.fish.world.getEntitiesByClass(this.fish.getClass(), this.fish.getBoundingBox().expand(8.0, 8.0, 8.0), predicate);
        SchoolingFishEntity _snowman3 = _snowman2.stream().filter(SchoolingFishEntity::canHaveMoreFishInGroup).findAny().orElse(this.fish);
        _snowman3.pullInOtherFish(_snowman2.stream().filter(schoolingFishEntity -> !schoolingFishEntity.hasLeader()));
