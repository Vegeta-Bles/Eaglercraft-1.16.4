...
extends Goal {
    ...
    public boolean canStart() {
        ...
        LivingEntity _snowman2 = this.mob.getTarget();
        if (_snowman2 == null) {
            return false;
        }
        if (!_snowman2.isAlive()) {
            return false;
        }
        this.path = this.mob.getNavigation().findPathTo(_snowman2, 0);
        if (this.path != null) {
            return true;
        }
        return this.getSquaredMaxAttackDistance(_snowman2) >= this.mob.squaredDistanceTo(_snowman2.getX(), _snowman2.getY(), _snowman2.getZ());
    }
    ...
    public void tick() {
        ...
        double _snowman2 = this.mob.squaredDistanceTo(livingEntity.getX(), livingEntity.getY(), livingEntity.getZ());
        ...
        this.attack(livingEntity, _snowman2);
    }
