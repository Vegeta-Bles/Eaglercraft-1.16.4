...
extends Goal {
    ...
    private List<MobEntity> getOthersInRange() {
        ...
        Box _snowman2 = Box.method_29968(((Entity)this.mob).getPos()).expand(d, 10.0, d);
        return ((MobEntity)this.mob).world.getEntitiesIncludingUngeneratedChunks(this.mob.getClass(), _snowman2);
    }
}
