...
extends AbstractPhase {
    ...
    public void clientTick() {
        if (this.ticks++ % 10 == 0) {
            ...
            _snowman = (this.dragon.getRandom().nextFloat() - 0.5f) * 4.0f;
            _snowman = (this.dragon.getRandom().nextFloat() - 0.5f) * 8.0f;
            this.dragon.world.addParticle(ParticleTypes.EXPLOSION_EMITTER, this.dragon.getX() + (double)f, this.dragon.getY() + 2.0 + (double)_snowman, this.dragon.getZ() + (double)_snowman, 0.0, 0.0, 0.0);
        }
    }
