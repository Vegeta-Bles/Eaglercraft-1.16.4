...
public class DamageSource {
    ...
    public Text getDeathMessage(LivingEntity entity) {
        ...
        String _snowman3 = _snowman2 + ".player";
        if (livingEntity != null) {
            return new TranslatableText(_snowman3, entity.getDisplayName(), livingEntity.getDisplayName());
        }
        return new TranslatableText(_snowman2, entity.getDisplayName());
    }
