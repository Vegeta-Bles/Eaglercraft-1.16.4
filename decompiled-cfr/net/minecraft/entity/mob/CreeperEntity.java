...
implements SkinOverlayOwner {
    ...
    public void tick() {
        if (this.isAlive()) {
            ...
            if ((n = this.getFuseSpeed()) > 0 && this.currentFuseTime == 0) {
                this.playSound(SoundEvents.ENTITY_CREEPER_PRIMED, 1.0f, 0.5f);
            }
            this.currentFuseTime += n;
    ...
    protected void dropEquipment(DamageSource source, int lootingMultiplier, boolean allowDrops) {
        ...
        if (entity != this && entity instanceof CreeperEntity && (_snowman = (CreeperEntity)entity).shouldDropHead()) {
    ...
    private void explode() {
        if (!this.world.isClient) {
            ...
            float _snowman2 = this.shouldRenderOverlay() ? 2.0f : 1.0f;
            this.dead = true;
            this.world.createExplosion(this, this.getX(), this.getY(), this.getZ(), (float)this.explosionRadius * _snowman2, destructionType);
            this.remove();
