...
extends GuardianEntity {
    ...
    protected void mobTick() {
        ...
        if ((this.age + this.getEntityId()) % 1200 == 0) {
            ...
            List<ServerPlayerEntity> _snowman2 = ((ServerWorld)this.world).getPlayers(serverPlayerEntity -> this.squaredDistanceTo((Entity)serverPlayerEntity) < 2500.0 && serverPlayerEntity.interactionManager.isSurvivalLike());
            int _snowman3 = 2;
            int _snowman4 = 6000;
            int _snowman5 = 1200;
            for (ServerPlayerEntity serverPlayerEntity2 : _snowman2) {
