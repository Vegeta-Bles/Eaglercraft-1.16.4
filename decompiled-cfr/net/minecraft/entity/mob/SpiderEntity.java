...
extends HostileEntity {
    ...
    public void setClimbingWall(boolean climbing) {
        byte by = this.dataTracker.get(SPIDER_FLAGS);
        by = climbing ? (byte)(by | 1) : (byte)(by & 0xFFFFFFFE);
        this.dataTracker.set(SPIDER_FLAGS, by);
    }
    ...
    public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData, @Nullable CompoundTag entityTag) {
        ...
        if (world.getRandom().nextInt(100) == 0) {
            ...
            ((Entity)object).refreshPositionAndAngles(this.getX(), this.getY(), this.getZ(), this.yaw, 0.0f);
            ((AbstractSkeletonEntity)object).initialize(world, difficulty, spawnReason, null, null);
        ...
        if (entityData instanceof SpiderData && (object = ((SpiderData)entityData).effect) != null) {
            this.addStatusEffect(new StatusEffectInstance((StatusEffect)object, Integer.MAX_VALUE));
        }
        return entityData;
    }
