...
extends IllagerEntity {
    ...
    public void addBonusForWave(int wave, boolean unused) {
        ...
        int _snowman3 = 1;
        if (wave > _snowman2.getMaxWaves(Difficulty.NORMAL)) {
            _snowman3 = 2;
        }
        boolean bl = _snowman = this.random.nextFloat() <= _snowman2.getEnchantmentChance();
        if (_snowman) {
            HashMap hashMap = Maps.newHashMap();
            hashMap.put(Enchantments.SHARPNESS, _snowman3);
