...
Hoglin {
    ...
    public boolean damage(DamageSource source, float amount) {
        ...
        LivingEntity _snowman2 = (LivingEntity)source.getAttacker();
        if (EntityPredicates.EXCEPT_CREATIVE_SPECTATOR_OR_PEACEFUL.test(_snowman2) && !LookTargetUtil.isNewTargetTooFar(this, _snowman2, 4.0)) {
            this.method_26938(_snowman2);
        }
        return bl;
    }
    ...
    protected void method_26931() {
        ...
        _snowman = this.brain.getFirstPossibleNonCoreActivity().orElse(null);
        if (_snowman == Activity.FIGHT && activity != Activity.FIGHT) {
            this.playAngrySound();
        }
