...
extends PassiveEntity {
    ...
    public void tickMovement() {
        ...
        if (this.loveTicks > 0) {
            ...
            if (this.loveTicks % 10 == 0) {
                ...
                _snowman = this.random.nextGaussian() * 0.02;
                this.world.addParticle(ParticleTypes.HEART, this.getParticleX(1.0), this.getRandomBodyY() + 0.5, this.getParticleZ(1.0), d, _snowman, _snowman);
            }
        }
    }
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if (this.isBreedingItem(itemStack)) {
            int n = this.getBreedingAge();
            if (!this.world.isClient && n == 0 && this.canEat()) {
            ...
            if (this.isBaby()) {
                this.eat(player, itemStack);
                this.growUp((int)((float)(-n / 20) * 0.1f), true);
    ...
    public void breed(ServerWorld serverWorld, AnimalEntity other) {
        ...
        ServerPlayerEntity _snowman2 = this.getLovingPlayer();
        if (_snowman2 == null && other.getLovingPlayer() != null) {
            _snowman2 = other.getLovingPlayer();
        }
        if (_snowman2 != null) {
            _snowman2.incrementStat(Stats.ANIMALS_BRED);
            Criteria.BRED_ANIMALS.trigger(_snowman2, this, other, passiveEntity);
        }
