...
extends WaterCreatureEntity {
    ...
    protected ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if (itemStack.getItem() == Items.WATER_BUCKET && this.isAlive()) {
            ...
            _snowman = this.getFishBucketItem();
            this.copyDataToStack(_snowman);
            if (!this.world.isClient) {
                Criteria.FILLED_BUCKET.trigger((ServerPlayerEntity)player, _snowman);
            }
    ...
    extends MoveControl {
        ...
        public void tick() {
            ...
            double _snowman2 = this.targetX - this.fish.getX();
            double _snowman3 = this.targetY - this.fish.getY();
            double _snowman4 = this.targetZ - this.fish.getZ();
            if (_snowman3 != 0.0) {
                double d = MathHelper.sqrt(_snowman2 * _snowman2 + _snowman3 * _snowman3 + _snowman4 * _snowman4);
                this.fish.setVelocity(this.fish.getVelocity().add(0.0, (double)this.fish.getMovementSpeed() * (_snowman3 / d) * 0.1, 0.0));
            }
            if (_snowman2 != 0.0 || _snowman4 != 0.0) {
                float f2 = (float)(MathHelper.atan2(_snowman4, _snowman2) * 57.2957763671875) - 90.0f;
                this.fish.bodyYaw = this.fish.yaw = this.changeAngle(this.fish.yaw, f2, 90.0f);
            }
        }
    }
