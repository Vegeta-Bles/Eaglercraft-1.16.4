...
Saddleable {
    ...
    public boolean canBeControlledByRider() {
        ...
        return _snowman2.getMainHandStack().getItem() == Items.CARROT_ON_A_STICK || _snowman2.getOffHandStack().getItem() == Items.CARROT_ON_A_STICK;
    }
    ...
    public Vec3d updatePassengerForDismount(LivingEntity passenger) {
        ...
        for (EntityPose entityPose : passenger.getPoses()) {
            ...
            for (int[] nArray : _snowman2) {
                _snowman4.set(_snowman3.getX() + nArray[0], _snowman3.getY(), _snowman3.getZ() + nArray[1]);
                double d = this.world.getDismountHeight(_snowman4);
                if (!Dismounting.canDismountInBlock(d) || !Dismounting.canPlaceEntityAt(this.world, passenger, box.offset(_snowman = Vec3d.ofCenter(_snowman4, d)))) continue;
