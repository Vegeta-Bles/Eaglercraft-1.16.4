...
extends AbstractMinecartEntity {
    ...
    protected void moveOnRail(BlockPos pos, BlockState state) {
        ...
        _snowman = FurnaceMinecartEntity.squaredHorizontalLength(_snowman2);
        _snowman = this.pushX * this.pushX + this.pushZ * this.pushZ;
        if (_snowman > 1.0E-4 && _snowman > 0.001) {
            _snowman = MathHelper.sqrt(_snowman);
            _snowman = MathHelper.sqrt(_snowman);
            this.pushX = _snowman2.x / _snowman * _snowman;
            this.pushZ = _snowman2.z / _snowman * _snowman;
        }
    }
