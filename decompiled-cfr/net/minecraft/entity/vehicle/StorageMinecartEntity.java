...
NamedScreenHandlerFactory {
    ...
    protected void applySlowdown() {
        float f = 0.98f;
        if (this.lootTableId == null) {
            int n = 15 - ScreenHandler.calculateComparatorOutput(this);
            f += (float)n * 0.001f;
        }
    ...
    public void generateLoot(@Nullable PlayerEntity player) {
        if (this.lootTableId != null && this.world.getServer() != null) {
            ...
            LootContext.Builder _snowman2 = new LootContext.Builder((ServerWorld)this.world).parameter(LootContextParameters.ORIGIN, this.getPos()).random(this.lootSeed);
            if (player != null) {
                _snowman2.luck(player.getLuck()).parameter(LootContextParameters.THIS_ENTITY, player);
            }
            lootTable.supplyInventory(this, _snowman2.build(LootContextTypes.CHEST));
        }
    }
    ...
    public ScreenHandler createMenu(int n, PlayerInventory playerInventory, PlayerEntity playerEntity) {
        if (this.lootTableId == null || !playerEntity.isSpectator()) {
            ...
            return this.getScreenHandler(n, playerInventory);
        }
        return null;
    }
