...
extends Item {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        ItemStack _snowman2 = user.getStackInHand(hand);
        if (!list.isEmpty()) {
            ...
            return TypedActionResult.success(this.fill(_snowman2, user, new ItemStack(Items.DRAGON_BREATH)), world.isClient());
        }
        ...
        if (((HitResult)blockHitResult).getType() == HitResult.Type.MISS) {
            return TypedActionResult.pass(_snowman2);
        }
        if (((HitResult)blockHitResult).getType() == HitResult.Type.BLOCK) {
            ...
            if (world.getFluidState(blockPos).isIn(FluidTags.WATER)) {
                ...
                return TypedActionResult.success(this.fill(_snowman2, user, PotionUtil.setPotion(new ItemStack(Items.POTION), Potions.WATER)), world.isClient());
            }
        }
        return TypedActionResult.pass(_snowman2);
    }
