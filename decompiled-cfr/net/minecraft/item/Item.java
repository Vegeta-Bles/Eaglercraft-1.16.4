...
implements ItemConvertible {
    ...
    protected static BlockHitResult raycast(World world, PlayerEntity player, RaycastContext.FluidHandling fluidHandling) {
        ...
        _snowman = player.yaw;
        Vec3d _snowman2 = player.getCameraPosVec(1.0f);
        ...
        _snowman = _snowman;
        _snowman = _snowman * _snowman;
        double _snowman3 = 5.0;
        Vec3d _snowman4 = _snowman2.add((double)_snowman * 5.0, (double)_snowman * 5.0, (double)_snowman * 5.0);
        return world.raycast(new RaycastContext(_snowman2, _snowman4, RaycastContext.ShapeType.OUTLINE, fluidHandling, player));
    }
