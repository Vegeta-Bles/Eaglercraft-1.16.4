...
extends MiningToolItem {
    ...
    public boolean isEffectiveOn(BlockState state) {
        int n = this.getMaterial().getMiningLevel();
        ...
        return _snowman2 == Material.STONE || _snowman2 == Material.METAL || _snowman2 == Material.REPAIR_STATION || state.isOf(Blocks.NETHER_GOLD_ORE);
    }
