...
public class MapBannerMarker {
    ...
    public static MapBannerMarker fromNbt(CompoundTag tag) {
        ...
        DyeColor _snowman2 = DyeColor.byName(tag.getString("Color"), DyeColor.WHITE);
        MutableText _snowman3 = tag.contains("Name") ? Text.Serializer.fromJson(tag.getString("Name")) : null;
        return new MapBannerMarker(blockPos, _snowman2, _snowman3);
    }
    ...
    public static MapBannerMarker fromWorldBlock(BlockView blockView, BlockPos blockPos) {
        ...
        if (blockEntity instanceof BannerBlockEntity) {
            ...
            DyeColor _snowman2 = bannerBlockEntity.getColorForState(() -> blockView.getBlockState(blockPos));
            Text _snowman3 = bannerBlockEntity.hasCustomName() ? bannerBlockEntity.getCustomName() : null;
            return new MapBannerMarker(blockPos, _snowman2, _snowman3);
        }
        return null;
    }
