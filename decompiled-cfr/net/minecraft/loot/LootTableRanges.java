...
public class LootTableRanges {
    ...
    public static LootTableRange fromJson(JsonElement json, JsonDeserializationContext context) throws JsonParseException {
        ...
        String _snowman2 = JsonHelper.getString(jsonObject, "type", LootTableRange.UNIFORM.toString());
        Class<? extends LootTableRange> _snowman3 = TYPES.get(new Identifier(_snowman2));
        if (_snowman3 == null) {
            throw new JsonParseException("Unknown generator: " + _snowman2);
        }
        return (LootTableRange)context.deserialize((JsonElement)jsonObject, _snowman3);
    }
