...
implements LootCondition {
    ...
    implements JsonSerializer<BlockStatePropertyLootCondition> {
        ...
        public BlockStatePropertyLootCondition fromJson(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext) {
            ...
            StatePredicate _snowman3 = StatePredicate.fromJson(jsonObject.get("properties"));
            _snowman3.check(_snowman2.getStateManager(), string -> {
                throw new JsonSyntaxException("Block " + _snowman2 + " has no property " + string);
            });
            return new BlockStatePropertyLootCondition(_snowman2, _snowman3);
        }
