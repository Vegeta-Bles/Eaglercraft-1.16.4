    ...
    public static <T extends CombinedEntry> LootPoolEntry.Serializer<T> createSerializer(final Factory<T> factory) {
        return new LootPoolEntry.Serializer<T>(){
            ...
            public void addEntryFields(JsonObject jsonObject, T t, JsonSerializationContext jsonSerializationContext) {
                jsonObject.add("children", jsonSerializationContext.serialize((Object)((CombinedEntry)t).children));
            }
            ...
            public final T fromJson(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext, LootCondition[] lootConditionArray) {
                LootPoolEntry[] lootPoolEntryArray = JsonHelper.deserialize(jsonObject, "children", jsonDeserializationContext, LootPoolEntry[].class);
                return factory.create(lootPoolEntryArray, lootConditionArray);
            }
