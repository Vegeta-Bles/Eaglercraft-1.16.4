...
extends LeafEntry {
    ...
    extends LeafEntry.Serializer<DynamicEntry> {
        ...
        @Override
        protected DynamicEntry fromJson(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext, int n, int n2, LootCondition[] lootConditionArray, LootFunction[] lootFunctionArray) {
            Identifier identifier = new Identifier(JsonHelper.getString(jsonObject, "name"));
            return new DynamicEntry(identifier, n, n2, lootConditionArray, lootFunctionArray);
        }
