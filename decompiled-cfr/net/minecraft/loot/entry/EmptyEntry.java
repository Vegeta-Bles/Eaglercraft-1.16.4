...
extends LeafEntry {
    ...
    extends LeafEntry.Serializer<EmptyEntry> {
        @Override
        public EmptyEntry fromJson(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext, int n, int n2, LootCondition[] lootConditionArray, LootFunction[] lootFunctionArray) {
            return new EmptyEntry(n, n2, lootConditionArray, lootFunctionArray);
        }
