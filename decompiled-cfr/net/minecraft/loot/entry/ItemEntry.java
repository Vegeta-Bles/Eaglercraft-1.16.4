...
extends LeafEntry {
    ...
    extends LeafEntry.Serializer<ItemEntry> {
        ...
        @Override
        protected ItemEntry fromJson(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext, int n, int n2, LootCondition[] lootConditionArray, LootFunction[] lootFunctionArray) {
            Item item = JsonHelper.getItem(jsonObject, "name");
            return new ItemEntry(item, n, n2, lootConditionArray, lootFunctionArray);
        }
