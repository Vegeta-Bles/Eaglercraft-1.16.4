...
implements EntryCombiner {
    ...
    implements JsonSerializer<T> {
        ...
        public final void toJson(JsonObject jsonObject, T t, JsonSerializationContext jsonSerializationContext) {
            if (!ArrayUtils.isEmpty((Object[])((LootPoolEntry)t).conditions)) {
                jsonObject.add("conditions", jsonSerializationContext.serialize((Object)((LootPoolEntry)t).conditions));
            }
            this.addEntryFields(jsonObject, t, jsonSerializationContext);
        }
