...
extends LeafEntry {
    ...
    extends LeafEntry.Serializer<LootTableEntry> {
        ...
        @Override
        protected LootTableEntry fromJson(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext, int n, int n2, LootCondition[] lootConditionArray, LootFunction[] lootFunctionArray) {
            Identifier identifier = new Identifier(JsonHelper.getString(jsonObject, "name"));
            return new LootTableEntry(identifier, n, n2, lootConditionArray, lootFunctionArray);
        }
