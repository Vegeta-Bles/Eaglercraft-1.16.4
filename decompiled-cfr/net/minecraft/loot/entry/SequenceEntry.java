...
extends CombinedEntry {
    SequenceEntry(LootPoolEntry[] lootPoolEntryArray, LootCondition[] lootConditionArray) {
        super(lootPoolEntryArray, lootConditionArray);
    }
        ...
        switch (children.length) {
            ...
            case 2: {
                ...
                return (lootContext, consumer) -> {
                    ...
                    _snowman.expand(lootContext, consumer);
                    return true;
                };
            }
        }
