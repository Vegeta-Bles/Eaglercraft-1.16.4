...
extends ConditionalLootFunction {
    ...
    extends ConditionalLootFunction.Serializer<EnchantWithLevelsLootFunction> {
        ...
        @Override
        public EnchantWithLevelsLootFunction fromJson(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext, LootCondition[] lootConditionArray) {
            LootTableRange lootTableRange = LootTableRanges.fromJson(jsonObject.get("levels"), jsonDeserializationContext);
            boolean _snowman2 = JsonHelper.getBoolean(jsonObject, "treasure", false);
            return new EnchantWithLevelsLootFunction(lootConditionArray, lootTableRange, _snowman2);
        }
