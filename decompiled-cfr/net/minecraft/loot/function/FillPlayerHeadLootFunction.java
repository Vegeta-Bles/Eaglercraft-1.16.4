...
extends ConditionalLootFunction {
    ...
    extends ConditionalLootFunction.Serializer<FillPlayerHeadLootFunction> {
        ...
        @Override
        public FillPlayerHeadLootFunction fromJson(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext, LootCondition[] lootConditionArray) {
            ...
            return new FillPlayerHeadLootFunction(lootConditionArray, entityTarget);
        }
