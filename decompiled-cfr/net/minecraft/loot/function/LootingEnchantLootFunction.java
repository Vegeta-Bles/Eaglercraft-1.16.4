...
extends ConditionalLootFunction {
    ...
    public ItemStack process(ItemStack stack, LootContext context) {
        ...
        if (entity instanceof LivingEntity) {
            int n = EnchantmentHelper.getLooting((LivingEntity)entity);
            if (n == 0) {
                return stack;
            }
            float _snowman2 = (float)n * this.countRange.nextFloat(context.getRandom());
            stack.increment(Math.round(_snowman2));
    ...
    extends ConditionalLootFunction.Serializer<LootingEnchantLootFunction> {
        ...
        @Override
        public LootingEnchantLootFunction fromJson(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext, LootCondition[] lootConditionArray) {
            int n = JsonHelper.getInt(jsonObject, "limit", 0);
            return new LootingEnchantLootFunction(lootConditionArray, JsonHelper.deserialize(jsonObject, "count", jsonDeserializationContext, UniformLootTableRange.class), n);
        }
