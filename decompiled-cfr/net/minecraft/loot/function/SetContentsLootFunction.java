...
extends ConditionalLootFunction {
    ...
    public ItemStack process(ItemStack stack, LootContext context) {
        ...
        Inventories.toTag(_snowman2, defaultedList);
        CompoundTag _snowman3 = stack.getOrCreateTag();
        _snowman3.put("BlockEntityTag", _snowman2.copyFrom(_snowman3.getCompound("BlockEntityTag")));
        return stack;
    }
    ...
    extends ConditionalLootFunction.Serializer<SetContentsLootFunction> {
        ...
        @Override
        public SetContentsLootFunction fromJson(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext, LootCondition[] lootConditionArray) {
            LootPoolEntry[] lootPoolEntryArray = JsonHelper.deserialize(jsonObject, "entries", jsonDeserializationContext, LootPoolEntry[].class);
            return new SetContentsLootFunction(lootConditionArray, Arrays.asList(lootPoolEntryArray));
        }
