...
extends ConditionalLootFunction {
    ...
    extends ConditionalLootFunction.Serializer<SetDamageLootFunction> {
        ...
        @Override
        public SetDamageLootFunction fromJson(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext, LootCondition[] lootConditionArray) {
            return new SetDamageLootFunction(lootConditionArray, JsonHelper.deserialize(jsonObject, "damage", jsonDeserializationContext, UniformLootTableRange.class));
        }
