...
extends ConditionalLootFunction {
    ...
    extends ConditionalLootFunction.Serializer<SetLootTableLootFunction> {
        ...
        @Override
        public SetLootTableLootFunction fromJson(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext, LootCondition[] lootConditionArray) {
            Identifier identifier = new Identifier(JsonHelper.getString(jsonObject, "name"));
            long _snowman2 = JsonHelper.getLong(jsonObject, "seed", 0L);
            return new SetLootTableLootFunction(lootConditionArray, identifier, _snowman2);
        }
