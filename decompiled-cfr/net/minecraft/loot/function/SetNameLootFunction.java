...
extends ConditionalLootFunction {
    ...
    extends ConditionalLootFunction.Serializer<SetNameLootFunction> {
        ...
        @Override
        public SetNameLootFunction fromJson(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext, LootCondition[] lootConditionArray) {
            MutableText mutableText = Text.Serializer.fromJson(jsonObject.get("name"));
            LootContext.EntityTarget _snowman2 = JsonHelper.deserialize(jsonObject, "entity", null, jsonDeserializationContext, LootContext.EntityTarget.class);
            return new SetNameLootFunction(lootConditionArray, mutableText, _snowman2);
        }
