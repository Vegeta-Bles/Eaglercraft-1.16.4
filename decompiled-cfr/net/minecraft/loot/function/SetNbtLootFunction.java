...
extends ConditionalLootFunction {
    ...
    extends ConditionalLootFunction.Serializer<SetNbtLootFunction> {
        ...
        @Override
        public SetNbtLootFunction fromJson(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext, LootCondition[] lootConditionArray) {
            try {
                CompoundTag compoundTag = StringNbtReader.parse(JsonHelper.getString(jsonObject, "tag"));
                return new SetNbtLootFunction(lootConditionArray, compoundTag);
            }
