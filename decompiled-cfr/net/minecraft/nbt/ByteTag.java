...
extends AbstractNumberTag {
    public static final TagReader<ByteTag> READER = new TagReader<ByteTag>(){
        ...
        @Override
        public ByteTag read(DataInput dataInput, int n, PositionTracker positionTracker) throws IOException {
    ...
    public Text toText(String indent, int depth) {
        MutableText mutableText = new LiteralText("b").formatted(RED);
