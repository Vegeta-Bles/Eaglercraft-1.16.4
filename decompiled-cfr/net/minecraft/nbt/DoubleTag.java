...
extends AbstractNumberTag {
    ...
    public static final TagReader<DoubleTag> READER = new TagReader<DoubleTag>(){
        ...
        @Override
        public DoubleTag read(DataInput dataInput, int n, PositionTracker positionTracker) throws IOException {
    ...
    public Text toText(String indent, int depth) {
        MutableText mutableText = new LiteralText("d").formatted(RED);
        return new LiteralText(String.valueOf(this.value)).append(mutableText).formatted(GOLD);
    }
