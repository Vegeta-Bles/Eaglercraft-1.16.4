...
extends AbstractNumberTag {
    ...
    public static final TagReader<FloatTag> READER = new TagReader<FloatTag>(){
        ...
        @Override
        public FloatTag read(DataInput dataInput, int n, PositionTracker positionTracker) throws IOException {
    ...
    public Text toText(String indent, int depth) {
        MutableText mutableText = new LiteralText("f").formatted(RED);
