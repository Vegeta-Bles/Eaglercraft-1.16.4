...
extends AbstractNumberTag {
    public static final TagReader<LongTag> READER = new TagReader<LongTag>(){
        ...
        @Override
        public LongTag read(DataInput dataInput, int n, PositionTracker positionTracker) throws IOException {
    ...
    public Text toText(String indent, int depth) {
        MutableText mutableText = new LiteralText("L").formatted(RED);
