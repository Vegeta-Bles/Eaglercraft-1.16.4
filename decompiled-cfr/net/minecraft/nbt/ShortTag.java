...
extends AbstractNumberTag {
    public static final TagReader<ShortTag> READER = new TagReader<ShortTag>(){
        ...
        @Override
        public ShortTag read(DataInput dataInput, int n, PositionTracker positionTracker) throws IOException {
    ...
    public Text toText(String indent, int depth) {
        MutableText mutableText = new LiteralText("s").formatted(RED);
