...
public class DamagePredicate {
    ...
    public static DamagePredicate fromJson(@Nullable JsonElement json) {
        ...
        NumberRange.FloatRange _snowman2 = NumberRange.FloatRange.fromJson(jsonObject.get("dealt"));
        NumberRange.FloatRange _snowman3 = NumberRange.FloatRange.fromJson(jsonObject.get("taken"));
        Boolean _snowman4 = jsonObject.has("blocked") ? Boolean.valueOf(JsonHelper.getBoolean(jsonObject, "blocked")) : null;
        EntityPredicate _snowman5 = EntityPredicate.fromJson(jsonObject.get("source_entity"));
        DamageSourcePredicate _snowman6 = DamageSourcePredicate.fromJson(jsonObject.get("type"));
        return new DamagePredicate(_snowman2, _snowman3, _snowman5, _snowman4, _snowman6);
    }
