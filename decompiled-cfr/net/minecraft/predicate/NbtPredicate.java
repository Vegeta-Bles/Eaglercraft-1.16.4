...
public class NbtPredicate {
    ...
    public static NbtPredicate fromJson(@Nullable JsonElement json) {
        ...
        try {
            CompoundTag compoundTag = StringNbtReader.parse(JsonHelper.asString(json, "nbt"));
        }
    ...
    public static CompoundTag entityToTag(Entity entity) {
        ...
        if (entity instanceof PlayerEntity && !(_snowman = ((PlayerEntity)entity).inventory.getMainHandStack()).isEmpty()) {
            compoundTag.put("SelectedItem", _snowman.toTag(new CompoundTag()));
        }
        return compoundTag;
    }
}
