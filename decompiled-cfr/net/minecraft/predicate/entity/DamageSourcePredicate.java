...
public class DamageSourcePredicate {
    ...
    public static DamageSourcePredicate fromJson(@Nullable JsonElement json) {
        ...
        Boolean _snowman2 = DamageSourcePredicate.getBoolean(jsonObject, "is_projectile");
        Boolean _snowman3 = DamageSourcePredicate.getBoolean(jsonObject, "is_explosion");
        Boolean _snowman4 = DamageSourcePredicate.getBoolean(jsonObject, "bypasses_armor");
        Boolean _snowman5 = DamageSourcePredicate.getBoolean(jsonObject, "bypasses_invulnerability");
        Boolean _snowman6 = DamageSourcePredicate.getBoolean(jsonObject, "bypasses_magic");
        Boolean _snowman7 = DamageSourcePredicate.getBoolean(jsonObject, "is_fire");
        Boolean _snowman8 = DamageSourcePredicate.getBoolean(jsonObject, "is_magic");
        Boolean _snowman9 = DamageSourcePredicate.getBoolean(jsonObject, "is_lightning");
        EntityPredicate _snowman10 = EntityPredicate.fromJson(jsonObject.get("direct_entity"));
        EntityPredicate _snowman11 = EntityPredicate.fromJson(jsonObject.get("source_entity"));
        return new DamageSourcePredicate(_snowman2, _snowman3, _snowman4, _snowman5, _snowman6, _snowman7, _snowman8, _snowman9, _snowman10, _snowman11);
    }
