...
public class EntityEffectPredicate {
    ...
    public static EntityEffectPredicate fromJson(@Nullable JsonElement json) {
        ...
        for (Map.Entry entry : jsonObject.entrySet()) {
            ...
            StatusEffect _snowman3 = Registry.STATUS_EFFECT.getOrEmpty(identifier).orElseThrow(() -> new JsonSyntaxException("Unknown effect '" + identifier + "'"));
            EffectData _snowman4 = EffectData.fromJson(JsonHelper.asObject((JsonElement)entry.getValue(), (String)entry.getKey()));
            _snowman2.put(_snowman3, _snowman4);
        }
        return new EntityEffectPredicate(_snowman2);
    }
    ...
    public static class EffectData {
        ...
        public static EffectData fromJson(JsonObject json) {
            ...
            _snowman = NumberRange.IntRange.fromJson(json.get("duration"));
            Boolean _snowman2 = json.has("ambient") ? Boolean.valueOf(JsonHelper.getBoolean(json, "ambient")) : null;
            Boolean _snowman3 = json.has("visible") ? Boolean.valueOf(JsonHelper.getBoolean(json, "visible")) : null;
            return new EffectData(intRange, _snowman, _snowman2, _snowman3);
        }
    }
}
