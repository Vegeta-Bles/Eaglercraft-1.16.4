...
public class EntityEquipmentPredicate {
    ...
    public static EntityEquipmentPredicate fromJson(@Nullable JsonElement json) {
        ...
        ItemPredicate _snowman2 = ItemPredicate.fromJson(jsonObject.get("head"));
        ItemPredicate _snowman3 = ItemPredicate.fromJson(jsonObject.get("chest"));
        ItemPredicate _snowman4 = ItemPredicate.fromJson(jsonObject.get("legs"));
        ItemPredicate _snowman5 = ItemPredicate.fromJson(jsonObject.get("feet"));
        ItemPredicate _snowman6 = ItemPredicate.fromJson(jsonObject.get("mainhand"));
        ItemPredicate _snowman7 = ItemPredicate.fromJson(jsonObject.get("offhand"));
        return new EntityEquipmentPredicate(_snowman2, _snowman3, _snowman4, _snowman5, _snowman6, _snowman7);
    }
