...
public class EntityFlagsPredicate {
    ...
    public static EntityFlagsPredicate fromJson(@Nullable JsonElement json) {
        ...
        Boolean _snowman2 = EntityFlagsPredicate.nullableBooleanFromJson(jsonObject, "is_on_fire");
        Boolean _snowman3 = EntityFlagsPredicate.nullableBooleanFromJson(jsonObject, "is_sneaking");
        Boolean _snowman4 = EntityFlagsPredicate.nullableBooleanFromJson(jsonObject, "is_sprinting");
        Boolean _snowman5 = EntityFlagsPredicate.nullableBooleanFromJson(jsonObject, "is_swimming");
        Boolean _snowman6 = EntityFlagsPredicate.nullableBooleanFromJson(jsonObject, "is_baby");
        return new EntityFlagsPredicate(_snowman2, _snowman3, _snowman4, _snowman5, _snowman6);
    }
    ...
    public static class Builder {
        ...
        public Builder method_29935(@Nullable Boolean bl) {
            this.isBaby = bl;
            return this;
        }
