...
public class EntityPredicate {
    ...
    public static EntityPredicate fromJson(@Nullable JsonElement json) {
        ...
        EntityTypePredicate _snowman2 = EntityTypePredicate.fromJson(jsonObject.get("type"));
        DistancePredicate _snowman3 = DistancePredicate.fromJson(jsonObject.get("distance"));
        LocationPredicate _snowman4 = LocationPredicate.fromJson(jsonObject.get("location"));
        EntityEffectPredicate _snowman5 = EntityEffectPredicate.fromJson(jsonObject.get("effects"));
        NbtPredicate _snowman6 = NbtPredicate.fromJson(jsonObject.get("nbt"));
        EntityFlagsPredicate _snowman7 = EntityFlagsPredicate.fromJson(jsonObject.get("flags"));
        EntityEquipmentPredicate _snowman8 = EntityEquipmentPredicate.fromJson(jsonObject.get("equipment"));
        PlayerPredicate _snowman9 = PlayerPredicate.fromJson(jsonObject.get("player"));
        FishingHookPredicate _snowman10 = FishingHookPredicate.fromJson(jsonObject.get("fishing_hook"));
        EntityPredicate _snowman11 = EntityPredicate.fromJson(jsonObject.get("vehicle"));
        EntityPredicate _snowman12 = EntityPredicate.fromJson(jsonObject.get("targeted_entity"));
        String _snowman13 = JsonHelper.getString(jsonObject, "team", null);
        Identifier _snowman14 = jsonObject.has("catType") ? new Identifier(JsonHelper.getString(jsonObject, "catType")) : null;
        return new Builder().type(_snowman2).distance(_snowman3).location(_snowman4).effects(_snowman5).nbt(_snowman6).flags(_snowman7).equipment(_snowman8).player(_snowman9).fishHook(_snowman10).team(_snowman13).vehicle(_snowman11).targetedEntity(_snowman12).catType(_snowman14).build();
    }
    ...
    public static class Extended {
        ...
        public static Extended[] requireInJson(JsonObject root, String key, AdvancementEntityPredicateDeserializer predicateDeserializer) {
            ...
            JsonArray _snowman2 = JsonHelper.asArray(jsonElement, key);
            Extended[] _snowman3 = new Extended[_snowman2.size()];
            for (int i = 0; i < _snowman2.size(); ++i) {
                _snowman3[i] = Extended.fromJson(key + "[" + i + "]", predicateDeserializer, _snowman2.get(i));
            }
            return _snowman3;
        }
        ...
        private static Extended fromJson(String key, AdvancementEntityPredicateDeserializer predicateDeserializer, @Nullable JsonElement json) {
            if (json != null && json.isJsonArray()) {
                LootCondition[] lootConditionArray = predicateDeserializer.loadConditions(json.getAsJsonArray(), predicateDeserializer.getAdvancementId().toString() + "/" + key, LootContextTypes.ADVANCEMENT_ENTITY);
                return new Extended(lootConditionArray);
            }
