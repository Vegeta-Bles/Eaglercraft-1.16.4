...
implements AutoCloseable {
    ...
    public ResourcePackManager(ResourcePackProvider ... resourcePackProviderArray) {
        this(ResourcePackProfile::new, resourcePackProviderArray);
    }
    ...
    private Map<String, ResourcePackProfile> providePackProfiles() {
        ...
        for (ResourcePackProvider resourcePackProvider : this.providers) {
            resourcePackProvider.register(resourcePackProfile -> treeMap.put(resourcePackProfile.getName(), resourcePackProfile), this.profileFactory);
        }
