...
public class ScoreboardCriterion {
    ...
    public static Optional<ScoreboardCriterion> createStatCriterion(String name) {
        ...
        return Registry.STAT_TYPE.getOrEmpty(Identifier.splitOn(name.substring(0, n), '.')).flatMap(statType -> ScoreboardCriterion.createStatCriterion(statType, Identifier.splitOn(name.substring(n + 1), '.')));
    }
