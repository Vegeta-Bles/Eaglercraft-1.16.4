...
extends AbstractTeam {
    ...
    public MutableText getFormattedName() {
        ...
        Formatting _snowman2 = this.getColor();
        if (_snowman2 != Formatting.RESET) {
            mutableText.formatted(_snowman2);
        }
        return mutableText;
    }
    ...
    public void setFriendlyFlagsBitwise(int n) {
        this.setFriendlyFireAllowed((n & 1) > 0);
        this.setShowFriendlyInvisibles((n & 2) > 0);
    }
