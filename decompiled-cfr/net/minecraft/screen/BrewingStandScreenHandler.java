...
extends ScreenHandler {
    ...
    public ItemStack transferSlot(PlayerEntity player, int index) {
        ...
        if (_snowman2 != null && _snowman2.hasStack()) {
            ...
            if (index >= 0 && index <= 2 || index == 3 || index == 4) {
                if (!this.insertItem(_snowman, 5, 41, true)) {
                    return ItemStack.EMPTY;
                }
                _snowman2.onStackChanged(_snowman, itemStack);
            } else if (FuelSlot.matches(itemStack) ? this.insertItem(_snowman, 4, 5, false) || this.ingredientSlot.canInsert(_snowman) && !this.insertItem(_snowman, 3, 4, false) : (this.ingredientSlot.canInsert(_snowman) ? !this.insertItem(_snowman, 3, 4, false) : (PotionSlot.matches(itemStack) && itemStack.getCount() == 1 ? !this.insertItem(_snowman, 0, 3, false) : (index >= 5 && index < 32 ? !this.insertItem(_snowman, 32, 41, false) : (index >= 32 && index < 41 ? !this.insertItem(_snowman, 5, 32, false) : !this.insertItem(_snowman, 5, 41, false)))))) {
                return ItemStack.EMPTY;
            }
            if (_snowman.isEmpty()) {
    ...
    extends Slot {
        public FuelSlot(Inventory inventory, int n, int n2, int n3) {
    ...
    extends Slot {
        public IngredientSlot(Inventory inventory, int n, int n2, int n3) {
            super(inventory, n, n2, n3);
        }
    ...
    extends Slot {
        public PotionSlot(Inventory inventory, int n, int n2, int n3) {
            super(inventory, n, n2, n3);
        }
