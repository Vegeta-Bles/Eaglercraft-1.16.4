...
extends ScreenHandler {
    ...
    public LecternScreenHandler(int syncId, Inventory inventory, PropertyDelegate propertyDelegate) {
        ...
        this.addSlot(new Slot(this, inventory, 0, 0, 0){
            final /* synthetic */ LecternScreenHandler field_17315;
            {
                this.field_17315 = lecternScreenHandler;
                super(inventory, n, n2, n3);
            }

            public void markDirty() {
                super.markDirty();
                this.field_17315.onContentChanged(this.inventory);
            }
        });
    ...
    public boolean onButtonClick(PlayerEntity player, int id) {
        if (id >= 100) {
            int n = id - 100;
            this.setProperty(0, n);
            return true;
        }
        switch (id) {
            case 2: {
                int n = this.propertyDelegate.get(0);
                this.setProperty(0, n + 1);
                return true;
            }
            case 1: {
                int n = this.propertyDelegate.get(0);
