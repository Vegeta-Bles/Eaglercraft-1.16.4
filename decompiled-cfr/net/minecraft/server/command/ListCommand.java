...
public class ListCommand {
    ...
    private static int execute(ServerCommandSource source, Function<ServerPlayerEntity, Text> nameProvider) {
        ...
        List<ServerPlayerEntity> _snowman2 = playerManager.getPlayerList();
        MutableText _snowman3 = Texts.join(_snowman2, nameProvider);
        source.sendFeedback(new TranslatableText("commands.list.players", _snowman2.size(), playerManager.getMaxPlayerCount(), _snowman3), false);
