...
public class TimeCommand {
    ...
    public static int executeAdd(ServerCommandSource source, int time) {
        ...
        int n = TimeCommand.getDayTime(source.getWorld());
        source.sendFeedback(new TranslatableText("commands.time.set", n), true);
        return n;
    }
}
