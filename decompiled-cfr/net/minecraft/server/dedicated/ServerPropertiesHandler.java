...
extends AbstractPropertiesHandler<ServerPropertiesHandler> {
    ...
    public final int maxBuildHeight = this.transformedParseInt("max-build-height", n -> MathHelper.clamp((n + 8) / 16 * 16, 64, 256), 256);
    ...
    public ServerPropertiesHandler(Properties properties, DynamicRegistryManager dynamicRegistryManager) {
        ...
        this.maxWorldSize = this.transformedParseInt("max-world-size", n -> MathHelper.clamp(n, 1, 29999984), 29999984);
        ...
        this.entityBroadcastRangePercentage = this.transformedParseInt("entity-broadcast-range-percentage", n -> MathHelper.clamp(n, 10, 1000), 100);
