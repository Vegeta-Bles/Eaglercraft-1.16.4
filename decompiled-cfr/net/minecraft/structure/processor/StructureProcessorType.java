...
public interface StructureProcessorType<P extends StructureProcessor> {
    ...
    public static final Codec<StructureProcessorList> field_25876 = Codec.either((Codec)field_26663.fieldOf("processors").codec(), field_26663).xmap(either -> (StructureProcessorList)either.map(structureProcessorList -> structureProcessorList, structureProcessorList -> structureProcessorList), Either::left);
