...
extends PosRuleTest {
    ...
    public boolean test(BlockPos blockPos, BlockPos blockPos2, BlockPos blockPos3, Random random) {
        int n = blockPos2.getManhattanDistance(blockPos3);
        float _snowman2 = random.nextFloat();
        return (double)_snowman2 <= MathHelper.clampedLerp(this.minChance, this.maxChance, MathHelper.getLerpProgress(n, this.minDistance, this.maxDistance));
    }
