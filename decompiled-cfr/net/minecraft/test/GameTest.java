...
public class GameTest {
    ...
    public void init(BlockPos blockPos, int n) {
        StructureBlockBlockEntity structureBlockBlockEntity = StructureTestUtil.method_22250(this.getStructureName(), blockPos, this.method_29402(), n, this.world, false);
