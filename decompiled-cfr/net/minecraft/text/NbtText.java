...
implements ParsableText {
    ...
    extends NbtText {
        ...
        protected Stream<CompoundTag> toNbt(ServerCommandSource source) {
            ...
            if (this.pos != null && (serverWorld = source.getWorld()).canSetBlock(_snowman = this.pos.toAbsoluteBlockPos(source)) && (_snowman = serverWorld.getBlockEntity(_snowman)) != null) {
                return Stream.of(_snowman.toTag(new CompoundTag()));
            }
            return Stream.empty();
        }
