...
implements ParsableText {
    ...
    private String getScore(String playerName, ServerCommandSource source) {
        ...
        if (minecraftServer != null && (_snowman = minecraftServer.getScoreboard()).playerHasObjective(playerName, _snowman = _snowman.getNullableObjective(this.objective))) {
            ScoreboardPlayerScore scoreboardPlayerScore = _snowman.getPlayerScore(playerName, _snowman);
    ...
    public MutableText parse(@Nullable ServerCommandSource source, @Nullable Entity sender, int depth) throws CommandSyntaxException {
        ...
        _snowman = sender != null && string.equals("*") ? sender.getEntityName() : string;
        return new LiteralText(this.getScore(_snowman, source));
    }
