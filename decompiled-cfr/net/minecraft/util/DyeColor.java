...
public enum DyeColor implements StringIdentifiable
{
    ...
    private DyeColor(int woolId, String name, int color, MaterialColor materialColor, int fireworkColor, int signColor) {
        ...
        int n2 = (color & 0xFF0000) >> 16;
        _snowman = (color & 0xFF00) >> 8;
        _snowman = (color & 0xFF) >> 0;
        this.colorSwapped = _snowman << 16 | _snowman << 8 | n2 << 0;
        this.colorComponents = new float[]{(float)n2 / 255.0f, (float)_snowman / 255.0f, (float)_snowman / 255.0f};
