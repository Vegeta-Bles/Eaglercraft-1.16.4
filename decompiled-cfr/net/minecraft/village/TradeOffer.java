...
public class TradeOffer {
    ...
    public TradeOffer(ItemStack itemStack, ItemStack itemStack2, ItemStack itemStack3, int n, int n2, int n3, float f, int n4) {
        this.firstBuyItem = itemStack;
        this.secondBuyItem = itemStack2;
        this.sellItem = itemStack3;
        this.uses = n;
        this.maxUses = n2;
        this.merchantExperience = n3;
    ...
    public ItemStack getAdjustedFirstBuyItem() {
        int n = this.firstBuyItem.getCount();
        ItemStack _snowman2 = this.firstBuyItem.copy();
        _snowman = Math.max(0, MathHelper.floor((float)(n * this.demandBonus) * this.priceMultiplier));
        _snowman2.setCount(MathHelper.clamp(n + _snowman + this.specialPrice, 1, this.firstBuyItem.getItem().getMaxCount()));
        return _snowman2;
    }
