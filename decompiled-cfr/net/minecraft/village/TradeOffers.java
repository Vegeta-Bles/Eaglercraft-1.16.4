...
public class TradeOffers {
    ...
    implements Factory {
        ...
        public TradeOffer create(Entity entity, Random random) {
            ...
            BlockPos _snowman2 = serverWorld.locateStructure(this.structure, entity.getBlockPos(), 100, true);
            if (_snowman2 != null) {
                ItemStack itemStack = FilledMapItem.createMap(serverWorld, _snowman2.getX(), _snowman2.getZ(), (byte)2, true, true);
                FilledMapItem.fillExplorationMap(serverWorld, itemStack);
                MapState.addDecorationsTag(itemStack, _snowman2, "+", this.iconType);
    ...
    implements Factory {
        ...
        public TradeOffer create(Entity entity, Random random) {
            ...
            Enchantment _snowman2 = (Enchantment)list.get(random.nextInt(list.size()));
            int _snowman3 = MathHelper.nextInt(random, _snowman2.getMinLevel(), _snowman2.getMaxLevel());
            ItemStack _snowman4 = EnchantedBookItem.forEnchantment(new EnchantmentLevelEntry(_snowman2, _snowman3));
            int _snowman5 = 2 + random.nextInt(5 + _snowman3 * 10) + 3 * _snowman3;
            if (_snowman2.isTreasure()) {
                _snowman5 *= 2;
            }
            if (_snowman5 > 64) {
                _snowman5 = 64;
            }
            return new TradeOffer(new ItemStack(Items.EMERALD, _snowman5), new ItemStack(Items.BOOK), _snowman4, 12, this.experience, 0.2f);
        }
    }
    ...
    implements Factory {
        ...
        public TradeOffer create(Entity entity, Random random) {
            ...
            _snowman2 = new ItemStack(this.sell);
            if (this.sell instanceof DyeableArmorItem) {
                ArrayList arrayList = Lists.newArrayList();
                arrayList.add(SellDyedArmorFactory.getDye(random));
                ...
                _snowman2 = DyeableItem.blendAndSetColor(_snowman2, arrayList);
            }
            return new TradeOffer(itemStack, _snowman2, this.maxUses, this.experience, 0.2f);
        }
    ...
    implements Factory {
        ...
        public TradeOffer create(Entity entity, Random random) {
            ItemStack itemStack = new ItemStack(Items.EMERALD, this.price);
            List _snowman2 = Registry.POTION.stream().filter(potion -> !potion.getEffects().isEmpty() && BrewingRecipeRegistry.isBrewable(potion)).collect(Collectors.toList());
            Potion _snowman3 = (Potion)_snowman2.get(random.nextInt(_snowman2.size()));
            _snowman = PotionUtil.setPotion(new ItemStack(this.sell.getItem(), this.sellCount), _snowman3);
            return new TradeOffer(itemStack, new ItemStack(this.secondBuy, this.secondCount), _snowman, this.maxUses, this.experience, this.priceMultiplier);
        }
    }
    ...
    implements Factory {
        ...
        public TradeOffer create(Entity entity, Random random) {
            ...
            ItemStack _snowman2 = EnchantmentHelper.enchant(random, new ItemStack(this.tool.getItem()), n, false);
            _snowman = Math.min(this.basePrice + n, 64);
            ItemStack _snowman3 = new ItemStack(Items.EMERALD, _snowman);
            return new TradeOffer(_snowman3, _snowman2, this.maxUses, this.experience, this.multiplier);
        }
    }
