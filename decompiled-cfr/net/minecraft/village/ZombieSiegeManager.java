...
implements Spawner {
    ...
    private Vec3d getSpawnVector(ServerWorld world, BlockPos pos) {
        for (int i = 0; i < 10; ++i) {
            _snowman = pos.getX() + world.random.nextInt(16) - 8;
            BlockPos blockPos = new BlockPos(_snowman, _snowman = world.getTopY(Heightmap.Type.WORLD_SURFACE, _snowman, _snowman = pos.getZ() + world.random.nextInt(16) - 8), _snowman);
