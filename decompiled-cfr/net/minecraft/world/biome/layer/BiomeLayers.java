...
public class BiomeLayers {
    private static final Int2IntMap field_26709 = (Int2IntMap)Util.make(new Int2IntOpenHashMap(), int2IntOpenHashMap -> {
    ...
    private static <T extends LayerSampler, C extends LayerSampleContext<T>> LayerFactory<T> build(boolean old, int biomeSize, int riverSize, LongFunction<C> contextProvider) {
        ...
        LayerFactory layerFactory2 = ContinentLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(1L));
        layerFactory2 = ScaleLayer.FUZZY.create((LayerSampleContext)contextProvider.apply(2000L), layerFactory2);
        layerFactory2 = IncreaseEdgeCurvatureLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(1L), layerFactory2);
        layerFactory2 = ScaleLayer.NORMAL.create((LayerSampleContext)contextProvider.apply(2001L), layerFactory2);
        layerFactory2 = IncreaseEdgeCurvatureLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(2L), layerFactory2);
        layerFactory2 = IncreaseEdgeCurvatureLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(50L), layerFactory2);
        layerFactory2 = IncreaseEdgeCurvatureLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(70L), layerFactory2);
        layerFactory2 = AddIslandLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(2L), layerFactory2);
        _snowman = OceanTemperatureLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(2L));
        _snowman = BiomeLayers.stack(2001L, ScaleLayer.NORMAL, _snowman, 6, contextProvider);
        layerFactory2 = AddColdClimatesLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(2L), layerFactory2);
        layerFactory2 = IncreaseEdgeCurvatureLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(3L), layerFactory2);
        layerFactory2 = AddClimateLayers.AddTemperateBiomesLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(2L), layerFactory2);
        layerFactory2 = AddClimateLayers.AddCoolBiomesLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(2L), layerFactory2);
        layerFactory2 = AddClimateLayers.AddSpecialBiomesLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(3L), layerFactory2);
        layerFactory2 = ScaleLayer.NORMAL.create((LayerSampleContext)contextProvider.apply(2002L), layerFactory2);
        layerFactory2 = ScaleLayer.NORMAL.create((LayerSampleContext)contextProvider.apply(2003L), layerFactory2);
        layerFactory2 = IncreaseEdgeCurvatureLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(4L), layerFactory2);
        layerFactory2 = AddMushroomIslandLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(5L), layerFactory2);
        layerFactory2 = AddDeepOceanLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(4L), layerFactory2);
        _snowman = layerFactory2 = BiomeLayers.stack(1000L, ScaleLayer.NORMAL, layerFactory2, 0, contextProvider);
        _snowman = BiomeLayers.stack(1000L, ScaleLayer.NORMAL, _snowman, 0, contextProvider);
        _snowman = SimpleLandNoiseLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(100L), _snowman);
        layerFactory = layerFactory2;
        layerFactory = new SetBaseBiomesLayer(old).create((LayerSampleContext)contextProvider.apply(200L), layerFactory);
        layerFactory = AddBambooJungleLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(1001L), layerFactory);
        layerFactory = BiomeLayers.stack(1000L, ScaleLayer.NORMAL, layerFactory, 2, contextProvider);
        layerFactory = EaseBiomeEdgeLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(1000L), layerFactory);
        _snowman = _snowman;
        _snowman = BiomeLayers.stack(1000L, ScaleLayer.NORMAL, _snowman, 2, contextProvider);
        layerFactory = AddHillsLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(1000L), layerFactory, _snowman);
        _snowman = BiomeLayers.stack(1000L, ScaleLayer.NORMAL, _snowman, 2, contextProvider);
        _snowman = BiomeLayers.stack(1000L, ScaleLayer.NORMAL, _snowman, riverSize, contextProvider);
        _snowman = NoiseToRiverLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(1L), _snowman);
        _snowman = SmoothLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(1000L), _snowman);
        layerFactory = AddSunflowerPlainsLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(1001L), layerFactory);
        for (int i = 0; i < biomeSize; ++i) {
            layerFactory = ScaleLayer.NORMAL.create((LayerSampleContext)contextProvider.apply(1000 + i), layerFactory);
            if (i == 0) {
            ...
            layerFactory = AddEdgeBiomesLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(1000L), layerFactory);
        }
        layerFactory = SmoothLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(1000L), layerFactory);
        layerFactory = AddRiversLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(100L), layerFactory, _snowman);
        layerFactory = ApplyOceanTemperatureLayer.INSTANCE.create((LayerSampleContext)contextProvider.apply(100L), layerFactory, _snowman);
        return layerFactory;
    }

    public static BiomeLayerSampler build(long seed, boolean old, int biomeSize, int riverSize) {
        int n = 25;
        LayerFactory<CachingLayerSampler> _snowman2 = BiomeLayers.build(old, biomeSize, riverSize, salt -> new CachingLayerContext(25, seed, salt));
        return new BiomeLayerSampler(_snowman2);
    }
    ...
    private static void method_31117(Int2IntOpenHashMap int2IntOpenHashMap, Category category, int n) {
