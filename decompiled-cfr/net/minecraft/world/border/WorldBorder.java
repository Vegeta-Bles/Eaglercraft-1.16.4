...
public class WorldBorder {
    ...
    public double getDistanceInsideBorder(double x, double z) {
        ...
        _snowman = this.getBoundSouth() - z;
        _snowman = x - this.getBoundWest();
        _snowman = this.getBoundEast() - x;
        _snowman = Math.min(_snowman, _snowman);
        _snowman = Math.min(_snowman, d);
        return Math.min(_snowman, _snowman);
    }
    ...
    public static class Properties {
        ...
        public static Properties fromDynamic(DynamicLike<?> dynamicLike, Properties properties) {
            ...
            _snowman = dynamicLike.get("BorderCenterZ").asDouble(properties.centerZ);
            _snowman = dynamicLike.get("BorderSize").asDouble(properties.size);
            long _snowman2 = dynamicLike.get("BorderSizeLerpTime").asLong(properties.targetRemainingTime);
            _snowman = dynamicLike.get("BorderSizeLerpTarget").asDouble(properties.targetSize);
            _snowman = dynamicLike.get("BorderSafeZone").asDouble(properties.buffer);
            _snowman = dynamicLike.get("BorderDamagePerBlock").asDouble(properties.damagePerBlock);
            int _snowman3 = dynamicLike.get("BorderWarningBlocks").asInt(properties.warningBlocks);
            int _snowman4 = dynamicLike.get("BorderWarningTime").asInt(properties.warningTime);
            return new Properties(d, _snowman, _snowman, _snowman, _snowman3, _snowman4, _snowman, _snowman2, _snowman);
        }
