...
StructureHolder {
    ...
    default public ChunkSection getHighestNonEmptySection() {
        ChunkSection[] chunkSectionArray = this.getSectionArray();
    ...
    default public void markBlockForPostProcessing(short s, int n) {
        Chunk.getList(this.getPostProcessingLists(), n).add(s);
    }
