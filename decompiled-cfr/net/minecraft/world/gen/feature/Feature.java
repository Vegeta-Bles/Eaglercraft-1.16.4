...
public abstract class Feature<FC extends FeatureConfig> {
    ...
    public Feature(Codec<FC> configCodec) {
        this.codec = configCodec.fieldOf("config").xmap(config -> new ConfiguredFeature<FeatureConfig, Feature>(this, (FeatureConfig)config), configuredFeature -> configuredFeature.config).codec();
    }
