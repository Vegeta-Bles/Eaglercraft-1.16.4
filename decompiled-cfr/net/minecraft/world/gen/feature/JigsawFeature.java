...
extends StructureFeature<StructurePoolFeatureConfig> {
    ...
    extends MarginedStructureStart<StructurePoolFeatureConfig> {
        ...
        @Override
        public void init(DynamicRegistryManager dynamicRegistryManager, ChunkGenerator chunkGenerator, StructureManager structureManager, int n, int n2, Biome biome, StructurePoolFeatureConfig structurePoolFeatureConfig) {
            BlockPos blockPos = new BlockPos(n * 16, this.jigsawFeature.structureStartY, n2 * 16);
