...
extends SurfaceBuilder<TernarySurfaceConfig> {
    ...
    public void generate(Random random, Chunk chunk, Biome biome, int n, int n2, int n3, double d, BlockState blockState, BlockState blockState2, int n4, long l, TernarySurfaceConfig ternarySurfaceConfig) {
        if (d > 1.75) {
            SurfaceBuilder.DEFAULT.generate(random, chunk, biome, n, n2, n3, d, blockState, blockState2, n4, l, SurfaceBuilder.COARSE_DIRT_CONFIG);
        } else if (d > -0.95) {
            SurfaceBuilder.DEFAULT.generate(random, chunk, biome, n, n2, n3, d, blockState, blockState2, n4, l, SurfaceBuilder.PODZOL_CONFIG);
        } else {
