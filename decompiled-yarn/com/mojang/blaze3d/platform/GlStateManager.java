...
import net.minecraft.class_4493$class_5518;
...
public class GlStateManager {
   private static final FloatBuffer MATRIX_BUFFER = GLX.make(MemoryUtil.memAllocFloat(16), _snowman -> Untracker.untrack(MemoryUtil.memAddress(_snowman)));
   ...
   private static final GlStateManager.CapabilityTracker[] LIGHT_ENABLE = IntStream.range(0, 8)
      .mapToObj(_snowman -> new GlStateManager.CapabilityTracker(16384 + _snowman))
   ...
   private static final class_4493$class_5518 field_26839 = new class_4493$class_5518();
   ...
   private static final GlStateManager.Texture2DState[] TEXTURES = IntStream.range(0, 12)
      .mapToObj(_snowman -> new GlStateManager.Texture2DState())
   ...
   public static void method_31317(int _snowman, int _snowman, int _snowman, int _snowman) {
      RenderSystem.assertThread(RenderSystem::isOnRenderThreadOrInit);
   ...
   public static void copyTexSubImage2d(int _snowman, int _snowman, int _snowman, int _snowman, int _snowman, int _snowman, int _snowman, int _snowman) {
      RenderSystem.assertThread(RenderSystem::isOnRenderThreadOrInit);
   ...
   public static void blitFramebuffer(int _snowman, int _snowman, int _snowman, int _snowman, int _snowman, int _snowman, int _snowman, int _snowman, int _snowman, int _snowman) {
      RenderSystem.assertThread(RenderSystem::isOnRenderThreadOrInit);
      switch (fboBlitMode) {
         case BASE:
   ...
   public static void setupOverlayColor(int texture, int size) {
      ...
      matrixMode(5890);
      loadIdentity();
      float _snowman = 1.0F / (float)(size - 1);
      scalef(_snowman, _snowman, _snowman);
      matrixMode(5888);
      bindTexture(texture);
   ...
   public static void setupLevelDiffuseLighting(Vector3f _snowman, Vector3f _snowman, Matrix4f _snowman) {
      RenderSystem.assertThread(RenderSystem::isOnRenderThread);
      pushMatrix();
      loadIdentity();
      enableLight(0);
      enableLight(1);
      Vector4f _snowmanxxx = new Vector4f(_snowman);
      _snowmanxxx.transform(_snowman);
      light(16384, 4611, getBuffer(_snowmanxxx.getX(), _snowmanxxx.getY(), _snowmanxxx.getZ(), 0.0F));
      float _snowmanxxxx = 0.6F;
      ...
      Vector4f _snowmanxxxxx = new Vector4f(_snowman);
      _snowmanxxxxx.transform(_snowman);
      light(16385, 4611, getBuffer(_snowmanxxxxx.getX(), _snowmanxxxxx.getY(), _snowmanxxxxx.getZ(), 0.0F));
      ...
      shadeModel(7424);
      float _snowmanxxxxxx = 0.4F;
      lightModel(2899, getBuffer(0.4F, 0.4F, 0.4F, 1.0F));
      popMatrix();
   }

   public static void setupGuiFlatDiffuseLighting(Vector3f _snowman, Vector3f _snowman) {
      RenderSystem.assertThread(RenderSystem::isOnRenderThread);
      Matrix4f _snowmanxx = new Matrix4f();
      _snowmanxx.loadIdentity();
      _snowmanxx.multiply(Matrix4f.scale(1.0F, -1.0F, 1.0F));
      _snowmanxx.multiply(Vector3f.POSITIVE_Y.getDegreesQuaternion(-22.5F));
      _snowmanxx.multiply(Vector3f.POSITIVE_X.getDegreesQuaternion(135.0F));
      setupLevelDiffuseLighting(_snowman, _snowman, _snowmanxx);
   }

   public static void setupGui3dDiffuseLighting(Vector3f _snowman, Vector3f _snowman) {
      RenderSystem.assertThread(RenderSystem::isOnRenderThread);
      Matrix4f _snowmanxx = new Matrix4f();
      _snowmanxx.loadIdentity();
      _snowmanxx.multiply(Vector3f.POSITIVE_Y.getDegreesQuaternion(62.0F));
      _snowmanxx.multiply(Vector3f.POSITIVE_X.getDegreesQuaternion(185.5F));
      _snowmanxx.multiply(Matrix4f.scale(1.0F, -1.0F, 1.0F));
      _snowmanxx.multiply(Vector3f.POSITIVE_Y.getDegreesQuaternion(-22.5F));
      _snowmanxx.multiply(Vector3f.POSITIVE_X.getDegreesQuaternion(135.0F));
      setupLevelDiffuseLighting(_snowman, _snowman, _snowmanxx);
   ...
   public static void texGenMode(GlStateManager.TexCoord coord, int mode) {
      RenderSystem.assertThread(RenderSystem::isOnRenderThread);
      GlStateManager.TexGenCoordState _snowman = getGenCoordState(coord);
      if (mode != _snowman.mode) {
         _snowman.mode = mode;
         GL11.glTexGeni(_snowman.coord, 9472, mode);
      }
   }
   ...
   public static void method_30498(int[] _snowman) {
      RenderSystem.assertThread(RenderSystem::isOnRenderThreadOrInit);
   ...
   public static void deleteTexture(int texture) {
      ...
      for (GlStateManager.Texture2DState _snowman : TEXTURES) {
         if (_snowman.boundTexture == texture) {
            _snowman.boundTexture = -1;
         }
      }
   }

   public static void method_30499(int[] _snowman) {
      RenderSystem.assertThread(RenderSystem::isOnRenderThreadOrInit);

      for (GlStateManager.Texture2DState _snowmanx : TEXTURES) {
         for (int _snowmanxx : _snowman) {
            if (_snowmanx.boundTexture == _snowmanxx) {
               _snowmanx.boundTexture = -1;
            }
         }
      }
   ...
   public static enum DstFactor {
      ...
      private DstFactor(int var3) {
         this.field_22528 = _snowman;
      }
   }
   ...
   public static enum SrcFactor {
      ...
      private SrcFactor(int var3) {
         this.field_22545 = _snowman;
      }
   }
