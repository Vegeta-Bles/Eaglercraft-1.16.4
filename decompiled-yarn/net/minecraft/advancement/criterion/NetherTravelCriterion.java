...
public class NetherTravelCriterion extends AbstractCriterion<NetherTravelCriterion.Conditions> {
   ...
   public NetherTravelCriterion.Conditions conditionsFromJson(JsonObject _snowman, EntityPredicate.Extended _snowman, AdvancementEntityPredicateDeserializer _snowman) {
      LocationPredicate _snowmanxxx = LocationPredicate.fromJson(_snowman.get("entered"));
      LocationPredicate _snowmanxxxx = LocationPredicate.fromJson(_snowman.get("exited"));
      DistancePredicate _snowmanxxxxx = DistancePredicate.fromJson(_snowman.get("distance"));
      return new NetherTravelCriterion.Conditions(_snowman, _snowmanxxx, _snowmanxxxx, _snowmanxxxxx);
   }

   public void trigger(ServerPlayerEntity player, Vec3d enteredPos) {
      this.test(player, _snowmanxx -> _snowmanxx.matches(player.getServerWorld(), enteredPos, player.getX(), player.getY(), player.getZ()));
   }
   ...
   public static class Conditions extends AbstractCriterionConditions {
      ...
      public JsonObject toJson(AdvancementEntityPredicateSerializer predicateSerializer) {
         ...
         _snowman.add("entered", this.enteredPos.toJson());
         _snowman.add("exited", this.exitedPos.toJson());
