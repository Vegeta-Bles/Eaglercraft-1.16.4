...
public class OnKilledCriterion extends AbstractCriterion<OnKilledCriterion.Conditions> {
   ...
   public OnKilledCriterion.Conditions conditionsFromJson(JsonObject _snowman, EntityPredicate.Extended _snowman, AdvancementEntityPredicateDeserializer _snowman) {
      return new OnKilledCriterion.Conditions(
         this.id, _snowman, EntityPredicate.Extended.getInJson(_snowman, "entity", _snowman), DamageSourcePredicate.fromJson(_snowman.get("killing_blow"))
      );
   }
   ...
   public void trigger(ServerPlayerEntity player, Entity entity, DamageSource killingDamage) {
      ...
      this.test(player, _snowmanxxx -> _snowmanxxx.test(player, _snowman, killingDamage));
   }
   ...
   public static class Conditions extends AbstractCriterionConditions {
      ...
      public JsonObject toJson(AdvancementEntityPredicateSerializer predicateSerializer) {
         ...
         _snowman.add("killing_blow", this.killingBlow.toJson());
         return _snowman;
      }
   }
}
