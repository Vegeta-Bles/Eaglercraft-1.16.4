...
public class AnvilBlock extends FallingBlock {
   ...
   public AnvilBlock(AbstractBlock.Settings _snowman) {
      super(_snowman);
   ...
   public NamedScreenHandlerFactory createScreenHandlerFactory(BlockState state, World world, BlockPos pos) {
      return new SimpleNamedScreenHandlerFactory((_snowmanxx, _snowmanxxx, _snowmanxxxx) -> new AnvilScreenHandler(_snowmanxx, _snowmanxxx, ScreenHandlerContext.create(world, pos)), TITLE);
   }

   @Override
   public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
      Direction _snowman = state.get(FACING);
      return _snowman.getAxis() == Direction.Axis.X ? X_AXIS_SHAPE : Z_AXIS_SHAPE;
   }
