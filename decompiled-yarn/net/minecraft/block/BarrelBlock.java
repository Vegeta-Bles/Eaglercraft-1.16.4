...
public class BarrelBlock extends BlockWithEntity {
   ...
   public BarrelBlock(AbstractBlock.Settings _snowman) {
      super(_snowman);
   ...
   public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
      if (world.isClient) {
         ...
         if (_snowman instanceof BarrelBlockEntity) {
            player.openHandledScreen((BarrelBlockEntity)_snowman);
   ...
   public void scheduledTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
      BlockEntity _snowman = world.getBlockEntity(pos);
      if (_snowman instanceof BarrelBlockEntity) {
         ((BarrelBlockEntity)_snowman).tick();
      }
   }
   ...
   public void onPlaced(World world, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack itemStack) {
      if (itemStack.hasCustomName()) {
         BlockEntity _snowman = world.getBlockEntity(pos);
         if (_snowman instanceof BarrelBlockEntity) {
            ((BarrelBlockEntity)_snowman).setCustomName(itemStack.getName());
         }
      }
   }
