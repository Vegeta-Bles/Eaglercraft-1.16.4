...
public class Blocks {
   ...
   public static final Block FIRE = register(
      "fire",
      new FireBlock(
         AbstractBlock.Settings.of(Material.FIRE, MaterialColor.LAVA).noCollision().breakInstantly().luminance(state -> 15).sounds(BlockSoundGroup.WOOL)
      )
   );
   ...
   public static final Block SPRUCE_SIGN = register(
      "spruce_sign",
      new SignBlock(
         AbstractBlock.Settings.of(Material.WOOD, SPRUCE_LOG.getDefaultMaterialColor()).noCollision().strength(1.0F).sounds(BlockSoundGroup.WOOD),
         SignType.SPRUCE
      )
   );
   ...
   public static final Block JUNGLE_SIGN = register(
      "jungle_sign",
      new SignBlock(
         AbstractBlock.Settings.of(Material.WOOD, JUNGLE_LOG.getDefaultMaterialColor()).noCollision().strength(1.0F).sounds(BlockSoundGroup.WOOD),
         SignType.JUNGLE
      )
   );
   ...
   public static final Block OAK_FENCE = register(
      "oak_fence",
      new FenceBlock(AbstractBlock.Settings.of(Material.WOOD, OAK_PLANKS.getDefaultMaterialColor()).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD))
   );
   ...
   public static final Block IRON_BARS = register(
      "iron_bars",
      new PaneBlock(
         AbstractBlock.Settings.of(Material.METAL, MaterialColor.CLEAR).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).nonOpaque()
      )
   );
   public static final Block CHAIN = register(
      "chain",
      new ChainBlock(
         AbstractBlock.Settings.of(Material.METAL, MaterialColor.CLEAR).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.CHAIN).nonOpaque()
      )
   );
   ...
   public static final Block COMMAND_BLOCK = register(
      "command_block",
      new CommandBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.BROWN).requiresTool().strength(-1.0F, 3600000.0F).dropsNothing())
   );
   public static final Block BEACON = register(
      "beacon",
      new BeaconBlock(
         AbstractBlock.Settings.of(Material.GLASS, MaterialColor.DIAMOND).strength(3.0F).luminance(state -> 15).nonOpaque().solidBlock(Blocks::never)
      )
   );
   ...
   public static final Block SKELETON_WALL_SKULL = register(
      "skeleton_wall_skull",
      new WallSkullBlock(SkullBlock.Type.SKELETON, AbstractBlock.Settings.of(Material.SUPPORTED).strength(1.0F).dropsLike(SKELETON_SKULL))
   );
   ...
   public static final Block ANVIL = register(
      "anvil",
      new AnvilBlock(
         AbstractBlock.Settings.of(Material.REPAIR_STATION, MaterialColor.IRON).requiresTool().strength(5.0F, 1200.0F).sounds(BlockSoundGroup.ANVIL)
      )
   );
   ...
   public static final Block REDSTONE_BLOCK = register(
      "redstone_block",
      new RedstoneBlock(
         AbstractBlock.Settings.of(Material.METAL, MaterialColor.LAVA)
            .requiresTool()
            .strength(5.0F, 6.0F)
   ...
   public static final Block HOPPER = register(
      "hopper",
      new HopperBlock(
         AbstractBlock.Settings.of(Material.METAL, MaterialColor.STONE).requiresTool().strength(3.0F, 4.8F).sounds(BlockSoundGroup.METAL).nonOpaque()
      )
   );
   ...
   public static final Block SEA_LANTERN = register(
      "sea_lantern",
      new Block(AbstractBlock.Settings.of(Material.GLASS, MaterialColor.QUARTZ).strength(0.3F).sounds(BlockSoundGroup.GLASS).luminance(state -> 15))
   );
   ...
   public static final Block END_ROD = register(
      "end_rod",
      new EndRodBlock(AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().luminance(state -> 14).sounds(BlockSoundGroup.WOOD).nonOpaque())
   );
   ...
   public static final Block LIGHT_BLUE_CONCRETE_POWDER = register(
      ...
      new ConcretePowderBlock(
         LIGHT_BLUE_CONCRETE, AbstractBlock.Settings.of(Material.AGGREGATE, DyeColor.LIGHT_BLUE).strength(0.5F).sounds(BlockSoundGroup.SAND)
      )
   );
   ...
   public static final Block LIGHT_GRAY_CONCRETE_POWDER = register(
      ...
      new ConcretePowderBlock(
         LIGHT_GRAY_CONCRETE, AbstractBlock.Settings.of(Material.AGGREGATE, DyeColor.LIGHT_GRAY).strength(0.5F).sounds(BlockSoundGroup.SAND)
      )
   );
   ...
   public static final Block BRAIN_CORAL_BLOCK = register(
      ...
      new CoralBlockBlock(
         ...
         AbstractBlock.Settings.of(Material.STONE, MaterialColor.PINK).requiresTool().strength(1.5F, 6.0F).sounds(BlockSoundGroup.CORAL)
      )
   );
   public static final Block BUBBLE_CORAL_BLOCK = register(
      ...
      new CoralBlockBlock(
         ...
         AbstractBlock.Settings.of(Material.STONE, MaterialColor.PURPLE).requiresTool().strength(1.5F, 6.0F).sounds(BlockSoundGroup.CORAL)
      )
   );
   ...
   public static final Block HORN_CORAL_BLOCK = register(
      ...
      new CoralBlockBlock(
         ...
         AbstractBlock.Settings.of(Material.STONE, MaterialColor.YELLOW).requiresTool().strength(1.5F, 6.0F).sounds(BlockSoundGroup.CORAL)
      )
   );
   ...
   public static final Block DEAD_BRAIN_CORAL_FAN = register(
      ...
      new DeadCoralFanBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).requiresTool().noCollision().breakInstantly())
   );
   ...
   public static final Block BLAST_FURNACE = register(
      "blast_furnace",
      new BlastFurnaceBlock(AbstractBlock.Settings.of(Material.STONE).requiresTool().strength(3.5F).luminance(createLightLevelFromBlockState(13)))
   );
   ...
   public static final Block GRINDSTONE = register(
      "grindstone",
      new GrindstoneBlock(
         AbstractBlock.Settings.of(Material.REPAIR_STATION, MaterialColor.IRON).requiresTool().strength(2.0F, 6.0F).sounds(BlockSoundGroup.STONE)
      )
   );
   ...
   public static final Block STONECUTTER = register(
      "stonecutter", new StonecutterBlock(AbstractBlock.Settings.of(Material.STONE).requiresTool().strength(3.5F))
   );
   ...
   public static final Block LANTERN = register(
      "lantern",
      new LanternBlock(
         AbstractBlock.Settings.of(Material.METAL).requiresTool().strength(3.5F).sounds(BlockSoundGroup.LANTERN).luminance(state -> 15).nonOpaque()
      )
   );
   public static final Block SOUL_LANTERN = register(
      "soul_lantern",
      new LanternBlock(
         AbstractBlock.Settings.of(Material.METAL).requiresTool().strength(3.5F).sounds(BlockSoundGroup.LANTERN).luminance(state -> 10).nonOpaque()
      )
   );
   ...
   public static final Block NETHER_SPROUTS = register(
      "nether_sprouts",
      new SproutsBlock(
         AbstractBlock.Settings.of(Material.NETHER_SHOOTS, MaterialColor.CYAN).noCollision().breakInstantly().sounds(BlockSoundGroup.NETHER_SPROUTS)
      )
   );
   ...
   public static final Block WARPED_FENCE_GATE = register(
      "warped_fence_gate",
      new FenceGateBlock(
         AbstractBlock.Settings.of(Material.NETHER_WOOD, WARPED_PLANKS.getDefaultMaterialColor()).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD)
      )
   );
   ...
   public static final Block POLISHED_BLACKSTONE_BRICK_STAIRS = register(
      ...
      new StairsBlock(POLISHED_BLACKSTONE_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(POLISHED_BLACKSTONE_BRICKS))
   );
   ...
   private static ToIntFunction<BlockState> createLightLevelFromBlockState(int litLevel) {
      return _snowmanx -> _snowmanx.get(Properties.LIT) ? litLevel : 0;
   }
   ...
   private static BedBlock createBedBlock(DyeColor color) {
      return new BedBlock(
         color,
         AbstractBlock.Settings.of(Material.WOOL, _snowmanx -> _snowmanx.get(BedBlock.PART) == BedPart.FOOT ? color.getMaterialColor() : MaterialColor.WEB)
            .sounds(BlockSoundGroup.WOOD)
            .strength(0.2F)
            .nonOpaque()
      );
   ...
   private static PillarBlock createLogBlock(MaterialColor topMaterialColor, MaterialColor sideMaterialColor) {
      return new PillarBlock(
         AbstractBlock.Settings.of(Material.WOOD, _snowmanxx -> _snowmanxx.get(PillarBlock.AXIS) == Direction.Axis.Y ? topMaterialColor : sideMaterialColor)
            .strength(2.0F)
            .sounds(BlockSoundGroup.WOOD)
      );
   }
   ...
   private static Block createNetherStemBlock(MaterialColor materialColor) {
      return new PillarBlock(AbstractBlock.Settings.of(Material.NETHER_WOOD, _snowmanx -> materialColor).strength(2.0F).sounds(BlockSoundGroup.NETHER_STEM));
   }
   ...
   private static ShulkerBoxBlock createShulkerBoxBlock(DyeColor color, AbstractBlock.Settings settings) {
      AbstractBlock.ContextPredicate _snowman = (_snowmanx, _snowmanxx, _snowmanxxx) -> {
         BlockEntity _snowmanxxx = _snowmanxx.getBlockEntity(_snowmanxxx);
         if (!(_snowmanxxx instanceof ShulkerBoxBlockEntity)) {
            return true;
         } else {
            ShulkerBoxBlockEntity _snowmanxxxx = (ShulkerBoxBlockEntity)_snowmanxxx;
            return _snowmanxxxx.suffocates();
         }
      };
      return new ShulkerBoxBlock(color, settings.strength(2.0F).dynamicBounds().nonOpaque().suffocates(_snowman).blockVision(_snowman));
   }

   private static PistonBlock createPistonBlock(boolean sticky) {
      AbstractBlock.ContextPredicate _snowman = (_snowmanx, _snowmanxx, _snowmanxxx) -> !_snowmanx.get(PistonBlock.EXTENDED);
      return new PistonBlock(sticky, AbstractBlock.Settings.of(Material.PISTON).strength(1.5F).solidBlock(Blocks::never).suffocates(_snowman).blockVision(_snowman));
   }
   ...
   static {
      for (Block _snowman : Registry.BLOCK) {
         ...
         while (var2.hasNext()) {
            ...
            Block.STATE_IDS.add(_snowmanx);
         }

         _snowman.getLootTableId();
      }
   }
}
