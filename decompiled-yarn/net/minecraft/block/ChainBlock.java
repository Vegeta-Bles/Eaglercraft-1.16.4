...
public class ChainBlock extends PillarBlock implements Waterloggable {
   ...
   public ChainBlock(AbstractBlock.Settings _snowman) {
      super(_snowman);
   ...
   public BlockState getPlacementState(ItemPlacementContext ctx) {
      ...
      boolean _snowmanx = _snowman.getFluid() == Fluids.WATER;
      return super.getPlacementState(ctx).with(WATERLOGGED, Boolean.valueOf(_snowmanx));
   }
