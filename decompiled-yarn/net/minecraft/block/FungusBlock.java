...
public class FungusBlock extends PlantBlock implements Fertilizable {
   ...
   protected FungusBlock(AbstractBlock.Settings settings, Supplier<ConfiguredFeature<HugeFungusFeatureConfig, ?>> _snowman) {
      super(settings);
      this.field_22135 = _snowman;
   }
   ...
   public boolean isFertilizable(BlockView world, BlockPos pos, BlockState state, boolean isClient) {
      Block _snowman = ((HugeFungusFeatureConfig)this.field_22135.get().config).validBaseBlock.getBlock();
      Block _snowmanx = world.getBlockState(pos.down()).getBlock();
