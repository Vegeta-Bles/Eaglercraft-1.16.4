...
public class GrindstoneBlock extends WallMountedBlock {
   ...
   protected GrindstoneBlock(AbstractBlock.Settings _snowman) {
      super(_snowman);
   ...
   public NamedScreenHandlerFactory createScreenHandlerFactory(BlockState state, World world, BlockPos pos) {
      return new SimpleNamedScreenHandlerFactory((_snowmanxx, _snowmanxxx, _snowmanxxxx) -> new GrindstoneScreenHandler(_snowmanxx, _snowmanxxx, ScreenHandlerContext.create(world, pos)), TITLE);
   }
