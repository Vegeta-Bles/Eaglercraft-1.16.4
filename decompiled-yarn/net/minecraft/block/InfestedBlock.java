...
public class InfestedBlock extends Block {
   ...
   private void spawnSilverfish(ServerWorld _snowman, BlockPos pos) {
      SilverfishEntity _snowmanx = EntityType.SILVERFISH.create(_snowman);
      _snowmanx.refreshPositionAndAngles((double)pos.getX() + 0.5, (double)pos.getY(), (double)pos.getZ() + 0.5, 0.0F, 0.0F);
      _snowman.spawnEntity(_snowmanx);
      _snowmanx.playSpawnEffects();
   }
