...
public class MagmaBlock extends Block {
   public MagmaBlock(AbstractBlock.Settings _snowman) {
      super(_snowman);
   }
   ...
   public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
      ...
      if (world.getFluidState(pos).isIn(FluidTags.WATER)) {
         ...
         world.spawnParticles(ParticleTypes.LARGE_SMOKE, (double)_snowman.getX() + 0.5, (double)_snowman.getY() + 0.25, (double)_snowman.getZ() + 0.5, 8, 0.5, 0.25, 0.5, 0.0);
      }
   }
