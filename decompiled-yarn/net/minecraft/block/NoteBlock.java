...
public class NoteBlock extends Block {
   ...
   public NoteBlock(AbstractBlock.Settings _snowman) {
      super(_snowman);
   ...
   public boolean onSyncedBlockEvent(BlockState state, World world, BlockPos pos, int type, int data) {
      int _snowman = state.get(NOTE);
      float _snowmanx = (float)Math.pow(2.0, (double)(_snowman - 12) / 12.0);
      world.playSound(null, pos, state.get(INSTRUMENT).getSound(), SoundCategory.RECORDS, 3.0F, _snowmanx);
      world.addParticle(ParticleTypes.NOTE, (double)pos.getX() + 0.5, (double)pos.getY() + 1.2, (double)pos.getZ() + 0.5, (double)_snowman / 24.0, 0.0, 0.0);
      return true;
   }
