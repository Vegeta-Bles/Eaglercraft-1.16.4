...
public class WallSignBlock extends AbstractSignBlock {
   ...
   public WallSignBlock(AbstractBlock.Settings _snowman, SignType _snowman) {
   ...
   public BlockState getPlacementState(ItemPlacementContext ctx) {
      ...
      WorldView _snowmanxx = ctx.getWorld();
      BlockPos _snowmanxxx = ctx.getBlockPos();
      Direction[] _snowmanxxxx = ctx.getPlacementDirections();

      for (Direction _snowmanxxxxx : _snowmanxxxx) {
         if (_snowmanxxxxx.getAxis().isHorizontal()) {
            Direction _snowmanxxxxxx = _snowmanxxxxx.getOpposite();
            _snowman = _snowman.with(FACING, _snowmanxxxxxx);
            if (_snowman.canPlaceAt(_snowmanxx, _snowmanxxx)) {
