...
public class BlockEntityType<T extends BlockEntity> {
   ...
   public static final BlockEntityType<PistonBlockEntity> PISTON = create(
      "piston", BlockEntityType.Builder.create(PistonBlockEntity::new, Blocks.MOVING_PISTON)
   );
   ...
   @Nullable
   public static Identifier getId(BlockEntityType<?> _snowman) {
      return Registry.BLOCK_ENTITY_TYPE.getId(_snowman);
   }

   private static <T extends BlockEntity> BlockEntityType<T> create(String _snowman, BlockEntityType.Builder<T> _snowman) {
      if (_snowman.blocks.isEmpty()) {
         LOGGER.warn("Block entity type {} requires at least one valid block to be defined!", _snowman);
      }

      Type<?> _snowmanxx = Util.getChoiceType(TypeReferences.BLOCK_ENTITY, _snowman);
      return Registry.register(Registry.BLOCK_ENTITY_TYPE, _snowman, _snowman.build(_snowmanxx));
   }
   ...
   public T get(BlockView world, BlockPos pos) {
      ...
      return (T)(_snowman != null && _snowman.getType() == this ? _snowman : null);
   }
   ...
   public static final class Builder<T extends BlockEntity> {
      ...
      public BlockEntityType<T> build(Type<?> _snowman) {
         return new BlockEntityType<>(this.supplier, this.blocks, _snowman);
      }
   }
}
