...
public class MobSpawnerBlockEntity extends BlockEntity implements Tickable {
   private final MobSpawnerLogic logic = new MobSpawnerLogic() {
      ...
      public void setSpawnEntry(MobSpawnerEntry spawnEntry) {
         ...
         if (this.getWorld() != null) {
            BlockState _snowman = this.getWorld().getBlockState(this.getPos());
            this.getWorld().updateListeners(MobSpawnerBlockEntity.this.pos, _snowman, _snowman, 4);
         }
      }
   };
   ...
   public CompoundTag toInitialChunkDataTag() {
      ...
      _snowman.remove("SpawnPotentials");
      return _snowman;
   }
