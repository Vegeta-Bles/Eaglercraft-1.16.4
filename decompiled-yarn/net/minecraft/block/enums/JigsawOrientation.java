...
public enum JigsawOrientation implements StringIdentifiable {
   ...
   public static JigsawOrientation byDirections(Direction facing, Direction rotation) {
      int _snowman = getIndex(rotation, facing);
      return (JigsawOrientation)BY_INDEX.get(_snowman);
   }
   ...
   static {
      for (JigsawOrientation _snowman : values()) {
         BY_INDEX.put(getIndex(_snowman.rotation, _snowman.facing), _snowman);
      }
   }
}
