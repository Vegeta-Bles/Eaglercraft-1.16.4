...
public class GlDebug {
   ...
   private static void info(int source, int type, int id, int severity, int _snowman, long _snowman, long _snowman) {
      LOGGER.info(
         ...
         GLDebugMessageCallback.getMessage(_snowman, _snowman)
      );
   }

   private static void registerConstant(int constant, String description) {
      CONSTANTS.merge(constant, description, (_snowman, _snowmanx) -> _snowman + "/" + _snowmanx);
   }
   ...
   public static void enableDebug(int verbosity, boolean sync) {
      ...
      if (verbosity > 0) {
         ...
         if (_snowman.GL_KHR_debug) {
            ...
            for (int _snowmanx = 0; _snowmanx < KHR_VERBOSITY_LEVELS.size(); _snowmanx++) {
               boolean _snowmanxx = _snowmanx < verbosity;
               KHRDebug.glDebugMessageControl(4352, 4352, KHR_VERBOSITY_LEVELS.get(_snowmanx), (int[])null, _snowmanxx);
            }
            ...
            for (int _snowmanx = 0; _snowmanx < ARB_VERBOSITY_LEVELS.size(); _snowmanx++) {
               boolean _snowmanxx = _snowmanx < verbosity;
               ARBDebugOutput.glDebugMessageControlARB(4352, 4352, ARB_VERBOSITY_LEVELS.get(_snowmanx), (int[])null, _snowmanxx);
            }
