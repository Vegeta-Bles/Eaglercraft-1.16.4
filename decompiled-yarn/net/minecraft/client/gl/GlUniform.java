...
public class GlUniform extends Uniform implements AutoCloseable {
   ...
   public static int getUniformLocation(int _snowman, CharSequence _snowman) {
      return GlStateManager.getUniformLocation(_snowman, _snowman);
   }

   public static void uniform1(int _snowman, int _snowman) {
      RenderSystem.glUniform1i(_snowman, _snowman);
   }

   public static int getAttribLocation(int _snowman, CharSequence _snowman) {
      return GlStateManager.getAttribLocation(_snowman, _snowman);
   }
   ...
   public void setLoc(int _snowman) {
      this.loc = _snowman;
   }
   ...
   public void set(float value1) {
      ((Buffer)this.floatData).position(0);
   ...
   public void set(int value1, int value2, int value3, int value4) {
      ((Buffer)this.intData).position(0);
      if (this.dataType >= 0) {
