...
public class ClientBossBar extends BossBar {
   ...
   public float getPercent() {
      long _snowman = Util.getMeasuringTimeMs() - this.timeHealthSet;
      float _snowmanx = MathHelper.clamp((float)_snowman / 100.0F, 0.0F, 1.0F);
      return MathHelper.lerp(_snowmanx, this.percent, this.healthLatest);
   }
