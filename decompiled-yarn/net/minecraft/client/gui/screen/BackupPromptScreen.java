...
public class BackupPromptScreen extends Screen {
   ...
   protected void init() {
      ...
      int _snowman = (this.wrappedText.method_30887() + 1) * 9;
      this.addButton(
         new ButtonWidget(
            this.width / 2 - 155,
            100 + _snowman,
            ...
            _snowmanx -> this.callback.proceed(true, this.eraseCacheCheckbox.isChecked())
         )
      );
      this.addButton(
         new ButtonWidget(
            ...
            _snowmanx -> this.callback.proceed(false, this.eraseCacheCheckbox.isChecked())
         )
      );
      this.addButton(new ButtonWidget(this.width / 2 - 155 + 80, 124 + _snowman, 150, 20, ScreenTexts.CANCEL, _snowmanx -> this.client.openScreen(this.parent)));
      this.eraseCacheCheckbox = new CheckboxWidget(this.width / 2 - 155 + 80, 76 + _snowman, 150, 20, new TranslatableText("selectWorld.backupEraseCache"), false);
