...
public class ConfirmChatLinkScreen extends ConfirmScreen {
   ...
   protected void init() {
      ...
      this.buttons.clear();
      this.children.clear();
      this.addButton(new ButtonWidget(this.width / 2 - 50 - 105, this.height / 6 + 96, 100, 20, this.yesTranslated, _snowman -> this.callback.accept(true)));
      this.addButton(new ButtonWidget(this.width / 2 - 50, this.height / 6 + 96, 100, 20, this.copy, _snowman -> {
         this.copyToClipboard();
         this.callback.accept(false);
      }));
      this.addButton(new ButtonWidget(this.width / 2 - 50 + 105, this.height / 6 + 96, 100, 20, this.noTranslated, _snowman -> this.callback.accept(false)));
   }
