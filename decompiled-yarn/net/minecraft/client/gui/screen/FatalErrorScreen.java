...
public class FatalErrorScreen extends Screen {
   ...
   public FatalErrorScreen(Text title, Text _snowman) {
      super(title);
   ...
   protected void init() {
      super.init();
      this.addButton(new ButtonWidget(this.width / 2 - 100, 140, 200, 20, ScreenTexts.CANCEL, _snowman -> this.client.openScreen(null)));
   }
