...
public class NoticeScreen extends Screen {
   ...
   public NoticeScreen(Runnable actionHandler, Text title, Text notice, Text _snowman) {
      super(title);
      this.actionHandler = actionHandler;
      this.notice = notice;
      this.buttonString = _snowman;
   }

   @Override
   protected void init() {
      super.init();
      this.addButton(new ButtonWidget(this.width / 2 - 100, this.height / 6 + 168, 200, 20, this.buttonString, _snowman -> this.actionHandler.run()));
