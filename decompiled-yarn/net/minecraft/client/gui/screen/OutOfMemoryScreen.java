...
public class OutOfMemoryScreen extends Screen {
   ...
   protected void init() {
      this.addButton(
         new ButtonWidget(
            this.width / 2 - 155, this.height / 4 + 120 + 12, 150, 20, new TranslatableText("gui.toTitle"), _snowman -> this.client.openScreen(new TitleScreen())
         )
      );
      this.addButton(
         new ButtonWidget(this.width / 2 - 155 + 160, this.height / 4 + 120 + 12, 150, 20, new TranslatableText("menu.quit"), _snowman -> this.client.scheduleStop())
      );
   }
