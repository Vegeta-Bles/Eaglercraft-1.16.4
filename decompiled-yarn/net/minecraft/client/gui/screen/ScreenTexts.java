...
public class ScreenTexts {
   ...
   public static MutableText composeToggleText(Text _snowman, boolean value) {
      return new TranslatableText(value ? "options.on.composed" : "options.off.composed", _snowman);
   }
}
