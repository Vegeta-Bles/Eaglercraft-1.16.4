...
public class MultiplayerWarningScreen extends Screen {
   ...
   protected void init() {
      ...
      int _snowman = (this.lines.method_30887() + 1) * 9 * 2;
      this.addButton(new ButtonWidget(this.width / 2 - 155, 100 + _snowman, 150, 20, ScreenTexts.PROCEED, _snowmanx -> {
      ...
      this.addButton(new ButtonWidget(this.width / 2 - 155 + 160, 100 + _snowman, 150, 20, ScreenTexts.BACK, _snowmanx -> this.client.openScreen(this.parent)));
      this.checkbox = new CheckboxWidget(this.width / 2 - 155 + 80, 76 + _snowman, 150, 20, CHECK_MESSAGE, false);
