...
public class SelectWorldScreen extends Screen {
   ...
   protected void init() {
      ...
      this.searchBox.setChangedListener(_snowman -> this.levelList.filter(() -> _snowman, false));
      ...
      this.selectButton = this.addButton(
         new ButtonWidget(
            ...
            _snowman -> this.levelList.method_20159().ifPresent(WorldListWidget.Entry::play)
         )
      );
      this.addButton(
         new ButtonWidget(
            ...
            _snowman -> this.client.openScreen(CreateWorldScreen.method_31130(this))
         )
      );
      this.editButton = this.addButton(
         new ButtonWidget(
            ...
            _snowman -> this.levelList.method_20159().ifPresent(WorldListWidget.Entry::edit)
         )
      );
      this.deleteButton = this.addButton(
         new ButtonWidget(
            ...
            _snowman -> this.levelList.method_20159().ifPresent(WorldListWidget.Entry::delete)
         )
      );
      this.recreateButton = this.addButton(
         new ButtonWidget(
            ...
            _snowman -> this.levelList.method_20159().ifPresent(WorldListWidget.Entry::recreate)
         )
      );
      this.addButton(new ButtonWidget(this.width / 2 + 82, this.height - 28, 72, 20, ScreenTexts.CANCEL, _snowman -> this.client.openScreen(this.parent)));
   ...
   public void setTooltip(List<OrderedText> _snowman) {
