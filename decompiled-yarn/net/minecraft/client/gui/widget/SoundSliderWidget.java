...
public class SoundSliderWidget extends OptionSliderWidget {
   ...
   protected void updateMessage() {
      Text _snowman = (Text)((float)this.value == (float)this.getYImage(false) ? ScreenTexts.OFF : new LiteralText((int)(this.value * 100.0) + "%"));
      this.setMessage(new TranslatableText("soundCategory." + this.category.getName()).append(": ").append(_snowman));
   }
