...
public class BooleanOption extends Option {
   ...
   public BooleanOption(String _snowman, @Nullable Text _snowman, Predicate<GameOptions> _snowman, BiConsumer<GameOptions, Boolean> _snowman) {
      super(_snowman);
      this.getter = _snowman;
      this.setter = _snowman;
      this.field_26923 = _snowman;
   }
