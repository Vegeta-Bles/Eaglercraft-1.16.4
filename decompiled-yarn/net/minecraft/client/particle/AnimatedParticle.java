...
public class AnimatedParticle extends SpriteBillboardParticle {
   ...
   public void setColor(int rgbHex) {
      float _snowman = (float)((rgbHex & 0xFF0000) >> 16) / 255.0F;
      float _snowmanx = (float)((rgbHex & 0xFF00) >> 8) / 255.0F;
      float _snowmanxx = (float)((rgbHex & 0xFF) >> 0) / 255.0F;
      float _snowmanxxx = 1.0F;
      this.setColor(_snowman * 1.0F, _snowmanx * 1.0F, _snowmanxx * 1.0F);
   }
