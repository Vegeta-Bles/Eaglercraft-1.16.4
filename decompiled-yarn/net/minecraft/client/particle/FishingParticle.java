...
public class FishingParticle extends SpriteBillboardParticle {
   ...
   public void tick() {
      ...
      if (this.maxAge-- <= 0) {
         ...
         this.setBoundingBoxSpacing(_snowmanx, _snowmanx);
         this.setSprite(this.spriteProvider.getSprite(_snowman % 4, 4));
      }
   }
   ...
   public static class Factory implements ParticleFactory<DefaultParticleType> {
      ...
      public Particle createParticle(DefaultParticleType _snowman, ClientWorld _snowman, double _snowman, double _snowman, double _snowman, double _snowman, double _snowman, double _snowman) {
         return new FishingParticle(_snowman, _snowman, _snowman, _snowman, _snowman, _snowman, _snowman, this.spriteProvider);
      }
   }
}
