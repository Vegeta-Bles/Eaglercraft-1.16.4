...
public class WaterBubbleParticle extends SpriteBillboardParticle {
   private WaterBubbleParticle(ClientWorld world, double x, double y, double z, double _snowman, double _snowman, double _snowman) {
      super(world, x, y, z);
   ...
   public static class Factory implements ParticleFactory<DefaultParticleType> {
      ...
      public Particle createParticle(DefaultParticleType _snowman, ClientWorld _snowman, double _snowman, double _snowman, double _snowman, double _snowman, double _snowman, double _snowman) {
         WaterBubbleParticle _snowmanxxxxxxxx = new WaterBubbleParticle(_snowman, _snowman, _snowman, _snowman, _snowman, _snowman, _snowman);
