...
public class RealmsGenericErrorScreen extends RealmsScreen {
   ...
   private void errorMessage(RealmsServiceException realmsServiceException) {
      if (realmsServiceException.errorCode == -1) {
         ...
         String _snowman = "mco.errorMessage." + realmsServiceException.errorCode;
         this.line2 = (Text)(I18n.hasTranslation(_snowman) ? new TranslatableText(_snowman) : Text.of(realmsServiceException.errorMsg));
      }
   }
   ...
   public void init() {
      ...
      this.addButton(new ButtonWidget(this.width / 2 - 100, this.height - 52, 200, 20, new LiteralText("Ok"), _snowman -> this.client.openScreen(this.parent)));
   }
