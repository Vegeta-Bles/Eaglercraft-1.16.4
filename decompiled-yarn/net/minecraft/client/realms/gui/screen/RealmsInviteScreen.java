...
public class RealmsInviteScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addButton(new ButtonWidget(this.width / 2 - 100, row(10), 200, 20, new TranslatableText("mco.configure.world.buttons.invite"), _snowman -> this.onInvite()));
      this.addButton(new ButtonWidget(this.width / 2 - 100, row(12), 200, 20, ScreenTexts.CANCEL, _snowman -> this.client.openScreen(this.parent)));
   }
   ...
   private void onInvite() {
      ...
      if (this.field_22696.getText() != null && !this.field_22696.getText().isEmpty()) {
         try {
            RealmsServer _snowmanx = _snowman.invite(this.serverData.id, this.field_22696.getText().trim());
            if (_snowmanx != null) {
               this.serverData.players = _snowmanx.players;
   ...
   private void showError(Text _snowman) {
      this.errorMsg = _snowman;
