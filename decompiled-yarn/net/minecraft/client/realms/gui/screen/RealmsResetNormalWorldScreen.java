...
public class RealmsResetNormalWorldScreen extends RealmsScreen {
   ...
   public RealmsResetNormalWorldScreen(RealmsResetWorldScreen parent, Text _snowman) {
      this.parent = parent;
      this.field_24206 = _snowman;
   }
   ...
   public void init() {
      ...
      this.addButton(new ButtonWidget(this.width / 2 - 102, row(4), 205, 20, this.method_27458(), _snowman -> {
         this.levelTypeIndex = (this.levelTypeIndex + 1) % field_24205.length;
         _snowman.setMessage(this.method_27458());
      }));
      this.addButton(new ButtonWidget(this.width / 2 - 102, row(6) - 2, 205, 20, this.method_27459(), _snowman -> {
         this.generateStructures = !this.generateStructures;
         _snowman.setMessage(this.method_27459());
      }));
      this.addButton(
         new ButtonWidget(
            this.width / 2 - 102,
            ...
            20,
            this.field_24206,
            _snowman -> this.parent.resetWorld(new RealmsResetWorldScreen.ResetWorldInfo(this.seedEdit.getText(), this.levelTypeIndex, this.generateStructures))
         )
      );
      this.addButton(new ButtonWidget(this.width / 2 + 8, row(12), 97, 20, ScreenTexts.BACK, _snowman -> this.client.openScreen(this.parent)));
      this.narrateLabels();
   }
