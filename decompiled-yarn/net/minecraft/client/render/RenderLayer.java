...
public abstract class RenderLayer extends RenderPhase {
   ...
   public static RenderLayer getArmorCutoutNoCull(Identifier texture) {
      RenderLayer.MultiPhaseParameters _snowman = RenderLayer.MultiPhaseParameters.builder()
         ...
         .layering(VIEW_OFFSET_Z_LAYERING)
         .build(true);
      return of("armor_cutout_no_cull", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, true, false, _snowman);
   }
   ...
   public static RenderLayer getEntitySolid(Identifier texture) {
      RenderLayer.MultiPhaseParameters _snowman = RenderLayer.MultiPhaseParameters.builder()
         ...
         .overlay(ENABLE_OVERLAY_COLOR)
         .build(true);
      return of("entity_solid", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, true, false, _snowman);
   }
   ...
   public static RenderLayer getEntityCutout(Identifier texture) {
      RenderLayer.MultiPhaseParameters _snowman = RenderLayer.MultiPhaseParameters.builder()
         ...
         .overlay(ENABLE_OVERLAY_COLOR)
         .build(true);
      return of("entity_cutout", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, true, false, _snowman);
   }
   ...
   public static RenderLayer getEntityCutoutNoCull(Identifier texture, boolean affectsOutline) {
      ...
      return of("entity_cutout_no_cull", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, true, false, _snowman);
   }
   ...
   public static RenderLayer getEntityCutoutNoCullZOffset(Identifier texture, boolean affectsOutline) {
      RenderLayer.MultiPhaseParameters _snowman = RenderLayer.MultiPhaseParameters.builder()
         ...
         .layering(VIEW_OFFSET_Z_LAYERING)
         .build(affectsOutline);
      return of("entity_cutout_no_cull_z_offset", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, true, false, _snowman);
   }
   ...
   public static RenderLayer getItemEntityTranslucentCull(Identifier texture) {
      RenderLayer.MultiPhaseParameters _snowman = RenderLayer.MultiPhaseParameters.builder()
         ...
         .build(true);
      return of("item_entity_translucent_cull", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, true, true, _snowman);
   }
   ...
   public static RenderLayer getEntityTranslucentCull(Identifier texture) {
      RenderLayer.MultiPhaseParameters _snowman = RenderLayer.MultiPhaseParameters.builder()
         ...
         .overlay(ENABLE_OVERLAY_COLOR)
         .build(true);
      return of("entity_translucent_cull", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, true, true, _snowman);
   }
   ...
   public static RenderLayer getEntityTranslucent(Identifier texture, boolean affectsOutline) {
      RenderLayer.MultiPhaseParameters _snowman = RenderLayer.MultiPhaseParameters.builder()
         ...
         .overlay(ENABLE_OVERLAY_COLOR)
         .build(affectsOutline);
      return of("entity_translucent", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, true, true, _snowman);
   }
   ...
   public static RenderLayer getEntitySmoothCutout(Identifier texture) {
      RenderLayer.MultiPhaseParameters _snowman = RenderLayer.MultiPhaseParameters.builder()
         ...
         .lightmap(ENABLE_LIGHTMAP)
         .build(true);
      return of("entity_smooth_cutout", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, _snowman);
   }
   ...
   public static RenderLayer getBeaconBeam(Identifier texture, boolean translucent) {
      RenderLayer.MultiPhaseParameters _snowman = RenderLayer.MultiPhaseParameters.builder()
         ...
         .fog(NO_FOG)
         .build(false);
      return of("beacon_beam", VertexFormats.POSITION_COLOR_TEXTURE_LIGHT_NORMAL, 7, 256, false, true, _snowman);
   }
   ...
   public static RenderLayer getEntityDecal(Identifier texture) {
      RenderLayer.MultiPhaseParameters _snowman = RenderLayer.MultiPhaseParameters.builder()
         ...
         .overlay(ENABLE_OVERLAY_COLOR)
         .build(false);
      return of("entity_decal", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, _snowman);
   }
   ...
   public static RenderLayer getEntityNoOutline(Identifier texture) {
      RenderLayer.MultiPhaseParameters _snowman = RenderLayer.MultiPhaseParameters.builder()
         ...
         .writeMaskState(COLOR_MASK)
         .build(false);
      return of("entity_no_outline", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, false, true, _snowman);
   }
   ...
   public static RenderLayer getEntityShadow(Identifier texture) {
      RenderLayer.MultiPhaseParameters _snowman = RenderLayer.MultiPhaseParameters.builder()
         ...
         .layering(VIEW_OFFSET_Z_LAYERING)
         .build(false);
      return of("entity_shadow", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, false, false, _snowman);
   }
   ...
   public static RenderLayer getEntityAlpha(Identifier texture, float alpha) {
      RenderLayer.MultiPhaseParameters _snowman = RenderLayer.MultiPhaseParameters.builder()
         ...
         .cull(DISABLE_CULLING)
         .build(true);
      return of("entity_alpha", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, _snowman);
   }

   public static RenderLayer getEyes(Identifier texture) {
      RenderPhase.Texture _snowman = new RenderPhase.Texture(texture, false, false);
      return of(
         "eyes",
         ...
         false,
         true,
         RenderLayer.MultiPhaseParameters.builder().texture(_snowman).transparency(ADDITIVE_TRANSPARENCY).writeMaskState(COLOR_MASK).fog(BLACK_FOG).build(false)
      );
   }
   ...
   public static RenderLayer getEndPortal(int layer) {
      RenderPhase.Transparency _snowman;
      RenderPhase.Texture _snowmanx;
      if (layer <= 1) {
         _snowman = TRANSLUCENT_TRANSPARENCY;
         _snowmanx = new RenderPhase.Texture(EndPortalBlockEntityRenderer.SKY_TEXTURE, false, false);
      } else {
         _snowman = ADDITIVE_TRANSPARENCY;
         _snowmanx = new RenderPhase.Texture(EndPortalBlockEntityRenderer.PORTAL_TEXTURE, false, false);
      }
      ...
      return of(
         ...
         false,
         true,
         RenderLayer.MultiPhaseParameters.builder().transparency(_snowman).texture(_snowmanx).texturing(new RenderPhase.PortalTexturing(layer)).fog(BLACK_FOG).build(false)
      );
   }
   ...
   static final class MultiPhase extends RenderLayer {
      ...
      private MultiPhase(
         ...
         this.affectedOutline = phases.outlineMode == RenderLayer.OutlineMode.AFFECTS_OUTLINE
            ? phases.texture.getId().map(_snowmanx -> getOutline(_snowmanx, phases.cull))
            : Optional.empty();
      ...
      static enum HashStrategy implements Strategy<RenderLayer.MultiPhase> {
         ...
         public int hashCode(@Nullable RenderLayer.MultiPhase _snowman) {
            return _snowman == null ? 0 : _snowman.hash;
         }

         public boolean equals(@Nullable RenderLayer.MultiPhase _snowman, @Nullable RenderLayer.MultiPhase _snowman) {
            if (_snowman == _snowman) {
               return true;
            } else {
               return _snowman != null && _snowman != null ? Objects.equals(_snowman.phases, _snowman.phases) : false;
            }
         }
      }
   }
   ...
   public static final class MultiPhaseParameters {
      ...
      public boolean equals(Object _snowman) {
         if (this == _snowman) {
            ...
            RenderLayer.MultiPhaseParameters _snowmanx = (RenderLayer.MultiPhaseParameters)_snowman;
            return this.outlineMode == _snowmanx.outlineMode && this.phases.equals(_snowmanx.phases);
         } else {
            return false;
         }
      }
