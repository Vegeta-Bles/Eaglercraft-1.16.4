...
public class RavagerEntityRenderer extends MobEntityRenderer<RavagerEntity, RavagerEntityModel> {
   ...
   public RavagerEntityRenderer(EntityRenderDispatcher _snowman) {
      super(_snowman, new RavagerEntityModel(), 1.1F);
   }

   public Identifier getTexture(RavagerEntity _snowman) {
      return TEXTURE;
   }
}
