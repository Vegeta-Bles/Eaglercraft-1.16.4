...
public class ZombieHorseEntityRenderer extends HorseBaseEntityRenderer<HorseBaseEntity, HorseEntityModel<HorseBaseEntity>> {
   ...
   public ZombieHorseEntityRenderer(EntityRenderDispatcher _snowman) {
      super(_snowman, new HorseEntityModel<>(0.0F), 1.0F);
   }

   public Identifier getTexture(HorseBaseEntity _snowman) {
