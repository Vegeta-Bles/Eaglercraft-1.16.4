...
public class ZombieVillagerEntityRenderer extends BipedEntityRenderer<ZombieVillagerEntity, ZombieVillagerEntityModel<ZombieVillagerEntity>> {
   ...
   public ZombieVillagerEntityRenderer(EntityRenderDispatcher dispatcher, ReloadableResourceManager _snowman) {
      ...
      this.addFeature(new VillagerClothingFeatureRenderer<>(this, _snowman, "zombie_villager"));
   }

   public Identifier getTexture(ZombieVillagerEntity _snowman) {
      return TEXTURE;
   }

   protected boolean isShaking(ZombieVillagerEntity _snowman) {
      return _snowman.isConverting();
   }
}
