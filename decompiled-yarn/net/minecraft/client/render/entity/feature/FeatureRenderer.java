...
public abstract class FeatureRenderer<T extends Entity, M extends EntityModel<T>> {
   ...
   protected static <T extends LivingEntity> void renderModel(
      ...
      VertexConsumer _snowman = vertexConsumers.getBuffer(RenderLayer.getEntityCutoutNoCull(texture));
      model.render(matrices, _snowman, light, LivingEntityRenderer.getOverlay(entity, 0.0F), red, green, blue, 1.0F);
   }
