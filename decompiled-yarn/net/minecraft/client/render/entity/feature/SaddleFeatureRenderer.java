...
public class SaddleFeatureRenderer<T extends Entity & Saddleable, M extends EntityModel<T>> extends FeatureRenderer<T, M> {
   ...
   public void render(
      ...
      if (entity.isSaddled()) {
         ...
         VertexConsumer _snowman = vertexConsumers.getBuffer(RenderLayer.getEntityCutoutNoCull(this.TEXTURE));
         this.model.render(matrices, _snowman, light, OverlayTexture.DEFAULT_UV, 1.0F, 1.0F, 1.0F, 1.0F);
      }
   }
}
