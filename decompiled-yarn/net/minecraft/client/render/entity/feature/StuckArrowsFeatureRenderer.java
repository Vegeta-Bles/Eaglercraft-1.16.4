...
public class StuckArrowsFeatureRenderer<T extends LivingEntity, M extends PlayerEntityModel<T>> extends StuckObjectsFeatureRenderer<T, M> {
   ...
   public StuckArrowsFeatureRenderer(LivingEntityRenderer<T, M> _snowman) {
      super(_snowman);
      this.dispatcher = _snowman.getRenderManager();
   }
   ...
   protected void renderObject(
      ...
      this.arrow.pitch = (float)(Math.atan2((double)directionY, (double)_snowman) * 180.0F / (float)Math.PI);
