...
public class CatEntityModel<T extends CatEntity> extends OcelotEntityModel<T> {
   ...
   public CatEntityModel(float _snowman) {
      super(_snowman);
   }

   public void animateModel(T _snowman, float _snowman, float _snowman, float _snowman) {
      this.sleepAnimation = _snowman.getSleepAnimation(_snowman);
      this.tailCurlAnimation = _snowman.getTailCurlAnimation(_snowman);
      this.headDownAnimation = _snowman.getHeadDownAnimation(_snowman);
