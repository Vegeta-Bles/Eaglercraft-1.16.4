...
public class SnowGolemEntityModel<T extends Entity> extends CompositeEntityModel<T> {
   ...
   public void setAngles(T entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
      ...
      float _snowman = MathHelper.sin(this.middleSnowball.yaw);
      float _snowmanx = MathHelper.cos(this.middleSnowball.yaw);
      ...
      this.leftArm.pivotX = _snowmanx * 5.0F;
      this.leftArm.pivotZ = -_snowman * 5.0F;
      this.rightArm.pivotX = -_snowmanx * 5.0F;
      this.rightArm.pivotZ = _snowman * 5.0F;
   }
