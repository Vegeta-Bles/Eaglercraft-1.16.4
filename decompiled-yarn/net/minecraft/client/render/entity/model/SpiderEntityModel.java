...
public class SpiderEntityModel<T extends Entity> extends CompositeEntityModel<T> {
   ...
   public void setAngles(T entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
      ...
      float _snowmanxxx = -(MathHelper.cos(limbAngle * 0.6662F * 2.0F + 0.0F) * 0.4F) * limbDistance;
      float _snowmanxxxx = -(MathHelper.cos(limbAngle * 0.6662F * 2.0F + (float) Math.PI) * 0.4F) * limbDistance;
      float _snowmanxxxxx = -(MathHelper.cos(limbAngle * 0.6662F * 2.0F + (float) (Math.PI / 2)) * 0.4F) * limbDistance;
      float _snowmanxxxxxx = -(MathHelper.cos(limbAngle * 0.6662F * 2.0F + (float) (Math.PI * 3.0 / 2.0)) * 0.4F) * limbDistance;
      float _snowmanxxxxxxx = Math.abs(MathHelper.sin(limbAngle * 0.6662F + 0.0F) * 0.4F) * limbDistance;
      float _snowmanxxxxxxxx = Math.abs(MathHelper.sin(limbAngle * 0.6662F + (float) Math.PI) * 0.4F) * limbDistance;
      float _snowmanxxxxxxxxx = Math.abs(MathHelper.sin(limbAngle * 0.6662F + (float) (Math.PI / 2)) * 0.4F) * limbDistance;
      float _snowmanxxxxxxxxxx = Math.abs(MathHelper.sin(limbAngle * 0.6662F + (float) (Math.PI * 3.0 / 2.0)) * 0.4F) * limbDistance;
      this.rightBackLeg.yaw += _snowmanxxx;
      this.leftBackLeg.yaw += -_snowmanxxx;
      this.rightBackMiddleLeg.yaw += _snowmanxxxx;
      this.leftBackMiddleLeg.yaw += -_snowmanxxxx;
      this.rightFrontMiddleLeg.yaw += _snowmanxxxxx;
      this.leftFrontMiddleLeg.yaw += -_snowmanxxxxx;
      this.rightFrontLeg.yaw += _snowmanxxxxxx;
      this.leftFrontLeg.yaw += -_snowmanxxxxxx;
      this.rightBackLeg.roll += _snowmanxxxxxxx;
      this.leftBackLeg.roll += -_snowmanxxxxxxx;
      this.rightBackMiddleLeg.roll += _snowmanxxxxxxxx;
      this.leftBackMiddleLeg.roll += -_snowmanxxxxxxxx;
      this.rightFrontMiddleLeg.roll += _snowmanxxxxxxxxx;
      this.leftFrontMiddleLeg.roll += -_snowmanxxxxxxxxx;
      this.rightFrontLeg.roll += _snowmanxxxxxxxxxx;
      this.leftFrontLeg.roll += -_snowmanxxxxxxxxxx;
   }
}
