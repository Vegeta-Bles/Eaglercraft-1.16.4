...
public class VexEntityModel extends BipedEntityModel<VexEntity> {
   ...
   public void setAngles(VexEntity _snowman, float _snowman, float _snowman, float _snowman, float _snowman, float _snowman) {
      ...
      this.rightWing.yaw = 0.47123894F + MathHelper.cos(_snowman * 0.8F) * (float) Math.PI * 0.05F;
