...
public class SpriteAtlasManager implements AutoCloseable {
   ...
   public SpriteAtlasManager(Collection<SpriteAtlasTexture> _snowman) {
      this.atlases = _snowman.stream().collect(Collectors.toMap(SpriteAtlasTexture::getId, Function.identity()));
   }
