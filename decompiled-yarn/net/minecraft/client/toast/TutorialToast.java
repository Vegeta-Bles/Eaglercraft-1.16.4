...
public class TutorialToast implements Toast {
   ...
   public Toast.Visibility draw(MatrixStack matrices, ToastManager manager, long startTime) {
      ...
      if (this.hasProgressBar) {
         ...
         float _snowman = (float)MathHelper.clampedLerp((double)this.lastProgress, (double)this.progress, (double)((float)(startTime - this.lastTime) / 100.0F));
         int _snowmanx;
         ...
         DrawableHelper.fill(matrices, 3, 28, (int)(3.0F + 154.0F * _snowman), 29, _snowmanx);
         this.lastProgress = _snowman;
