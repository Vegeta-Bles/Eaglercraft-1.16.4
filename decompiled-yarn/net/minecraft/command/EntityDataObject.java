...
public class EntityDataObject implements DataCommandObject {
   private static final SimpleCommandExceptionType INVALID_ENTITY_EXCEPTION = new SimpleCommandExceptionType(
      new TranslatableText("commands.data.entity.invalid")
   );
   public static final Function<String, DataCommand.ObjectType> TYPE_FACTORY = _snowman -> new DataCommand.ObjectType() {
         ...
         public DataCommandObject getObject(CommandContext<ServerCommandSource> context) throws CommandSyntaxException {
            return new EntityDataObject(EntityArgumentType.getEntity(context, _snowman));
         }
         ...
         public ArgumentBuilder<ServerCommandSource, ?> addArgumentsToBuilder(
            ...
            return argument.then(
               CommandManager.literal("entity").then((ArgumentBuilder)argumentAdder.apply(CommandManager.argument(_snowman, EntityArgumentType.entity())))
            );
         }
      };
   ...
   public void setTag(CompoundTag tag) throws CommandSyntaxException {
      if (this.entity instanceof PlayerEntity) {
         ...
         UUID _snowman = this.entity.getUuid();
         this.entity.fromTag(tag);
         this.entity.setUuid(_snowman);
      }
   }
   ...
   public Text feedbackGet(NbtPathArgumentType.NbtPath _snowman, double scale, int result) {
      return new TranslatableText("commands.data.entity.get", _snowman, this.entity.getDisplayName(), String.format(Locale.ROOT, "%.2f", scale), result);
   }
}
