...
public class ItemModelGenerator {
   ...
   public void register() {
      ...
      for (int _snowman = 1; _snowman < 64; _snowman++) {
         this.register(Items.CLOCK, String.format("_%02d", _snowman), Models.GENERATED);
      }
      ...
      for (int _snowman = 0; _snowman < 32; _snowman++) {
         if (_snowman != 16) {
            this.register(Items.COMPASS, String.format("_%02d", _snowman), Models.GENERATED);
         }
      }
