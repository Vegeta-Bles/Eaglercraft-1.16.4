...
public final class TextureKey {
   ...
   private static TextureKey method_27043(String _snowman) {
      return new TextureKey(_snowman, null);
   }

   private static TextureKey method_27044(String _snowman, TextureKey _snowman) {
      return new TextureKey(_snowman, _snowman);
   }

   private TextureKey(String _snowman, @Nullable TextureKey _snowman) {
      this.name = _snowman;
