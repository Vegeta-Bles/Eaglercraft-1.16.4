...
public class AdventureTabAdvancementGenerator implements Consumer<Consumer<Advancement>> {
   ...
   public AdventureTabAdvancementGenerator() {
   }
   ...
   public void accept(Consumer<Advancement> _snowman) {
      ...
      Advancement _snowmanxx = Advancement.Task.create()
         ...
         .build(_snowman, "adventure/sleep_in_bed");
      requireListedBiomesVisited(Advancement.Task.create(), BIOMES)
         ...
         .build(_snowman, "adventure/adventuring_time");
      Advancement _snowmanxxx = Advancement.Task.create()
         ...
         .build(_snowman, "adventure/trade");
      Advancement _snowmanxxxx = this.requireListedMobsKilled(Advancement.Task.create())
         .parent(_snowmanx)
         .display(
            Items.IRON_SWORD,
         ...
         .criteriaMerger(CriterionMerger.OR)
         .build(_snowman, "adventure/kill_a_mob");
      this.requireListedMobsKilled(Advancement.Task.create())
         ...
         .build(_snowman, "adventure/kill_all_mobs");
      Advancement _snowmanxxxxx = Advancement.Task.create()
         ...
         .build(_snowman, "adventure/shoot_arrow");
      Advancement _snowmanxxxxxx = Advancement.Task.create()
         ...
         .build(_snowman, "adventure/throw_trident");
      Advancement.Task.create()
         ...
         .build(_snowman, "adventure/very_very_frightening");
      Advancement.Task.create()
         .parent(_snowmanxxx)
         .display(
         ...
         .build(_snowman, "adventure/summon_iron_golem");
      Advancement.Task.create()
         ...
         .build(_snowman, "adventure/sniper_duel");
      Advancement.Task.create()
         .parent(_snowmanxxxx)
         .display(
         ...
         .build(_snowman, "adventure/totem_of_undying");
      Advancement _snowmanxxxxxxx = Advancement.Task.create()
         ...
         .build(_snowman, "adventure/ol_betsy");
      Advancement.Task.create()
         ...
         .build(_snowman, "adventure/whos_the_pillager_now");
      Advancement.Task.create()
         .parent(_snowmanxxxxxxx)
         .display(
            Items.CROSSBOW,
         ...
         .build(_snowman, "adventure/two_birds_one_arrow");
      Advancement.Task.create()
         .parent(_snowmanxxxxxxx)
         .display(
            Items.CROSSBOW,
         ...
         .build(_snowman, "adventure/arbalistic");
      Advancement _snowmanxxxxxxxx = Advancement.Task.create()
         ...
         .build(_snowman, "adventure/voluntary_exile");
      Advancement.Task.create()
         ...
         .build(_snowman, "adventure/hero_of_the_village");
      Advancement.Task.create()
         .parent(_snowmanx)
         .display(
         ...
         .build(_snowman, "adventure/honey_block_slide");
      Advancement.Task.create()
         .parent(_snowmanxxxxx)
         .display(
         ...
         .criterion(
            ...
            TargetHitCriterion.Conditions.create(
               ...
               EntityPredicate.Extended.ofLegacy(
                  EntityPredicate.Builder.create().distance(DistancePredicate.horizontal(NumberRange.FloatRange.atLeast(30.0F))).build()
               )
            )
         )
         .build(_snowman, "adventure/bullseye");
   }

   private Advancement.Task requireListedMobsKilled(Advancement.Task _snowman) {
      for (EntityType<?> _snowmanx : MONSTERS) {
         _snowman.criterion(
            Registry.ENTITY_TYPE.getId(_snowmanx).toString(), OnKilledCriterion.Conditions.createPlayerKilledEntity(EntityPredicate.Builder.create().type(_snowmanx))
         );
      }
   ...
   protected static Advancement.Task requireListedBiomesVisited(Advancement.Task _snowman, List<RegistryKey<Biome>> _snowman) {
      for (RegistryKey<Biome> _snowmanxx : _snowman) {
         _snowman.criterion(_snowmanxx.getValue().toString(), LocationArrivalCriterion.Conditions.create(LocationPredicate.biome(_snowmanxx)));
      }
