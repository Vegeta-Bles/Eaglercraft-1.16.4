...
public class BlockLootTableGenerator implements Consumer<BiConsumer<Identifier, LootTable.Builder>> {
   ...
   private static LootTable.Builder drops(Block dropWithSilkTouch, ItemConvertible drop, LootTableRange count) {
      return dropsWithSilkTouch(
         dropWithSilkTouch,
         (LootPoolEntry.Builder<?>)applyExplosionDecay(dropWithSilkTouch, ItemEntry.builder(drop).apply(SetCountLootFunction.builder(count)))
      );
   }
      ...
      return LootTable.builder()
         .pool(
            addSurvivesExplosionCondition(
               Blocks.FLOWER_POT, LootPool.builder().rolls(ConstantLootTableRange.create(1)).with(ItemEntry.builder(Blocks.FLOWER_POT))
            )
         )
   ...
   private static <T extends Comparable<T> & StringIdentifiable> LootTable.Builder dropsWithProperty(Block drop, Property<T> _snowman, T _snowman) {
      return LootTable.builder()
         .pool(
            addSurvivesExplosionCondition(
               drop,
               LootPool.builder()
                  ...
                  .with(
                     ItemEntry.builder(drop)
                        .conditionally(BlockStatePropertyLootCondition.builder(drop).properties(StatePredicate.Builder.create().exactMatch(_snowman, _snowman)))
                  )
            )
         );
   }
                     ...
                     ItemEntry.builder(drop)
                        .apply(
                           SetCountLootFunction.builder(BinomialLootTableRange.create(3, 0.06666667F))
                              .conditionally(
                                 BlockStatePropertyLootCondition.builder(stem).properties(StatePredicate.Builder.create().exactMatch(StemBlock.AGE, 0))
                              )
                        )
                        .apply(
                           SetCountLootFunction.builder(BinomialLootTableRange.create(3, 0.13333334F))
                              .conditionally(
                                 BlockStatePropertyLootCondition.builder(stem).properties(StatePredicate.Builder.create().exactMatch(StemBlock.AGE, 1))
                              )
                        )
                        .apply(
                           SetCountLootFunction.builder(BinomialLootTableRange.create(3, 0.2F))
                              .conditionally(
                                 BlockStatePropertyLootCondition.builder(stem).properties(StatePredicate.Builder.create().exactMatch(StemBlock.AGE, 2))
                              )
                        )
                        .apply(
                           SetCountLootFunction.builder(BinomialLootTableRange.create(3, 0.26666668F))
                              .conditionally(
                                 BlockStatePropertyLootCondition.builder(stem).properties(StatePredicate.Builder.create().exactMatch(StemBlock.AGE, 3))
                              )
                        )
                        .apply(
                           SetCountLootFunction.builder(BinomialLootTableRange.create(3, 0.33333334F))
                              .conditionally(
                                 BlockStatePropertyLootCondition.builder(stem).properties(StatePredicate.Builder.create().exactMatch(StemBlock.AGE, 4))
                              )
                        )
                        .apply(
                           SetCountLootFunction.builder(BinomialLootTableRange.create(3, 0.4F))
                              .conditionally(
                                 BlockStatePropertyLootCondition.builder(stem).properties(StatePredicate.Builder.create().exactMatch(StemBlock.AGE, 5))
                              )
                        )
                        .apply(
                           SetCountLootFunction.builder(BinomialLootTableRange.create(3, 0.46666667F))
                              .conditionally(
                                 BlockStatePropertyLootCondition.builder(stem).properties(StatePredicate.Builder.create().exactMatch(StemBlock.AGE, 6))
                              )
                        )
                        .apply(
                           SetCountLootFunction.builder(BinomialLootTableRange.create(3, 0.53333336F))
                              .conditionally(
                                 BlockStatePropertyLootCondition.builder(stem).properties(StatePredicate.Builder.create().exactMatch(StemBlock.AGE, 7))
                              )
                        )
                  )
            )
   ...
   private static LootTable.Builder method_30159(Block _snowman) {
      return LootTable.builder()
         .pool(LootPool.builder().conditionally(WITH_SHEARS).with(ItemEntry.builder(_snowman).apply(SetCountLootFunction.builder(ConstantLootTableRange.create(2)))));
   }

   private static LootTable.Builder method_30158(Block _snowman, Block _snowman) {
      LootPoolEntry.Builder<?> _snowmanxx = ItemEntry.builder(_snowman)
         .apply(SetCountLootFunction.builder(ConstantLootTableRange.create(2)))
         .conditionally(WITH_SHEARS)
         .alternatively(
            ((LeafEntry.Builder)addSurvivesExplosionCondition(_snowman, ItemEntry.builder(Items.WHEAT_SEEDS)))
               .conditionally(RandomChanceLootCondition.builder(0.125F))
         );
      return LootTable.builder()
         .pool(
            LootPool.builder()
               .with(_snowmanxx)
               .conditionally(
                  BlockStatePropertyLootCondition.builder(_snowman).properties(StatePredicate.Builder.create().exactMatch(TallPlantBlock.HALF, DoubleBlockHalf.LOWER))
               )
               .conditionally(
         ...
         .pool(
            LootPool.builder()
               .with(_snowmanxx)
               .conditionally(
                  BlockStatePropertyLootCondition.builder(_snowman).properties(StatePredicate.Builder.create().exactMatch(TallPlantBlock.HALF, DoubleBlockHalf.UPPER))
               )
               .conditionally(
                  LocationCheckLootCondition.method_30151(
                     LocationPredicate.Builder.create()
   ...
   public void accept(BiConsumer<Identifier, LootTable.Builder> _snowman) {
      ...
      this.addDrop(Blocks.STONE, _snowmanx -> drops(_snowmanx, Blocks.COBBLESTONE));
      this.addDrop(Blocks.GRASS_BLOCK, _snowmanx -> drops(_snowmanx, Blocks.DIRT));
      this.addDrop(Blocks.PODZOL, _snowmanx -> drops(_snowmanx, Blocks.DIRT));
      this.addDrop(Blocks.MYCELIUM, _snowmanx -> drops(_snowmanx, Blocks.DIRT));
      this.addDrop(Blocks.TUBE_CORAL_BLOCK, _snowmanx -> drops(_snowmanx, Blocks.DEAD_TUBE_CORAL_BLOCK));
      this.addDrop(Blocks.BRAIN_CORAL_BLOCK, _snowmanx -> drops(_snowmanx, Blocks.DEAD_BRAIN_CORAL_BLOCK));
      this.addDrop(Blocks.BUBBLE_CORAL_BLOCK, _snowmanx -> drops(_snowmanx, Blocks.DEAD_BUBBLE_CORAL_BLOCK));
      this.addDrop(Blocks.FIRE_CORAL_BLOCK, _snowmanx -> drops(_snowmanx, Blocks.DEAD_FIRE_CORAL_BLOCK));
      this.addDrop(Blocks.HORN_CORAL_BLOCK, _snowmanx -> drops(_snowmanx, Blocks.DEAD_HORN_CORAL_BLOCK));
      this.addDrop(Blocks.CRIMSON_NYLIUM, _snowmanx -> drops(_snowmanx, Blocks.NETHERRACK));
      this.addDrop(Blocks.WARPED_NYLIUM, _snowmanx -> drops(_snowmanx, Blocks.NETHERRACK));
      this.addDrop(Blocks.BOOKSHELF, _snowmanx -> drops(_snowmanx, Items.BOOK, ConstantLootTableRange.create(3)));
      this.addDrop(Blocks.CLAY, _snowmanx -> drops(_snowmanx, Items.CLAY_BALL, ConstantLootTableRange.create(4)));
      this.addDrop(Blocks.ENDER_CHEST, _snowmanx -> drops(_snowmanx, Blocks.OBSIDIAN, ConstantLootTableRange.create(8)));
      this.addDrop(Blocks.SNOW_BLOCK, _snowmanx -> drops(_snowmanx, Items.SNOWBALL, ConstantLootTableRange.create(4)));
      ...
      this.addDrop(Blocks.BLACK_BED, _snowmanx -> dropsWithProperty(_snowmanx, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.BLUE_BED, _snowmanx -> dropsWithProperty(_snowmanx, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.BROWN_BED, _snowmanx -> dropsWithProperty(_snowmanx, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.CYAN_BED, _snowmanx -> dropsWithProperty(_snowmanx, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.GRAY_BED, _snowmanx -> dropsWithProperty(_snowmanx, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.GREEN_BED, _snowmanx -> dropsWithProperty(_snowmanx, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.LIGHT_BLUE_BED, _snowmanx -> dropsWithProperty(_snowmanx, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.LIGHT_GRAY_BED, _snowmanx -> dropsWithProperty(_snowmanx, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.LIME_BED, _snowmanx -> dropsWithProperty(_snowmanx, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.MAGENTA_BED, _snowmanx -> dropsWithProperty(_snowmanx, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.PURPLE_BED, _snowmanx -> dropsWithProperty(_snowmanx, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.ORANGE_BED, _snowmanx -> dropsWithProperty(_snowmanx, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.PINK_BED, _snowmanx -> dropsWithProperty(_snowmanx, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.RED_BED, _snowmanx -> dropsWithProperty(_snowmanx, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.WHITE_BED, _snowmanx -> dropsWithProperty(_snowmanx, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.YELLOW_BED, _snowmanx -> dropsWithProperty(_snowmanx, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.LILAC, _snowmanx -> dropsWithProperty(_snowmanx, TallPlantBlock.HALF, DoubleBlockHalf.LOWER));
      this.addDrop(Blocks.SUNFLOWER, _snowmanx -> dropsWithProperty(_snowmanx, TallPlantBlock.HALF, DoubleBlockHalf.LOWER));
      this.addDrop(Blocks.PEONY, _snowmanx -> dropsWithProperty(_snowmanx, TallPlantBlock.HALF, DoubleBlockHalf.LOWER));
      this.addDrop(Blocks.ROSE_BUSH, _snowmanx -> dropsWithProperty(_snowmanx, TallPlantBlock.HALF, DoubleBlockHalf.LOWER));
      this.addDrop(
         Blocks.TNT,
         LootTable.builder()
            .pool(
                           ...
                           ItemEntry.builder(Items.COCOA_BEANS)
                              .apply(
                                 SetCountLootFunction.builder(ConstantLootTableRange.create(3))
                                    .conditionally(
                                       BlockStatePropertyLootCondition.builder(_snowmanx).properties(StatePredicate.Builder.create().exactMatch(CocoaBlock.AGE, 2))
                                    )
                              )
                        )
                     )
               ...
               .pool(
                  LootPool.builder()
                     ...
                     .with(
                        (LootPoolEntry.Builder<?>)applyExplosionDecay(
                           Blocks.SEA_PICKLE,
                           ItemEntry.builder(_snowmanx)
                              .apply(
                                 SetCountLootFunction.builder(ConstantLootTableRange.create(2))
                                    .conditionally(
                                       BlockStatePropertyLootCondition.builder(_snowmanx)
                                          .properties(StatePredicate.Builder.create().exactMatch(SeaPickleBlock.PICKLES, 2))
                                    )
                              )
                              .apply(
                                 SetCountLootFunction.builder(ConstantLootTableRange.create(3))
                                    .conditionally(
                                       BlockStatePropertyLootCondition.builder(_snowmanx)
                                          .properties(StatePredicate.Builder.create().exactMatch(SeaPickleBlock.PICKLES, 3))
                                    )
                              )
                              .apply(
                                 SetCountLootFunction.builder(ConstantLootTableRange.create(4))
                                    .conditionally(
                                       BlockStatePropertyLootCondition.builder(_snowmanx)
                                          .properties(StatePredicate.Builder.create().exactMatch(SeaPickleBlock.PICKLES, 4))
                                    )
                              )
                        )
                     )
      ...
      this.addDrop(
         Blocks.COMPOSTER,
         _snowmanx -> LootTable.builder()
               .pool(LootPool.builder().with((LootPoolEntry.Builder<?>)applyExplosionDecay(_snowmanx, ItemEntry.builder(Items.COMPOSTER))))
               .pool(
                  LootPool.builder()
                     .with(ItemEntry.builder(Items.BONE_MEAL))
                     .conditionally(BlockStatePropertyLootCondition.builder(_snowmanx).properties(StatePredicate.Builder.create().exactMatch(ComposterBlock.LEVEL, 8)))
               )
      );
               ...
               .pool(
                  addSurvivesExplosionCondition(
                     ...
                     LootPool.builder()
                        ...
                        .with(
                           ItemEntry.builder(_snowmanx)
                              .apply(CopyNbtLootFunction.builder(CopyNbtLootFunction.Source.BLOCK_ENTITY).withOperation("SkullOwner", "SkullOwner"))
                        )
                  )
               )
      );
      ...
      this.addDrop(Blocks.BIRCH_LEAVES, _snowmanx -> leavesDrop(_snowmanx, Blocks.BIRCH_SAPLING, SAPLING_DROP_CHANCE));
      this.addDrop(Blocks.ACACIA_LEAVES, _snowmanx -> leavesDrop(_snowmanx, Blocks.ACACIA_SAPLING, SAPLING_DROP_CHANCE));
      this.addDrop(Blocks.JUNGLE_LEAVES, _snowmanx -> leavesDrop(_snowmanx, Blocks.JUNGLE_SAPLING, JUNGLE_SAPLING_DROP_CHANCE));
      this.addDrop(Blocks.SPRUCE_LEAVES, _snowmanx -> leavesDrop(_snowmanx, Blocks.SPRUCE_SAPLING, SAPLING_DROP_CHANCE));
      this.addDrop(Blocks.OAK_LEAVES, _snowmanx -> oakLeavesDrop(_snowmanx, Blocks.OAK_SAPLING, SAPLING_DROP_CHANCE));
      this.addDrop(Blocks.DARK_OAK_LEAVES, _snowmanx -> oakLeavesDrop(_snowmanx, Blocks.DARK_OAK_SAPLING, SAPLING_DROP_CHANCE));
      LootCondition.Builder _snowmanx = BlockStatePropertyLootCondition.builder(Blocks.BEETROOTS)
         .properties(StatePredicate.Builder.create().exactMatch(BeetrootsBlock.AGE, 3));
      this.addDrop(Blocks.BEETROOTS, cropDrops(Blocks.BEETROOTS, Items.BEETROOT, Items.BEETROOT_SEEDS, _snowmanx));
      LootCondition.Builder _snowmanxx = BlockStatePropertyLootCondition.builder(Blocks.WHEAT)
         .properties(StatePredicate.Builder.create().exactMatch(CropBlock.AGE, 7));
      this.addDrop(Blocks.WHEAT, cropDrops(Blocks.WHEAT, Items.WHEAT, Items.WHEAT_SEEDS, _snowmanxx));
      LootCondition.Builder _snowmanxxx = BlockStatePropertyLootCondition.builder(Blocks.CARROTS)
      ...
      LootCondition.Builder _snowmanxxxx = BlockStatePropertyLootCondition.builder(Blocks.POTATOES)
      ...
      this.addDrop(
         ...
         _snowmanxxxxx -> applyExplosionDecay(
               _snowmanxxxxx,
               LootTable.builder()
                  .pool(
                     LootPool.builder()
      ...
      this.addDrop(Blocks.BROWN_MUSHROOM_BLOCK, _snowmanxxxxx -> mushroomBlockDrops(_snowmanxxxxx, Blocks.BROWN_MUSHROOM));
      this.addDrop(Blocks.RED_MUSHROOM_BLOCK, _snowmanxxxxx -> mushroomBlockDrops(_snowmanxxxxx, Blocks.RED_MUSHROOM));
      this.addDrop(Blocks.COAL_ORE, _snowmanxxxxx -> oreDrops(_snowmanxxxxx, Items.COAL));
      this.addDrop(Blocks.EMERALD_ORE, _snowmanxxxxx -> oreDrops(_snowmanxxxxx, Items.EMERALD));
      this.addDrop(Blocks.NETHER_QUARTZ_ORE, _snowmanxxxxx -> oreDrops(_snowmanxxxxx, Items.QUARTZ));
      this.addDrop(Blocks.DIAMOND_ORE, _snowmanxxxxx -> oreDrops(_snowmanxxxxx, Items.DIAMOND));
      this.addDrop(
         Blocks.NETHER_GOLD_ORE,
         _snowmanxxxxx -> dropsWithSilkTouch(
               _snowmanxxxxx,
               (LootPoolEntry.Builder<?>)applyExplosionDecay(
                  _snowmanxxxxx,
      ...
      this.addDrop(
         Blocks.COBWEB,
         _snowmanxxxxx -> dropsWithSilkTouchOrShears(_snowmanxxxxx, (LootPoolEntry.Builder<?>)addSurvivesExplosionCondition(_snowmanxxxxx, ItemEntry.builder(Items.STRING)))
      );
      this.addDrop(
         Blocks.DEAD_BUSH,
         _snowmanxxxxx -> dropsWithShears(
               _snowmanxxxxx,
               (LootPoolEntry.Builder<?>)applyExplosionDecay(
                  _snowmanxxxxx, ItemEntry.builder(Items.STICK).apply(SetCountLootFunction.builder(UniformLootTableRange.between(0.0F, 2.0F)))
               )
            )
      );
      ...
      this.addDrop(Blocks.LARGE_FERN, _snowmanxxxxx -> method_30158(_snowmanxxxxx, Blocks.FERN));
      this.addDrop(Blocks.TALL_GRASS, _snowmanxxxxx -> method_30158(_snowmanxxxxx, Blocks.GRASS));
      this.addDrop(Blocks.MELON_STEM, _snowmanxxxxx -> cropStemDrops(_snowmanxxxxx, Items.MELON_SEEDS));
      this.addDrop(Blocks.ATTACHED_MELON_STEM, _snowmanxxxxx -> attachedCropStemDrops(_snowmanxxxxx, Items.MELON_SEEDS));
      this.addDrop(Blocks.PUMPKIN_STEM, _snowmanxxxxx -> cropStemDrops(_snowmanxxxxx, Items.PUMPKIN_SEEDS));
      this.addDrop(Blocks.ATTACHED_PUMPKIN_STEM, _snowmanxxxxx -> attachedCropStemDrops(_snowmanxxxxx, Items.PUMPKIN_SEEDS));
      this.addDrop(
         Blocks.CHORUS_FLOWER,
         _snowmanxxxxx -> LootTable.builder()
               .pool(
                  LootPool.builder()
                     .rolls(ConstantLootTableRange.create(1))
                     .with(
                        ((LeafEntry.Builder)addSurvivesExplosionCondition(_snowmanxxxxx, ItemEntry.builder(_snowmanxxxxx)))
                           ...
                           ItemEntry.builder(Items.NETHER_WART)
                              .apply(
                                 SetCountLootFunction.builder(UniformLootTableRange.between(2.0F, 4.0F))
                                    .conditionally(
                                       BlockStatePropertyLootCondition.builder(_snowmanxxxxx)
                        ...
                        AlternativeEntry.builder(
                           AlternativeEntry.builder(
                                 ItemEntry.builder(Items.SNOWBALL)
                                    .conditionally(
                                       BlockStatePropertyLootCondition.builder(_snowmanxxxxx)
                                          .properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 1))
                                    ),
                                 ItemEntry.builder(Items.SNOWBALL)
                                    .conditionally(
                                       BlockStatePropertyLootCondition.builder(_snowmanxxxxx)
                                          .properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 2))
                                    )
                                    .apply(SetCountLootFunction.builder(ConstantLootTableRange.create(2))),
                                 ItemEntry.builder(Items.SNOWBALL)
                                    .conditionally(
                                       BlockStatePropertyLootCondition.builder(_snowmanxxxxx)
                                          .properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 3))
                                    )
                                    .apply(SetCountLootFunction.builder(ConstantLootTableRange.create(3))),
                                 ItemEntry.builder(Items.SNOWBALL)
                                    .conditionally(
                                       BlockStatePropertyLootCondition.builder(_snowmanxxxxx)
                                          .properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 4))
                                    )
                                    .apply(SetCountLootFunction.builder(ConstantLootTableRange.create(4))),
                                 ItemEntry.builder(Items.SNOWBALL)
                                    .conditionally(
                                       BlockStatePropertyLootCondition.builder(_snowmanxxxxx)
                                          .properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 5))
                                    )
                                    .apply(SetCountLootFunction.builder(ConstantLootTableRange.create(5))),
                                 ItemEntry.builder(Items.SNOWBALL)
                                    .conditionally(
                                       BlockStatePropertyLootCondition.builder(_snowmanxxxxx)
                                          .properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 6))
                                    )
                                    .apply(SetCountLootFunction.builder(ConstantLootTableRange.create(6))),
                                 ItemEntry.builder(Items.SNOWBALL)
                                    .conditionally(
                                       BlockStatePropertyLootCondition.builder(_snowmanxxxxx)
                                          .properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 7))
                                    )
                           ...
                           AlternativeEntry.builder(
                              ItemEntry.builder(Blocks.SNOW)
                                 .conditionally(
                                    BlockStatePropertyLootCondition.builder(_snowmanxxxxx).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 1))
                                 ),
                              ItemEntry.builder(Blocks.SNOW)
                                 .apply(SetCountLootFunction.builder(ConstantLootTableRange.create(2)))
                                 .conditionally(
                                    BlockStatePropertyLootCondition.builder(_snowmanxxxxx).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 2))
                                 ),
                              ItemEntry.builder(Blocks.SNOW)
                                 .apply(SetCountLootFunction.builder(ConstantLootTableRange.create(3)))
                                 .conditionally(
                                    BlockStatePropertyLootCondition.builder(_snowmanxxxxx).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 3))
                                 ),
                              ItemEntry.builder(Blocks.SNOW)
                                 .apply(SetCountLootFunction.builder(ConstantLootTableRange.create(4)))
                                 .conditionally(
                                    BlockStatePropertyLootCondition.builder(_snowmanxxxxx).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 4))
                                 ),
                              ItemEntry.builder(Blocks.SNOW)
                                 .apply(SetCountLootFunction.builder(ConstantLootTableRange.create(5)))
                                 .conditionally(
                                    BlockStatePropertyLootCondition.builder(_snowmanxxxxx).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 5))
                                 ),
                              ItemEntry.builder(Blocks.SNOW)
                                 .apply(SetCountLootFunction.builder(ConstantLootTableRange.create(6)))
                                 .conditionally(
                                    BlockStatePropertyLootCondition.builder(_snowmanxxxxx).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 6))
                                 ),
                              ItemEntry.builder(Blocks.SNOW)
                                 .apply(SetCountLootFunction.builder(ConstantLootTableRange.create(7)))
                                 .conditionally(
                                    BlockStatePropertyLootCondition.builder(_snowmanxxxxx).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 7))
                                 ),
         ...
         _snowmanxxxxx -> dropsWithSilkTouch(
               ...
               addSurvivesExplosionCondition(
                  ...
                  ItemEntry.builder(Items.FLINT)
                     ...
                     .alternatively(ItemEntry.builder(_snowmanxxxxx))
               )
            )
      );
      this.addDrop(
         ...
         _snowmanxxxxx -> dropsWithSilkTouch(
               ...
               (LootPoolEntry.Builder<?>)addSurvivesExplosionCondition(
                  _snowmanxxxxx, ItemEntry.builder(Items.CHARCOAL).apply(SetCountLootFunction.builder(ConstantLootTableRange.create(2)))
               )
            )
      );
      this.addDrop(
      ...
      this.addDrop(
         ...
         _snowmanxxxxx -> dropsWithSilkTouch(
               _snowmanxxxxx,
               (LootPoolEntry.Builder<?>)addSurvivesExplosionCondition(
                  _snowmanxxxxx, ItemEntry.builder(Items.SOUL_SOIL).apply(SetCountLootFunction.builder(ConstantLootTableRange.create(1)))
               )
            )
      );
      ...
      Set<Identifier> _snowmanxxxxx = Sets.newHashSet();

      for (Block _snowmanxxxxxx : Registry.BLOCK) {
         Identifier _snowmanxxxxxxx = _snowmanxxxxxx.getLootTableId();
         if (_snowmanxxxxxxx != LootTables.EMPTY && _snowmanxxxxx.add(_snowmanxxxxxxx)) {
            LootTable.Builder _snowmanxxxxxxxx = this.lootTables.remove(_snowmanxxxxxxx);
            if (_snowmanxxxxxxxx == null) {
               throw new IllegalStateException(String.format("Missing loottable '%s' for '%s'", _snowmanxxxxxxx, Registry.BLOCK.getId(_snowmanxxxxxx)));
            }

            _snowman.accept(_snowmanxxxxxxx, _snowmanxxxxxxxx);
         }
      }
   ...
   private void addVinePlantDrop(Block block, Block drop) {
      LootTable.Builder _snowman = dropsWithSilkTouchOrShears(
         block, ItemEntry.builder(block).conditionally(TableBonusLootCondition.builder(Enchantments.FORTUNE, 0.33F, 0.55F, 0.77F, 1.0F))
      );
      this.addDrop(block, _snowman);
      this.addDrop(drop, _snowman);
   }

   public static LootTable.Builder addDoorDrop(Block _snowman) {
      return dropsWithProperty(_snowman, DoorBlock.HALF, DoubleBlockHalf.LOWER);
   }

   public void addPottedPlantDrop(Block _snowman) {
      this.addDrop(_snowman, _snowmanx -> pottedPlantDrops(((FlowerPotBlock)_snowmanx).getContent()));
   }
   ...
   public void addDrop(Block _snowman, ItemConvertible drop) {
      this.addDrop(_snowman, drops(drop));
   }

   public void addDropWithSilkTouch(Block _snowman) {
      this.addDropWithSilkTouch(_snowman, _snowman);
   }

   public void addDrop(Block _snowman) {
      this.addDrop(_snowman, _snowman);
   }

   private void addDrop(Block _snowman, Function<Block, LootTable.Builder> _snowman) {
      this.addDrop(_snowman, _snowman.apply(_snowman));
   }

   private void addDrop(Block _snowman, LootTable.Builder lootTable) {
      this.lootTables.put(_snowman.getLootTableId(), lootTable);
   }
}
