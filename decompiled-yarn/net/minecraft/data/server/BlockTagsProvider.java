...
public class BlockTagsProvider extends AbstractTagProvider<Block> {
   public BlockTagsProvider(DataGenerator _snowman) {
      super(_snowman, Registry.BLOCK);
   }
   ...
   protected Path getOutput(Identifier _snowman) {
      return this.root.getOutput().resolve("data/" + _snowman.getNamespace() + "/tags/blocks/" + _snowman.getPath() + ".json");
   }
