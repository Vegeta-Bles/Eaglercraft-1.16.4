...
public class EndTabAdvancementGenerator implements Consumer<Consumer<Advancement>> {
   public EndTabAdvancementGenerator() {
   }
   ...
   public void accept(Consumer<Advancement> _snowman) {
      ...
      Advancement _snowmanxx = Advancement.Task.create()
         ...
         .build(_snowman, "end/kill_dragon");
      Advancement _snowmanxxx = Advancement.Task.create()
         ...
         .build(_snowman, "end/enter_end_gateway");
      Advancement.Task.create()
         ...
         .build(_snowman, "end/respawn_dragon");
      Advancement _snowmanxxxx = Advancement.Task.create()
         ...
         .build(_snowman, "end/find_end_city");
      Advancement.Task.create()
         .parent(_snowmanxx)
         .display(
            Items.DRAGON_BREATH,
         ...
         .build(_snowman, "end/dragon_breath");
      Advancement.Task.create()
         .parent(_snowmanxxxx)
         .display(
            Items.SHULKER_SHELL,
