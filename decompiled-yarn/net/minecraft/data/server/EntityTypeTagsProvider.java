...
public class EntityTypeTagsProvider extends AbstractTagProvider<EntityType<?>> {
   public EntityTypeTagsProvider(DataGenerator _snowman) {
      super(_snowman, Registry.ENTITY_TYPE);
   }
   ...
   protected Path getOutput(Identifier _snowman) {
      return this.root.getOutput().resolve("data/" + _snowman.getNamespace() + "/tags/entity_types/" + _snowman.getPath() + ".json");
   }
