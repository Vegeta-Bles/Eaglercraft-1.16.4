...
public class NetherTabAdvancementGenerator implements Consumer<Consumer<Advancement>> {
   ...
   public NetherTabAdvancementGenerator() {
   }
   ...
   public void accept(Consumer<Advancement> _snowman) {
      ...
      Advancement _snowmanxx = Advancement.Task.create()
         ...
         .build(_snowman, "nether/return_to_sender");
      Advancement _snowmanxxx = Advancement.Task.create()
         ...
         .build(_snowman, "nether/find_fortress");
      Advancement.Task.create()
         ...
         .build(_snowman, "nether/fast_travel");
      Advancement.Task.create()
         .parent(_snowmanxx)
         .display(
            Items.GHAST_TEAR,
         ...
         .build(_snowman, "nether/uneasy_alliance");
      Advancement _snowmanxxxx = Advancement.Task.create()
         ...
         .build(_snowman, "nether/get_wither_skull");
      Advancement _snowmanxxxxx = Advancement.Task.create()
         ...
         .build(_snowman, "nether/summon_wither");
      Advancement _snowmanxxxxxx = Advancement.Task.create()
         ...
         .build(_snowman, "nether/obtain_blaze_rod");
      Advancement _snowmanxxxxxxx = Advancement.Task.create()
         ...
         .build(_snowman, "nether/create_beacon");
      Advancement.Task.create()
         ...
         .build(_snowman, "nether/create_full_beacon");
      Advancement _snowmanxxxxxxxx = Advancement.Task.create()
         ...
         .build(_snowman, "nether/brew_potion");
      Advancement _snowmanxxxxxxxxx = Advancement.Task.create()
         ...
         .build(_snowman, "nether/all_potions");
      Advancement.Task.create()
         ...
         .build(_snowman, "nether/all_effects");
      Advancement _snowmanxxxxxxxxxx = Advancement.Task.create()
         ...
         .build(_snowman, "nether/obtain_ancient_debris");
      Advancement.Task.create()
         ...
         .build(_snowman, "nether/netherite_armor");
      Advancement.Task.create()
         .parent(_snowmanxxxxxxxxxx)
         .display(
            Items.LODESTONE,
         ...
         .build(_snowman, "nether/use_lodestone");
      Advancement _snowmanxxxxxxxxxxx = Advancement.Task.create()
         ...
         .build(_snowman, "nether/obtain_crying_obsidian");
      Advancement.Task.create()
         ...
         .build(_snowman, "nether/charge_respawn_anchor");
      Advancement _snowmanxxxxxxxxxxxx = Advancement.Task.create()
         .parent(_snowmanx)
         .display(
      ...
      AdventureTabAdvancementGenerator.requireListedBiomesVisited(Advancement.Task.create(), NETHER_BIOMES)
         ...
         .build(_snowman, "nether/explore_nether");
      Advancement _snowmanxxxxxxxxxxxxx = Advancement.Task.create()
         .parent(_snowmanx)
         .display(
         ...
         .build(_snowman, "nether/find_bastion");
      Advancement.Task.create()
         .parent(_snowmanxxxxxxxxxxxxx)
         .display(
            Blocks.CHEST,
         ...
         .criterion(
            "loot_bastion_hoglin_stable", PlayerGeneratesContainerLootCriterion.Conditions.create(new Identifier("minecraft:chests/bastion_hoglin_stable"))
         )
         ...
         .build(_snowman, "nether/loot_bastion");
      Advancement.Task.create()
         .parent(_snowmanx)
         .criteriaMerger(CriterionMerger.OR)
         .display(
         ...
         .build(_snowman, "nether/distract_piglin");
   }
}
