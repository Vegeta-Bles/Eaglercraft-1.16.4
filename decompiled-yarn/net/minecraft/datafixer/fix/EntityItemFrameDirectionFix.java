...
public class EntityItemFrameDirectionFix extends ChoiceFix {
   ...
   public Dynamic<?> fixDirection(Dynamic<?> _snowman) {
      return _snowman.set("Facing", _snowman.createByte(updateDirection(_snowman.get("Facing").asByte((byte)0))));
   }
   ...
   private static byte updateDirection(byte _snowman) {
      switch (_snowman) {
         case 0:
            return 3;
         case 1:
