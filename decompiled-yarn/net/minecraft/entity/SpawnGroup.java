...
public enum SpawnGroup implements StringIdentifiable {
   ...
   private static final Map<String, SpawnGroup> BY_NAME = Arrays.stream(values())
      .collect(Collectors.toMap(SpawnGroup::getName, spawnGroup -> (SpawnGroup)spawnGroup));
   ...
   private SpawnGroup(String name, int spawnCap, boolean peaceful, boolean var6, int var7) {
      this.name = name;
      this.capacity = spawnCap;
      this.peaceful = peaceful;
      this.animal = _snowman;
      this.immediateDespawnRange = _snowman;
   }
