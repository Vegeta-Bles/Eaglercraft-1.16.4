...
public class TntEntity extends Entity {
   ...
   public TntEntity(EntityType<? extends TntEntity> _snowman, World _snowman) {
   ...
   public TntEntity(World world, double x, double y, double z, @Nullable LivingEntity igniter) {
      ...
      double _snowman = world.random.nextDouble() * (float) (Math.PI * 2);
      this.setVelocity(-Math.sin(_snowman) * 0.02, 0.2F, -Math.cos(_snowman) * 0.02);
      this.setFuse(80);
      this.prevX = x;
      this.prevY = y;
      this.prevZ = z;
