...
public class EntityLookTarget implements LookTarget {
   ...
   public EntityLookTarget(Entity entity, boolean _snowman) {
      this.entity = entity;
      this.field_24382 = _snowman;
   }
   ...
   public boolean isSeenBy(LivingEntity entity) {
      if (!(this.entity instanceof LivingEntity)) {
         ...
         Optional<List<LivingEntity>> _snowman = entity.getBrain().getOptionalMemory(MemoryModuleType.VISIBLE_MOBS);
         return this.entity.isAlive() && _snowman.isPresent() && _snowman.get().contains(this.entity);
      }
   }
