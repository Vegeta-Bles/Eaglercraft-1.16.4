...
public abstract class Sensor<E extends LivingEntity> {
   ...
   public final void tick(ServerWorld _snowman, E entity) {
      if (--this.lastSenseTime <= 0L) {
         this.lastSenseTime = (long)this.senseInterval;
         this.sense(_snowman, entity);
      }
   }
   ...
   protected static boolean method_30954(LivingEntity _snowman, LivingEntity _snowman) {
      return _snowman.getBrain().method_29519(MemoryModuleType.ATTACK_TARGET, _snowman) ? field_26631.test(_snowman, _snowman) : field_26630.test(_snowman, _snowman);
   }
}
