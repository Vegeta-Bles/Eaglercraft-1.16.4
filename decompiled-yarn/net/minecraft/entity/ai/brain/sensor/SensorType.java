...
public class SensorType<U extends Sensor<?>> {
   ...
   private SensorType(Supplier<U> _snowman) {
      this.factory = _snowman;
   }
   ...
   private static <U extends Sensor<?>> SensorType<U> register(String id, Supplier<U> _snowman) {
      return Registry.register(Registry.SENSOR_TYPE, new Identifier(id), new SensorType<>(_snowman));
   }
}
