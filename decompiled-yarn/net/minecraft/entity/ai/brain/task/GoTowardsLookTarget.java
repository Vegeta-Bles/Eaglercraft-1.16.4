...
public class GoTowardsLookTarget extends Task<LivingEntity> {
   ...
   protected void run(ServerWorld world, LivingEntity entity, long time) {
      ...
      LookTarget _snowmanx = _snowman.getOptionalMemory(MemoryModuleType.LOOK_TARGET).get();
      _snowman.remember(MemoryModuleType.WALK_TARGET, new WalkTarget(_snowmanx, this.speed, this.completionRange));
   }
}
