...
public class DolphinLookControl extends LookControl {
   ...
   public void tick() {
      ...
      float _snowman = MathHelper.wrapDegrees(this.entity.headYaw - this.entity.bodyYaw);
      if (_snowman < (float)(-this.maxYawDifference)) {
         this.entity.bodyYaw -= 4.0F;
      } else if (_snowman > (float)this.maxYawDifference) {
         this.entity.bodyYaw += 4.0F;
      }
   }
}
