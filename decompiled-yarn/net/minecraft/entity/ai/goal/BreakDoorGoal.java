...
public class BreakDoorGoal extends DoorInteractGoal {
   ...
   public void tick() {
      ...
      this.breakProgress++;
      int _snowman = (int)((float)this.breakProgress / (float)this.getMaxProgress() * 10.0F);
      if (_snowman != this.prevBreakProgress) {
         this.mob.world.setBlockBreakingInfo(this.mob.getEntityId(), this.doorPos, _snowman);
         this.prevBreakProgress = _snowman;
      }
