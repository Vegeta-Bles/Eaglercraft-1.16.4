...
public class MoveIntoWaterGoal extends Goal {
   ...
   public void start() {
      ...
      for (BlockPos _snowmanx : BlockPos.iterate(
         ...
         if (this.mob.world.getFluidState(_snowmanx).isIn(FluidTags.WATER)) {
            _snowman = _snowmanx;
            break;
         }
      }
      ...
      if (_snowman != null) {
         this.mob.getMoveControl().moveTo((double)_snowman.getX(), (double)_snowman.getY(), (double)_snowman.getZ(), 1.0);
      }
   }
}
