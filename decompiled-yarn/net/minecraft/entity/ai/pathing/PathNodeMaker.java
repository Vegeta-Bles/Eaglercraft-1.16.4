...
public abstract class PathNodeMaker {
   ...
   protected PathNode method_27137(BlockPos _snowman) {
      return this.getNode(_snowman.getX(), _snowman.getY(), _snowman.getZ());
   }

   protected PathNode getNode(int x, int y, int z) {
      return (PathNode)this.pathNodeCache.computeIfAbsent(PathNode.hash(x, y, z), _snowmanxxx -> new PathNode(x, y, z));
   }
