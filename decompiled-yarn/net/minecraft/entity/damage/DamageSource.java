...
public class DamageSource {
   ...
   public Text getDeathMessage(LivingEntity entity) {
      LivingEntity _snowman = entity.getPrimeAdversary();
      String _snowmanx = "death.attack." + this.name;
      String _snowmanxx = _snowmanx + ".player";
      return _snowman != null ? new TranslatableText(_snowmanxx, entity.getDisplayName(), _snowman.getDisplayName()) : new TranslatableText(_snowmanx, entity.getDisplayName());
   }
   ...
   public boolean isSourceCreativePlayer() {
      Entity _snowman = this.getAttacker();
      return _snowman instanceof PlayerEntity && ((PlayerEntity)_snowman).abilities.creativeMode;
   }
