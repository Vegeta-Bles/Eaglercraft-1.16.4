...
public class EndCrystalEntity extends Entity {
   ...
   public EndCrystalEntity(EntityType<? extends EndCrystalEntity> _snowman, World _snowman) {
   ...
   public void tick() {
      ...
      if (this.world instanceof ServerWorld) {
         ...
         if (((ServerWorld)this.world).getEnderDragonFight() != null && this.world.getBlockState(_snowman).isAir()) {
   ...
   private void crystalDestroyed(DamageSource source) {
      if (this.world instanceof ServerWorld) {
         EnderDragonFight _snowman = ((ServerWorld)this.world).getEnderDragonFight();
         if (_snowman != null) {
            _snowman.crystalDestroyed(this, source);
         }
      }
   }
