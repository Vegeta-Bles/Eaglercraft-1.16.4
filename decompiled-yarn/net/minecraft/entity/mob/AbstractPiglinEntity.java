...
public abstract class AbstractPiglinEntity extends HostileEntity {
   ...
   public AbstractPiglinEntity(EntityType<? extends AbstractPiglinEntity> _snowman, World _snowman) {
   ...
   protected void zombify(ServerWorld world) {
      ZombifiedPiglinEntity _snowman = this.method_29243(EntityType.ZOMBIFIED_PIGLIN, true);
      if (_snowman != null) {
