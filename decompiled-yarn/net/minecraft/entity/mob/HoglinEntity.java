...
public class HoglinEntity extends AnimalEntity implements Monster, Hoglin {
   ...
   public HoglinEntity(EntityType<? extends HoglinEntity> _snowman, World _snowman) {
   ...
   protected Brain<?> deserializeBrain(Dynamic<?> _snowman) {
      return HoglinBrain.create(this.createBrainProfile().deserialize(_snowman));
   }
   ...
   public static boolean canSpawn(EntityType<HoglinEntity> type, WorldAccess world, SpawnReason spawnReason, BlockPos pos, Random _snowman) {
   ...
   private void zombify(ServerWorld word) {
      ZoglinEntity _snowman = this.method_29243(EntityType.ZOGLIN, true);
      if (_snowman != null) {
   ...
   public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
      HoglinEntity _snowman = EntityType.HOGLIN.create(world);
      if (_snowman != null) {
   ...
   protected SoundEvent getAmbientSound() {
      return this.world.isClient ? null : HoglinBrain.method_30083(this).orElse(null);
   }
   ...
   protected void method_30081(SoundEvent _snowman) {
