...
public class MagmaCubeEntity extends SlimeEntity {
   public MagmaCubeEntity(EntityType<? extends MagmaCubeEntity> _snowman, World _snowman) {
   ...
   protected void jump() {
      ...
      this.setVelocity(_snowman.x, (double)(this.getJumpVelocity() + (float)this.getSize() * 0.1F), _snowman.z);
   ...
   protected void swimUpward(Tag<Fluid> fluid) {
      if (fluid == FluidTags.LAVA) {
         Vec3d _snowman = this.getVelocity();
         this.setVelocity(_snowman.x, (double)(0.22F + (float)this.getSize() * 0.05F), _snowman.z);
         this.velocityDirty = true;
      } else {
