...
public class PiglinBruteEntity extends AbstractPiglinEntity {
   ...
   public PiglinBruteEntity(EntityType<? extends PiglinBruteEntity> _snowman, World _snowman) {
   ...
   protected Brain<?> deserializeBrain(Dynamic<?> _snowman) {
      return PiglinBruteBrain.create(this, this.createBrainProfile().deserialize(_snowman));
   }
