...
public class SpiderEntity extends HostileEntity {
   ...
   public SpiderEntity(EntityType<? extends SpiderEntity> _snowman, World _snowman) {
   ...
   public void setClimbingWall(boolean climbing) {
      byte _snowman = this.dataTracker.get(SPIDER_FLAGS);
      if (climbing) {
      ...
      this.dataTracker.set(SPIDER_FLAGS, _snowman);
   }
   ...
   public EntityData initialize(
      ...
      if (world.getRandom().nextInt(100) == 0) {
         SkeletonEntity _snowman = EntityType.SKELETON.create(this.world);
         _snowman.refreshPositionAndAngles(this.getX(), this.getY(), this.getZ(), this.yaw, 0.0F);
         _snowman.initialize(world, difficulty, spawnReason, null, null);
         _snowman.startRiding(this);
      }
      ...
      if (entityData instanceof SpiderEntity.SpiderData) {
         StatusEffect _snowman = ((SpiderEntity.SpiderData)entityData).effect;
         if (_snowman != null) {
            this.addStatusEffect(new StatusEffectInstance(_snowman, Integer.MAX_VALUE));
         }
      }
   ...
   static class AttackGoal extends MeleeAttackGoal {
      ...
      public boolean shouldContinue() {
         float _snowman = this.mob.getBrightnessAtEyes();
         if (_snowman >= 0.5F && this.mob.getRandom().nextInt(100) == 0) {
   ...
   static class FollowTargetGoal<T extends LivingEntity> extends net.minecraft.entity.ai.goal.FollowTargetGoal<T> {
      ...
      public boolean canStart() {
         float _snowman = this.mob.getBrightnessAtEyes();
         return _snowman >= 0.5F ? false : super.canStart();
      }
   }
