...
public class ChickenEntity extends AnimalEntity {
   ...
   public ChickenEntity(EntityType<? extends ChickenEntity> _snowman, World _snowman) {
   ...
   public ChickenEntity createChild(ServerWorld _snowman, PassiveEntity _snowman) {
      return EntityType.CHICKEN.create(_snowman);
   }
   ...
   public void updatePassengerPosition(Entity passenger) {
      ...
      passenger.updatePosition(this.getX() + (double)(0.1F * _snowman), this.getBodyY(0.5) + passenger.getHeightOffset() + 0.0, this.getZ() - (double)(0.1F * _snowmanx));
