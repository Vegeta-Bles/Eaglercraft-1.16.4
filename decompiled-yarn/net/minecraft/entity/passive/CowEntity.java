...
public class CowEntity extends AnimalEntity {
   public CowEntity(EntityType<? extends CowEntity> _snowman, World _snowman) {
   ...
   public ActionResult interactMob(PlayerEntity player, Hand hand) {
      ...
      if (_snowman.getItem() == Items.BUCKET && !this.isBaby()) {
         player.playSound(SoundEvents.ENTITY_COW_MILK, 1.0F, 1.0F);
         ItemStack _snowmanx = ItemUsage.method_30012(_snowman, player, Items.MILK_BUCKET.getDefaultStack());
   ...
   public CowEntity createChild(ServerWorld _snowman, PassiveEntity _snowman) {
      return EntityType.COW.create(_snowman);
   }
