...
public class OcelotEntity extends AnimalEntity {
   ...
   public OcelotEntity(EntityType<? extends OcelotEntity> _snowman, World _snowman) {
   ...
   public ActionResult interactMob(PlayerEntity player, Hand hand) {
      ...
      if ((this.temptGoal == null || this.temptGoal.isActive()) && !this.isTrusting() && this.isBreedingItem(_snowman) && player.squaredDistanceTo(this) < 9.0) {
   ...
   public OcelotEntity createChild(ServerWorld _snowman, PassiveEntity _snowman) {
      return EntityType.OCELOT.create(_snowman);
   }
   ...
   public boolean canSpawn(WorldView world) {
      if (world.intersectsEntities(this) && !world.containsFluid(this.getBoundingBox())) {
         ...
         if (_snowman.getY() < world.getSeaLevel()) {
            return false;
         }

         BlockState _snowmanx = world.getBlockState(_snowman.down());
         if (_snowmanx.isOf(Blocks.GRASS_BLOCK) || _snowmanx.isIn(BlockTags.LEAVES)) {
            return true;
         }
      }
