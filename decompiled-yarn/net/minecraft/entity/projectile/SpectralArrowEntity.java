...
public class SpectralArrowEntity extends PersistentProjectileEntity {
   ...
   public SpectralArrowEntity(EntityType<? extends SpectralArrowEntity> _snowman, World _snowman) {
   ...
   protected void onHit(LivingEntity target) {
      super.onHit(target);
      StatusEffectInstance _snowman = new StatusEffectInstance(StatusEffects.GLOWING, this.duration, 0);
