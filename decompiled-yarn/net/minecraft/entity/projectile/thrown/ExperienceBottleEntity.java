...
public class ExperienceBottleEntity extends ThrownItemEntity {
   public ExperienceBottleEntity(EntityType<? extends ExperienceBottleEntity> _snowman, World _snowman) {
   ...
   protected void onCollision(HitResult hitResult) {
      ...
      if (!this.world.isClient) {
         ...
         int _snowman = 3 + this.world.random.nextInt(5) + this.world.random.nextInt(5);
