...
public abstract class Fluid {
   ...
   protected Fluid() {
      StateManager.Builder<Fluid, FluidState> _snowman = new StateManager.Builder<>(this);
      this.appendProperties(_snowman);
      this.stateManager = _snowman.build(Fluid::getDefaultState, FluidState::new);
   ...
   protected void onRandomTick(World world, BlockPos pos, FluidState state, Random _snowman) {
   }
