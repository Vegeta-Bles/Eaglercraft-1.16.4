...
public class Items {
   ...
   public static final Item ORANGE_SHULKER_BOX = register(
      new BlockItem(Blocks.ORANGE_SHULKER_BOX, new Item.Settings().maxCount(1).group(ItemGroup.DECORATIONS))
   );
   ...
   public static final Item YELLOW_SHULKER_BOX = register(
      new BlockItem(Blocks.YELLOW_SHULKER_BOX, new Item.Settings().maxCount(1).group(ItemGroup.DECORATIONS))
   );
   ...
   public static final Item PURPLE_SHULKER_BOX = register(
      new BlockItem(Blocks.PURPLE_SHULKER_BOX, new Item.Settings().maxCount(1).group(ItemGroup.DECORATIONS))
   );
   ...
   public static final Item WOODEN_SHOVEL = register(
      "wooden_shovel", new ShovelItem(ToolMaterials.WOOD, 1.5F, -3.0F, new Item.Settings().group(ItemGroup.TOOLS))
   );
   public static final Item WOODEN_PICKAXE = register(
      "wooden_pickaxe", new PickaxeItem(ToolMaterials.WOOD, 1, -2.8F, new Item.Settings().group(ItemGroup.TOOLS))
   );
   ...
   public static final Item STONE_SHOVEL = register(
      "stone_shovel", new ShovelItem(ToolMaterials.STONE, 1.5F, -3.0F, new Item.Settings().group(ItemGroup.TOOLS))
   );
   public static final Item STONE_PICKAXE = register(
      "stone_pickaxe", new PickaxeItem(ToolMaterials.STONE, 1, -2.8F, new Item.Settings().group(ItemGroup.TOOLS))
   );
   ...
   public static final Item GOLDEN_SHOVEL = register(
      "golden_shovel", new ShovelItem(ToolMaterials.GOLD, 1.5F, -3.0F, new Item.Settings().group(ItemGroup.TOOLS))
   );
   public static final Item GOLDEN_PICKAXE = register(
      "golden_pickaxe", new PickaxeItem(ToolMaterials.GOLD, 1, -2.8F, new Item.Settings().group(ItemGroup.TOOLS))
   );
   ...
   public static final Item DIAMOND_SWORD = register(
      "diamond_sword", new SwordItem(ToolMaterials.DIAMOND, 3, -2.4F, new Item.Settings().group(ItemGroup.COMBAT))
   );
   ...
   public static final Item IRON_HORSE_ARMOR = register(
      "iron_horse_armor", new HorseArmorItem(5, "iron", new Item.Settings().maxCount(1).group(ItemGroup.MISC))
   );
   ...
   public static final Item LIGHT_BLUE_BANNER = register(
      "light_blue_banner",
      new BannerItem(Blocks.LIGHT_BLUE_BANNER, Blocks.LIGHT_BLUE_WALL_BANNER, new Item.Settings().maxCount(16).group(ItemGroup.DECORATIONS))
   );
   ...
   public static final Item LIGHT_GRAY_BANNER = register(
      "light_gray_banner",
      new BannerItem(Blocks.LIGHT_GRAY_BANNER, Blocks.LIGHT_GRAY_WALL_BANNER, new Item.Settings().maxCount(16).group(ItemGroup.DECORATIONS))
   );
   ...
   public static final Item HONEY_BOTTLE = register(
      "honey_bottle",
      new HoneyBottleItem(new Item.Settings().recipeRemainder(GLASS_BOTTLE).food(FoodComponents.HONEY_BOTTLE).group(ItemGroup.FOOD).maxCount(16))
   );
