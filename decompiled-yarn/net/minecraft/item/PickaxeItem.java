...
public class PickaxeItem extends MiningToolItem {
   ...
   public boolean isEffectiveOn(BlockState state) {
      int _snowman = this.getMaterial().getMiningLevel();
      if (state.isOf(Blocks.OBSIDIAN)
         ...
         return _snowmanx == Material.STONE || _snowmanx == Material.METAL || _snowmanx == Material.REPAIR_STATION || state.isOf(Blocks.NETHER_GOLD_ORE);
      } else {
         return _snowman >= 1;
      }
   }
   ...
   public float getMiningSpeedMultiplier(ItemStack stack, BlockState state) {
      ...
      return _snowman != Material.METAL && _snowman != Material.REPAIR_STATION && _snowman != Material.STONE ? super.getMiningSpeedMultiplier(stack, state) : this.miningSpeed;
   }
}
