...
public class LootTableReporter {
   ...
   public LootTableReporter withTable(String name, Identifier id) {
      ImmutableSet<Identifier> _snowman = ImmutableSet.builder().addAll(this.tables).add(id).build();
      return new LootTableReporter(this.messages, () -> this.getName() + name, this.contextType, this.conditionGetter, this.conditions, this.tableGetter, _snowman);
   }

   public LootTableReporter withCondition(String name, Identifier id) {
      ImmutableSet<Identifier> _snowman = ImmutableSet.builder().addAll(this.conditions).add(id).build();
      return new LootTableReporter(this.messages, () -> this.getName() + name, this.contextType, this.conditionGetter, _snowman, this.tableGetter, this.tables);
   }
