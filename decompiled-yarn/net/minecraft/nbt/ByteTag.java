...
public class ByteTag extends AbstractNumberTag {
   public static final TagReader<ByteTag> READER = new TagReader<ByteTag>() {
      public ByteTag read(DataInput _snowman, int _snowman, PositionTracker _snowman) throws IOException {
         _snowman.add(72L);
         return ByteTag.of(_snowman.readByte());
      }
   ...
   static class Cache {
      ...
      static {
         for (int _snowman = 0; _snowman < VALUES.length; _snowman++) {
            VALUES[_snowman] = new ByteTag((byte)(_snowman - 128));
         }
      }
   }
}
