...
public class FloatTag extends AbstractNumberTag {
   ...
   public static final TagReader<FloatTag> READER = new TagReader<FloatTag>() {
      public FloatTag read(DataInput _snowman, int _snowman, PositionTracker _snowman) throws IOException {
         _snowman.add(96L);
         return FloatTag.of(_snowman.readFloat());
      }
   ...
   public Text toText(String indent, int depth) {
      Text _snowman = new LiteralText("f").formatted(RED);
