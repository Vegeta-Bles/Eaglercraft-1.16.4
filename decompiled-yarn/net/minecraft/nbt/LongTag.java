...
public class LongTag extends AbstractNumberTag {
   public static final TagReader<LongTag> READER = new TagReader<LongTag>() {
      public LongTag read(DataInput _snowman, int _snowman, PositionTracker _snowman) throws IOException {
         _snowman.add(128L);
         return LongTag.of(_snowman.readLong());
      }
   ...
   static class Cache {
      ...
      static {
         for (int _snowman = 0; _snowman < VALUES.length; _snowman++) {
            VALUES[_snowman] = new LongTag((long)(-128 + _snowman));
         }
      }
   }
}
