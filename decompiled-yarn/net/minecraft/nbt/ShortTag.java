...
public class ShortTag extends AbstractNumberTag {
   public static final TagReader<ShortTag> READER = new TagReader<ShortTag>() {
      public ShortTag read(DataInput _snowman, int _snowman, PositionTracker _snowman) throws IOException {
         _snowman.add(80L);
         return ShortTag.of(_snowman.readShort());
      }
   ...
   public Text toText(String indent, int depth) {
      Text _snowman = new LiteralText("s").formatted(RED);
   ...
   static class Cache {
      ...
      static {
         for (int _snowman = 0; _snowman < VALUES.length; _snowman++) {
            VALUES[_snowman] = new ShortTag((short)(-128 + _snowman));
         }
      }
   }
}
