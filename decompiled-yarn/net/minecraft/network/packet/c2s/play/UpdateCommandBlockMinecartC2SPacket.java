...
public class UpdateCommandBlockMinecartC2SPacket implements Packet<ServerPlayPacketListener> {
   ...
   public void apply(ServerPlayPacketListener _snowman) {
      _snowman.onUpdateCommandBlockMinecart(this);
   }

   @Nullable
   public CommandBlockExecutor getMinecartCommandExecutor(World world) {
      Entity _snowman = world.getEntityById(this.entityId);
      return _snowman instanceof CommandBlockMinecartEntity ? ((CommandBlockMinecartEntity)_snowman).getCommandExecutor() : null;
   }
