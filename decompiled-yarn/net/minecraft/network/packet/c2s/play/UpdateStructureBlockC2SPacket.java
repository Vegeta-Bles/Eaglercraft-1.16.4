...
public class UpdateStructureBlockC2SPacket implements Packet<ServerPlayPacketListener> {
   ...
   public void read(PacketByteBuf buf) throws IOException {
      ...
      int _snowmanxx = buf.readByte();
      this.ignoreEntities = (_snowmanxx & 1) != 0;
      this.showAir = (_snowmanxx & 2) != 0;
      this.showBoundingBox = (_snowmanxx & 4) != 0;
   }
   ...
   public void apply(ServerPlayPacketListener _snowman) {
      _snowman.onStructureBlockUpdate(this);
   }
