...
public class GameJoinS2CPacket implements Packet<ClientPlayPacketListener> {
   ...
   public void read(PacketByteBuf buf) throws IOException {
      ...
      this.dimensionType = buf.<Supplier<DimensionType>>decode(DimensionType.REGISTRY_CODEC).get();
   ...
   public void write(PacketByteBuf buf) throws IOException {
      ...
      for (RegistryKey<World> _snowman : this.dimensionIds) {
         buf.writeIdentifier(_snowman.getValue());
      }
