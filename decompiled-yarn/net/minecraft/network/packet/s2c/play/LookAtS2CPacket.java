...
public class LookAtS2CPacket implements Packet<ClientPlayPacketListener> {
   ...
   public LookAtS2CPacket(EntityAnchorArgumentType.EntityAnchor _snowman, double targetX, double targetY, double targetZ) {
      this.selfAnchor = _snowman;
   ...
   public LookAtS2CPacket(EntityAnchorArgumentType.EntityAnchor selfAnchor, Entity entity, EntityAnchorArgumentType.EntityAnchor targetAnchor) {
      ...
      Vec3d _snowman = targetAnchor.positionAt(entity);
   ...
   public Vec3d getTargetPosition(World world) {
      if (this.lookAtEntity) {
         Entity _snowman = world.getEntityById(this.entityId);
         return _snowman == null ? new Vec3d(this.targetX, this.targetY, this.targetZ) : this.targetAnchor.positionAt(_snowman);
      } else {
