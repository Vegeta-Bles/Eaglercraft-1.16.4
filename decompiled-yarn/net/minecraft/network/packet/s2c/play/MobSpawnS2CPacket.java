...
public class MobSpawnS2CPacket implements Packet<ClientPlayPacketListener> {
   ...
   public MobSpawnS2CPacket(LivingEntity entity) {
      ...
      double _snowman = 3.9;
      Vec3d _snowmanx = entity.getVelocity();
      double _snowmanxx = MathHelper.clamp(_snowmanx.x, -3.9, 3.9);
      double _snowmanxxx = MathHelper.clamp(_snowmanx.y, -3.9, 3.9);
      double _snowmanxxxx = MathHelper.clamp(_snowmanx.z, -3.9, 3.9);
      this.velocityX = (int)(_snowmanxx * 8000.0);
      this.velocityY = (int)(_snowmanxxx * 8000.0);
      this.velocityZ = (int)(_snowmanxxxx * 8000.0);
   }
