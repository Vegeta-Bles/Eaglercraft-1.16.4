...
public class ParticleS2CPacket implements Packet<ClientPlayPacketListener> {
   ...
   public void read(PacketByteBuf buf) throws IOException {
      ParticleType<?> _snowman = Registry.PARTICLE_TYPE.get(buf.readInt());
      if (_snowman == null) {
         _snowman = ParticleTypes.BARRIER;
      }
      ...
      this.parameters = this.readParticleParameters(buf, (ParticleType<ParticleEffect>)_snowman);
   }
