...
public class PlayerPositionLookS2CPacket implements Packet<ClientPlayPacketListener> {
   ...
   public void apply(ClientPlayPacketListener _snowman) {
      _snowman.onPlayerPositionLook(this);
   }
   ...
   public static enum Flag {
      ...
      private boolean isSet(int _snowman) {
         return (_snowman & this.getMask()) == this.getMask();
      }

      public static Set<PlayerPositionLookS2CPacket.Flag> getFlags(int _snowman) {
         Set<PlayerPositionLookS2CPacket.Flag> _snowmanx = EnumSet.noneOf(PlayerPositionLookS2CPacket.Flag.class);

         for (PlayerPositionLookS2CPacket.Flag _snowmanxx : values()) {
            if (_snowmanxx.isSet(_snowman)) {
      ...
      public static int getBitfield(Set<PlayerPositionLookS2CPacket.Flag> _snowman) {
         int _snowmanx = 0;

         for (PlayerPositionLookS2CPacket.Flag _snowmanxx : _snowman) {
            _snowmanx |= _snowmanxx.getMask();
         }
