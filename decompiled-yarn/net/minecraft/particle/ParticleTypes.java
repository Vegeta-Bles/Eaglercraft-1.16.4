...
public class ParticleTypes {
   ...
   public static final ParticleType<DustParticleEffect> DUST = register("dust", DustParticleEffect.PARAMETERS_FACTORY, _snowman -> DustParticleEffect.CODEC);
   ...
   private static <T extends ParticleEffect> ParticleType<T> register(String name, ParticleEffect.Factory<T> factory, Function<ParticleType<T>, Codec<T>> _snowman) {
      return Registry.register(Registry.PARTICLE_TYPE, name, new ParticleType<T>(false, factory) {
         @Override
         public Codec<T> getCodec() {
            return _snowman.apply(this);
         }
      });
   }
}
