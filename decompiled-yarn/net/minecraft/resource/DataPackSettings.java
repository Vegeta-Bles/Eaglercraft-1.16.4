...
public class DataPackSettings {
   ...
   public static final Codec<DataPackSettings> CODEC = RecordCodecBuilder.create(
      _snowman -> _snowman.group(Codec.STRING.listOf().fieldOf("Enabled").forGetter(_snowmanx -> _snowmanx.enabled), Codec.STRING.listOf().fieldOf("Disabled").forGetter(_snowmanx -> _snowmanx.disabled))
            .apply(_snowman, DataPackSettings::new)
   );
