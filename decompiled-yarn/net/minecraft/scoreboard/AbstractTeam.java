...
public abstract class AbstractTeam {
   ...
   public boolean isEqual(@Nullable AbstractTeam _snowman) {
   ...
   public static enum CollisionRule {
      ...
      private static final Map<String, AbstractTeam.CollisionRule> COLLISION_RULES = Arrays.stream(values())
         .collect(Collectors.toMap(_snowman -> _snowman.name, _snowman -> (AbstractTeam.CollisionRule)_snowman));
   ...
   public static enum VisibilityRule {
      ...
      private static final Map<String, AbstractTeam.VisibilityRule> VISIBILITY_RULES = Arrays.stream(values())
         .collect(Collectors.toMap(_snowman -> _snowman.name, _snowman -> (AbstractTeam.VisibilityRule)_snowman));
      public final String name;
      public final int value;
