...
public class ScoreboardObjective {
   ...
   public ScoreboardObjective(Scoreboard scoreboard, String name, ScoreboardCriterion criterion, Text displayName, ScoreboardCriterion.RenderType _snowman) {
      this.scoreboard = scoreboard;
      this.name = name;
      this.criterion = criterion;
      this.displayName = displayName;
      this.field_24194 = this.method_27441();
      this.renderType = _snowman;
   }
