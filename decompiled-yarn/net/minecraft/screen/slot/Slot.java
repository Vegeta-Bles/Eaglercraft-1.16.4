...
public class Slot {
   ...
   public void onStackChanged(ItemStack originalItem, ItemStack _snowman) {
      int _snowmanx = _snowman.getCount() - originalItem.getCount();
      if (_snowmanx > 0) {
         this.onCrafted(_snowman, _snowmanx);
      }
   }
