...
public class BufferHelper {
   ...
   public static String getString(byte[] buf, int _snowman, int _snowman) {
      int _snowmanxx = _snowman - 1;
      int _snowmanxxx = _snowman > _snowmanxx ? _snowmanxx : _snowman;

      while (0 != buf[_snowmanxxx] && _snowmanxxx < _snowmanxx) {
         _snowmanxxx++;
      }

      return new String(buf, _snowman, _snowmanxxx - _snowman, StandardCharsets.UTF_8);
   }
