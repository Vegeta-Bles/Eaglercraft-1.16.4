      ...
      if (null != this.thread) {
         ...
         while (this.thread.isAlive()) {
            try {
               ...
               if (++_snowman >= 5) {
                  LOGGER.warn("Waited {} seconds attempting force stop!", _snowman);
               } else if (this.thread.isAlive()) {
                  LOGGER.warn("Thread {} ({}) failed to exit after {} second(s)", this, this.thread.getState(), _snowman, new Exception("Stack:"));
