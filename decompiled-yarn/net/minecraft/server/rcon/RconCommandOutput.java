...
public class RconCommandOutput implements CommandOutput {
   ...
   public ServerCommandSource createRconCommandSource() {
      ServerWorld _snowman = this.server.getOverworld();
      return new ServerCommandSource(this, Vec3d.of(_snowman.getSpawnPos()), Vec2f.ZERO, _snowman, 4, "Rcon", RCON_NAME, this.server, null);
   }
