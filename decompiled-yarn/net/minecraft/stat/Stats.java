...
public class Stats {
   ...
   private static Identifier register(String _snowman, StatFormatter _snowman) {
      Identifier _snowmanxx = new Identifier(_snowman);
      Registry.register(Registry.CUSTOM_STAT, _snowman, _snowmanxx);
      CUSTOM.getOrCreateStat(_snowmanxx, _snowman);
      return _snowmanxx;
   }

   private static <T> StatType<T> registerType(String _snowman, Registry<T> _snowman) {
      return Registry.register(Registry.STAT_TYPE, _snowman, new StatType<>(_snowman));
   }
}
