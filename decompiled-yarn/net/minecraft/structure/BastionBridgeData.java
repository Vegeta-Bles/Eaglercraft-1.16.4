   ...
   static {
      StructurePools.register(
         new StructurePool(
            ...
            ImmutableList.of(
               ...
               Pair.of(
                  StructurePoolElement.method_30435("bastion/bridge/starting_pieces/entrance_face", StructureProcessorLists.BASTION_GENERIC_DEGRADATION), 1
               )
            ),
      ...
      StructurePools.register(
         new StructurePool(
            ...
            new Identifier("empty"),
            ImmutableList.of(
               Pair.of(StructurePoolElement.method_30435("bastion/bridge/rampart_plates/plate_0", StructureProcessorLists.RAMPART_DEGRADATION), 1)
            ),
            StructurePool.Projection.RIGID
         )
      );
      StructurePools.register(
         new StructurePool(
            ...
            ImmutableList.of(
               ...
               Pair.of(
                  StructurePoolElement.method_30435("bastion/bridge/connectors/back_bridge_bottom", StructureProcessorLists.BASTION_GENERIC_DEGRADATION), 1
               )
            ),
            StructurePool.Projection.RIGID
         )
