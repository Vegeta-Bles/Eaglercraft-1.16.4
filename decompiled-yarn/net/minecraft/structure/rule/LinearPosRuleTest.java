...
public class LinearPosRuleTest extends PosRuleTest {
   public static final Codec<LinearPosRuleTest> CODEC = RecordCodecBuilder.create(
      _snowman -> _snowman.group(
            ...
            .apply(_snowman, LinearPosRuleTest::new)
   );
   ...
   public boolean test(BlockPos _snowman, BlockPos _snowman, BlockPos _snowman, Random _snowman) {
      int _snowmanxxxx = _snowman.getManhattanDistance(_snowman);
      float _snowmanxxxxx = _snowman.nextFloat();
      return (double)_snowmanxxxxx
         <= MathHelper.clampedLerp(
            (double)this.minChance, (double)this.maxChance, MathHelper.getLerpProgress((double)_snowmanxxxx, (double)this.minDistance, (double)this.maxDistance)
         );
   }
