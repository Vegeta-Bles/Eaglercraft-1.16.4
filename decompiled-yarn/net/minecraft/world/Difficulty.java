...
public enum Difficulty {
   ...
   private static final Difficulty[] BY_NAME = Arrays.stream(values()).sorted(Comparator.comparingInt(Difficulty::getId)).toArray(Difficulty[]::new);
   ...
   public static Difficulty byName(String name) {
      for (Difficulty _snowman : values()) {
