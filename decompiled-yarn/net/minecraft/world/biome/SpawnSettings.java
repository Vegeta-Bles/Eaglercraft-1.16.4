...
public class SpawnSettings {
   ...
   public static final SpawnSettings INSTANCE = new SpawnSettings(
      0.1F, Stream.of(SpawnGroup.values()).collect(ImmutableMap.toImmutableMap(_snowman -> _snowman, _snowman -> ImmutableList.of())), ImmutableMap.of(), false
   );
   public static final MapCodec<SpawnSettings> CODEC = RecordCodecBuilder.mapCodec(
      _snowman -> _snowman.group(
               Codec.FLOAT.optionalFieldOf("creature_spawn_probability", 0.1F).forGetter(_snowmanx -> _snowmanx.creatureSpawnProbability),
               Codec.simpleMap(
                     SpawnGroup.CODEC,
   ...
   public static class Builder {
      private final Map<SpawnGroup, List<SpawnSettings.SpawnEntry>> spawners = Stream.of(SpawnGroup.values())
         .collect(ImmutableMap.toImmutableMap(_snowman -> _snowman, _snowman -> Lists.newArrayList()));
      ...
      public SpawnSettings build() {
         return new SpawnSettings(
            ...
            this.spawners.entrySet().stream().collect(ImmutableMap.toImmutableMap(Entry::getKey, _snowman -> ImmutableList.copyOf((Collection)_snowman.getValue()))),
   ...
   public static class SpawnDensity {
      public static final Codec<SpawnSettings.SpawnDensity> CODEC = RecordCodecBuilder.create(
         _snowman -> _snowman.group(Codec.DOUBLE.fieldOf("energy_budget").forGetter(_snowmanx -> _snowmanx.gravityLimit), Codec.DOUBLE.fieldOf("charge").forGetter(_snowmanx -> _snowmanx.mass))
               .apply(_snowman, SpawnSettings.SpawnDensity::new)
      );
   ...
   public static class SpawnEntry extends WeightedPicker.Entry {
      public static final Codec<SpawnSettings.SpawnEntry> CODEC = RecordCodecBuilder.create(
         _snowman -> _snowman.group(
                  Registry.ENTITY_TYPE.fieldOf("type").forGetter(_snowmanx -> _snowmanx.type),
                  Codec.INT.fieldOf("weight").forGetter(_snowmanx -> _snowmanx.weight),
                  Codec.INT.fieldOf("minCount").forGetter(_snowmanx -> _snowmanx.minGroupSize),
                  Codec.INT.fieldOf("maxCount").forGetter(_snowmanx -> _snowmanx.maxGroupSize)
               )
               .apply(_snowman, SpawnSettings.SpawnEntry::new)
      );
