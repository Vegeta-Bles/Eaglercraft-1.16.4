...
public class GenerationStep {
   public static enum Carver implements StringIdentifiable {
      ...
      private static final Map<String, GenerationStep.Carver> BY_NAME = Arrays.stream(values())
         .collect(Collectors.toMap(GenerationStep.Carver::getName, _snowman -> (GenerationStep.Carver)_snowman));
