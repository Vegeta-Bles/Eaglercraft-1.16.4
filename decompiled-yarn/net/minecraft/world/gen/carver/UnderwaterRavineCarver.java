...
public class UnderwaterRavineCarver extends RavineCarver {
   public UnderwaterRavineCarver(Codec<ProbabilityConfig> _snowman) {
      super(_snowman);
   ...
   protected boolean carveAtPoint(
      ...
      return UnderwaterCaveCarver.carveAtPoint(this, chunk, carvingMask, _snowman, _snowman, seaLevel, mainChunkX, mainChunkZ, x, z, relativeX, y, relativeZ);
   }
}
