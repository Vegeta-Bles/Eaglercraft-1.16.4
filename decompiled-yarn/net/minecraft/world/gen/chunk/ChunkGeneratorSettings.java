...
public final class ChunkGeneratorSettings {
   public static final Codec<ChunkGeneratorSettings> CODEC = RecordCodecBuilder.create(
      _snowman -> _snowman.group(
            ...
            .apply(_snowman, ChunkGeneratorSettings::new)
   );
   ...
   private static ChunkGeneratorSettings createUndergroundSettings(
      ...
      Map<StructureFeature<?>, StructureConfig> _snowman = Maps.newHashMap(StructuresConfig.DEFAULT_STRUCTURES);
      _snowman.put(StructureFeature.RUINED_PORTAL, new StructureConfig(25, 10, 34222645));
      return new ChunkGeneratorSettings(
         new StructuresConfig(Optional.ofNullable(structuresConfig.getStronghold()), _snowman),
         new GenerationShapeConfig(
            128,
   ...
   static {
      ...
      register(
         ...
         createIslandSettings(
            new StructuresConfig(true), Blocks.STONE.getDefaultState(), Blocks.WATER.getDefaultState(), FLOATING_ISLANDS.getValue(), false, false
         )
      );
   }
}
