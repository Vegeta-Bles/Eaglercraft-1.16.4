...
public class ConfiguredDecorator<DC extends DecoratorConfig> implements Decoratable<ConfiguredDecorator<?>> {
   public static final Codec<ConfiguredDecorator<?>> CODEC = Registry.DECORATOR.dispatch("type", _snowman -> _snowman.decorator, Decorator::getCodec);
   ...
   public ConfiguredDecorator<?> decorate(ConfiguredDecorator<?> _snowman) {
      return new ConfiguredDecorator<>(Decorator.DECORATED, new DecoratedDecoratorConfig(_snowman, this));
   }
