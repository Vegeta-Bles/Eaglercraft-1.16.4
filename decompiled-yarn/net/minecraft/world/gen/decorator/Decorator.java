...
public abstract class Decorator<DC extends DecoratorConfig> {
   ...
   public static final Decorator<RangeDecoratorConfig> RANGE_VERY_BIASED = register(
      "range_very_biased", new RangeVeryBiasedDecorator(RangeDecoratorConfig.CODEC)
   );
   ...
   public Decorator(Codec<DC> configCodec) {
      this.codec = configCodec.fieldOf("config").xmap(_snowman -> new ConfiguredDecorator<>(this, (DC)_snowman), ConfiguredDecorator::getConfig).codec();
   }
