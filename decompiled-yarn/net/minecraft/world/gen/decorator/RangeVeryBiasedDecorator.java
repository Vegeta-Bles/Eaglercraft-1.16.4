...
public class RangeVeryBiasedDecorator extends SimpleDecorator<RangeDecoratorConfig> {
   public RangeVeryBiasedDecorator(Codec<RangeDecoratorConfig> _snowman) {
      super(_snowman);
   }
   ...
   public Stream<BlockPos> getPositions(Random _snowman, RangeDecoratorConfig _snowman, BlockPos _snowman) {
      ...
      int _snowmanxxxxx = _snowman.nextInt(_snowman.nextInt(_snowman.nextInt(_snowman.maximum - _snowman.topOffset) + _snowman.bottomOffset) + _snowman.bottomOffset);
