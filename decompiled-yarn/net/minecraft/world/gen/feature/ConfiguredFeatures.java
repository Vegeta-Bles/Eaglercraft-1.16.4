...
public class ConfiguredFeatures {
   ...
   private static final ImmutableList<Supplier<ConfiguredFeature<?, ?>>> FOREST_FLOWER_VEGETATION_CONFIGS = ImmutableList.of(
      (Supplier<ConfiguredFeature<RandomPatchFeatureConfig, ?>>)() -> Feature.RANDOM_PATCH
            .configure(
      ...
      (Supplier<ConfiguredFeature<RandomPatchFeatureConfig, ?>>)() -> Feature.NO_BONEMEAL_FLOWER
            .configure(
      ...
      Feature.SIMPLE_RANDOM_SELECTOR
         .configure(
            new SimpleRandomFeatureConfig(
               ImmutableList.of(
                  (Supplier<ConfiguredFeature<DefaultFeatureConfig, ?>>)() -> Feature.CORAL_TREE.configure(FeatureConfig.DEFAULT),
                  (Supplier<ConfiguredFeature<DefaultFeatureConfig, ?>>)() -> Feature.CORAL_CLAW.configure(FeatureConfig.DEFAULT),
                  (Supplier<ConfiguredFeature<DefaultFeatureConfig, ?>>)() -> Feature.CORAL_MUSHROOM.configure(FeatureConfig.DEFAULT)
               )
            )
         )
         .decorate(ConfiguredFeatures.Decorators.TOP_SOLID_HEIGHTMAP)
