...
public class DesertPyramidFeature extends StructureFeature<DefaultFeatureConfig> {
   public DesertPyramidFeature(Codec<DefaultFeatureConfig> _snowman) {
      super(_snowman);
   }
   ...
   public static class Start extends StructureStart<DefaultFeatureConfig> {
      ...
      public void init(DynamicRegistryManager _snowman, ChunkGenerator _snowman, StructureManager _snowman, int _snowman, int _snowman, Biome _snowman, DefaultFeatureConfig _snowman) {
         DesertTempleGenerator _snowmanxxxxxxx = new DesertTempleGenerator(this.random, _snowman * 16, _snowman * 16);
