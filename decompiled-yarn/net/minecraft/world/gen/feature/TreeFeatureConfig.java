...
public class TreeFeatureConfig implements FeatureConfig {
   public static final Codec<TreeFeatureConfig> CODEC = RecordCodecBuilder.create(
      _snowman -> _snowman.group(
               BlockStateProvider.TYPE_CODEC.fieldOf("trunk_provider").forGetter(_snowmanx -> _snowmanx.trunkProvider),
               BlockStateProvider.TYPE_CODEC.fieldOf("leaves_provider").forGetter(_snowmanx -> _snowmanx.leavesProvider),
               FoliagePlacer.TYPE_CODEC.fieldOf("foliage_placer").forGetter(_snowmanx -> _snowmanx.foliagePlacer),
               TrunkPlacer.CODEC.fieldOf("trunk_placer").forGetter(_snowmanx -> _snowmanx.trunkPlacer),
               FeatureSize.TYPE_CODEC.fieldOf("minimum_size").forGetter(_snowmanx -> _snowmanx.minimumSize),
               TreeDecorator.TYPE_CODEC.listOf().fieldOf("decorators").forGetter(_snowmanx -> _snowmanx.decorators),
               Codec.INT.fieldOf("max_water_depth").orElse(0).forGetter(_snowmanx -> _snowmanx.maxWaterDepth),
               Codec.BOOL.fieldOf("ignore_vines").orElse(false).forGetter(_snowmanx -> _snowmanx.ignoreVines),
               Heightmap.Type.CODEC.fieldOf("heightmap").forGetter(_snowmanx -> _snowmanx.heightmap)
            )
            .apply(_snowman, TreeFeatureConfig::new)
   );
