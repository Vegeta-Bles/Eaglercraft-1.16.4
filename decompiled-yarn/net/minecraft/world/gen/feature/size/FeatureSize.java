...
public abstract class FeatureSize {
   ...
   protected static <S extends FeatureSize> RecordCodecBuilder<S, OptionalInt> createCodecBuilder() {
      return Codec.intRange(0, 80)
         ...
         .xmap(_snowman -> _snowman.map(OptionalInt::of).orElse(OptionalInt.empty()), _snowman -> _snowman.isPresent() ? Optional.of(_snowman.getAsInt()) : Optional.empty())
         .forGetter(_snowman -> _snowman.minClippedHeight);
   }
