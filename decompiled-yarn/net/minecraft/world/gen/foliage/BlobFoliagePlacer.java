...
public class BlobFoliagePlacer extends FoliagePlacer {
   public static final Codec<BlobFoliagePlacer> CODEC = RecordCodecBuilder.create(_snowman -> createCodec(_snowman).apply(_snowman, BlobFoliagePlacer::new));
   ...
   protected static <P extends BlobFoliagePlacer> P3<Mu<P>, UniformIntDistribution, UniformIntDistribution, Integer> createCodec(Instance<P> builder) {
      return fillFoliagePlacerFields(builder).and(Codec.intRange(0, 16).fieldOf("height").forGetter(_snowman -> _snowman.height));
   }
   ...
   protected void generate(
      ...
      for (int _snowman = offset; _snowman >= offset - foliageHeight; _snowman--) {
         int _snowmanx = Math.max(radius + treeNode.getFoliageRadius() - 1 - _snowman / 2, 0);
