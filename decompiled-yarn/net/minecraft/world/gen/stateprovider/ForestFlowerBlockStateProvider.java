...
public class ForestFlowerBlockStateProvider extends BlockStateProvider {
   ...
   public BlockState getBlockState(Random random, BlockPos pos) {
      double _snowman = MathHelper.clamp((1.0 + Biome.FOLIAGE_NOISE.sample((double)pos.getX() / 48.0, (double)pos.getZ() / 48.0, false)) / 2.0, 0.0, 0.9999);
      return FLOWERS[(int)(_snowman * (double)FLOWERS.length)];
   }
}
