...
public class ConfiguredSurfaceBuilder<SC extends SurfaceConfig> {
   public static final Codec<ConfiguredSurfaceBuilder<?>> CODEC = Registry.SURFACE_BUILDER.dispatch(_snowman -> _snowman.surfaceBuilder, SurfaceBuilder::getCodec);
   public static final Codec<Supplier<ConfiguredSurfaceBuilder<?>>> REGISTRY_CODEC = RegistryElementCodec.of(
      Registry.CONFIGURED_SURFACE_BUILDER_WORLDGEN, CODEC
   );
