...
public class TrunkPlacerType<P extends TrunkPlacer> {
   ...
   private static <P extends TrunkPlacer> TrunkPlacerType<P> register(String id, Codec<P> _snowman) {
      return Registry.register(Registry.TRUNK_PLACER_TYPE, id, new TrunkPlacerType<>(_snowman));
   }

   private TrunkPlacerType(Codec<P> _snowman) {
      this.codec = _snowman;
   }
