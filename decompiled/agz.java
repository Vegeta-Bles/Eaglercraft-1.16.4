...
public class agz {
   ...
   private static final Object2IntMap<String> e = (Object2IntMap<String>)DataFixUtils.make(new Object2IntOpenHashMap(), var0 -> var0.defaultReturnValue(-1));

   private static void a(int var0, String var1, String... var2) {
      Dynamic<?> _snowman = b(_snowman);
      b[_snowman] = _snowman;
      int _snowmanx = _snowman >> 4;
      if (c[_snowmanx] == null) {
         c[_snowmanx] = _snowman;
      }

      for (String _snowmanxx : _snowman) {
         Dynamic<?> _snowmanxxx = b(_snowmanxx);
         String _snowmanxxxx = _snowmanxxx.get("Name").asString("");
         e.putIfAbsent(_snowmanxxxx, _snowman);
         d.put(_snowmanxxx, _snowman);
      }
   }

   private static void a() {
      for (int _snowman = 0; _snowman < b.length; _snowman++) {
         if (b[_snowman] == null) {
            b[_snowman] = c[_snowman >> 4];
         }
      }
   }

   public static Dynamic<?> a(Dynamic<?> var0) {
      int _snowman = d.getInt(_snowman);
      if (_snowman >= 0 && _snowman < b.length) {
         Dynamic<?> _snowmanx = b[_snowman];
         return _snowmanx == null ? _snowman : _snowmanx;
      } else {
         return _snowman;
      }
   }
   ...
   public static String a(String var0) {
      int _snowman = e.getInt(_snowman);
      if (_snowman >= 0 && _snowman < b.length) {
         Dynamic<?> _snowmanx = b[_snowman];
         return _snowmanx == null ? _snowman : _snowmanx.get("Name").asString("");
      } else {
         return _snowman;
      }
   }
   ...
   public static Dynamic<?> b(String var0) {
      try {
         return new Dynamic(mo.a, mu.a(_snowman.replace('\'', '"')));
      } catch (Exception var2) {
         a.error("Parsing {}", _snowman, var2);
         throw new RuntimeException(var2);
      }
   }

   public static Dynamic<?> b(int var0) {
      Dynamic<?> _snowman = null;
      if (_snowman >= 0 && _snowman < b.length) {
         _snowman = b[_snowman];
      }

      return _snowman == null ? b[0] : _snowman;
   }
