...
public class ahh extends DataFix {
   ...
   public ahh(Schema var1, boolean var2) {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         _snowman,
         var2x -> var2x.updateTyped(_snowman, var2xx -> var2xx.update(DSL.remainderFinder(), var2xxx -> this.a((Dynamic<?>)var2x.get(DSL.remainderFinder()), var2xxx)))
      );
   }

   private Dynamic<?> a(Dynamic<?> var1, Dynamic<?> var2) {
      String _snowman = _snowman.get("id").asString("");
      if (a.containsKey(_snowman)) {
         Pair<String, ImmutableMap<String, String>> _snowmanx = (Pair<String, ImmutableMap<String, String>>)a.get(_snowman);
         if (((String)_snowmanx.getFirst()).equals(_snowman.get("id").asString(""))) {
            String _snowmanxx = _snowman.get("Template").asString("");
            _snowman = _snowman.set("Template", _snowman.createString((String)((ImmutableMap)_snowmanx.getSecond()).getOrDefault(_snowmanxx, _snowmanxx)));
         }
      }
