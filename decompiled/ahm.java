...
public class ahm extends DataFix {
   ...
   public ahm(Schema var1, boolean var2) {
      super(_snowman, _snowman);
   }

   public static int a(String var0) {
      Integer _snowman = a.get(_snowman);
   ...
   public TypeRewriteRule makeRule() {
      ...
      Function<Typed<?>, Typed<?>> _snowmanxx = var1x -> this.a(var1x, "DisplayTile", "DisplayData", "DisplayState");
      Function<Typed<?>, Typed<?>> _snowmanxxx = var1x -> this.a(var1x, "inTile", "inData", "inBlockState");
      Type<Pair<Either<Pair<String, Either<Integer, String>>, Unit>, Dynamic<?>>> _snowmanxxxx = DSL.and(
         DSL.optional(DSL.field("inTile", DSL.named(akn.q.typeName(), DSL.or(DSL.intType(), aln.a())))), DSL.remainderType()
      );
      Function<Typed<?>, Typed<?>> _snowmanxxxxx = var1x -> var1x.update(_snowman.finder(), DSL.remainderType(), Pair::getSecond);
      return this.fixTypeEverywhereTyped("EntityBlockStateFix", _snowman.getType(akn.p), _snowmanx.getType(akn.p), var4x -> {
         var4x = this.a(var4x, "minecraft:falling_block", this::a);
         var4x = this.a(var4x, "minecraft:enderman", var1x -> this.a(var1x, "carried", "carriedData", "carriedBlockState"));
         var4x = this.a(var4x, "minecraft:arrow", _snowman);
         var4x = this.a(var4x, "minecraft:spectral_arrow", _snowman);
         var4x = this.a(var4x, "minecraft:egg", _snowman);
         var4x = this.a(var4x, "minecraft:ender_pearl", _snowman);
         var4x = this.a(var4x, "minecraft:fireball", _snowman);
         var4x = this.a(var4x, "minecraft:potion", _snowman);
         var4x = this.a(var4x, "minecraft:small_fireball", _snowman);
         var4x = this.a(var4x, "minecraft:snowball", _snowman);
         var4x = this.a(var4x, "minecraft:wither_skull", _snowman);
         var4x = this.a(var4x, "minecraft:xp_bottle", _snowman);
         var4x = this.a(var4x, "minecraft:commandblock_minecart", _snowman);
         var4x = this.a(var4x, "minecraft:minecart", _snowman);
         var4x = this.a(var4x, "minecraft:chest_minecart", _snowman);
         var4x = this.a(var4x, "minecraft:furnace_minecart", _snowman);
         var4x = this.a(var4x, "minecraft:tnt_minecart", _snowman);
         var4x = this.a(var4x, "minecraft:hopper_minecart", _snowman);
         return this.a(var4x, "minecraft:spawner_minecart", _snowman);
      });
   }

   private Typed<?> a(Typed<?> var1) {
      Type<Either<Pair<String, Either<Integer, String>>, Unit>> _snowman = DSL.optional(
         DSL.field("Block", DSL.named(akn.q.typeName(), DSL.or(DSL.intType(), aln.a())))
      );
      Type<Either<Pair<String, Dynamic<?>>, Unit>> _snowmanx = DSL.optional(DSL.field("BlockState", DSL.named(akn.m.typeName(), DSL.remainderType())));
      Dynamic<?> _snowmanxx = (Dynamic<?>)_snowman.get(DSL.remainderFinder());
      return _snowman.update(_snowman.finder(), _snowmanx, var1x -> {
         int _snowmanxxx = (Integer)var1x.map(var0x -> (Integer)((Either)var0x.getSecond()).map(var0xx -> var0xx, ahm::a), var1xx -> {
            Optional<Number> _snowmanx = _snowman.get("TileID").asNumber().result();
            return _snowmanx.map(Number::intValue).orElseGet(() -> _snowman.get("Tile").asByte((byte)0) & 0xFF);
         });
         int _snowmanx = _snowman.get("Data").asInt(0) & 15;
         return Either.left(Pair.of(akn.m.typeName(), agz.b(_snowmanxxx << 4 | _snowmanx)));
      }).set(DSL.remainderFinder(), _snowmanxx.remove("Data").remove("TileID").remove("Tile"));
   }

   private Typed<?> a(Typed<?> var1, String var2, String var3, String var4) {
      Type<Pair<String, Either<Integer, String>>> _snowman = DSL.field(_snowman, DSL.named(akn.q.typeName(), DSL.or(DSL.intType(), aln.a())));
      Type<Pair<String, Dynamic<?>>> _snowmanx = DSL.field(_snowman, DSL.named(akn.m.typeName(), DSL.remainderType()));
      Dynamic<?> _snowmanxx = (Dynamic<?>)_snowman.getOrCreate(DSL.remainderFinder());
      return _snowman.update(_snowman.finder(), _snowmanx, var2x -> {
         int _snowmanxxx = (Integer)((Either)var2x.getSecond()).map(var0x -> var0x, ahm::a);
         int _snowmanx = _snowman.get(_snowman).asInt(0) & 15;
         return Pair.of(akn.m.typeName(), agz.b(_snowmanxxx << 4 | _snowmanx));
      }).set(DSL.remainderFinder(), _snowmanxx.remove(_snowman));
   }

   private Typed<?> a(Typed<?> var1, String var2, Function<Typed<?>, Typed<?>> var3) {
      ...
      return _snowman.updateTyped(DSL.namedChoice(_snowman, _snowman), _snowmanx, _snowman);
   }
}
