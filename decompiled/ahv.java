...
public class ahv extends DataFix {
   ...
   public ahv(Schema var1, boolean var2) {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> _snowmanxx = this.getInputSchema().getType(akn.l);
      Type<?> _snowmanxxx = this.getOutputSchema().getType(akn.l);
      return TypeRewriteRule.seq(
         this.convertUnchecked("item stack entity name hook converter", _snowmanxx, _snowmanxxx),
         this.fixTypeEverywhere("EntityIdFix", _snowman, _snowmanx, var0 -> var0x -> var0x.mapFirst(var0xx -> a.getOrDefault(var0xx, var0xx)))
      );
   }
}
