...
public class aik extends akw {
   ...
   public aik(Schema var1, boolean var2) {
      super("EntityTheRenameningBlock", _snowman, _snowman);
   }

   @Override
   protected String a(String var1) {
      if (_snowman.startsWith("minecraft:bred_")) {
         _snowman = "minecraft:" + _snowman.substring("minecraft:bred_".length());
      }
