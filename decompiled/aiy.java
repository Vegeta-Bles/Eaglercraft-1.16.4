...
public class aiy extends DataFix {
   ...
   public aiy(Schema var1, boolean var2) {
      super(_snowman, _snowman);
   }

   public static String a(int var0) {
      return (String)a.get(_snowman);
   }

   public TypeRewriteRule makeRule() {
      Type<Either<Integer, Pair<String, String>>> _snowman = DSL.or(DSL.intType(), DSL.named(akn.r.typeName(), aln.a()));
      Type<Pair<String, String>> _snowmanx = DSL.named(akn.r.typeName(), aln.a());
      OpticFinder<Either<Integer, Pair<String, String>>> _snowmanxx = DSL.fieldFinder("id", _snowman);
      return this.fixTypeEverywhereTyped(
         "ItemIdFix",
         this.getInputSchema().getType(akn.l),
         this.getOutputSchema().getType(akn.l),
         var2x -> var2x.update(_snowman, _snowman, var0x -> (Pair)var0x.map(var0xx -> Pair.of(akn.r.typeName(), a(var0xx.intValue())), var0xx -> var0xx))
      );
   }
}
