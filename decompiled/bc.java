...
public class bc extends ck<bc.a> {
   private static final vk a = new vk("enter_block");
   ...
   public bc.a a(JsonObject var1, bg.b var2, ax var3) {
      ...
      return new bc.a(_snowman, _snowman, _snowmanx);
   }
