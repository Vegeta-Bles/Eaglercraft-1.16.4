public class dxf extends dzb {
   private final dyw a;

   private dxf(dwt var1, double var2, double var4, double var6, double var8, dyw var10) {
      ...
      this.w = _snowman;
      this.x = _snowman;
      this.B = 1.0F - (float)_snowman * 0.5F;
      this.b(_snowman);
   }
   ...
   public static class a implements dyj<hi> {
      ...
      public dyg a(hi var1, dwt var2, double var3, double var5, double var7, double var9, double var11, double var13) {
         return new dxf(_snowman, _snowman, _snowman, _snowman, _snowman, this.a);
      }
   }
}
