...
public class hh {
   ...
   public static final hg<hd> o = a("dust", hd.c, var0 -> hd.b);
   ...
   public static final Codec<hf> au = gm.V.dispatch("type", hf::b, hg::e);

   private static hi a(String var0, boolean var1) {
      return gm.a(gm.V, _snowman, new hi(_snowman));
   }

   private static <T extends hf> hg<T> a(String var0, hf.a<T> var1, final Function<hg<T>, Codec<T>> var2) {
      return gm.a(gm.V, _snowman, new hg<T>(false, _snowman) {
         @Override
         public Codec<T> e() {
