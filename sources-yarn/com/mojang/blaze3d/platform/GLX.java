...
public class GLX {
   ...
   public static void _renderCrosshair(int size, boolean drawX, boolean drawY, boolean drawZ) {
      ...
      if (drawX) {
         ...
         lv2.vertex((double)size, 0.0, 0.0).color(0, 0, 0, 255).next();
      }

      if (drawY) {
         lv2.vertex(0.0, 0.0, 0.0).color(0, 0, 0, 255).next();
         lv2.vertex(0.0, (double)size, 0.0).color(0, 0, 0, 255).next();
      }

      if (drawZ) {
         lv2.vertex(0.0, 0.0, 0.0).color(0, 0, 0, 255).next();
         lv2.vertex(0.0, 0.0, (double)size).color(0, 0, 0, 255).next();
      }
      ...
      if (drawX) {
         ...
         lv2.vertex((double)size, 0.0, 0.0).color(255, 0, 0, 255).next();
      }

      if (drawY) {
         lv2.vertex(0.0, 0.0, 0.0).color(0, 255, 0, 255).next();
         lv2.vertex(0.0, (double)size, 0.0).color(0, 255, 0, 255).next();
      }

      if (drawZ) {
         lv2.vertex(0.0, 0.0, 0.0).color(127, 127, 255, 255).next();
         lv2.vertex(0.0, 0.0, (double)size).color(127, 127, 255, 255).next();
      }
