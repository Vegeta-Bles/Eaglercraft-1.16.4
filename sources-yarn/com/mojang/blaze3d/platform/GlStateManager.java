...
public class GlStateManager {
   ...
   public static void setupLevelDiffuseLighting(Vector3f arg, Vector3f arg2, Matrix4f arg3) {
      ...
      lv.transform(arg3);
      light(16384, 4611, getBuffer(lv.getX(), lv.getY(), lv.getZ(), 0.0F));
      float f = 0.6F;
      ...
      lv2.transform(arg3);
      light(16385, 4611, getBuffer(lv2.getX(), lv2.getY(), lv2.getZ(), 0.0F));
   ...
   public static void setupGuiFlatDiffuseLighting(Vector3f arg, Vector3f arg2) {
      ...
      setupLevelDiffuseLighting(arg, arg2, lv);
   }
   ...
   public static void texGenMode(GlStateManager.TexCoord coord, int mode) {
      RenderSystem.assertThread(RenderSystem::isOnRenderThread);
      GlStateManager.TexGenCoordState lv = getGenCoordState(coord);
      if (mode != lv.mode) {
         lv.mode = mode;
         GL11.glTexGeni(lv.coord, 9472, mode);
      }
   }
