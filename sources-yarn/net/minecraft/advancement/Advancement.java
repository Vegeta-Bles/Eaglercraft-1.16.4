...
public class Advancement {
   ...
   public Advancement(
      ...
      if (display == null) {
         ...
         Text lv3 = Texts.setStyleIfAbsent(lv.shallowCopy(), Style.EMPTY.withColor(lv2)).append("\n").append(display.getDescription());
         Text lv4 = lv.shallowCopy().styled(arg2 -> arg2.withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, lv3)));
   ...
   public static class Task {
      ...
      public Advancement.Task rewards(AdvancementRewards.Builder arg) {
      ...
      public Advancement.Task criterion(String name, CriterionConditions arg) {
         return this.criterion(name, new AdvancementCriterion(arg));
      }

      public Advancement.Task criterion(String name, AdvancementCriterion arg) {
      ...
      public static Advancement.Task fromJson(JsonObject obj, AdvancementEntityPredicateDeserializer predicateDeserializer) {
         ...
         if (map.isEmpty()) {
            ...
            return new Advancement.Task(lv, lv2, lv3, map, strings);
         }
      }
      ...
      public static Advancement.Task fromPacket(PacketByteBuf buf) {
         ...
         return new Advancement.Task(lv, lv2, AdvancementRewards.NONE, map, strings);
      }
