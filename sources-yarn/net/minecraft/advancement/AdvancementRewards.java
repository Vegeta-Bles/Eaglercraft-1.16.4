...
public class AdvancementRewards {
   ...
   public void apply(ServerPlayerEntity player) {
      ...
      LootContext lv = new LootContext.Builder(player.getServerWorld())
      ...
      this.function
         ...
         .ifPresent(arg2 -> minecraftServer.getCommandFunctionManager().execute(arg2, player.getCommandSource().withSilent().withLevel(2)));
   }
