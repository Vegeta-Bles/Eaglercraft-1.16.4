...
public class BrewedPotionCriterion extends AbstractCriterion<BrewedPotionCriterion.Conditions> {
   ...
   public BrewedPotionCriterion.Conditions conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended arg, AdvancementEntityPredicateDeserializer arg2) {
      Potion lv = null;
      ...
      return new BrewedPotionCriterion.Conditions(arg, lv);
   }
