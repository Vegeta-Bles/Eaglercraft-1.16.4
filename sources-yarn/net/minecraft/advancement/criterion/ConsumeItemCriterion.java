...
public class ConsumeItemCriterion extends AbstractCriterion<ConsumeItemCriterion.Conditions> {
   ...
   public ConsumeItemCriterion.Conditions conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended arg, AdvancementEntityPredicateDeserializer arg2) {
      return new ConsumeItemCriterion.Conditions(arg, ItemPredicate.fromJson(jsonObject.get("item")));
   }
