...
public interface Criterion<T extends CriterionConditions> {
   ...
   void beginTrackingCondition(PlayerAdvancementTracker manager, Criterion.ConditionsContainer<T> arg2);

   void endTrackingCondition(PlayerAdvancementTracker manager, Criterion.ConditionsContainer<T> arg2);
   ...
   public static class ConditionsContainer<T extends CriterionConditions> {
      ...
      public boolean equals(Object o) {
         if (this == o) {
            ...
            Criterion.ConditionsContainer<?> lv = (Criterion.ConditionsContainer<?>)o;
