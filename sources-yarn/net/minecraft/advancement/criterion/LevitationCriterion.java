...
public class LevitationCriterion extends AbstractCriterion<LevitationCriterion.Conditions> {
   ...
   public LevitationCriterion.Conditions conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended arg, AdvancementEntityPredicateDeserializer arg2) {
      ...
      return new LevitationCriterion.Conditions(arg, lv, lv2);
   }
