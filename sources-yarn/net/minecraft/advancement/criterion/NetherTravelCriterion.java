...
public class NetherTravelCriterion extends AbstractCriterion<NetherTravelCriterion.Conditions> {
   ...
   public NetherTravelCriterion.Conditions conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended arg, AdvancementEntityPredicateDeserializer arg2) {
      ...
      return new NetherTravelCriterion.Conditions(arg, lv, lv2, lv3);
   }
