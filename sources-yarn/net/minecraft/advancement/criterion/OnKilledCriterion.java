...
public class OnKilledCriterion extends AbstractCriterion<OnKilledCriterion.Conditions> {
   ...
   public OnKilledCriterion.Conditions conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended arg, AdvancementEntityPredicateDeserializer arg2) {
      return new OnKilledCriterion.Conditions(
         this.id, arg, EntityPredicate.Extended.getInJson(jsonObject, "entity", arg2), DamageSourcePredicate.fromJson(jsonObject.get("killing_blow"))
      );
   }
