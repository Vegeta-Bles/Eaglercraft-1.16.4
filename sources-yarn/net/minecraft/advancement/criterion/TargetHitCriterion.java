...
public class TargetHitCriterion extends AbstractCriterion<TargetHitCriterion.Conditions> {
   ...
   public TargetHitCriterion.Conditions conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended arg, AdvancementEntityPredicateDeserializer arg2) {
      ...
      return new TargetHitCriterion.Conditions(arg, lv, lv2);
   }
   ...
   public static class Conditions extends AbstractCriterionConditions {
      ...
      public static TargetHitCriterion.Conditions create(NumberRange.IntRange signalStrength, EntityPredicate.Extended arg2) {
         return new TargetHitCriterion.Conditions(EntityPredicate.Extended.EMPTY, signalStrength, arg2);
      }
