...
public class TickCriterion extends AbstractCriterion<TickCriterion.Conditions> {
   ...
   public TickCriterion.Conditions conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended arg, AdvancementEntityPredicateDeserializer arg2) {
      return new TickCriterion.Conditions(arg);
   }
