...
public class UsedEnderEyeCriterion extends AbstractCriterion<UsedEnderEyeCriterion.Conditions> {
   ...
   public UsedEnderEyeCriterion.Conditions conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended arg, AdvancementEntityPredicateDeserializer arg2) {
      NumberRange.FloatRange lv = NumberRange.FloatRange.fromJson(jsonObject.get("distance"));
      return new UsedEnderEyeCriterion.Conditions(arg, lv);
   }
