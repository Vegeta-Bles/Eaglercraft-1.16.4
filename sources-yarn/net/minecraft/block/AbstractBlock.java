...
public abstract class AbstractBlock {
   ...
   public abstract static class AbstractBlockState extends State<Block, BlockState> {
      ...
      protected AbstractBlockState(Block block, ImmutableMap<Property<?>, Comparable<?>> propertyMap, MapCodec<BlockState> mapCodec) {
         ...
         AbstractBlock.Settings lv = block.settings;
         ...
         this.materialColor = lv.materialColorFactory.apply(this.asBlockState());
      ...
      public final void updateNeighbors(WorldAccess world, BlockPos pos, int flags, int maxUpdateDepth) {
         ...
         for (Direction lv2 : AbstractBlock.FACINGS) {
            ...
            Block.replace(lv3, lv4, world, lv, flags, maxUpdateDepth);
         }
      }
      ...
      public boolean method_27851(Tag<Block> arg, Predicate<AbstractBlock.AbstractBlockState> predicate) {
      ...
      static final class ShapeCache {
         ...
         private ShapeCache(BlockState state) {
            ...
            this.exceedsCube = Arrays.stream(Direction.Axis.values())
               .anyMatch(arg -> this.collisionShape.getMin(arg) < 0.0 || this.collisionShape.getMax(arg) > 1.0);
   ...
   public static class Settings {
      ...
      public static AbstractBlock.Settings copy(AbstractBlock block) {
         AbstractBlock.Settings lv = new AbstractBlock.Settings(block.material, block.settings.materialColorFactory);
