...
public class CropBlock extends PlantBlock implements Fertilizable {
   ...
   protected static float getAvailableMoisture(Block block, BlockView world, BlockPos pos) {
      ...
      boolean bl2 = block == world.getBlockState(lv3).getBlock() || block == world.getBlockState(lv4).getBlock();
      if (bl && bl2) {
         f /= 2.0F;
      } else {
         boolean bl3 = block == world.getBlockState(lv5.north()).getBlock()
            || block == world.getBlockState(lv6.north()).getBlock()
            || block == world.getBlockState(lv6.south()).getBlock()
            || block == world.getBlockState(lv5.south()).getBlock();
         if (bl3) {
            f /= 2.0F;
         }
      }
