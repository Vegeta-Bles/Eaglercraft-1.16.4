...
public class EnderChestBlock extends AbstractChestBlock<EnderChestBlockEntity> implements Waterloggable {
   ...
   public BlockState getPlacementState(ItemPlacementContext ctx) {
      ...
      return this.getDefaultState().with(FACING, ctx.getPlayerFacing().getOpposite()).with(WATERLOGGED, Boolean.valueOf(lv.getFluid() == Fluids.WATER));
   }
      ...
      if (lv != null && lv2 instanceof EnderChestBlockEntity) {
         ...
         if (world.getBlockState(lv3).isSolidBlock(world, lv3)) {
            ...
            player.openHandledScreen(
               new SimpleNamedScreenHandlerFactory((i, arg2, arg3) -> GenericContainerScreenHandler.createGeneric9x3(i, arg2, lv), CONTAINER_NAME)
            );
