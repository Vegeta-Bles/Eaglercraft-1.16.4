...
public class EntityShapeContext implements ShapeContext {
   protected static final ShapeContext ABSENT = new EntityShapeContext(false, -Double.MAX_VALUE, Items.AIR, arg -> false) {
      @Override
   ...
   protected EntityShapeContext(Entity entity) {
      this(
         ...
         entity instanceof LivingEntity ? ((LivingEntity)entity)::canWalkOnFluid : arg -> false
      );
   }
