...
public class LecternBlock extends BlockWithEntity {
   ...
   public BlockState getPlacementState(ItemPlacementContext ctx) {
      ...
      boolean bl = false;
      if (!lv.isClient && lv4 != null && lv3 != null && lv4.isCreativeLevelTwoOp() && lv3.contains("BlockEntityTag")) {
         CompoundTag lv5 = lv3.getCompound("BlockEntityTag");
         if (lv5.contains("Book")) {
            bl = true;
         }
      }
   ...
   public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
      if (state.get(HAS_BOOK)) {
         ...
         return !lv.isEmpty() && !lv.getItem().isIn(ItemTags.LECTERN_BOOKS) ? ActionResult.CONSUME : ActionResult.PASS;
      }
   }
