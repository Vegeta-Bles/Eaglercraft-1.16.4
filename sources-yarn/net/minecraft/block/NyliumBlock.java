...
public class NyliumBlock extends Block implements Fertilizable {
   ...
   public void grow(ServerWorld world, Random random, BlockPos pos, BlockState state) {
      ...
      if (lv.isOf(Blocks.CRIMSON_NYLIUM)) {
         NetherForestVegetationFeature.generate(world, random, lv2, ConfiguredFeatures.Configs.CRIMSON_ROOTS_CONFIG, 3, 1);
      } else if (lv.isOf(Blocks.WARPED_NYLIUM)) {
         NetherForestVegetationFeature.generate(world, random, lv2, ConfiguredFeatures.Configs.WARPED_ROOTS_CONFIG, 3, 1);
         NetherForestVegetationFeature.generate(world, random, lv2, ConfiguredFeatures.Configs.NETHER_SPROUTS_CONFIG, 3, 1);
