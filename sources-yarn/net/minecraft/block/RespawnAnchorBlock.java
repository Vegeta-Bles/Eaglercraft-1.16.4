...
public class RespawnAnchorBlock extends Block {
   ...
   public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
      ...
      if (hand == Hand.MAIN_HAND && !isChargeItem(lv) && isChargeItem(player.getStackInHand(Hand.OFF_HAND))) {
         ...
         if (!world.isClient) {
            ...
            if (lv2.getSpawnPointDimension() != world.getRegistryKey() || !lv2.getSpawnPointPosition().equals(pos)) {
   ...
   private void explode(BlockState state, World world, final BlockPos explodedPos) {
      ...
      boolean bl = Direction.Type.HORIZONTAL.stream().map(explodedPos::offset).anyMatch(arg2 -> hasStillWater(arg2, world));
   ...
   public static Optional<Vec3d> findRespawnPosition(EntityType<?> entity, CollisionView arg2, BlockPos pos) {
      Optional<Vec3d> optional = method_30842(entity, arg2, pos, true);
      return optional.isPresent() ? optional : method_30842(entity, arg2, pos, false);
   }

   private static Optional<Vec3d> method_30842(EntityType<?> arg, CollisionView arg2, BlockPos arg3, boolean bl) {
      BlockPos.Mutable lv = new BlockPos.Mutable();
      UnmodifiableIterator var5 = field_26443.iterator();

      while (var5.hasNext()) {
         Vec3i lv2 = (Vec3i)var5.next();
         lv.set(arg3).move(lv2);
         Vec3d lv3 = Dismounting.method_30769(arg, arg2, lv, bl);
         if (lv3 != null) {
