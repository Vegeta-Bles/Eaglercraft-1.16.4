...
public class SnowBlock extends Block {
   ...
   public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
      ...
      if (lv.isOf(Blocks.ICE) || lv.isOf(Blocks.PACKED_ICE) || lv.isOf(Blocks.BARRIER)) {
         ...
         return !lv.isOf(Blocks.HONEY_BLOCK) && !lv.isOf(Blocks.SOUL_SAND)
            ? Block.isFaceFullSquare(lv.getCollisionShape(world, pos.down()), Direction.UP) || lv.getBlock() == this && lv.get(LAYERS) == 8
            : true;
      }
   }
