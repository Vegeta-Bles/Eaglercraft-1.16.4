...
public class TurtleEggBlock extends Block {
   ...
   private void tryBreakEgg(World world, BlockPos arg2, Entity entity, int inverseChance) {
      if (this.breaksEgg(world, entity)) {
         if (!world.isClient && world.random.nextInt(inverseChance) == 0) {
            BlockState lv = world.getBlockState(arg2);
            if (lv.isOf(Blocks.TURTLE_EGG)) {
   ...
   public static boolean isSand(BlockView arg, BlockPos arg2) {
      return method_29952(arg, arg2.down());
   }
   ...
   public BlockState getPlacementState(ItemPlacementContext ctx) {
      ...
      return lv.isOf(this) ? lv.with(EGGS, Integer.valueOf(Math.min(4, lv.get(EGGS) + 1))) : super.getPlacementState(ctx);
   }
   ...
   private boolean breaksEgg(World arg, Entity arg2) {
      if (arg2 instanceof TurtleEntity || arg2 instanceof BatEntity) {
         ...
         return !(arg2 instanceof LivingEntity) ? false : arg2 instanceof PlayerEntity || arg.getGameRules().getBoolean(GameRules.DO_MOB_GRIEFING);
      }
   }
}
