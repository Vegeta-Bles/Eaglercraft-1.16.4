...
public enum BannerPattern {
   ...
   public static final int field_24417 = (int)Arrays.stream(VALUES).filter(arg -> arg.field_24419).count();
   ...
   public static class Patterns {
      ...
      public ListTag toTag() {
         ...
         for (Pair<BannerPattern, DyeColor> pair : this.entries) {
            ...
            lv2.putString("Pattern", ((BannerPattern)pair.getLeft()).id);
