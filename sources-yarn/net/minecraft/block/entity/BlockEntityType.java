...
public class BlockEntityType<T extends BlockEntity> {
   ...
   private static <T extends BlockEntity> BlockEntityType<T> create(String string, BlockEntityType.Builder<T> arg) {
      if (arg.blocks.isEmpty()) {
   ...
   public T get(BlockView world, BlockPos pos) {
      ...
      return (T)(lv != null && lv.getType() == this ? lv : null);
   }
