...
public class EnderChestBlockEntity extends BlockEntity implements ChestAnimationProgress, Tickable {
   ...
   public void tick() {
      ...
      if (this.viewerCount == 0 && this.animationProgress > 0.0F || this.viewerCount > 0 && this.animationProgress < 1.0F) {
         ...
         if (this.animationProgress < 0.5F && g >= 0.5F) {
            ...
            this.world
               .playSound(
                  null, l, (double)j + 0.5, m, SoundEvents.BLOCK_ENDER_CHEST_CLOSE, SoundCategory.BLOCKS, 0.5F, this.world.random.nextFloat() * 0.1F + 0.9F
               );
         }
   ...
   public boolean canPlayerUse(PlayerEntity arg) {
      return this.world.getBlockEntity(this.pos) != this
         ? false
         : !(arg.squaredDistanceTo((double)this.pos.getX() + 0.5, (double)this.pos.getY() + 0.5, (double)this.pos.getZ() + 0.5) > 64.0);
   }
