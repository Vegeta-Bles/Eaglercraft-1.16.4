   ...
   public static class Loader implements FontLoader {
               ...
               if (k > 0) {
                  ...
                  if (is.length != l) {
                     throw new JsonParseException(
                        "Elements of chars have to be the same length (found: " + is.length + ", expected: " + l + "), pad with space or \\u0000"
                     );
                  }
               }
      ...
      public Font load(ResourceManager manager) {
         try (Resource lv = manager.getResource(this.filename)) {
            ...
            for (int m = 0; m < this.chars.size(); m++) {
               ...
               for (int o : this.chars.get(m)) {
                  ...
                  if (o != 0 && o != 32) {
                     ...
                     BitmapFont.BitmapFontGlyph lv3 = (BitmapFont.BitmapFontGlyph)int2ObjectMap.put(
            ...
            return new BitmapFont(lv2, int2ObjectMap);
