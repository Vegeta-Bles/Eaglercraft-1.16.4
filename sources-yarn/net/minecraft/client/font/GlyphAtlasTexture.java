...
public class GlyphAtlasTexture extends AbstractTexture {
   ...
   public GlyphRenderer getGlyphRenderer(RenderableGlyph glyph) {
      if (glyph.hasColor() != this.hasColor) {
         ...
         GlyphAtlasTexture.Slot lv = this.rootSlot.findSlotFor(glyph);
         if (lv != null) {
            this.bindTexture();
            ...
            return new GlyphRenderer(
               ...
               ((float)lv.x - 0.01F + (float)glyph.getWidth()) / 256.0F,
               ((float)lv.y + 0.01F) / 256.0F,
               ((float)lv.y - 0.01F + (float)glyph.getHeight()) / 256.0F,
               glyph.getXMin(),
               glyph.getXMax(),
               glyph.getYMin(),
               glyph.getYMax()
   ...
   static class Slot {
      ...
      GlyphAtlasTexture.Slot findSlotFor(RenderableGlyph glyph) {
         if (this.subSlot1 != null && this.subSlot2 != null) {
            GlyphAtlasTexture.Slot lv = this.subSlot1.findSlotFor(glyph);
            if (lv == null) {
