...
public class TrueTypeFontLoader implements FontLoader {
   ...
   public Font load(ResourceManager manager) {
      ...
      try (Resource lv = manager.getResource(new Identifier(this.filename.getNamespace(), "font/" + this.filename.getPath()))) {
         ...
         if (!STBTruetype.stbtt_InitFont(sTBTTFontinfo, byteBuffer)) {
            ...
            return new TrueTypeFont(byteBuffer, sTBTTFontinfo, this.size, this.oversample, this.shiftX, this.shiftY, this.excludedCharacters);
         }
