...
public class Framebuffer {
      ...
      if (GlStateManager.supportsGl30()) {
         ...
         if (i != 0) {
            ...
            GlStateManager.copyTexSubImage2d(
               3553, 0, 0, 0, 0, 0, Math.min(this.textureWidth, arg.textureWidth), Math.min(this.textureHeight, arg.textureHeight)
            );
   ...
   private void drawInternal(int width, int height, boolean bl) {
      ...
      lv2.vertex(0.0, (double)g, 0.0).texture(0.0F, 0.0F).color(255, 255, 255, 255).next();
      lv2.vertex((double)f, (double)g, 0.0).texture(h, 0.0F).color(255, 255, 255, 255).next();
      lv2.vertex((double)f, 0.0, 0.0).texture(h, k).color(255, 255, 255, 255).next();
