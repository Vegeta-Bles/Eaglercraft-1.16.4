      ...
      if (verbosity > 0) {
         ...
         if (gLCapabilities.GL_KHR_debug) {
            ...
            for (int j = 0; j < KHR_VERBOSITY_LEVELS.size(); j++) {
               ...
               KHRDebug.glDebugMessageControl(4352, 4352, KHR_VERBOSITY_LEVELS.get(j), (int[])null, bl2);
            }
            ...
            for (int k = 0; k < ARB_VERBOSITY_LEVELS.size(); k++) {
               ...
               ARBDebugOutput.glDebugMessageControlARB(4352, 4352, ARB_VERBOSITY_LEVELS.get(k), (int[])null, bl3);
            }
