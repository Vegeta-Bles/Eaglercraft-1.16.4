...
public class ShaderEffect implements AutoCloseable {
   ...
   private void parseEffect(TextureManager arg, Identifier location) throws IOException, JsonSyntaxException {
      ...
      try {
         ...
         if (JsonHelper.hasArray(jsonObject, "targets")) {
            ...
            for (JsonElement jsonElement : jsonArray) {
               try {
                  ...
                  ShaderParseException lv2 = ShaderParseException.wrap(var17);
         ...
         if (JsonHelper.hasArray(jsonObject, "passes")) {
            ...
            for (JsonElement jsonElement2 : jsonArray2) {
               try {
                  ...
                  ShaderParseException lv3 = ShaderParseException.wrap(var16);
         ...
         String string;
         if (lv != null) {
            string = " (" + lv.getResourcePackName() + ")";
         } else {
            string = "";
         }

         ShaderParseException lv4 = ShaderParseException.wrap(var18);
         lv4.addFaultyFile(location.getPath() + string);
         throw lv4;
      } finally {
         ...
         if (jsonArray != null) {
            ...
            for (JsonElement jsonElement2 : jsonArray) {
               try {
                  ...
                  ShaderParseException lv8 = ShaderParseException.wrap(var33);
         ...
         if (jsonArray2 != null) {
            ...
            for (JsonElement jsonElement3 : jsonArray2) {
               try {
                  ...
                  ShaderParseException lv9 = ShaderParseException.wrap(var30);
      ...
      if (lv == null) {
         ...
         for (JsonElement jsonElement2 : JsonHelper.getArray(jsonObject, "values")) {
            try {
               ...
               ShaderParseException lv2 = ShaderParseException.wrap(var12);
