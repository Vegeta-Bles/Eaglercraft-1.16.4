...
public class DatapackFailureScreen extends Screen {
   ...
   protected void init() {
      ...
      this.addButton(
         new ButtonWidget(this.width / 2 - 155, this.height / 6 + 96, 150, 20, new TranslatableText("datapackFailure.safeMode"), arg -> this.field_25452.run())
      );
      this.addButton(
         new ButtonWidget(this.width / 2 - 155 + 160, this.height / 6 + 96, 150, 20, new TranslatableText("gui.toTitle"), arg -> this.client.openScreen(null))
      );
   }
