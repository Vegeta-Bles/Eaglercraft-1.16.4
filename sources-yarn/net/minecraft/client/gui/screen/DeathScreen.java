...
public class DeathScreen extends Screen {
         ...
         new ButtonWidget(
            ...
            arg -> {
               if (this.isHardcore) {
                  ...
                  ConfirmScreen lvx = new ConfirmScreen(
                     this::onConfirmQuit,
   ...
   private Style getTextComponentUnderMouse(int mouseX) {
      if (this.message == null) {
         ...
         return mouseX >= k && mouseX <= l ? this.client.textRenderer.getTextHandler().getStyleAt(this.message, mouseX - k) : null;
      }
   }
