...
public class DemoScreen extends Screen {
   ...
   protected void init() {
      ...
      this.field_26538 = class_5489.method_30892(
         ...
         new TranslatableText(
            ...
            lv.keyForward.getBoundKeyLocalizedText(),
            lv.keyLeft.getBoundKeyLocalizedText(),
            lv.keyBack.getBoundKeyLocalizedText(),
            lv.keyRight.getBoundKeyLocalizedText()
         ),
         new TranslatableText("demo.help.movementMouse"),
         new TranslatableText("demo.help.jump", lv.keyJump.getBoundKeyLocalizedText()),
         new TranslatableText("demo.help.inventory", lv.keyInventory.getBoundKeyLocalizedText())
      );
   ...
   public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
      ...
      l = this.field_26538.method_30896(matrices, k, l + 12, 12, 5197647);
      this.field_26539.method_30896(matrices, k, l + 20, 9, 2039583);
