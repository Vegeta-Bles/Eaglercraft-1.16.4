   ...
   private void initWidgets() {
      ...
      this.addButton(
         new ButtonWidget(
            ...
            arg -> this.client.openScreen(new AdvancementsScreen(this.client.player.networkHandler.getAdvancementHandler()))
         )
      );
      this.addButton(
         new ButtonWidget(
            ...
            arg -> this.client.openScreen(new StatsScreen(this, this.client.player.getStatHandler()))
         )
      );
      ...
      this.addButton(
         new ButtonWidget(
            ...
            arg -> this.client.openScreen(new ConfirmChatLinkScreen(bl -> {
                  if (bl) {
      ...
      ButtonWidget lv = this.addButton(
         new ButtonWidget(
            ...
            arg -> this.client.openScreen(new OpenToLanScreen(this))
         )
      );
      lv.active = this.client.isIntegratedServerRunning() && !this.client.getServer().isRemote();
      ButtonWidget lv2 = this.addButton(
         new ButtonWidget(this.width / 2 - 102, this.height / 4 + 120 + -16, 204, 20, new TranslatableText("menu.returnToMenu"), arg -> {
            ...
            if (bl) {
               ...
               RealmsBridgeScreen lvx = new RealmsBridgeScreen();
               lvx.switchToRealms(new TitleScreen());
            } else {
