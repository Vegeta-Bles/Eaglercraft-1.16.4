...
public class GameModeSelectionScreen extends Screen {
   ...
   private net.minecraft.world.GameMode method_30106() {
      ...
      if (lv2 == net.minecraft.world.GameMode.NOT_SET) {
         if (lv == net.minecraft.world.GameMode.CREATIVE) {
            lv2 = net.minecraft.world.GameMode.SURVIVAL;
         } else {
            lv2 = net.minecraft.world.GameMode.CREATIVE;
         }
      }
   ...
   protected void init() {
      ...
      for (int i = 0; i < GameModeSelectionScreen.GameMode.VALUES.length; i++) {
         GameModeSelectionScreen.GameMode lv = GameModeSelectionScreen.GameMode.VALUES[i];
         this.gameModeButtons.add(new GameModeSelectionScreen.ButtonWidget(lv, this.width / 2 - UI_WIDTH / 2 + i * 30, this.height / 2 - 30));
      }
   }
   ...
   public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
      if (!this.checkForClose()) {
         ...
         this.gameMode.ifPresent(arg2 -> drawCenteredText(matrices, this.textRenderer, arg2.getText(), this.width / 2, this.height / 2 - 30 - 20, -1));
         ...
         for (GameModeSelectionScreen.ButtonWidget lv : this.gameModeButtons) {
   ...
   private static void apply(MinecraftClient client, Optional<GameModeSelectionScreen.GameMode> gameMode) {
      if (client.interactionManager != null && client.player != null && gameMode.isPresent()) {
         Optional<GameModeSelectionScreen.GameMode> optional2 = GameModeSelectionScreen.GameMode.of(client.interactionManager.getCurrentGameMode());
         GameModeSelectionScreen.GameMode lv = gameMode.get();
   ...
   public class ButtonWidget extends AbstractButtonWidget {
      ...
      public ButtonWidget(GameModeSelectionScreen.GameMode arg2, int x, int y) {
      ...
      private void drawBackground(MatrixStack matrices, TextureManager arg2) {
         arg2.bindTexture(GameModeSelectionScreen.TEXTURE);
         matrices.push();
   ...
   static enum GameMode {
      ...
      private static Optional<GameModeSelectionScreen.GameMode> of(net.minecraft.world.GameMode arg) {
         switch (arg) {
            case SPECTATOR:
               return Optional.of(SPECTATOR);
            case SURVIVAL:
