...
public class LevelLoadingScreen extends Screen {
   ...
   public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
      ...
      drawCenteredString(matrices, this.textRenderer, string, k, m - 9 / 2 - 30, 16777215);
   }
   ...
   public static void drawChunkMap(MatrixStack arg, WorldGenerationProgressTracker arg2, int i, int j, int k, int l) {
      ...
      int u = -16772609;
      if (l != 0) {
         fill(arg, i - t, j - t, i - t + 1, j + t, -16772609);
         fill(arg, i + t - 1, j - t, i + t, j + t, -16772609);
         fill(arg, i - t, j - t, i + t, j - t + 1, -16772609);
         fill(arg, i - t, j + t - 1, i + t, j + t, -16772609);
      }
      ...
      for (int v = 0; v < p; v++) {
         for (int w = 0; w < p; w++) {
            ...
            int x = r + v * m;
            int y = s + w * m;
            fill(arg, x, y, x + k, y + k, STATUS_TO_COLOR.getInt(lv) | 0xFF000000);
         }
      }
   }
}
