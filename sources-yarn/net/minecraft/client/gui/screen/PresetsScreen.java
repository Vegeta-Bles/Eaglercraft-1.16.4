...
public class PresetsScreen extends Screen {
   ...
   private static FlatChunkGeneratorLayer method_29059(String string, int i) {
      ...
      Block lv;
      try {
         lv = Registry.BLOCK.getOrEmpty(new Identifier(string2)).orElse(null);
      ...
      if (lv == null) {
         ...
         FlatChunkGeneratorLayer lv3 = new FlatChunkGeneratorLayer(m, lv);
         lv3.setStartY(i);
         return lv3;
      }
   }
   ...
   private static List<FlatChunkGeneratorLayer> method_29058(String string) {
      ...
      for (String string2 : strings) {
         FlatChunkGeneratorLayer lv = method_29059(string2, i);
         if (lv == null) {
   ...
   public static FlatChunkGeneratorConfig method_29060(Registry<Biome> arg, String string, FlatChunkGeneratorConfig arg2) {
      ...
      if (!iterator.hasNext()) {
         return FlatChunkGeneratorConfig.getDefaultConfig(arg);
      } else {
         List<FlatChunkGeneratorLayer> list = method_29058(iterator.next());
         if (list.isEmpty()) {
            return FlatChunkGeneratorConfig.getDefaultConfig(arg);
         } else {
            FlatChunkGeneratorConfig lv = arg2.method_29965(list, arg2.getStructuresConfig());
            RegistryKey<Biome> lv2 = BiomeKeys.PLAINS;
            if (iterator.hasNext()) {
               try {
                  Identifier lv3 = new Identifier(iterator.next());
                  lv2 = RegistryKey.of(Registry.BIOME_KEY, lv3);
                  arg.getOrEmpty(lv2).orElseThrow(() -> new IllegalArgumentException("Invalid Biome: " + lv3));
               } catch (Exception var8) {
                  field_25043.error("Error while parsing flat world string => {}", var8.getMessage());
               }
            }

            RegistryKey<Biome> lv4 = lv2;
            lv.setBiome(() -> arg.getOrThrow(lv4));
            return lv;
         }
      }
   }

   private static String method_29062(Registry<Biome> arg, FlatChunkGeneratorConfig arg2) {
      ...
      stringBuilder.append(";");
      stringBuilder.append(arg.getId(arg2.getBiome()));
   ...
   protected void init() {
      ...
      Registry<Biome> lv = this.parent.parent.moreOptionsDialog.method_29700().get(Registry.BIOME_KEY);
      this.customPresetField.setText(method_29062(lv, this.parent.method_29055()));
      ...
      this.selectPresetButton = this.addButton(
         new ButtonWidget(this.width / 2 - 155, this.height - 28, 150, 20, new TranslatableText("createWorld.customize.presets.select"), arg2 -> {
            FlatChunkGeneratorConfig lvx = method_29060(lv, this.customPresetField.getText(), this.field_25044);
            this.parent.method_29054(lvx);
   ...
   private static void addPreset(
      ...
      RegistryKey<Biome> arg3,
      List<StructureFeature<?>> structures,
      boolean bl,
      boolean bl2,
      boolean bl3,
      FlatChunkGeneratorLayer... args
   ) {
      PRESETS.add(new PresetsScreen.SuperflatPreset(icon.asItem(), arg, arg2 -> {
         Map<StructureFeature<?>, StructureConfig> map = Maps.newHashMap();

         for (StructureFeature<?> lv : structures) {
            map.put(lv, (StructureConfig)StructuresConfig.DEFAULT_STRUCTURES.get(lv));
         }

         StructuresConfig lv2 = new StructuresConfig(bl ? Optional.of(StructuresConfig.DEFAULT_STRONGHOLD) : Optional.empty(), map);
         FlatChunkGeneratorConfig lv3 = new FlatChunkGeneratorConfig(lv2, arg2);
         if (bl2) {
            lv3.enableFeatures();
         }
         ...
         lv3.setBiome(() -> arg2.getOrThrow(arg3));
         lv3.updateLayerBlocks();
         return lv3.withStructuresConfig(lv2);
      }));
   }
   ...
   static class SuperflatPreset {
      ...
      public SuperflatPreset(Item icon, Text arg2, Function<Registry<Biome>, FlatChunkGeneratorConfig> function) {
         this.icon = icon;
         this.name = arg2;
   ...
   class SuperflatPresetsListWidget extends AlwaysSelectedEntryListWidget<PresetsScreen.SuperflatPresetsListWidget.SuperflatPresetEntry> {
      ...
      public void setSelected(@Nullable PresetsScreen.SuperflatPresetsListWidget.SuperflatPresetEntry arg) {
         super.setSelected(arg);
         if (arg != null) {
            NarratorManager.INSTANCE
               .narrate(new TranslatableText("narrator.select", PresetsScreen.PRESETS.get(this.children().indexOf(arg)).getName()).getString());
         }
      ...
      public class SuperflatPresetEntry extends AlwaysSelectedEntryListWidget.Entry<PresetsScreen.SuperflatPresetsListWidget.SuperflatPresetEntry> {
         ...
         public void render(
            ...
            PresetsScreen.SuperflatPreset lv = PresetsScreen.PRESETS.get(index);
            this.method_2200(matrices, x, y, lv.icon);
            PresetsScreen.this.textRenderer.draw(matrices, lv.name, (float)(x + 18 + 5), (float)(y + 6), 16777215);
         }
         ...
         private void setPreset() {
            ...
            PresetsScreen.SuperflatPreset lv = PresetsScreen.PRESETS.get(SuperflatPresetsListWidget.this.children().indexOf(this));
            Registry<Biome> lv2 = PresetsScreen.this.parent.parent.moreOptionsDialog.method_29700().get(Registry.BIOME_KEY);
            PresetsScreen.this.field_25044 = lv.field_25045.apply(lv2);
            PresetsScreen.this.customPresetField.setText(PresetsScreen.method_29062(lv2, PresetsScreen.this.field_25044));
