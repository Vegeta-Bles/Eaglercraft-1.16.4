...
public class TitleScreen extends Screen {
   ...
   public static CompletableFuture<Void> loadTexturesAsync(TextureManager arg, Executor executor) {
      return CompletableFuture.allOf(
         arg.loadTextureAsync(MINECRAFT_TITLE_TEXTURE, executor),
         arg.loadTextureAsync(EDITION_TITLE_TEXTURE, executor),
         arg.loadTextureAsync(PANORAMA_OVERLAY, executor),
         PANORAMA_CUBE_MAP.loadTexturesAsync(arg, executor)
      );
   }
   ...
   protected void init() {
      ...
      this.addButton(
         new TexturedButtonWidget(
            ...
            256,
            256,
            arg -> this.client.openScreen(new LanguageOptionsScreen(this, this.client.options, this.client.getLanguageManager())),
      ...
      this.addButton(
         new ButtonWidget(
            ...
            arg -> this.client.openScreen(new OptionsScreen(this, this.client.options))
         )
      );
      ...
      this.addButton(
         new TexturedButtonWidget(
            ...
            32,
            64,
            arg -> this.client.openScreen(new AccessibilityOptionsScreen(this, this.client.options)),
      ...
      if (this.client.options.realmsNotifications && !this.realmsNotificationsInitialized) {
         RealmsBridgeScreen lv = new RealmsBridgeScreen();
   ...
   private void initWidgetsNormal(int y, int spacingY) {
      this.addButton(
         new ButtonWidget(
            this.width / 2 - 100, y, 200, 20, new TranslatableText("menu.singleplayer"), arg -> this.client.openScreen(new SelectWorldScreen(this))
         )
      );
      boolean bl = this.client.isMultiplayerEnabled();
      ButtonWidget.TooltipSupplier lv = bl
         ? ButtonWidget.EMPTY
         : (arg, arg2, i, j) -> {
            if (!arg.active) {
               this.renderOrderedTooltip(
                  arg2, this.client.textRenderer.wrapLines(new TranslatableText("title.multiplayer.disabled"), Math.max(this.width / 2 - 43, 170)), i, j
               );
            }
         };
      this.addButton(new ButtonWidget(this.width / 2 - 100, y + spacingY * 1, 200, 20, new TranslatableText("menu.multiplayer"), arg -> {
         Screen lvx = (Screen)(this.client.options.skipMultiplayerWarning ? new MultiplayerScreen(this) : new MultiplayerWarningScreen(this));
         this.client.openScreen(lvx);
      }, lv)).active = bl;
      this.addButton(new ButtonWidget(this.width / 2 - 100, y + spacingY * 2, 200, 20, new TranslatableText("menu.online"), arg -> this.switchToRealms(), lv)).active = bl;
   }

   private void initWidgetsDemo(int y, int spacingY) {
      boolean bl = this.method_31129();
      this.addButton(new ButtonWidget(this.width / 2 - 100, y, 200, 20, new TranslatableText("menu.playdemo"), arg -> {
         if (bl) {
            this.client.startIntegratedServer("Demo_World");
         } else {
            DynamicRegistryManager.Impl lv = DynamicRegistryManager.create();
            this.client.method_29607("Demo_World", MinecraftServer.DEMO_LEVEL_INFO, lv, GeneratorOptions.method_31112(lv));
         }
      }));
                     ...
                     this.client
                        .openScreen(
                           new ConfirmScreen(
                              ...
                              new TranslatableText("selectWorld.deleteWarning", lv3.getDisplayName()),
   ...
   private boolean method_31129() {
      try (LevelStorage.Session lv = this.client.getLevelStorage().createSession("Demo_World")) {
         return lv.getLevelSummary() != null;
   ...
   public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
      ...
      if ((n & -67108864) != 0) {
         ...
         drawTexture(matrices, l + 88, 67, 0.0F, 0.0F, 98, 14, 128, 16);
         if (this.splashText != null) {
            ...
            drawCenteredString(matrices, this.textRenderer, this.splashText, 0, -8, 16776960 | n);
         ...
         drawStringWithShadow(matrices, this.textRenderer, string, 2, this.height - 10, 16777215 | n);
         drawStringWithShadow(matrices, this.textRenderer, "Copyright Mojang AB. Do not distribute!", this.copyrightTextX, this.height - 10, 16777215 | n);
         if (mouseX > this.copyrightTextX && mouseX < this.copyrightTextX + this.copyrightTextWidth && mouseY > this.height - 10 && mouseY < this.height) {
            fill(matrices, this.copyrightTextX, this.height - 1, this.copyrightTextX + this.copyrightTextWidth, this.height, 16777215 | n);
         }
