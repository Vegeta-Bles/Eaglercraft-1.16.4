...
public class AdvancementTab extends DrawableHelper {
   ...
   public void render(MatrixStack arg) {
      ...
      fill(arg, 4680, 2260, -4680, -2260, -16777216);
      RenderSystem.colorMask(true, true, true, true);
      RenderSystem.translatef(0.0F, 0.0F, -950.0F);
      RenderSystem.depthFunc(518);
      fill(arg, 234, 113, 0, 0, -16777216);
      ...
      for (int m = -1; m <= 15; m++) {
         for (int n = -1; n <= 8; n++) {
            drawTexture(arg, k + 16 * m, l + 16 * n, 0.0F, 0.0F, 16, 16, 16, 16);
         }
      }
   ...
   public void drawWidgetTooltip(MatrixStack arg, int i, int j, int k, int l) {
      ...
      fill(arg, 0, 0, 234, 113, MathHelper.floor(this.alpha * 255.0F) << 24);
      boolean bl = false;
