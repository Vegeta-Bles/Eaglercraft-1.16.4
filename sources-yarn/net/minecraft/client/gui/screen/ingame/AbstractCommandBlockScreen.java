...
public abstract class AbstractCommandBlockScreen extends Screen {
   ...
   protected void init() {
      ...
      this.doneButton = this.addButton(
         new ButtonWidget(this.width / 2 - 4 - 150, this.height / 4 + 120 + 12, 150, 20, ScreenTexts.DONE, arg -> this.commitAndClose())
      );
      ...
      this.toggleTrackingOutputButton = this.addButton(
         new ButtonWidget(this.width / 2 + 150 - 20, this.getTrackOutputButtonHeight(), 20, 20, new LiteralText("O"), arg -> {
            CommandBlockExecutor lv = this.getCommandExecutor();
            lv.shouldTrackOutput(!lv.isTrackingOutput());
   ...
   public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
      ...
      if (!this.previousOutputTextField.getText().isEmpty()) {
         ...
         drawTextWithShadow(matrices, this.textRenderer, field_26558, this.width / 2 - 150, k + 4, 10526880);
