...
public class StructureBlockScreen extends Screen {
   ...
   protected void init() {
      ...
      this.buttonDetect = this.addButton(
         new ButtonWidget(this.width / 2 + 4 + 100, 120, 50, 20, new TranslatableText("structure_block.button.detect_size"), arg -> {
            if (this.structureBlock.getMode() == StructureBlockMode.SAVE) {
   ...
   public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
      ...
      drawTextWithShadow(matrices, this.textRenderer, lv.method_30844(), this.width / 2 - 153, 174, 10526880);
