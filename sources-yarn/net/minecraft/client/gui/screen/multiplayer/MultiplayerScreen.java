...
public class MultiplayerScreen extends Screen {
   ...
   protected void init() {
      ...
      this.buttonJoin = this.addButton(
         new ButtonWidget(this.width / 2 - 154, this.height - 52, 100, 20, new TranslatableText("selectServer.select"), arg -> this.connect())
      );
      ...
      this.buttonEdit = this.addButton(new ButtonWidget(this.width / 2 - 154, this.height - 28, 70, 20, new TranslatableText("selectServer.edit"), arg -> {
         MultiplayerServerListWidget.Entry lv = this.serverListWidget.getSelected();
      ...
      this.buttonDelete = this.addButton(new ButtonWidget(this.width / 2 - 74, this.height - 28, 70, 20, new TranslatableText("selectServer.delete"), arg -> {
         ...
         if (lv instanceof MultiplayerServerListWidget.ServerEntry) {
            ...
            if (string != null) {
               Text lv2 = new TranslatableText("selectServer.deleteQuestion");
               Text lv3 = new TranslatableText("selectServer.deleteWarning", string);
               Text lv4 = new TranslatableText("selectServer.deleteButton");
