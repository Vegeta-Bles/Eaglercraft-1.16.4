...
public class LanguageOptionsScreen extends GameOptionsScreen {
   ...
   protected void init() {
      ...
      this.doneButton = this.addButton(new ButtonWidget(this.width / 2 - 155 + 160, this.height - 38, 150, 20, ScreenTexts.DONE, button -> {
         LanguageOptionsScreen.LanguageSelectionListWidget.LanguageEntry lv = this.languageSelectionList.getSelected();
   ...
   class LanguageSelectionListWidget extends AlwaysSelectedEntryListWidget<LanguageOptionsScreen.LanguageSelectionListWidget.LanguageEntry> {
      public LanguageSelectionListWidget(MinecraftClient client) {
         ...
         for (LanguageDefinition lv : LanguageOptionsScreen.this.languageManager.getAllLanguages()) {
            LanguageOptionsScreen.LanguageSelectionListWidget.LanguageEntry lv2 = new LanguageOptionsScreen.LanguageSelectionListWidget.LanguageEntry(lv);
            this.addEntry(lv2);
            if (LanguageOptionsScreen.this.languageManager.getLanguage().getCode().equals(lv.getCode())) {
      ...
      public void setSelected(@Nullable LanguageOptionsScreen.LanguageSelectionListWidget.LanguageEntry arg) {
