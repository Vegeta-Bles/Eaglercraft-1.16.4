...
public class ResourcePackOrganizer {
   ...
   public ResourcePackOrganizer(
      Runnable updateCallback, Function<ResourcePackProfile, Identifier> function, ResourcePackManager arg, Consumer<ResourcePackManager> consumer
   ) {
   ...
   public Stream<ResourcePackOrganizer.Pack> getDisabledPacks() {
      return this.disabledPacks.stream().map(arg -> new ResourcePackOrganizer.DisabledPack(arg));
   }

   public Stream<ResourcePackOrganizer.Pack> getEnabledPacks() {
      return this.enabledPacks.stream().map(arg -> new ResourcePackOrganizer.EnabledPack(arg));
   }
