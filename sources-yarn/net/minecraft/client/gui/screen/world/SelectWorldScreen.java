   ...
   protected void init() {
      ...
      this.selectButton = this.addButton(
         new ButtonWidget(
            ...
            arg -> this.levelList.method_20159().ifPresent(WorldListWidget.Entry::play)
         )
      );
      this.addButton(
         new ButtonWidget(
            ...
            arg -> this.client.openScreen(CreateWorldScreen.method_31130(this))
         )
      );
      this.editButton = this.addButton(
         new ButtonWidget(
            ...
            arg -> this.levelList.method_20159().ifPresent(WorldListWidget.Entry::edit)
         )
      );
      this.deleteButton = this.addButton(
         new ButtonWidget(
            ...
            arg -> this.levelList.method_20159().ifPresent(WorldListWidget.Entry::delete)
         )
      );
      this.recreateButton = this.addButton(
         new ButtonWidget(
            ...
            arg -> this.levelList.method_20159().ifPresent(WorldListWidget.Entry::recreate)
         )
      );
