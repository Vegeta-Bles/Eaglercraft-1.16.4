...
public abstract class AbstractButtonWidget extends DrawableHelper implements Drawable, Element {
   ...
   public void renderButton(MatrixStack matrices, int mouseX, int mouseY, float delta) {
      ...
      drawCenteredText(
         matrices, lv2, this.getMessage(), this.x + this.width / 2, this.y + (this.height - 8) / 2, l | MathHelper.ceil(this.alpha * 255.0F) << 24
      );
   }
   ...
   public void setMessage(Text arg) {
      if (!Objects.equals(arg.getString(), this.message.getString())) {
