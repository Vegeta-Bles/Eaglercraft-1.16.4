...
public class Main {
   ...
   public static void main(String[] args) {
      ...
      OptionSpec<String> optionSpec11 = optionParser.accepts("username")
         .withRequiredArg()
         .defaultsTo("Player" + Util.getMeasuringTimeMs() % 1000L, new String[0]);
      ...
      RunArgs lv2 = new RunArgs(
         new RunArgs.Network(lv, propertyMap, propertyMap2, proxy),
      ...
      try {
         ...
         lv4 = new MinecraftClient(lv2);
         RenderSystem.finishInitialization();
      } catch (GlException var69) {
         LOGGER.warn("Failed to create window: ", var69);
         return;
      } catch (Throwable var70) {
         CrashReport lv6 = CrashReport.create(var70, "Initializing game");
