...
public class ClientPlayNetworkHandler implements ClientPlayPacketListener {
   ...
   public void onGameJoin(GameJoinS2CPacket packet) {
      ...
      RegistryKey<World> lv = packet.getDimensionId();
      DimensionType lv2 = packet.getDimensionType();
      this.chunkLoadDistance = packet.getViewDistance();
      boolean bl = packet.isDebugWorld();
      boolean bl2 = packet.isFlatWorld();
      ClientWorld.Properties lv3 = new ClientWorld.Properties(Difficulty.NORMAL, packet.isHardcore(), bl2);
      this.worldProperties = lv3;
      this.world = new ClientWorld(this, lv3, lv, lv2, this.chunkLoadDistance, this.client::getProfiler, this.client.worldRenderer, bl, packet.getSha256Seed());
   ...
   public void onEntitySpawn(EntitySpawnS2CPacket packet) {
      ...
      if (lv == EntityType.CHEST_MINECART) {
         lv2 = new ChestMinecartEntity(this.world, d, e, f);
      } else if (lv == EntityType.FURNACE_MINECART) {
         lv2 = new FurnaceMinecartEntity(this.world, d, e, f);
      } else if (lv == EntityType.TNT_MINECART) {
         lv2 = new TntMinecartEntity(this.world, d, e, f);
      } else if (lv == EntityType.SPAWNER_MINECART) {
         lv2 = new SpawnerMinecartEntity(this.world, d, e, f);
      } else if (lv == EntityType.HOPPER_MINECART) {
         lv2 = new HopperMinecartEntity(this.world, d, e, f);
      } else if (lv == EntityType.COMMAND_BLOCK_MINECART) {
         lv2 = new CommandBlockMinecartEntity(this.world, d, e, f);
      } else if (lv == EntityType.MINECART) {
         lv2 = new MinecartEntity(this.world, d, e, f);
         ...
         if (lv9 instanceof PlayerEntity) {
            lv2 = new FishingBobberEntity(this.world, (PlayerEntity)lv9, d, e, f);
         } else {
            lv2 = null;
         }
      } else if (lv == EntityType.ARROW) {
         lv2 = new ArrowEntity(this.world, d, e, f);
         Entity lv13 = this.world.getEntityById(packet.getEntityData());
         if (lv13 != null) {
            ((PersistentProjectileEntity)lv2).setOwner(lv13);
         }
      } else if (lv == EntityType.SPECTRAL_ARROW) {
         lv2 = new SpectralArrowEntity(this.world, d, e, f);
         Entity lv15 = this.world.getEntityById(packet.getEntityData());
         if (lv15 != null) {
            ((PersistentProjectileEntity)lv2).setOwner(lv15);
         }
      } else if (lv == EntityType.TRIDENT) {
         lv2 = new TridentEntity(this.world, d, e, f);
         Entity lv17 = this.world.getEntityById(packet.getEntityData());
         if (lv17 != null) {
            ((PersistentProjectileEntity)lv2).setOwner(lv17);
         }
      } else if (lv == EntityType.SNOWBALL) {
         lv2 = new SnowballEntity(this.world, d, e, f);
      } else if (lv == EntityType.LLAMA_SPIT) {
         lv2 = new LlamaSpitEntity(this.world, d, e, f, packet.getVelocityX(), packet.getVelocityY(), packet.getVelocityZ());
      } else if (lv == EntityType.ITEM_FRAME) {
         lv2 = new ItemFrameEntity(this.world, new BlockPos(d, e, f), Direction.byId(packet.getEntityData()));
      } else if (lv == EntityType.LEASH_KNOT) {
         lv2 = new LeashKnotEntity(this.world, new BlockPos(d, e, f));
      } else if (lv == EntityType.ENDER_PEARL) {
         lv2 = new EnderPearlEntity(this.world, d, e, f);
      } else if (lv == EntityType.EYE_OF_ENDER) {
         lv2 = new EyeOfEnderEntity(this.world, d, e, f);
      } else if (lv == EntityType.FIREWORK_ROCKET) {
         lv2 = new FireworkRocketEntity(this.world, d, e, f, ItemStack.EMPTY);
      } else if (lv == EntityType.FIREBALL) {
         lv2 = new FireballEntity(this.world, d, e, f, packet.getVelocityX(), packet.getVelocityY(), packet.getVelocityZ());
      } else if (lv == EntityType.DRAGON_FIREBALL) {
         lv2 = new DragonFireballEntity(this.world, d, e, f, packet.getVelocityX(), packet.getVelocityY(), packet.getVelocityZ());
      } else if (lv == EntityType.SMALL_FIREBALL) {
         lv2 = new SmallFireballEntity(this.world, d, e, f, packet.getVelocityX(), packet.getVelocityY(), packet.getVelocityZ());
      } else if (lv == EntityType.WITHER_SKULL) {
         lv2 = new WitherSkullEntity(this.world, d, e, f, packet.getVelocityX(), packet.getVelocityY(), packet.getVelocityZ());
      } else if (lv == EntityType.SHULKER_BULLET) {
         lv2 = new ShulkerBulletEntity(this.world, d, e, f, packet.getVelocityX(), packet.getVelocityY(), packet.getVelocityZ());
      } else if (lv == EntityType.EGG) {
         lv2 = new EggEntity(this.world, d, e, f);
      } else if (lv == EntityType.EVOKER_FANGS) {
         lv2 = new EvokerFangsEntity(this.world, d, e, f, 0.0F, 0, null);
      } else if (lv == EntityType.POTION) {
         lv2 = new PotionEntity(this.world, d, e, f);
      } else if (lv == EntityType.EXPERIENCE_BOTTLE) {
         lv2 = new ExperienceBottleEntity(this.world, d, e, f);
      } else if (lv == EntityType.BOAT) {
         lv2 = new BoatEntity(this.world, d, e, f);
      } else if (lv == EntityType.TNT) {
         lv2 = new TntEntity(this.world, d, e, f, null);
      } else if (lv == EntityType.ARMOR_STAND) {
         lv2 = new ArmorStandEntity(this.world, d, e, f);
      } else if (lv == EntityType.END_CRYSTAL) {
         lv2 = new EndCrystalEntity(this.world, d, e, f);
      } else if (lv == EntityType.ITEM) {
         lv2 = new ItemEntity(this.world, d, e, f);
      } else if (lv == EntityType.FALLING_BLOCK) {
         lv2 = new FallingBlockEntity(this.world, d, e, f, Block.getStateFromRawId(packet.getEntityData()));
      } else if (lv == EntityType.AREA_EFFECT_CLOUD) {
         lv2 = new AreaEffectCloudEntity(this.world, d, e, f);
      } else if (lv == EntityType.LIGHTNING_BOLT) {
         lv2 = new LightningEntity(EntityType.LIGHTNING_BOLT, this.world);
      } else {
         lv2 = null;
      }
      ...
      if (lv2 != null) {
         ...
         lv2.refreshPositionAfterTeleport(d, e, f);
         lv2.pitch = (float)(packet.getPitch() * 360) / 256.0F;
         lv2.yaw = (float)(packet.getYaw() * 360) / 256.0F;
         lv2.setEntityId(i);
         lv2.setUuid(packet.getUuid());
         this.world.addEntity(i, lv2);
         if (lv2 instanceof AbstractMinecartEntity) {
            this.client.getSoundManager().play(new MovingMinecartSoundInstance((AbstractMinecartEntity)lv2));
         }
      }
   }
      ...
      if (lv != null) {
         if (!lv.isLogicalSideForUpdatingMovement()) {
            if (packet.isPositionChanged()) {
               Vec3d lv2 = packet.calculateDeltaPosition(lv.getTrackedPosition());
               lv.updateTrackedPosition(lv2);
   ...
   public void onPlayerPositionLook(PlayerPositionLookS2CPacket packet) {
      ...
      if (bl) {
         ...
         lv.lastRenderX = lv.lastRenderX + packet.getX();
      } else {
         d = 0.0;
         e = packet.getX();
         lv.lastRenderX = e;
      ...
      if (bl2) {
         h = lv2.getY();
         i = lv.getY() + packet.getY();
         lv.lastRenderY = lv.lastRenderY + packet.getY();
      } else {
         h = 0.0;
         i = packet.getY();
         lv.lastRenderY = i;
      ...
      if (bl3) {
         l = lv2.getZ();
         m = lv.getZ() + packet.getZ();
         lv.lastRenderZ = lv.lastRenderZ + packet.getZ();
      } else {
         l = 0.0;
         m = packet.getZ();
         lv.lastRenderZ = m;
      ...
      lv.updatePositionAndAngles(e, i, m, p, q);
   ...
   public void onChunkDeltaUpdate(ChunkDeltaUpdateS2CPacket packet) {
      ...
      packet.visitUpdates((arg, arg2) -> this.world.setBlockState(arg, arg2, i));
   }
   ...
   public void onChunkData(ChunkDataS2CPacket packet) {
      ...
      int i = packet.getX();
      int j = packet.getZ();
      BiomeArray lv = packet.getBiomeArray() == null ? null : new BiomeArray(this.registryManager.get(Registry.BIOME_KEY), packet.getBiomeArray());
      WorldChunk lv2 = this.world
         .getChunkManager()
         .loadChunkFromPacket(i, j, lv, packet.getReadBuffer(), packet.getHeightmaps(), packet.getVerticalStripBitmask(), packet.isFullChunk());
   ...
   public void onItemPickupAnimation(ItemPickupAnimationS2CPacket packet) {
      ...
      if (lv != null) {
         ...
         this.client
            .particleManager
            .addParticle(new ItemPickupParticle(this.client.getEntityRenderDispatcher(), this.client.getBufferBuilders(), this.world, lv, lv2));
   ...
   public void onMobSpawn(MobSpawnS2CPacket packet) {
      ...
      if (lv != null) {
         ...
         if (lv instanceof BeeEntity) {
            ...
            AbstractBeeSoundInstance lv2;
            if (bl) {
               lv2 = new AggressiveBeeSoundInstance((BeeEntity)lv);
            } else {
   ...
   private static ItemStack getActiveTotemOfUndying(PlayerEntity player) {
      for (Hand lv : Hand.values()) {
         ...
         if (lv2.getItem() == Items.TOTEM_OF_UNDYING) {
            return lv2;
         }
      }
   ...
   public void onPlayerRespawn(PlayerRespawnS2CPacket packet) {
      NetworkThreadUtils.forceMainThread(packet, this, this.client);
      RegistryKey<World> lv = packet.getDimension();
      DimensionType lv2 = packet.method_29445();
      ...
      if (lv != lv3.world.getRegistryKey()) {
         ...
         this.world = new ClientWorld(
            this, lv5, lv, lv2, this.chunkLoadDistance, this.client::getProfiler, this.client.worldRenderer, bl, packet.getSha256Seed()
         );
      ...
      ClientPlayerEntity lv6 = this.client
         .interactionManager
         .createPlayer(this.world, lv3.getStatHandler(), lv3.getRecipeBook(), lv3.isSneaking(), lv3.isSprinting());
      lv6.setEntityId(i);
   ...
   public void onScreenHandlerSlotUpdate(ScreenHandlerSlotUpdateS2CPacket packet) {
      ...
      if (packet.getSyncId() == -1) {
         ...
         if (this.client.currentScreen instanceof CreativeInventoryScreen) {
            ...
            bl = lv3.getSelectedTab() != ItemGroup.INVENTORY.getIndex();
         }
   ...
   public void onConfirmScreenAction(ConfirmScreenActionS2CPacket packet) {
      ...
      } else if (packet.getSyncId() == lv2.currentScreenHandler.syncId) {
   ...
   public void onBlockEntityUpdate(BlockEntityUpdateS2CPacket packet) {
      ...
      boolean bl = i == 2 && lv2 instanceof CommandBlockBlockEntity;
      if (i == 1 && lv2 instanceof MobSpawnerBlockEntity
         || bl
         || i == 3 && lv2 instanceof BeaconBlockEntity
         || i == 4 && lv2 instanceof SkullBlockEntity
         || i == 6 && lv2 instanceof BannerBlockEntity
         || i == 7 && lv2 instanceof StructureBlockBlockEntity
         || i == 8 && lv2 instanceof EndGatewayBlockEntity
         || i == 9 && lv2 instanceof SignBlockEntity
         || i == 11 && lv2 instanceof BedBlockEntity
         || i == 5 && lv2 instanceof ConduitBlockEntity
         || i == 12 && lv2 instanceof JigsawBlockEntity
         || i == 13 && lv2 instanceof CampfireBlockEntity
         || i == 14 && lv2 instanceof BeehiveBlockEntity) {
   ...
   public void onEquipmentUpdate(EntityEquipmentUpdateS2CPacket packet) {
      ...
      Entity lv = this.world.getEntityById(packet.getId());
      if (lv != null) {
         packet.getEquipmentList().forEach(pair -> lv.equipStack((EquipmentSlot)pair.getFirst(), (ItemStack)pair.getSecond()));
      }
   }
   ...
   public void onGameStateChange(GameStateChangeS2CPacket packet) {
      ...
      if (lv2 == GameStateChangeS2CPacket.NO_RESPAWN_BLOCK) {
         lv.sendMessage(new TranslatableText("block.minecraft.spawn.not_valid"), false);
            ...
            this.client
               ...
               .addMessage(
                  new TranslatableText(
                     "demo.help.movement",
                     lv3.keyForward.getBoundKeyLocalizedText(),
                     lv3.keyLeft.getBoundKeyLocalizedText(),
                     lv3.keyBack.getBoundKeyLocalizedText(),
                     lv3.keyRight.getBoundKeyLocalizedText()
                  )
               );
         } else if (f == 102.0F) {
   ...
   public void onMapUpdate(MapUpdateS2CPacket packet) {
      ...
      if (lv2 == null) {
         ...
         if (lv.getTexture(string) != null) {
            MapState lv3 = lv.getState(lv.getTexture(string));
            if (lv3 != null) {
               lv2 = lv3;
            }
         }
         ...
         case ADD:
            for (Identifier lv6 : packet.getRecipeIdsToChange()) {
               this.recipeManager.get(lv6).ifPresent(arg2 -> {
                  ...
                  RecipeToast.show(this.client.getToastManager(), (Recipe<?>)arg2);
               });
            }
      }
      ...
      if (lv instanceof LivingEntity) {
         ...
         if (lv2 != null) {
            StatusEffectInstance lv3 = new StatusEffectInstance(
               lv2, packet.getDuration(), packet.getAmplifier(), packet.isAmbient(), packet.shouldShowParticles(), packet.shouldShowIcon()
            );
   ...
   public void onPlayerList(PlayerListS2CPacket packet) {
      ...
      for (PlayerListS2CPacket.Entry lv : packet.getEntries()) {
         if (packet.getAction() == PlayerListS2CPacket.Action.REMOVE_PLAYER) {
            this.client.getSocialInteractionsManager().method_31341(lv.getProfile().getId());
            ...
            if (packet.getAction() == PlayerListS2CPacket.Action.ADD_PLAYER) {
               ...
               this.client.getSocialInteractionsManager().method_31337(lv2);
            }
         ...
         if (string.startsWith("level://")) {
            ...
            if (lv != null && lv.getResourcePack() == ServerInfo.ResourcePackState.ENABLED) {
               ...
               this.client.execute(() -> this.client.openScreen(new ConfirmScreen(bl -> {
                     ...
                     ServerInfo lvx = this.client.getCurrentServerEntry();
                     if (bl) {
                        if (lvx != null) {
                           lvx.setResourcePackState(ServerInfo.ResourcePackState.ENABLED);
                        }
                        ...
                        if (lvx != null) {
                           lvx.setResourcePackState(ServerInfo.ResourcePackState.DISABLED);
                        }

                        this.sendResourcePackStatus(ResourcePackStatusC2SPacket.Status.DECLINED);
                     }

                     ServerList.updateServerListEntry(lvx);
                     this.client.openScreen(null);
   ...
   public void onCustomPayload(CustomPayloadS2CPacket packet) {
      ...
      try {
         ...
         if (CustomPayloadS2CPacket.BRAND.equals(lv)) {
            ...
            DimensionType lv6 = this.registryManager.getDimensionTypes().get(lv2.readIdentifier());
            ...
            ((WorldGenAttemptDebugRenderer)this.client.debugRenderer.worldGenAttemptDebugRenderer)
               .method_3872(lv2.readBlockPos(), lv2.readFloat(), lv2.readFloat(), lv2.readFloat(), lv2.readFloat(), lv2.readFloat());
            ...
            Position lv13 = new PositionImpl(d, e, g);
            ...
            Path lv14;
            if (bl2) {
               lv14 = Path.fromBuffer(lv2);
            } else {
               lv14 = null;
            }

            boolean bl3 = lv2.readBoolean();
            VillageDebugRenderer.Brain lv16 = new VillageDebugRenderer.Brain(uUID, aa, string3, string4, ab, h, ac, lv13, string5, lv14, bl3);
            int ad = lv2.readInt();
            ...
            Position lv19 = new PositionImpl(ap, aq, ar);
   ...
   public void onTeam(TeamS2CPacket packet) {
      ...
      Team lv2;
      if (packet.getMode() == 0) {
         lv2 = lv.addTeam(packet.getTeamName());
      } else {
         lv2 = lv.getTeam(packet.getTeamName());
      }

      if (packet.getMode() == 0 || packet.getMode() == 2) {
         lv2.setDisplayName(packet.getDisplayName());
         lv2.setColor(packet.getPlayerPrefix());
         lv2.setFriendlyFlagsBitwise(packet.getFlags());
         AbstractTeam.VisibilityRule lv4 = AbstractTeam.VisibilityRule.getRule(packet.getNameTagVisibilityRule());
         if (lv4 != null) {
            lv2.setNameTagVisibilityRule(lv4);
         }

         AbstractTeam.CollisionRule lv5 = AbstractTeam.CollisionRule.getRule(packet.getCollisionRule());
         if (lv5 != null) {
            lv2.setCollisionRule(lv5);
         }

         lv2.setPrefix(packet.getPrefix());
         lv2.setSuffix(packet.getSuffix());
      }

      if (packet.getMode() == 0 || packet.getMode() == 3) {
         for (String string : packet.getPlayerList()) {
            lv.addPlayerToTeam(string, lv2);
         }
      }

      if (packet.getMode() == 4) {
         for (String string2 : packet.getPlayerList()) {
            lv.removePlayerFromTeam(string2, lv2);
         }
      }
      ...
      if (lv != null) {
         if (!(lv instanceof LivingEntity)) {
            ...
            for (EntityAttributesS2CPacket.Entry lv3 : packet.getEntries()) {
               ...
               if (lv4 == null) {
                  LOGGER.warn("Entity {} does not have attribute {}", lv, Registry.ATTRIBUTE.getId(lv3.getId()));
               } else {
      ...
      if (lv.syncId == packet.getSyncId() && lv.isNotRestricted(this.client.player)) {
         this.recipeManager.get(packet.getRecipeId()).ifPresent(arg2 -> {
            if (this.client.currentScreen instanceof RecipeBookProvider) {
               ...
               lvx.showGhostRecipe((Recipe<?>)arg2, lv.slots);
            }
         });
      }
   }
   ...
   public void onSetTradeOffers(SetTradeOffersS2CPacket packet) {
      ...
      if (packet.getSyncId() == lv.syncId && lv instanceof MerchantScreenHandler) {
         ((MerchantScreenHandler)lv).setOffers(new TradeOfferList(packet.getOffers().toTag()));
   ...
   private void updateLighting(
      int chunkX, int chunkZ, LightingProvider provider, LightType type, int mask, int filledMask, Iterator<byte[]> updates, boolean bl
   ) {
      for (int m = 0; m < 18; m++) {
         int n = -1 + m;
         boolean bl2 = (mask & 1 << m) != 0;
         boolean bl3 = (filledMask & 1 << m) != 0;
         if (bl2 || bl3) {
            provider.enqueueSectionData(
               type, ChunkSectionPos.from(chunkX, n, chunkZ), bl2 ? new ChunkNibbleArray((byte[])updates.next().clone()) : new ChunkNibbleArray(), bl
            );
   ...
   public PlayerListEntry getPlayerListEntry(String profileName) {
      for (PlayerListEntry lv : this.playerListEntries.values()) {
         if (lv.getProfile().getName().equals(profileName)) {
            return lv;
         }
      }
