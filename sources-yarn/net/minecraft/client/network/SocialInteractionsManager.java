...
public class SocialInteractionsManager {
   ...
   public void method_31337(PlayerListEntry arg) {
      ...
      if (lv instanceof SocialInteractionsScreen) {
         SocialInteractionsScreen lv2 = (SocialInteractionsScreen)lv;
         lv2.method_31353(arg);
      }
   }
