...
public class KeyBinding implements Comparable<KeyBinding> {
   ...
   public int compareTo(KeyBinding arg) {
      return this.category.equals(arg.category)
         ? I18n.translate(this.translationKey).compareTo(I18n.translate(arg.translationKey))
         : categoryOrderMap.get(this.category).compareTo(categoryOrderMap.get(arg.category));
   }

   public static Supplier<Text> getLocalizedName(String id) {
      KeyBinding lv = keysById.get(id);
      return lv == null ? () -> new TranslatableText(id) : lv::getBoundKeyLocalizedText;
   }
