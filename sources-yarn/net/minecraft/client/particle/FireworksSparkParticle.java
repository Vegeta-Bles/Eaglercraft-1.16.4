...
public class FireworksSparkParticle {
   ...
   static class Explosion extends AnimatedParticle {
      ...
      public void tick() {
         ...
         if (this.trail && this.age < this.maxAge / 2 && (this.age + this.maxAge) % 2 == 0) {
            FireworksSparkParticle.Explosion lv = new FireworksSparkParticle.Explosion(
   ...
   public static class ExplosionFactory implements ParticleFactory<DefaultParticleType> {
      ...
      public Particle createParticle(DefaultParticleType arg, ClientWorld arg2, double d, double e, double f, double g, double h, double i) {
         FireworksSparkParticle.Explosion lv = new FireworksSparkParticle.Explosion(
            arg2, d, e, f, g, h, i, MinecraftClient.getInstance().particleManager, this.spriteProvider
         );
         lv.setColorAlpha(0.99F);
         return lv;
      }
   ...
   public static class FireworkParticle extends NoRenderParticle {
         ...
         if (this.age == 0 && this.explosions != null) {
            ...
            if (this.explosions.size() >= 3) {
               ...
               for (int i = 0; i < this.explosions.size(); i++) {
                  ...
                  if (FireworkItem.Type.byId(lv.getByte("Type")) == FireworkItem.Type.LARGE_BALL) {
                     bl2 = true;
                     break;
                  }
               }
      ...
      private void addExplosionParticle(
         ...
         FireworksSparkParticle.Explosion lv = (FireworksSparkParticle.Explosion)this.particleManager
   ...
   public static class FlashFactory implements ParticleFactory<DefaultParticleType> {
      ...
      public Particle createParticle(DefaultParticleType arg, ClientWorld arg2, double d, double e, double f, double g, double h, double i) {
         FireworksSparkParticle.Flash lv = new FireworksSparkParticle.Flash(arg2, d, e, f);
