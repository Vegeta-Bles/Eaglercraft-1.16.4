...
public class ItemPickupParticle extends Particle {
   ...
   private ItemPickupParticle(
      EntityRenderDispatcher dispatcher, BufferBuilderStorage bufferStorage, ClientWorld world, Entity arg4, Entity interactingEntity, Vec3d velocity
   ) {
   ...
   private Entity method_29358(Entity arg) {
      return (Entity)(!(arg instanceof ItemEntity) ? arg : ((ItemEntity)arg).method_29271());
   }
