...
public class RedDustParticle extends SpriteBillboardParticle {
   ...
   private RedDustParticle(
      ...
      this.colorRed = ((float)(Math.random() * 0.2F) + 0.8F) * arg2.getRed() * j;
      this.colorGreen = ((float)(Math.random() * 0.2F) + 0.8F) * arg2.getGreen() * j;
      this.colorBlue = ((float)(Math.random() * 0.2F) + 0.8F) * arg2.getBlue() * j;
      this.scale = this.scale * 0.75F * arg2.getScale();
