...
public class DisconnectedRealmsScreen extends RealmsScreen {
   ...
   public DisconnectedRealmsScreen(Screen parent, Text arg2, Text reason) {
      this.parent = parent;
      this.title = arg2;
      this.reason = reason;
   }
   ...
   public void init() {
      ...
      this.addButton(
         new ButtonWidget(this.width / 2 - 100, this.height / 2 + this.textHeight / 2 + 9, 200, 20, ScreenTexts.BACK, arg2 -> lv.openScreen(this.parent))
      );
   }
