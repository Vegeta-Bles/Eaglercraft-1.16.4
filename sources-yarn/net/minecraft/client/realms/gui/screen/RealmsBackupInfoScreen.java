...
public class RealmsBackupInfoScreen extends RealmsScreen {
   ...
   private Text checkForSpecificMetadata(String key, String value) {
      ...
      if (string3.contains("game") && string3.contains("mode")) {
         ...
         return (Text)(string3.contains("game") && string3.contains("difficulty") ? this.gameDifficultyMetadata(value) : new LiteralText(value));
      }
   }
   ...
   class BackupInfoListEntry extends AlwaysSelectedEntryListWidget.Entry<RealmsBackupInfoScreen.BackupInfoListEntry> {
      ...
      public void render(
         ...
         DrawableHelper.drawStringWithShadow(matrices, lv, this.key, x, y, 10526880);
