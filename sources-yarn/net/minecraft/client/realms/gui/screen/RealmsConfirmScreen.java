...
public class RealmsConfirmScreen extends RealmsScreen {
   ...
   @Override
   public void init() {
      this.addButton(new ButtonWidget(this.width / 2 - 105, row(9), 100, 20, ScreenTexts.YES, arg -> this.field_22692.accept(true)));
      this.addButton(new ButtonWidget(this.width / 2 + 5, row(9), 100, 20, ScreenTexts.NO, arg -> this.field_22692.accept(false)));
   }
