...
public class RealmsCreateRealmScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.createButton = this.addButton(
         new ButtonWidget(this.width / 2 - 100, this.height / 4 + 120 + 17, 97, 20, new TranslatableText("mco.create.world"), arg -> this.createWorld())
      );
   ...
   private void createWorld() {
      if (this.valid()) {
         RealmsResetWorldScreen lv = new RealmsResetWorldScreen(
            this.parent,
            this.server,
         ...
         lv.setResetTitle(new TranslatableText("mco.create.world.reset.title"));
         this.client
            .openScreen(
               new RealmsLongRunningMcoTaskScreen(this.parent, new WorldCreationTask(this.server.id, this.nameBox.getText(), this.descriptionBox.getText(), lv))
            );
      }
   }
