...
public class RealmsInviteScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addButton(
         new ButtonWidget(this.width / 2 - 100, row(10), 200, 20, new TranslatableText("mco.configure.world.buttons.invite"), arg -> this.onInvite())
      );
      this.addButton(new ButtonWidget(this.width / 2 - 100, row(12), 200, 20, ScreenTexts.CANCEL, arg -> this.client.openScreen(this.parent)));
   }
   ...
   private void showError(Text arg) {
      this.errorMsg = arg;
