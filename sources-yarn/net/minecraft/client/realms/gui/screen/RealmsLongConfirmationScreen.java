...
public class RealmsLongConfirmationScreen extends RealmsScreen {
   ...
   public RealmsLongConfirmationScreen(BooleanConsumer booleanConsumer, RealmsLongConfirmationScreen.Type type, Text arg2, Text arg3, boolean yesNoQuestion) {
   ...
   public void init() {
      ...
      if (this.yesNoQuestion) {
         this.addButton(new ButtonWidget(this.width / 2 - 105, row(8), 100, 20, ScreenTexts.YES, arg -> this.field_22697.accept(true)));
         this.addButton(new ButtonWidget(this.width / 2 + 5, row(8), 100, 20, ScreenTexts.NO, arg -> this.field_22697.accept(false)));
      } else {
         this.addButton(new ButtonWidget(this.width / 2 - 50, row(8), 100, 20, new TranslatableText("mco.gui.ok"), arg -> this.field_22697.accept(true)));
      }
   }
