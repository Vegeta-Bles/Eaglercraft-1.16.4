...
public class RealmsLongRunningMcoTaskScreen extends RealmsScreen implements Errable {
   ...
   public void init() {
      this.task.init();
      this.addButton(new ButtonWidget(this.width / 2 - 106, row(12), 212, 20, ScreenTexts.CANCEL, arg -> this.cancelOrBackButtonClicked()));
   }
   ...
   public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
      ...
      if (lv == null) {
         ...
         drawCenteredText(matrices, this.textRenderer, lv, this.width / 2, row(8), 16711680);
      }
   ...
   public void error(Text arg) {
      ...
      Realms.narrateNow(arg.getString());
      this.onError();
      this.addButton(new ButtonWidget(this.width / 2 - 106, this.height / 4 + 120 + 12, 200, 20, ScreenTexts.BACK, argx -> this.cancelOrBackButtonClicked()));
   }
