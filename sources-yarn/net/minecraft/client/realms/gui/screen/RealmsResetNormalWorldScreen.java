...
public class RealmsResetNormalWorldScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addButton(new ButtonWidget(this.width / 2 - 102, row(4), 205, 20, this.method_27458(), arg -> {
         this.levelTypeIndex = (this.levelTypeIndex + 1) % field_24205.length;
         arg.setMessage(this.method_27458());
      }));
      this.addButton(new ButtonWidget(this.width / 2 - 102, row(6) - 2, 205, 20, this.method_27459(), arg -> {
      ...
      this.addButton(
         new ButtonWidget(
            ...
            20,
            this.field_24206,
            arg -> this.parent.resetWorld(new RealmsResetWorldScreen.ResetWorldInfo(this.seedEdit.getText(), this.levelTypeIndex, this.generateStructures))
         )
      );
      this.addButton(new ButtonWidget(this.width / 2 + 8, row(12), 97, 20, ScreenTexts.BACK, arg -> this.client.openScreen(this.parent)));
      this.narrateLabels();
   }
