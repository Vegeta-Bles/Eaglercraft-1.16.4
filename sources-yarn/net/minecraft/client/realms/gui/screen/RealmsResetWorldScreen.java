...
public class RealmsResetWorldScreen extends RealmsScreenWithCallback {
   ...
   public void setResetTitle(Text arg) {
      this.field_20501 = arg;
   }

   @Override
   public void init() {
      this.addButton(new ButtonWidget(this.width / 2 - 40, row(14) - 10, 80, 20, this.buttonTitle, arg -> this.client.openScreen(this.parent)));
      ...
      this.addButton(
         new RealmsResetWorldScreen.FrameButton(
            ...
            NEW_WORLD_TEXTURE,
            arg -> this.client.openScreen(new RealmsResetNormalWorldScreen(this, this.title))
         )
      );
      this.addButton(
         new RealmsResetWorldScreen.FrameButton(this.frame(2), row(0) + 10, new TranslatableText("mco.reset.world.upload"), UPLOAD_TEXTURE, arg -> {
            Screen lv = new RealmsSelectFileToUploadScreen(this.serverData.id, this.slot != -1 ? this.slot : this.serverData.activeSlot, this, this.field_22712);
            this.client.openScreen(lv);
         })
      );
      this.addButton(
         new RealmsResetWorldScreen.FrameButton(this.frame(3), row(0) + 10, new TranslatableText("mco.reset.world.template"), SURVIVAL_SPAWN_TEXTURE, arg -> {
      ...
      this.addButton(
         new RealmsResetWorldScreen.FrameButton(this.frame(1), row(6) + 20, new TranslatableText("mco.reset.world.adventure"), ADVENTURE_TEXTURE, arg -> {
      ...
      this.addButton(
         new RealmsResetWorldScreen.FrameButton(this.frame(2), row(6) + 20, new TranslatableText("mco.reset.world.experience"), EXPERIENCE_TEXTURE, arg -> {
      ...
      this.addButton(
         new RealmsResetWorldScreen.FrameButton(this.frame(3), row(6) + 20, new TranslatableText("mco.reset.world.inspiration"), INSPIRATION_TEXTURE, arg -> {
   ...
   private void drawFrame(MatrixStack arg, int x, int y, Text text, Identifier arg3, boolean bl, boolean bl2) {
      ...
      DrawableHelper.drawTexture(arg, x + 2, y + 14, 0.0F, 0.0F, 56, 56, 56, 56);
      ...
      DrawableHelper.drawTexture(arg, x, y + 12, 0.0F, 0.0F, 60, 60, 60, 60);
      int k = bl ? 10526880 : 16777215;
      drawCenteredText(arg, this.textRenderer, text, x + 30, y, k);
   }
   ...
   private void method_25207(@Nullable String string, @Nullable WorldTemplate arg, int i, boolean bl) {
      this.client
         .openScreen(
            new RealmsLongRunningMcoTaskScreen(this.parent, new ResettingWorldTask(string, arg, i, bl, this.serverData.id, this.field_20501, this.field_22711))
         );
   }
