...
public class RealmsSettingsScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.doneButton = this.addButton(new ButtonWidget(i - 2, row(12), 106, 20, new TranslatableText("mco.configure.world.buttons.done"), arg -> this.save()));
      this.addButton(new ButtonWidget(this.width / 2 + 2, row(12), 106, 20, ScreenTexts.CANCEL, arg -> this.client.openScreen(this.parent)));
      ...
      ButtonWidget lv = new ButtonWidget(this.width / 2 - 53, row(0), 106, 20, new TranslatableText(string), arg -> {
         if (this.serverData.state == RealmsServer.State.OPEN) {
            Text lvx = new TranslatableText("mco.configure.world.close.question.line1");
            Text lv2 = new TranslatableText("mco.configure.world.close.question.line2");
            ...
            }, RealmsLongConfirmationScreen.Type.Info, lvx, lv2, true));
         } else {
