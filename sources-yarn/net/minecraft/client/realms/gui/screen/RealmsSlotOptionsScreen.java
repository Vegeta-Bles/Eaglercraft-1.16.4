   ...
   public void init() {
      ...
      if (this.worldType == RealmsServer.WorldType.NORMAL) {
         ...
         if (this.worldType == RealmsServer.WorldType.ADVENTUREMAP) {
            lv = new TranslatableText("mco.configure.world.edit.subscreen.adventuremap");
         } else if (this.worldType == RealmsServer.WorldType.INSPIRATION) {
            lv = new TranslatableText("mco.configure.world.edit.subscreen.inspiration");
         } else {
            lv = new TranslatableText("mco.configure.world.edit.subscreen.experience");
         }

         this.toastMessage = new RealmsLabel(lv, this.width / 2, 26, 16711680);
         this.pvp = true;
      ...
      this.pvpButton = this.addButton(new ButtonWidget(this.column2_x, row(1), this.column_width, 20, this.pvpTitle(), arg -> {
         this.pvp = !this.pvp;
         arg.setMessage(this.pvpTitle());
      }));
      this.addButton(new ButtonWidget(this.column1_x, row(3), this.column_width, 20, this.gameModeTitle(), arg -> {
         this.gameModeIndex = (this.gameModeIndex + 1) % GAME_MODES.length;
         arg.setMessage(this.gameModeTitle());
      }));
      this.spawnAnimalsButton = this.addButton(new ButtonWidget(this.column2_x, row(3), this.column_width, 20, this.spawnAnimalsTitle(), arg -> {
         this.spawnAnimals = !this.spawnAnimals;
         arg.setMessage(this.spawnAnimalsTitle());
      }));
      this.addButton(new ButtonWidget(this.column1_x, row(5), this.column_width, 20, this.difficultyTitle(), arg -> {
      ...
      this.spawnMonstersButton = this.addButton(new ButtonWidget(this.column2_x, row(5), this.column_width, 20, this.spawnMonstersTitle(), arg -> {
      ...
      this.spawnNPCsButton = this.addButton(new ButtonWidget(this.column2_x, row(7), this.column_width, 20, this.spawnNPCsTitle(), arg -> {
         this.spawnNPCs = !this.spawnNPCs;
         arg.setMessage(this.spawnNPCsTitle());
      }));
      this.gameModeButton = this.addButton(new ButtonWidget(this.column1_x, row(9), this.column_width, 20, this.forceGameModeTitle(), arg -> {
         this.forceGameMode = !this.forceGameMode;
         arg.setMessage(this.forceGameModeTitle());
      }));
      this.commandBlocksButton = this.addButton(new ButtonWidget(this.column2_x, row(9), this.column_width, 20, this.commandBlocksTitle(), arg -> {
      ...
      this.addButton(
         new ButtonWidget(this.column1_x, row(13), this.column_width, 20, new TranslatableText("mco.configure.world.buttons.done"), arg -> this.saveSettings())
      );
      this.addButton(new ButtonWidget(this.column2_x, row(13), this.column_width, 20, ScreenTexts.CANCEL, arg -> this.client.openScreen(this.parent)));
