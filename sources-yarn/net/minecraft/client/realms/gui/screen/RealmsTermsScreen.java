...
public class RealmsTermsScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addButton(new ButtonWidget(this.width / 4, row(12), i, 20, new TranslatableText("mco.terms.buttons.agree"), arg -> this.agreedToTos()));
      this.addButton(
         new ButtonWidget(this.width / 2 + 4, row(12), i, 20, new TranslatableText("mco.terms.buttons.disagree"), arg -> this.client.openScreen(this.parent))
      );
   }
   ...
   public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
      ...
      int k = this.textRenderer.getWidth(field_26524);
      int l = this.width / 2 - 121 + k;
      int m = row(5);
      int n = l + this.textRenderer.getWidth(field_26525) + 1;
      int o = m + 1 + 9;
      this.onLink = l <= mouseX && mouseX <= n && m <= mouseY && mouseY <= o;
      this.textRenderer.draw(matrices, field_26525, (float)(this.width / 2 - 120 + k), (float)row(5), this.onLink ? 7107012 : 3368635);
