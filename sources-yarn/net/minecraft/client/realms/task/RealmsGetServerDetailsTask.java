      ...
      if (bl3) {
         ...
         if (bl) {
            ...
            if (lv5.resourcePackUrl != null && lv5.resourcePackHash != null) {
               Text lv6 = new TranslatableText("mco.configure.world.resourcepack.question.line1");
               Text lv7 = new TranslatableText("mco.configure.world.resourcepack.question.line2");
               setScreen(
                           ...
                           if (blx) {
                              ...
                              try {
                                 MinecraftClient.getInstance()
                                    ...
                                    .download(lv5.resourcePackUrl, lv5.resourcePackHash)
                                    .thenRun(
                                       () -> this.setScreen(
                                             new RealmsLongRunningMcoTaskScreen(this.lastScreen, new RealmsConnectTask(this.lastScreen, this.server, lv5))
                                          )
                                    )
               ...
               this.setScreen(new RealmsLongRunningMcoTaskScreen(this.lastScreen, new RealmsConnectTask(this.lastScreen, this.server, lv5)));
            }
         } else {
