...
public class OutlineVertexConsumerProvider implements VertexConsumerProvider {
   ...
   public VertexConsumer getBuffer(RenderLayer arg) {
      if (arg.isOutline()) {
         ...
         return new OutlineVertexConsumerProvider.OutlineVertexConsumer(lv, this.red, this.green, this.blue, this.alpha);
      } else {
         ...
         if (optional.isPresent()) {
            ...
            OutlineVertexConsumerProvider.OutlineVertexConsumer lv4 = new OutlineVertexConsumerProvider.OutlineVertexConsumer(
               lv3, this.red, this.green, this.blue, this.alpha
            );
