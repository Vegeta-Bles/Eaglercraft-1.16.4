...
public abstract class RenderLayer extends RenderPhase {
   ...
   public static RenderLayer getArmorCutoutNoCull(Identifier texture) {
      RenderLayer.MultiPhaseParameters lv = RenderLayer.MultiPhaseParameters.builder()
         ...
         .layering(VIEW_OFFSET_Z_LAYERING)
         .build(true);
      return of("armor_cutout_no_cull", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, true, false, lv);
   }
   ...
   public static RenderLayer getEntitySolid(Identifier texture) {
      RenderLayer.MultiPhaseParameters lv = RenderLayer.MultiPhaseParameters.builder()
         ...
         .overlay(ENABLE_OVERLAY_COLOR)
         .build(true);
      return of("entity_solid", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, true, false, lv);
   }
   ...
   public static RenderLayer getEntityCutout(Identifier texture) {
      RenderLayer.MultiPhaseParameters lv = RenderLayer.MultiPhaseParameters.builder()
         ...
         .overlay(ENABLE_OVERLAY_COLOR)
         .build(true);
      return of("entity_cutout", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, true, false, lv);
   }
   ...
   public static RenderLayer getEntityCutoutNoCull(Identifier texture, boolean affectsOutline) {
      ...
      return of("entity_cutout_no_cull", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, true, false, lv);
   }
   ...
   public static RenderLayer getEntityCutoutNoCullZOffset(Identifier texture, boolean affectsOutline) {
      RenderLayer.MultiPhaseParameters lv = RenderLayer.MultiPhaseParameters.builder()
         ...
         .layering(VIEW_OFFSET_Z_LAYERING)
         .build(affectsOutline);
      return of("entity_cutout_no_cull_z_offset", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, true, false, lv);
   }
   ...
   public static RenderLayer getItemEntityTranslucentCull(Identifier texture) {
      RenderLayer.MultiPhaseParameters lv = RenderLayer.MultiPhaseParameters.builder()
         ...
         .build(true);
      return of("item_entity_translucent_cull", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, true, true, lv);
   }
   ...
   public static RenderLayer getEntityTranslucentCull(Identifier texture) {
      RenderLayer.MultiPhaseParameters lv = RenderLayer.MultiPhaseParameters.builder()
         ...
         .overlay(ENABLE_OVERLAY_COLOR)
         .build(true);
      return of("entity_translucent_cull", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, true, true, lv);
   }
   ...
   public static RenderLayer getEntityTranslucent(Identifier texture, boolean affectsOutline) {
      RenderLayer.MultiPhaseParameters lv = RenderLayer.MultiPhaseParameters.builder()
         ...
         .overlay(ENABLE_OVERLAY_COLOR)
         .build(affectsOutline);
      return of("entity_translucent", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, true, true, lv);
   }
   ...
   public static RenderLayer getEntitySmoothCutout(Identifier texture) {
      RenderLayer.MultiPhaseParameters lv = RenderLayer.MultiPhaseParameters.builder()
         ...
         .lightmap(ENABLE_LIGHTMAP)
         .build(true);
      return of("entity_smooth_cutout", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, lv);
   }
   ...
   public static RenderLayer getBeaconBeam(Identifier texture, boolean translucent) {
      RenderLayer.MultiPhaseParameters lv = RenderLayer.MultiPhaseParameters.builder()
         ...
         .fog(NO_FOG)
         .build(false);
      return of("beacon_beam", VertexFormats.POSITION_COLOR_TEXTURE_LIGHT_NORMAL, 7, 256, false, true, lv);
   }
   ...
   public static RenderLayer getEntityDecal(Identifier texture) {
      RenderLayer.MultiPhaseParameters lv = RenderLayer.MultiPhaseParameters.builder()
         ...
         .overlay(ENABLE_OVERLAY_COLOR)
         .build(false);
      return of("entity_decal", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, lv);
   }
   ...
   public static RenderLayer getEntityNoOutline(Identifier texture) {
      RenderLayer.MultiPhaseParameters lv = RenderLayer.MultiPhaseParameters.builder()
         ...
         .writeMaskState(COLOR_MASK)
         .build(false);
      return of("entity_no_outline", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, false, true, lv);
   }
   ...
   public static RenderLayer getEntityShadow(Identifier texture) {
      RenderLayer.MultiPhaseParameters lv = RenderLayer.MultiPhaseParameters.builder()
         ...
         .layering(VIEW_OFFSET_Z_LAYERING)
         .build(false);
      return of("entity_shadow", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, false, false, lv);
   }
   ...
   public static RenderLayer getEntityAlpha(Identifier texture, float alpha) {
      RenderLayer.MultiPhaseParameters lv = RenderLayer.MultiPhaseParameters.builder()
         ...
         .cull(DISABLE_CULLING)
         .build(true);
      return of("entity_alpha", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, 7, 256, lv);
   }
   ...
   public static RenderLayer getEyes(Identifier texture) {
      ...
      return of(
         ...
         false,
         true,
         RenderLayer.MultiPhaseParameters.builder().texture(lv).transparency(ADDITIVE_TRANSPARENCY).writeMaskState(COLOR_MASK).fog(BLACK_FOG).build(false)
      );
   }
   ...
   public static RenderLayer getEndPortal(int layer) {
      RenderPhase.Transparency lv;
      RenderPhase.Texture lv2;
      if (layer <= 1) {
         lv = TRANSLUCENT_TRANSPARENCY;
         lv2 = new RenderPhase.Texture(EndPortalBlockEntityRenderer.SKY_TEXTURE, false, false);
      } else {
         lv = ADDITIVE_TRANSPARENCY;
         lv2 = new RenderPhase.Texture(EndPortalBlockEntityRenderer.PORTAL_TEXTURE, false, false);
      }
      ...
      return of(
         ...
         false,
         true,
         RenderLayer.MultiPhaseParameters.builder().transparency(lv).texture(lv2).texturing(new RenderPhase.PortalTexturing(layer)).fog(BLACK_FOG).build(false)
      );
   }
   ...
   static final class MultiPhase extends RenderLayer {
      ...
      private MultiPhase(
         ...
         this.affectedOutline = phases.outlineMode == RenderLayer.OutlineMode.AFFECTS_OUTLINE
            ? phases.texture.getId().map(arg2 -> getOutline(arg2, phases.cull))
            : Optional.empty();
      ...
      static enum HashStrategy implements Strategy<RenderLayer.MultiPhase> {
         ...
         public int hashCode(@Nullable RenderLayer.MultiPhase arg) {
            return arg == null ? 0 : arg.hash;
         }

         public boolean equals(@Nullable RenderLayer.MultiPhase arg, @Nullable RenderLayer.MultiPhase arg2) {
            if (arg == arg2) {
               return true;
            } else {
   ...
   public static final class MultiPhaseParameters {
      ...
      public boolean equals(Object object) {
         if (this == object) {
            ...
            RenderLayer.MultiPhaseParameters lv = (RenderLayer.MultiPhaseParameters)object;
