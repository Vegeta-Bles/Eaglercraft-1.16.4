...
public class VertexFormatElement {
   ...
   private boolean isValidType(int index, VertexFormatElement.Type arg) {
      return index == 0 || arg == VertexFormatElement.Type.UV;
   }
   ...
   public boolean equals(Object o) {
      if (this == o) {
         ...
         if (this.count != lv.count) {
            return false;
         } else if (this.index != lv.index) {
            return false;
         } else {
            return this.format != lv.format ? false : this.type == lv.type;
         }
      } else {
         return false;
      }
   ...
   public static enum Type {
      ...
      private Type(String name, VertexFormatElement.Type.Starter arg, IntConsumer intConsumer) {
         this.name = name;
         this.starter = arg;
