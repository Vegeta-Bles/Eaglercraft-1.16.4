...
public class BlockRenderManager implements SynchronousResourceReloadListener {
   ...
   public boolean renderFluid(BlockPos pos, BlockRenderView arg2, VertexConsumer arg3, FluidState arg4) {
      try {
         ...
         CrashReport lv = CrashReport.create(var8, "Tesselating liquid in world");
      ...
      if (lv != BlockRenderType.INVISIBLE) {
         switch (lv) {
            case MODEL:
               ...
               this.blockModelRenderer
                  .render(matrices.peek(), vertexConsumer.getBuffer(RenderLayers.getEntityBlockLayer(state, false)), state, lv2, f, g, h, light, overlay);
               break;
