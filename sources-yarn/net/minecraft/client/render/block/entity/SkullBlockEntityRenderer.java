...
public class SkullBlockEntityRenderer extends BlockEntityRenderer<SkullBlockEntity> {
   private static final Map<SkullBlock.SkullType, SkullEntityModel> MODELS = Util.make(Maps.newHashMap(), hashMap -> {
      ...
      SkullEntityModel lv2 = new SkullOverlayEntityModel();
   ...
   public static void render(
      ...
      float f,
      SkullBlock.SkullType arg2,
      @Nullable GameProfile gameProfile,
      float g,
      MatrixStack arg3,
      VertexConsumerProvider arg4,
      int i
   ) {
      ...
      if (arg == null) {
         ...
         float h = 0.25F;
         arg3.translate((double)(0.5F - (float)arg.getOffsetX() * 0.25F), 0.25, (double)(0.5F - (float)arg.getOffsetZ() * 0.25F));
      }

      arg3.scale(-1.0F, -1.0F, 1.0F);
      VertexConsumer lv2 = arg4.getBuffer(method_3578(arg2, gameProfile));
   ...
   private static RenderLayer method_3578(SkullBlock.SkullType arg, @Nullable GameProfile gameProfile) {
      ...
      if (arg == SkullBlock.Type.PLAYER && gameProfile != null) {
         ...
         Map<Type, MinecraftProfileTexture> map = lv2.getSkinProvider().getTextures(gameProfile);
         return map.containsKey(Type.SKIN)
            ? RenderLayer.getEntityTranslucent(lv2.getSkinProvider().loadSkin(map.get(Type.SKIN), Type.SKIN))
