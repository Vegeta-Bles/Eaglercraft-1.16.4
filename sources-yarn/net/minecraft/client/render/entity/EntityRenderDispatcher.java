...
public class EntityRenderDispatcher {
   ...
   public EntityRenderDispatcher(TextureManager textureManager, ItemRenderer arg2, ReloadableResourceManager arg3, TextRenderer arg4, GameOptions arg5) {
      ...
      for (EntityType<?> lv : Registry.ENTITY_TYPE) {
         if (lv != EntityType.PLAYER && !this.renderers.containsKey(lv)) {
            throw new IllegalStateException("No renderer registered for " + Registry.ENTITY_TYPE.getId(lv));
         }
      }
   }
   ...
   public <T extends Entity> EntityRenderer<? super T> getRenderer(T entity) {
      if (entity instanceof AbstractClientPlayerEntity) {
         ...
         return lv != null ? lv : this.playerRenderer;
      } else {
   ...
   public <E extends Entity> void render(
      ...
      try {
         ...
         if (this.gameOptions.entityShadows && this.renderShadows && lv.shadowRadius > 0.0F && !entity.isInvisible()) {
            ...
            if (n > 0.0F) {
               renderShadow(matrices, vertexConsumers, entity, n, tickDelta, this.world, lv.shadowRadius);
            }
         }
         ...
         lv5.add("Rotation", yaw);
         lv5.add("Delta", tickDelta);
   ...
   private void renderHitbox(MatrixStack matrices, VertexConsumer vertices, Entity entity, float tickDelta) {
      ...
      vertices.vertex(lv3, (float)(lv2.x * 2.0), (float)((double)entity.getStandingEyeHeight() + lv2.y * 2.0), (float)(lv2.z * 2.0))
         .color(0, 0, 255, 255)
         .next();
   }
   ...
   private static void renderShadow(
      ...
      for (BlockPos lv4 : BlockPos.iterate(new BlockPos(k, m, o), new BlockPos(l, n, p))) {
         renderShadowPart(lv2, lv3, world, lv4, d, e, j, i, opacity);
      }
   }
         ...
         if (lv2.isFullCube(world, lv)) {
            ...
            if (!lv3.isEmpty()) {
               ...
               if (i >= 0.0F) {
                  ...
                  drawShadowVertex(entry, vertices, i, o, q, r, t, v);
                  drawShadowVertex(entry, vertices, i, o, q, s, t, w);
                  drawShadowVertex(entry, vertices, i, p, q, s, u, w);
                  drawShadowVertex(entry, vertices, i, p, q, r, u, v);
               }
            }
         }
      }
