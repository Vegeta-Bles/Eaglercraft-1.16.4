...
public class ItemFrameEntityRenderer extends EntityRenderer<ItemFrameEntity> {
   ...
   public void render(ItemFrameEntity arg, float f, float g, MatrixStack arg2, VertexConsumerProvider arg3, int i) {
      ...
      if (!bl) {
         ...
         lv3.getModelRenderer()
            .render(arg2.peek(), arg3.getBuffer(TexturedRenderLayers.getEntitySolid()), null, lv4.getModel(lv5), 1.0F, 1.0F, 1.0F, i, OverlayTexture.DEFAULT_UV);
         arg2.pop();
      }

      ItemStack lv6 = arg.getHeldItemStack();
      if (!lv6.isEmpty()) {
         boolean bl2 = lv6.getItem() == Items.FILLED_MAP;
         if (bl) {
   ...
   protected boolean hasLabel(ItemFrameEntity arg) {
      if (MinecraftClient.isHudEnabled()
         ...
         && arg.getHeldItemStack().hasCustomName()
