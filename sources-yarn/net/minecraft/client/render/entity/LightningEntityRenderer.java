...
public class LightningEntityRenderer extends EntityRenderer<LightningEntity> {
      ...
      for (int l = 0; l < 4; l++) {
         ...
         for (int m = 0; m < 3; m++) {
            ...
            for (int r = n; r >= o; r--) {
               ...
               method_23183(lv2, lv, p, q, r, s, t, 0.45F, 0.45F, 0.5F, y, z, false, false, true, false);
               method_23183(lv2, lv, p, q, r, s, t, 0.45F, 0.45F, 0.5F, y, z, true, false, true, true);
               method_23183(lv2, lv, p, q, r, s, t, 0.45F, 0.45F, 0.5F, y, z, true, true, false, true);
               method_23183(lv2, lv, p, q, r, s, t, 0.45F, 0.45F, 0.5F, y, z, false, true, false, false);
            }
         }
      }
   }
   ...
   private static void method_23183(
      ...
      arg2.vertex(arg, f + (bl ? o : -o), (float)(i * 16), g + (bl2 ? o : -o)).color(k, l, m, 0.3F).next();
      arg2.vertex(arg, h + (bl ? n : -n), (float)((i + 1) * 16), j + (bl2 ? n : -n)).color(k, l, m, 0.3F).next();
      arg2.vertex(arg, h + (bl3 ? n : -n), (float)((i + 1) * 16), j + (bl4 ? n : -n)).color(k, l, m, 0.3F).next();
      arg2.vertex(arg, f + (bl3 ? o : -o), (float)(i * 16), g + (bl4 ? o : -o)).color(k, l, m, 0.3F).next();
   }
