...
public class TropicalFishColorFeatureRenderer extends FeatureRenderer<TropicalFishEntity, EntityModel<TropicalFishEntity>> {
   ...
   public void render(MatrixStack arg, VertexConsumerProvider arg2, int i, TropicalFishEntity arg3, float f, float g, float h, float j, float k, float l) {
      EntityModel<TropicalFishEntity> lv = (EntityModel<TropicalFishEntity>)(arg3.getShape() == 0 ? this.smallModel : this.largeModel);
      float[] fs = arg3.getPatternColorComponents();
      render(this.getContextModel(), lv, arg3.getVarietyId(), arg, arg2, i, arg3, f, g, j, k, l, h, fs[0], fs[1], fs[2]);
   }
}
