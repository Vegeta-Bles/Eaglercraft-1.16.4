...
public class VillagerResourceMetadata {
   ...
   public VillagerResourceMetadata(VillagerResourceMetadata.HatType arg) {
      this.hatType = arg;
   }
   ...
   public static enum HatType {
      ...
      private static final Map<String, VillagerResourceMetadata.HatType> byName = Arrays.stream(values())
         .collect(Collectors.toMap(VillagerResourceMetadata.HatType::getName, arg -> (VillagerResourceMetadata.HatType)arg));
