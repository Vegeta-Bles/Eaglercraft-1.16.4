...
public class ArmorStandEntityModel extends ArmorStandArmorEntityModel {
   ...
   public void animateModel(ArmorStandEntity arg, float f, float g, float h) {
      ...
      this.plate.yaw = (float) (Math.PI / 180.0) * -MathHelper.lerpAngleDegrees(h, arg.prevYaw, arg.yaw);
   ...
   public void setAngles(ArmorStandEntity arg, float f, float g, float h, float i, float j) {
      ...
      this.leftLeg.setPivot(1.9F, 12.0F, 0.0F);
      this.rightLeg.setPivot(-1.9F, 12.0F, 0.0F);
      this.rightTorso.pitch = (float) (Math.PI / 180.0) * arg.getBodyRotation().getPitch();
      this.rightTorso.yaw = (float) (Math.PI / 180.0) * arg.getBodyRotation().getYaw();
      this.rightTorso.roll = (float) (Math.PI / 180.0) * arg.getBodyRotation().getRoll();
      this.leftTorso.pitch = (float) (Math.PI / 180.0) * arg.getBodyRotation().getPitch();
      this.leftTorso.yaw = (float) (Math.PI / 180.0) * arg.getBodyRotation().getYaw();
      this.leftTorso.roll = (float) (Math.PI / 180.0) * arg.getBodyRotation().getRoll();
      this.hip.pitch = (float) (Math.PI / 180.0) * arg.getBodyRotation().getPitch();
      this.hip.yaw = (float) (Math.PI / 180.0) * arg.getBodyRotation().getYaw();
      this.hip.roll = (float) (Math.PI / 180.0) * arg.getBodyRotation().getRoll();
   }
