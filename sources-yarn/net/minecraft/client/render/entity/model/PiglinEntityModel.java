...
public class PiglinEntityModel<T extends MobEntity> extends PlayerEntityModel<T> {
   ...
   public void setAngles(T arg, float f, float g, float h, float i, float j) {
      ...
      if (arg instanceof AbstractPiglinEntity) {
         ...
         CrossbowPosing.method_29352(this.leftArm, this.rightArm, arg.isAttacking(), this.handSwingProgress, h);
      }
   ...
   protected void method_29353(T arg, float f) {
      if (this.handSwingProgress > 0.0F && arg instanceof PiglinEntity && ((PiglinEntity)arg).getActivity() == PiglinActivity.ATTACKING_WITH_MELEE_WEAPON) {
         ...
         super.method_29353(arg, f);
      }
   }

   private void method_29354(T arg) {
      if (arg.isLeftHanded()) {
