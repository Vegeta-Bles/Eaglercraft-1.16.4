...
public class RabbitEntityModel<T extends RabbitEntity> extends EntityModel<T> {
   ...
   public void render(MatrixStack matrices, VertexConsumer vertices, int light, int overlay, float red, float green, float blue, float alpha) {
      if (this.child) {
         ...
         ImmutableList.of(this.head, this.leftEar, this.rightEar, this.nose)
            .forEach(arg3 -> arg3.render(matrices, vertices, light, overlay, red, green, blue, alpha));
         matrices.pop();
         matrices.push();
   ...
   public void setAngles(T arg, float f, float g, float h, float i, float j) {
      ...
      this.field_3531 = MathHelper.sin(arg.getJumpProgress(k) * (float) Math.PI);
   ...
   public void animateModel(T arg, float f, float g, float h) {
      ...
      this.field_3531 = MathHelper.sin(arg.getJumpProgress(h) * (float) Math.PI);
   }
}
