...
public enum CubeFace {
   ...
   private static final CubeFace[] DIRECTION_LOOKUP = Util.make(new CubeFace[6], args -> {
      args[CubeFace.DirectionIds.DOWN] = DOWN;
      args[CubeFace.DirectionIds.UP] = UP;
      args[CubeFace.DirectionIds.NORTH] = NORTH;
      args[CubeFace.DirectionIds.SOUTH] = SOUTH;
      args[CubeFace.DirectionIds.WEST] = WEST;
      args[CubeFace.DirectionIds.EAST] = EAST;
   });
