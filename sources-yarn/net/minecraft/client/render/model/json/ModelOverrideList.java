...
public class ModelOverrideList {
   ...
   public ModelOverrideList(
      ...
      this.models = overrides.stream().map(arg3 -> {
         UnbakedModel lv = unbakedModelGetter.apply(arg3.getModelId());
         return Objects.equals(lv, unbakedModel) ? null : modelLoader.bake(arg3.getModelId(), net.minecraft.client.render.model.ModelRotation.X0_Y0);
   ...
   public BakedModel apply(BakedModel model, ItemStack stack, @Nullable ClientWorld world, @Nullable LivingEntity entity) {
      if (!this.overrides.isEmpty()) {
         for (int i = 0; i < this.overrides.size(); i++) {
            ...
            if (lv.matches(stack, world, entity)) {
