...
public class ClientBuiltinResourcePackProvider implements ResourcePackProvider {
   ...
   public void register(Consumer<ResourcePackProfile> consumer, ResourcePackProfile.Factory factory) {
      ...
      ResourcePackProfile lv2 = this.method_25454(factory);
      if (lv2 != null) {
         consumer.accept(lv2);
      }
   }
   ...
   public CompletableFuture<?> download(String string, String string2) {
      ...
      try {
         ...
         if (file.exists()) {
            ...
            completableFuture = NetworkUtils.download(file, string, map, 104857600, lv, lv2.getNetworkProxy());
         }

         this.downloadTask = completableFuture.<Void>thenCompose(
   ...
   public CompletableFuture<Void> loadServerPack(File packZip, ResourcePackSource arg) {
      PackResourceMetadata lv2;
      try (ZipResourcePack lv = new ZipResourcePack(packZip)) {
         lv2 = lv.parseMetadata(PackResourceMetadata.READER);
      } catch (IOException var17) {
      ...
      this.serverContainer = new ResourcePackProfile(
         ...
         lv2.getDescription(),
         ResourcePackCompatibility.from(lv2.getPackFormat()),
   ...
   private ResourcePackProfile method_25454(ResourcePackProfile.Factory arg) {
      ...
      if (file != null && file.isFile()) {
         lv = method_25453(arg, () -> method_16048(file));
      }

      if (lv == null && SharedConstants.isDevelopment) {
         File file2 = this.index.findFile("../resourcepacks/programmer_art");
         if (file2 != null && file2.isDirectory()) {
            lv = method_25453(arg, () -> method_25455(file2));
         }
      }
