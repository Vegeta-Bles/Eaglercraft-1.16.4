...
public class VideoWarningManager extends SinglePreparationResourceReloadListener<VideoWarningManager.WarningPatternLoader> {
   ...
   protected VideoWarningManager.WarningPatternLoader prepare(ResourceManager arg, Profiler arg2) {
   ...
   protected void apply(VideoWarningManager.WarningPatternLoader arg, ResourceManager arg2, Profiler arg3) {
   ...
   private static JsonObject loadWarnlist(ResourceManager resourceManager, Profiler profiler) {
      ...
      try (
         Resource lv = resourceManager.getResource(GPU_WARNLIST_ID);
