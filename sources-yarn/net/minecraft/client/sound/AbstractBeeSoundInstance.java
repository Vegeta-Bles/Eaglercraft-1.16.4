...
public abstract class AbstractBeeSoundInstance extends MovingSoundInstance {
   ...
   public AbstractBeeSoundInstance(BeeEntity arg, SoundEvent arg2, SoundCategory arg3) {
      super(arg2, arg3);
      this.bee = arg;
      this.x = (double)((float)arg.getX());
      this.y = (double)((float)arg.getY());
      this.z = (double)((float)arg.getZ());
      this.repeat = true;
      this.repeatDelay = 0;
      this.volume = 0.0F;
   }
