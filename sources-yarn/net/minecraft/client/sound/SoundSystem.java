...
public class SoundSystem {
   ...
   public void reloadSounds() {
      ...
      for (SoundEvent lv : Registry.SOUND_EVENT) {
         ...
         if (this.loader.get(lv2) == null) {
            LOGGER.warn("Missing sound for event: {}", Registry.SOUND_EVENT.getId(lv));
   ...
   private float getSoundVolume(@Nullable SoundCategory arg) {
      return arg != null && arg != SoundCategory.MASTER ? this.settings.getSoundVolume(arg) : 1.0F;
   }
   ...
   public void updateSoundVolume(SoundCategory arg, float volume) {
      if (this.started) {
         if (arg == SoundCategory.MASTER) {
            ...
            this.sources.forEach((argx, arg2) -> {
               float f = this.getAdjustedVolume(argx);
               arg2.run(argxx -> {
                  if (f <= 0.0F) {
                     argxx.stop();
                  } else {
   ...
   public void stop(SoundInstance arg) {
      if (this.started) {
         Channel.SourceManager lv = this.sources.get(arg);
         if (lv != null) {
            lv.run(Source::stop);
         }
      }
   ...
   private void tick() {
      ...
      while (iterator.hasNext()) {
         ...
         if (h <= 0.0F) {
            ...
            int i = this.soundEndTicks.get(lv5);
            if (i <= this.ticks) {
   ...
   private static boolean isRepeatDelayed(SoundInstance arg) {
      return arg.isRepeatable() && canRepeatInstantly(arg);
   }
   ...
   public boolean isPlaying(SoundInstance arg) {
      if (!this.started) {
         ...
         return this.soundEndTicks.containsKey(arg) && this.soundEndTicks.get(arg) <= this.ticks ? true : this.sources.containsKey(arg);
      }
   }
               ...
               if (lv3 == SoundManager.MISSING_SOUND) {
                  ...
                  if (h == 0.0F && !arg.shouldAlwaysPlay()) {
                     ...
                     if (!this.listeners.isEmpty()) {
                        boolean bl2 = bl || lv5 == SoundInstance.AttenuationType.NONE || this.listener.getPos().squaredDistanceTo(lv6) < (double)(g * g);
                        if (bl2) {
                     ...
                     if (this.listener.getVolume() <= 0.0F) {
                        ...
                        boolean bl3 = shouldRepeatInstantly(arg);
                        boolean bl4 = lv3.isStreamed();
                        CompletableFuture<Channel.SourceManager> completableFuture = this.channel
                           .createSource(lv3.isStreamed() ? SoundEngine.RunMode.STREAMING : SoundEngine.RunMode.STATIC);
                        ...
                        if (lv8 == null) {
                           ...
                           if (!bl4) {
                              this.soundLoader.loadStatic(lv3.getLocation()).thenAccept(arg2 -> lv8.run(arg2x -> {
                                    arg2x.setBuffer(arg2);
                                    arg2x.play();
                                 }));
                           } else {
                              this.soundLoader.loadStreamed(lv3.getLocation(), bl3).thenAccept(arg2 -> lv8.run(arg2x -> {
   ...
   public void stopSounds(@Nullable Identifier arg, @Nullable SoundCategory arg2) {
      if (arg2 != null) {
         for (SoundInstance lv : this.sounds.get(arg2)) {
            if (arg == null || lv.getId().equals(arg)) {
               this.stop(lv);
            }
         }
      } else if (arg == null) {
