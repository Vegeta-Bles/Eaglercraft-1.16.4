...
public class Source {
   ...
   public void setPosition(Vec3d arg) {
      AL10.alSourcefv(this.pointer, 4100, new float[]{(float)arg.x, (float)arg.y, (float)arg.z});
   }
   ...
   public void setBuffer(StaticSound arg) {
      arg.getStreamBufferPointer().ifPresent(i -> AL10.alSourcei(this.pointer, 4105, i));
   }
