...
public class ResourceTexture extends AbstractTexture {
   ...
   public void load(ResourceManager manager) throws IOException {
      ResourceTexture.TextureData lv = this.loadTextureData(manager);
      lv.checkException();
   ...
   public static class TextureData implements Closeable {
      ...
      public static ResourceTexture.TextureData load(ResourceManager arg, Identifier arg2) {
         try (Resource lv = arg.getResource(arg2)) {
            ...
            try {
               ...
               ResourceTexture.LOGGER.warn("Failed reading metadata of: {}", arg2, var17);
            }

            return new ResourceTexture.TextureData(lv3, lv2);
