...
public class AdvancementToast implements Toast {
   ...
   public Toast.Visibility draw(MatrixStack matrices, ToastManager manager, long startTime) {
      ...
      if (lv != null) {
         ...
         if (list.size() == 1) {
            manager.getGame().textRenderer.draw(matrices, lv.getFrame().getToastText(), 30.0F, 7.0F, i | 0xFF000000);
            ...
            if (startTime < 1500L) {
               ...
               manager.getGame().textRenderer.draw(matrices, lv.getFrame().getToastText(), 30.0F, 11.0F, i | k);
            } else {
               ...
               for (OrderedText lv2 : list) {
                  manager.getGame().textRenderer.draw(matrices, lv2, 30.0F, (float)n, 16777215 | m);
                  n += 9;
               }
            }
         }
