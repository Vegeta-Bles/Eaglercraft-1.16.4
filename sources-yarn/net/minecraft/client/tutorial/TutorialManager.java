...
public class TutorialManager {
   ...
   public void method_31365(TutorialToast arg, int i) {
      this.field_26893.add(new TutorialManager.class_5524(arg, i));
      this.client.getToastManager().add(arg);
   }

   public void method_31364(TutorialToast arg) {
      this.field_26893.removeIf(arg2 -> arg2.field_26894 == arg);
      arg.hide();
   }

   public void tick() {
      this.field_26893.removeIf(object -> object.method_31368());
      if (this.currentHandler != null) {
   ...
   static final class class_5524 {
      ...
      private class_5524(TutorialToast arg, int i) {
         this.field_26894 = arg;
         this.field_26895 = i;
      }
