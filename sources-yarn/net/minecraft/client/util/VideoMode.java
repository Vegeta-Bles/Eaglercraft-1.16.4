...
public final class VideoMode {
   ...
   public boolean equals(Object o) {
      if (this == o) {
         ...
         return this.width == lv.width
            && this.height == lv.height
            && this.redBits == lv.redBits
            && this.greenBits == lv.greenBits
            && this.blueBits == lv.blueBits
            && this.refreshRate == lv.refreshRate;
      } else {
         return false;
      }
   }
