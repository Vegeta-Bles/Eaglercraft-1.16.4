...
public class EntitySelectorReader {
   ...
   public static final BiConsumer<Vec3d, List<? extends Entity>> NEAREST = (arg, list) -> list.sort(
         (arg2, arg3) -> Doubles.compare(arg2.squaredDistanceTo(arg), arg3.squaredDistanceTo(arg))
      );
   public static final BiConsumer<Vec3d, List<? extends Entity>> FURTHEST = (arg, list) -> list.sort(
         (arg2, arg3) -> Doubles.compare(arg3.squaredDistanceTo(arg), arg2.squaredDistanceTo(arg))
      );
   ...
   public EntitySelector build() {
      ...
      if (this.dx == null && this.dy == null && this.dz == null) {
         if (this.distance.getMax() != null) {
            ...
            lv2 = new Box((double)(-f), (double)(-f), (double)(-f), (double)(f + 1.0F), (double)(f + 1.0F), (double)(f + 1.0F));
         } else {
            lv2 = null;
         }
      } else {
         lv2 = this.createBox(this.dx == null ? 0.0 : this.dx, this.dy == null ? 0.0 : this.dy, this.dz == null ? 0.0 : this.dz);
      }
      ...
      if (this.x == null && this.y == null && this.z == null) {
         ...
         function = arg -> new Vec3d(this.x == null ? arg.x : this.x, this.y == null ? arg.y : this.y, this.z == null ? arg.z : this.z);
      }
   ...
   private void buildPredicate() {
      if (this.pitchRange != FloatRangeArgument.ANY) {
         this.predicate = this.predicate.and(this.rotationPredicate(this.pitchRange, arg -> (double)arg.pitch));
      }

      if (this.yawRange != FloatRangeArgument.ANY) {
         this.predicate = this.predicate.and(this.rotationPredicate(this.yawRange, arg -> (double)arg.yaw));
      }

      if (!this.levelRange.isDummy()) {
         this.predicate = this.predicate
            .and(arg -> !(arg instanceof ServerPlayerEntity) ? false : this.levelRange.test(((ServerPlayerEntity)arg).experienceLevel));
      }
   }

   private Predicate<Entity> rotationPredicate(FloatRangeArgument arg, ToDoubleFunction<Entity> toDoubleFunction) {
      double d = (double)MathHelper.wrapDegrees(arg.getMin() == null ? 0.0F : arg.getMin());
      double e = (double)MathHelper.wrapDegrees(arg.getMax() == null ? 359.0F : arg.getMax());
      return argx -> {
         double f = MathHelper.wrapDegrees(toDoubleFunction.applyAsDouble(argx));
