...
public class TranslatableBuiltInExceptions implements BuiltInExceptionProvider {
   ...
   private static final SimpleCommandExceptionType READER_EXPECTED_END_QUOTE = new SimpleCommandExceptionType(
      new TranslatableText("parsing.quote.expected.end")
   );
   ...
   private static final SimpleCommandExceptionType DISPATCHER_UNKNOWN_ARGUMENT = new SimpleCommandExceptionType(
      new TranslatableText("command.unknown.argument")
   );
