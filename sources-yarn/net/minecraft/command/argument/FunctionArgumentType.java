      ...
      if (stringReader.canRead() && stringReader.peek() == '#') {
         ...
         return new FunctionArgumentType.FunctionArgument() {
            ...
            public Collection<CommandFunction> getFunctions(CommandContext<ServerCommandSource> commandContext) throws CommandSyntaxException {
               Tag<CommandFunction> lv = FunctionArgumentType.getFunctionTag(commandContext, lv);
               return lv.values();
            }
            ...
            public Pair<Identifier, Either<CommandFunction, Tag<CommandFunction>>> getFunctionOrTag(CommandContext<ServerCommandSource> commandContext) throws CommandSyntaxException {
               return Pair.of(lv, Either.right(FunctionArgumentType.getFunctionTag(commandContext, lv)));
            }
         };
      } else {
         ...
         return new FunctionArgumentType.FunctionArgument() {
            @Override
            public Collection<CommandFunction> getFunctions(CommandContext<ServerCommandSource> commandContext) throws CommandSyntaxException {
               return Collections.singleton(FunctionArgumentType.getFunction(commandContext, lv2));
            }

            @Override
            public Pair<Identifier, Either<CommandFunction, Tag<CommandFunction>>> getFunctionOrTag(CommandContext<ServerCommandSource> commandContext) throws CommandSyntaxException {
               return Pair.of(lv2, Either.left(FunctionArgumentType.getFunction(commandContext, lv2)));
            }
         };
      }
   }
