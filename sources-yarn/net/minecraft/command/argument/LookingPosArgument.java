...
public class LookingPosArgument implements PosArgument {
   ...
   public Vec3d toAbsolutePos(ServerCommandSource source) {
      ...
      float f = MathHelper.cos((lv.y + 90.0F) * (float) (Math.PI / 180.0));
      float g = MathHelper.sin((lv.y + 90.0F) * (float) (Math.PI / 180.0));
      float h = MathHelper.cos(-lv.x * (float) (Math.PI / 180.0));
      float i = MathHelper.sin(-lv.x * (float) (Math.PI / 180.0));
      float j = MathHelper.cos((-lv.x + 90.0F) * (float) (Math.PI / 180.0));
      float k = MathHelper.sin((-lv.x + 90.0F) * (float) (Math.PI / 180.0));
