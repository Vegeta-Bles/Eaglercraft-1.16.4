...
public class DataCache {
   ...
   public DataCache(Path path, String string) throws IOException {
      ...
      this.files().forEach(pathx -> {
         String var10000 = this.oldSha1.put(pathx, "");
      });
   ...
   public void write() throws IOException {
      ...
      IOUtils.writeLines(
         this.newSha1.entrySet().stream().map(entry -> entry.getValue() + ' ' + this.root.relativize(entry.getKey())).collect(Collectors.toList()),
