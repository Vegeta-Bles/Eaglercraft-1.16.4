...
public class BlockStateModelGenerator {
   ...
   private void method_31063(Block arg, Identifier arg2) {
      this.blockStateCollector.accept(createAxisRotatedBlockState(arg, arg2));
   }
   ...
   private BlockStateModelGenerator.BlockTexturePool registerTexturePool(Block block, TexturedModel.Factory modelFactory) {
      ...
      return new BlockStateModelGenerator.BlockTexturePool(lv.getTexture()).base(block, lv.getModel());
   }
   ...
   private void registerDoor(Block doorBlock) {
      ...
      this.blockStateCollector.accept(createDoorBlockState(doorBlock, lv2, lv3, lv4, lv5));
   }
   ...
   private void registerSunflower() {
      ...
      Identifier lv2 = this.createSubModel(Blocks.SUNFLOWER, "_bottom", BlockStateModelGenerator.TintType.NOT_TINTED.getCrossModel(), Texture::cross);
            ...
            VariantsBlockStateSupplier.create(rail)
               .coordinate(
                  BlockStateVariantMap.create(Properties.RAIL_SHAPE)
                     ...
                     .register(
                        RailShape.EAST_WEST, BlockStateVariant.create().put(VariantSettings.MODEL, lv3).put(VariantSettings.Y, VariantSettings.Rotation.R90)
                     )
                     .register(
                        RailShape.ASCENDING_EAST,
                        BlockStateVariant.create().put(VariantSettings.MODEL, lv5).put(VariantSettings.Y, VariantSettings.Rotation.R90)
                     )
                     .register(
                        RailShape.ASCENDING_WEST,
                        BlockStateVariant.create().put(VariantSettings.MODEL, lv6).put(VariantSettings.Y, VariantSettings.Rotation.R90)
                     )
                     ...
                     .register(
                        RailShape.SOUTH_WEST, BlockStateVariant.create().put(VariantSettings.MODEL, lv4).put(VariantSettings.Y, VariantSettings.Rotation.R90)
                     )
                     .register(
                        RailShape.NORTH_WEST, BlockStateVariant.create().put(VariantSettings.MODEL, lv4).put(VariantSettings.Y, VariantSettings.Rotation.R180)
                     )
                     .register(
                        RailShape.NORTH_EAST, BlockStateVariant.create().put(VariantSettings.MODEL, lv4).put(VariantSettings.Y, VariantSettings.Rotation.R270)
                     )
               )
         );
   }
   ...
   private void registerStraightRail(Block rail) {
      ...
      BlockStateVariantMap lv7 = BlockStateVariantMap.create(Properties.POWERED, Properties.STRAIGHT_RAIL_SHAPE).register((boolean_, arg7) -> {
         switch (arg7) {
            case NORTH_SOUTH:
               return BlockStateVariant.create().put(VariantSettings.MODEL, boolean_ ? lv4 : lv);
            case EAST_WEST:
               return BlockStateVariant.create().put(VariantSettings.MODEL, boolean_ ? lv4 : lv).put(VariantSettings.Y, VariantSettings.Rotation.R90);
            case ASCENDING_EAST:
               return BlockStateVariant.create().put(VariantSettings.MODEL, boolean_ ? lv5 : lv2).put(VariantSettings.Y, VariantSettings.Rotation.R90);
            case ASCENDING_WEST:
               return BlockStateVariant.create().put(VariantSettings.MODEL, boolean_ ? lv6 : lv3).put(VariantSettings.Y, VariantSettings.Rotation.R90);
            case ASCENDING_NORTH:
               return BlockStateVariant.create().put(VariantSettings.MODEL, boolean_ ? lv5 : lv2);
            case ASCENDING_SOUTH:
               return BlockStateVariant.create().put(VariantSettings.MODEL, boolean_ ? lv6 : lv3);
            default:
   ...
   private void registerSouthDefaultHorizontalFacing(TexturedModel.Factory modelFactory, Block... blocks) {
      for (Block lv : blocks) {
         ...
         this.blockStateCollector
            .accept(
               VariantsBlockStateSupplier.create(lv, BlockStateVariant.create().put(VariantSettings.MODEL, lv2))
                  .coordinate(createSouthDefaultHorizontalRotationStates())
            );
      }
   }
      ...
      this.blockStateCollector
         .accept(
            MultipartBlockStateSupplier.create(glassPane)
               ...
               .with(
                  When.create().set(Properties.EAST, true),
                  BlockStateVariant.create().put(VariantSettings.MODEL, lv3).put(VariantSettings.Y, VariantSettings.Rotation.R90)
               )
               .with(When.create().set(Properties.SOUTH, true), BlockStateVariant.create().put(VariantSettings.MODEL, lv4))
               .with(
                  When.create().set(Properties.WEST, true),
                  BlockStateVariant.create().put(VariantSettings.MODEL, lv4).put(VariantSettings.Y, VariantSettings.Rotation.R90)
               )
               ...
               .with(
                  ...
                  BlockStateVariant.create().put(VariantSettings.MODEL, lv5).put(VariantSettings.Y, VariantSettings.Rotation.R270)
               )
         );
   }
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(beehive)
               .coordinate(createNorthDefaultHorizontalRotationStates())
               .coordinate(createValueFencedModelMap(Properties.HONEY_LEVEL, 5, lv4, lv3))
         );
   }
   ...
   private void registerCrop(Block crop, Property<Integer> ageProperty, int... ageTextureIndices) {
      if (ageProperty.getValues().size() != ageTextureIndices.length) {
         ...
         BlockStateVariantMap lv = BlockStateVariantMap.create(ageProperty).register(integer -> {
            ...
            Identifier lvx = (Identifier)int2ObjectMap.computeIfAbsent(i, j -> this.createSubModel(crop, "_stage" + i, Models.CROP, Texture::crop));
               ...
               .coordinate(
                  BlockStateVariantMap.create(Properties.HORIZONTAL_FACING, Properties.ATTACHMENT)
                     ...
                     .register(
                        Direction.SOUTH,
                        Attachment.FLOOR,
                        BlockStateVariant.create().put(VariantSettings.MODEL, lv).put(VariantSettings.Y, VariantSettings.Rotation.R180)
                     )
                     .register(
                        Direction.EAST,
                        Attachment.FLOOR,
                        BlockStateVariant.create().put(VariantSettings.MODEL, lv).put(VariantSettings.Y, VariantSettings.Rotation.R90)
                     )
                     .register(
                        Direction.WEST,
                        Attachment.FLOOR,
                        BlockStateVariant.create().put(VariantSettings.MODEL, lv).put(VariantSettings.Y, VariantSettings.Rotation.R270)
                     )
                     .register(Direction.NORTH, Attachment.CEILING, BlockStateVariant.create().put(VariantSettings.MODEL, lv2))
                     .register(
                        Direction.SOUTH,
                        Attachment.CEILING,
                        BlockStateVariant.create().put(VariantSettings.MODEL, lv2).put(VariantSettings.Y, VariantSettings.Rotation.R180)
                     )
                     .register(
                        Direction.EAST,
                        Attachment.CEILING,
                        BlockStateVariant.create().put(VariantSettings.MODEL, lv2).put(VariantSettings.Y, VariantSettings.Rotation.R90)
                     )
                     .register(
                        Direction.WEST,
                        Attachment.CEILING,
                        BlockStateVariant.create().put(VariantSettings.MODEL, lv2).put(VariantSettings.Y, VariantSettings.Rotation.R270)
                     )
                     .register(
                        Direction.NORTH,
                     ...
                     .register(
                        Direction.WEST,
                        Attachment.SINGLE_WALL,
                        BlockStateVariant.create().put(VariantSettings.MODEL, lv3).put(VariantSettings.Y, VariantSettings.Rotation.R180)
                     )
                     .register(
                        Direction.SOUTH,
                     ...
                     .register(
                        Direction.WEST,
                        Attachment.DOUBLE_WALL,
                        BlockStateVariant.create().put(VariantSettings.MODEL, lv4).put(VariantSettings.Y, VariantSettings.Rotation.R180)
                     )
               )
         );
   }
   ...
   private void method_27166(Block... args) {
      ...
      for (Block lv2 : args) {
         ...
         this.blockStateCollector
            .accept(
               VariantsBlockStateSupplier.create(lv2)
                  .coordinate(createBooleanModelMap(Properties.LIT, lv3, lv))
                  .coordinate(createSouthDefaultHorizontalRotationStates())
            );
      }
   ...
   private void registerCartographyTable() {
      ...
      this.blockStateCollector
         .accept(createSingletonBlockState(Blocks.CARTOGRAPHY_TABLE, Models.CUBE.upload(Blocks.CARTOGRAPHY_TABLE, lv, this.modelCollector)));
   }
            ...
            VariantsBlockStateSupplier.create(block)
               .coordinate(
                  BlockStateVariantMap.create(Properties.FACING)
                     .register(Direction.DOWN, BlockStateVariant.create().put(VariantSettings.MODEL, lv4).put(VariantSettings.X, VariantSettings.Rotation.R180))
                     ...
                     .register(Direction.EAST, BlockStateVariant.create().put(VariantSettings.MODEL, lv3).put(VariantSettings.Y, VariantSettings.Rotation.R90))
                     .register(
                        Direction.SOUTH, BlockStateVariant.create().put(VariantSettings.MODEL, lv3).put(VariantSettings.Y, VariantSettings.Rotation.R180)
                     )
                     .register(Direction.WEST, BlockStateVariant.create().put(VariantSettings.MODEL, lv3).put(VariantSettings.Y, VariantSettings.Rotation.R270))
               )
         );
   }
         ...
         .accept(
            MultipartBlockStateSupplier.create(Blocks.CHORUS_PLANT)
               ...
               .with(
                  When.create().set(Properties.EAST, false),
                  BlockStateVariant.create()
                     .put(VariantSettings.MODEL, lv3)
                     .put(VariantSettings.Y, VariantSettings.Rotation.R90)
                     .put(VariantSettings.UVLOCK, true),
                  BlockStateVariant.create()
                     .put(VariantSettings.MODEL, lv4)
                     .put(VariantSettings.Y, VariantSettings.Rotation.R90)
                     .put(VariantSettings.UVLOCK, true),
                  BlockStateVariant.create()
                     .put(VariantSettings.MODEL, lv5)
                     .put(VariantSettings.Y, VariantSettings.Rotation.R90)
                     .put(VariantSettings.UVLOCK, true),
                  BlockStateVariant.create()
                     .put(VariantSettings.MODEL, lv2)
               ...
               .coordinate(
                  BlockStateVariantMap.create(Properties.INVERTED)
                     .register(
                        false,
                        BlockStateVariant.create()
                           .put(VariantSettings.MODEL, Models.TEMPLATE_DAYLIGHT_DETECTOR.upload(Blocks.DAYLIGHT_DETECTOR, lv2, this.modelCollector))
                     )
                     .register(
                        true,
                        BlockStateVariant.create()
   ...
   private void method_31064(Block arg) {
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(arg, BlockStateVariant.create().put(VariantSettings.MODEL, ModelIds.getBlockModelId(arg)))
               .coordinate(this.createUpDefaultFacingVariantMap())
         );
   }
   ...
   private void registerFarmland() {
      ...
      this.blockStateCollector
         .accept(VariantsBlockStateSupplier.create(Blocks.FARMLAND).coordinate(createValueFencedModelMap(Properties.MOISTURE, 7, lv4, lv3)));
   }
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(topSoil)
               .coordinate(BlockStateVariantMap.create(Properties.SNOWY).register(true, snowyVariant).register(false, list))
         );
   }
            ...
            VariantsBlockStateSupplier.create(Blocks.HOPPER)
               .coordinate(
                  BlockStateVariantMap.create(Properties.HOPPER_FACING)
                     ...
                     .register(Direction.EAST, BlockStateVariant.create().put(VariantSettings.MODEL, lv2).put(VariantSettings.Y, VariantSettings.Rotation.R90))
                     .register(
                        Direction.SOUTH, BlockStateVariant.create().put(VariantSettings.MODEL, lv2).put(VariantSettings.Y, VariantSettings.Rotation.R180)
                     )
                     .register(Direction.WEST, BlockStateVariant.create().put(VariantSettings.MODEL, lv2).put(VariantSettings.Y, VariantSettings.Rotation.R270))
               )
         );
   }
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockStateSupplier.create(
               ...
               BlockStateVariant.create().put(VariantSettings.MODEL, lv).put(VariantSettings.X, VariantSettings.Rotation.R90),
               BlockStateVariant.create().put(VariantSettings.MODEL, lv).put(VariantSettings.X, VariantSettings.Rotation.R180),
               BlockStateVariant.create().put(VariantSettings.MODEL, lv).put(VariantSettings.X, VariantSettings.Rotation.R270),
               BlockStateVariant.create().put(VariantSettings.MODEL, lv).put(VariantSettings.Y, VariantSettings.Rotation.R90),
               BlockStateVariant.create()
                  .put(VariantSettings.MODEL, lv)
                  .put(VariantSettings.Y, VariantSettings.Rotation.R90)
               ...
               .coordinate(
                  BlockStateVariantMap.create(Properties.SHORT, Properties.PISTON_TYPE)
                     .register(
                        ...
                        PistonType.DEFAULT,
                        BlockStateVariant.create()
                           .put(VariantSettings.MODEL, Models.TEMPLATE_PISTON_HEAD.upload(Blocks.PISTON, "_head", lv3, this.modelCollector))
                     )
                     .register(
                        false,
                        PistonType.STICKY,
                        BlockStateVariant.create()
                           .put(VariantSettings.MODEL, Models.TEMPLATE_PISTON_HEAD.upload(Blocks.PISTON, "_head_sticky", lv2, this.modelCollector))
                     )
                     .register(
                        true,
                        PistonType.DEFAULT,
                        BlockStateVariant.create()
                           .put(VariantSettings.MODEL, Models.TEMPLATE_PISTON_HEAD_SHORT.upload(Blocks.PISTON, "_head_short", lv3, this.modelCollector))
                     )
                     .register(
                        true,
                        PistonType.STICKY,
   ...
   public void register() {
      ...
      this.registerSingleton(
         Blocks.CHISELED_QUARTZ_BLOCK, TexturedModel.CUBE_COLUMN.withTexture(arg -> arg.put(TextureKey.SIDE, Texture.getId(Blocks.CHISELED_QUARTZ_BLOCK)))
      );
      ...
      this.registerTexturePool(Texture.all(Blocks.STONE)).base(arg -> {
         Identifier lv = Models.CUBE_ALL.upload(Blocks.STONE, arg, this.modelCollector);
         Identifier lv2 = Models.CUBE_MIRRORED_ALL.upload(Blocks.STONE, arg, this.modelCollector);
         this.blockStateCollector.accept(createBlockStateWithTwoModelAndRandomInversion(Blocks.STONE, lv, lv2));
         return lv;
      ...
      this.registerTexturePool(
            Blocks.CUT_SANDSTONE, TexturedModel.CUBE_COLUMN.get(Blocks.SANDSTONE).texture(arg -> arg.put(TextureKey.SIDE, Texture.getId(Blocks.CUT_SANDSTONE)))
         )
      ...
      SpawnEggItem.getAll().forEach(arg -> this.registerParentedItemModel(arg, ModelIds.getMinecraftNamespacedItem("template_spawn_egg")));
   }
   ...
   class BlockTexturePool {
      ...
      public BlockStateModelGenerator.BlockTexturePool button(Block buttonBlock) {
         Identifier lv = Models.BUTTON.upload(buttonBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
         Identifier lv2 = Models.BUTTON_PRESSED.upload(buttonBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
         ...
         Identifier lv3 = Models.BUTTON_INVENTORY.upload(buttonBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
      ...
      public BlockStateModelGenerator.BlockTexturePool wall(Block wallBlock) {
         Identifier lv = Models.TEMPLATE_WALL_POST.upload(wallBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
         Identifier lv2 = Models.TEMPLATE_WALL_SIDE.upload(wallBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
         Identifier lv3 = Models.TEMPLATE_WALL_SIDE_TALL.upload(wallBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
         ...
         Identifier lv4 = Models.WALL_INVENTORY.upload(wallBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
      ...
      public BlockStateModelGenerator.BlockTexturePool fence(Block fenceBlock) {
         Identifier lv = Models.FENCE_POST.upload(fenceBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
         Identifier lv2 = Models.FENCE_SIDE.upload(fenceBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
         ...
         Identifier lv3 = Models.FENCE_INVENTORY.upload(fenceBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
      ...
      public BlockStateModelGenerator.BlockTexturePool fenceGate(Block fenceGateBlock) {
         Identifier lv = Models.TEMPLATE_FENCE_GATE_OPEN.upload(fenceGateBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
         Identifier lv2 = Models.TEMPLATE_FENCE_GATE.upload(fenceGateBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
         Identifier lv3 = Models.TEMPLATE_FENCE_GATE_WALL_OPEN.upload(fenceGateBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
         Identifier lv4 = Models.TEMPLATE_FENCE_GATE_WALL.upload(fenceGateBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
      ...
      public BlockStateModelGenerator.BlockTexturePool pressurePlate(Block pressurePlateBlock) {
         Identifier lv = Models.PRESSURE_PLATE_UP.upload(pressurePlateBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
         Identifier lv2 = Models.PRESSURE_PLATE_DOWN.upload(pressurePlateBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
      ...
      public BlockStateModelGenerator.BlockTexturePool sign(Block signBlock, Block wallSignBlock) {
         Identifier lv = Models.PARTICLE.upload(signBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
      ...
      public BlockStateModelGenerator.BlockTexturePool slab(Block slabBlock) {
         if (this.baseModelId == null) {
            ...
            Identifier lv = Models.SLAB.upload(slabBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
            Identifier lv2 = Models.SLAB_TOP.upload(slabBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
      ...
      public BlockStateModelGenerator.BlockTexturePool stairs(Block stairsBlock) {
         Identifier lv = Models.INNER_STAIRS.upload(stairsBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
         Identifier lv2 = Models.STAIRS.upload(stairsBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
         Identifier lv3 = Models.OUTER_STAIRS.upload(stairsBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
   ...
   class BuiltinModelPool {
      ...
      public BlockStateModelGenerator.BuiltinModelPool includeWithItem(Model model, Block... blocks) {
         for (Block lv : blocks) {
            model.upload(ModelIds.getItemModelId(lv.asItem()), Texture.particle(lv), BlockStateModelGenerator.this.modelCollector);
         }
   ...
   class LogTexturePool {
      ...
      public BlockStateModelGenerator.LogTexturePool stem(Block stemBlock) {
         Identifier lv = Models.CUBE_COLUMN.upload(stemBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
      ...
      public BlockStateModelGenerator.LogTexturePool log(Block logBlock) {
         Identifier lv = Models.CUBE_COLUMN.upload(logBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
         Identifier lv2 = Models.CUBE_COLUMN_HORIZONTAL.upload(logBlock, this.texture, BlockStateModelGenerator.this.modelCollector);
