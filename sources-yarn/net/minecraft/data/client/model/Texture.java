...
public class Texture {
   ...
   public static Texture wallSideTopBottom(Block block) {
      Identifier lv = getId(block);
      return new Texture()
         .put(TextureKey.WALL, lv)
         .put(TextureKey.SIDE, lv)
         .put(TextureKey.TOP, getSubId(block, "_top"))
         .put(TextureKey.BOTTOM, getSubId(block, "_bottom"));
   }

   public static Texture method_27168(Block arg) {
      Identifier lv = getId(arg);
      return new Texture().put(TextureKey.WALL, lv).put(TextureKey.SIDE, lv).put(TextureKey.END, getSubId(arg, "_top"));
   }
   ...
   public static Texture method_27167(Block arg) {
      return new Texture().put(TextureKey.LIT_LOG, getSubId(arg, "_log_lit")).put(TextureKey.FIRE, getSubId(arg, "_fire"));
   }
