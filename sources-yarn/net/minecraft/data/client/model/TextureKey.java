...
public final class TextureKey {
   ...
   private static TextureKey method_27044(String string, TextureKey arg) {
      return new TextureKey(string, arg);
   }

   private TextureKey(String string, @Nullable TextureKey arg) {
      this.name = string;
      this.parent = arg;
   }
