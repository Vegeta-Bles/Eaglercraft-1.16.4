...
public class AdventureTabAdvancementGenerator implements Consumer<Consumer<Advancement>> {
   ...
   public void accept(Consumer<Advancement> consumer) {
      Advancement lv = Advancement.Task.create()
         .display(
            Items.MAP,
      ...
      Advancement lv2 = Advancement.Task.create()
         .parent(lv)
         .display(
            Blocks.RED_BED,
      ...
      Advancement lv3 = Advancement.Task.create()
         .parent(lv)
         .display(
            Items.EMERALD,
      ...
      Advancement lv4 = this.requireListedMobsKilled(Advancement.Task.create())
         .parent(lv)
         .display(
            Items.IRON_SWORD,
      ...
      Advancement lv5 = Advancement.Task.create()
         .parent(lv4)
         .display(
            Items.BOW,
      ...
      Advancement lv6 = Advancement.Task.create()
         .parent(lv4)
         .display(
            Items.TRIDENT,
      ...
      Advancement lv7 = Advancement.Task.create()
         .parent(lv)
         .display(
            Items.CROSSBOW,
      ...
      Advancement lv8 = Advancement.Task.create()
         .parent(lv)
         .display(
   ...
   private Advancement.Task requireListedMobsKilled(Advancement.Task arg) {
      for (EntityType<?> lv : MONSTERS) {
         arg.criterion(
            Registry.ENTITY_TYPE.getId(lv).toString(), OnKilledCriterion.Conditions.createPlayerKilledEntity(EntityPredicate.Builder.create().type(lv))
         );
      }
   ...
   protected static Advancement.Task requireListedBiomesVisited(Advancement.Task arg, List<RegistryKey<Biome>> list) {
      for (RegistryKey<Biome> lv : list) {
         arg.criterion(lv.getValue().toString(), LocationArrivalCriterion.Conditions.create(LocationPredicate.biome(lv)));
      }
