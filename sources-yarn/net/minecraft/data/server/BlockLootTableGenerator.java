...
public class BlockLootTableGenerator implements Consumer<BiConsumer<Identifier, LootTable.Builder>> {
   ...
   private static <T extends Comparable<T> & StringIdentifiable> LootTable.Builder dropsWithProperty(Block drop, Property<T> arg2, T comparable) {
      return LootTable.builder()
         .pool(
            addSurvivesExplosionCondition(
               drop,
               LootPool.builder()
                  ...
                  .with(
                     ItemEntry.builder(drop)
                        .conditionally(BlockStatePropertyLootCondition.builder(drop).properties(StatePredicate.Builder.create().exactMatch(arg2, comparable)))
                  )
            )
         );
   }
   ...
   private static LootTable.Builder method_30159(Block arg) {
      return LootTable.builder()
         .pool(LootPool.builder().conditionally(WITH_SHEARS).with(ItemEntry.builder(arg).apply(SetCountLootFunction.builder(ConstantLootTableRange.create(2)))));
   }

   private static LootTable.Builder method_30158(Block arg, Block arg2) {
      LootPoolEntry.Builder<?> lv = ItemEntry.builder(arg2)
         .apply(SetCountLootFunction.builder(ConstantLootTableRange.create(2)))
         .conditionally(WITH_SHEARS)
         .alternatively(
            ((LeafEntry.Builder)addSurvivesExplosionCondition(arg, ItemEntry.builder(Items.WHEAT_SEEDS)))
               .conditionally(RandomChanceLootCondition.builder(0.125F))
         );
      return LootTable.builder()
         .pool(
            LootPool.builder()
               .with(lv)
               .conditionally(
                  BlockStatePropertyLootCondition.builder(arg)
   ...
   public void accept(BiConsumer<Identifier, LootTable.Builder> biConsumer) {
      ...
      this.addDrop(Blocks.STONE, arg -> drops(arg, Blocks.COBBLESTONE));
      this.addDrop(Blocks.GRASS_BLOCK, arg -> drops(arg, Blocks.DIRT));
      this.addDrop(Blocks.PODZOL, arg -> drops(arg, Blocks.DIRT));
      this.addDrop(Blocks.MYCELIUM, arg -> drops(arg, Blocks.DIRT));
      this.addDrop(Blocks.TUBE_CORAL_BLOCK, arg -> drops(arg, Blocks.DEAD_TUBE_CORAL_BLOCK));
      this.addDrop(Blocks.BRAIN_CORAL_BLOCK, arg -> drops(arg, Blocks.DEAD_BRAIN_CORAL_BLOCK));
      this.addDrop(Blocks.BUBBLE_CORAL_BLOCK, arg -> drops(arg, Blocks.DEAD_BUBBLE_CORAL_BLOCK));
      this.addDrop(Blocks.FIRE_CORAL_BLOCK, arg -> drops(arg, Blocks.DEAD_FIRE_CORAL_BLOCK));
      this.addDrop(Blocks.HORN_CORAL_BLOCK, arg -> drops(arg, Blocks.DEAD_HORN_CORAL_BLOCK));
      this.addDrop(Blocks.CRIMSON_NYLIUM, arg -> drops(arg, Blocks.NETHERRACK));
      this.addDrop(Blocks.WARPED_NYLIUM, arg -> drops(arg, Blocks.NETHERRACK));
      this.addDrop(Blocks.BOOKSHELF, arg -> drops(arg, Items.BOOK, ConstantLootTableRange.create(3)));
      this.addDrop(Blocks.CLAY, arg -> drops(arg, Items.CLAY_BALL, ConstantLootTableRange.create(4)));
      this.addDrop(Blocks.ENDER_CHEST, arg -> drops(arg, Blocks.OBSIDIAN, ConstantLootTableRange.create(8)));
      this.addDrop(Blocks.SNOW_BLOCK, arg -> drops(arg, Items.SNOWBALL, ConstantLootTableRange.create(4)));
      ...
      this.addDrop(Blocks.BLACK_BED, arg -> dropsWithProperty(arg, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.BLUE_BED, arg -> dropsWithProperty(arg, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.BROWN_BED, arg -> dropsWithProperty(arg, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.CYAN_BED, arg -> dropsWithProperty(arg, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.GRAY_BED, arg -> dropsWithProperty(arg, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.GREEN_BED, arg -> dropsWithProperty(arg, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.LIGHT_BLUE_BED, arg -> dropsWithProperty(arg, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.LIGHT_GRAY_BED, arg -> dropsWithProperty(arg, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.LIME_BED, arg -> dropsWithProperty(arg, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.MAGENTA_BED, arg -> dropsWithProperty(arg, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.PURPLE_BED, arg -> dropsWithProperty(arg, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.ORANGE_BED, arg -> dropsWithProperty(arg, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.PINK_BED, arg -> dropsWithProperty(arg, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.RED_BED, arg -> dropsWithProperty(arg, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.WHITE_BED, arg -> dropsWithProperty(arg, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.YELLOW_BED, arg -> dropsWithProperty(arg, BedBlock.PART, BedPart.HEAD));
      this.addDrop(Blocks.LILAC, arg -> dropsWithProperty(arg, TallPlantBlock.HALF, DoubleBlockHalf.LOWER));
      this.addDrop(Blocks.SUNFLOWER, arg -> dropsWithProperty(arg, TallPlantBlock.HALF, DoubleBlockHalf.LOWER));
      this.addDrop(Blocks.PEONY, arg -> dropsWithProperty(arg, TallPlantBlock.HALF, DoubleBlockHalf.LOWER));
      this.addDrop(Blocks.ROSE_BUSH, arg -> dropsWithProperty(arg, TallPlantBlock.HALF, DoubleBlockHalf.LOWER));
      this.addDrop(
         Blocks.TNT,
         LootTable.builder()
            .pool(
                           ...
                           ItemEntry.builder(Items.COCOA_BEANS)
                              .apply(
                                 SetCountLootFunction.builder(ConstantLootTableRange.create(3))
                                    .conditionally(
                                       BlockStatePropertyLootCondition.builder(arg).properties(StatePredicate.Builder.create().exactMatch(CocoaBlock.AGE, 2))
                                    )
                              )
                        )
                     )
      ...
      this.addDrop(
         Blocks.COMPOSTER,
         arg -> LootTable.builder()
               .pool(LootPool.builder().with((LootPoolEntry.Builder<?>)applyExplosionDecay(arg, ItemEntry.builder(Items.COMPOSTER))))
               .pool(
                  LootPool.builder()
                     .with(ItemEntry.builder(Items.BONE_MEAL))
                     .conditionally(
                        BlockStatePropertyLootCondition.builder(arg).properties(StatePredicate.Builder.create().exactMatch(ComposterBlock.LEVEL, 8))
                     )
               )
      );
      ...
      this.addDrop(Blocks.BIRCH_LEAVES, arg -> leavesDrop(arg, Blocks.BIRCH_SAPLING, SAPLING_DROP_CHANCE));
      this.addDrop(Blocks.ACACIA_LEAVES, arg -> leavesDrop(arg, Blocks.ACACIA_SAPLING, SAPLING_DROP_CHANCE));
      this.addDrop(Blocks.JUNGLE_LEAVES, arg -> leavesDrop(arg, Blocks.JUNGLE_SAPLING, JUNGLE_SAPLING_DROP_CHANCE));
      this.addDrop(Blocks.SPRUCE_LEAVES, arg -> leavesDrop(arg, Blocks.SPRUCE_SAPLING, SAPLING_DROP_CHANCE));
      this.addDrop(Blocks.OAK_LEAVES, arg -> oakLeavesDrop(arg, Blocks.OAK_SAPLING, SAPLING_DROP_CHANCE));
      this.addDrop(Blocks.DARK_OAK_LEAVES, arg -> oakLeavesDrop(arg, Blocks.DARK_OAK_SAPLING, SAPLING_DROP_CHANCE));
      LootCondition.Builder lv = BlockStatePropertyLootCondition.builder(Blocks.BEETROOTS)
         .properties(StatePredicate.Builder.create().exactMatch(BeetrootsBlock.AGE, 3));
      this.addDrop(Blocks.BEETROOTS, cropDrops(Blocks.BEETROOTS, Items.BEETROOT, Items.BEETROOT_SEEDS, lv));
      LootCondition.Builder lv2 = BlockStatePropertyLootCondition.builder(Blocks.WHEAT)
         .properties(StatePredicate.Builder.create().exactMatch(CropBlock.AGE, 7));
      this.addDrop(Blocks.WHEAT, cropDrops(Blocks.WHEAT, Items.WHEAT, Items.WHEAT_SEEDS, lv2));
      LootCondition.Builder lv3 = BlockStatePropertyLootCondition.builder(Blocks.CARROTS)
      ...
      LootCondition.Builder lv4 = BlockStatePropertyLootCondition.builder(Blocks.POTATOES)
      ...
      this.addDrop(
         ...
         applyExplosionDecay(
            ...
            LootTable.builder()
               ...
               .pool(
                  LootPool.builder().conditionally(lv4).with(ItemEntry.builder(Items.POISONOUS_POTATO).conditionally(RandomChanceLootCondition.builder(0.02F)))
               )
         )
      );
      this.addDrop(
         Blocks.SWEET_BERRY_BUSH,
         arg -> applyExplosionDecay(
               arg,
               LootTable.builder()
                  .pool(
                     LootPool.builder()
      ...
      this.addDrop(Blocks.BROWN_MUSHROOM_BLOCK, arg -> mushroomBlockDrops(arg, Blocks.BROWN_MUSHROOM));
      this.addDrop(Blocks.RED_MUSHROOM_BLOCK, arg -> mushroomBlockDrops(arg, Blocks.RED_MUSHROOM));
      this.addDrop(Blocks.COAL_ORE, arg -> oreDrops(arg, Items.COAL));
      this.addDrop(Blocks.EMERALD_ORE, arg -> oreDrops(arg, Items.EMERALD));
      this.addDrop(Blocks.NETHER_QUARTZ_ORE, arg -> oreDrops(arg, Items.QUARTZ));
      this.addDrop(Blocks.DIAMOND_ORE, arg -> oreDrops(arg, Items.DIAMOND));
      this.addDrop(
         Blocks.NETHER_GOLD_ORE,
         arg -> dropsWithSilkTouch(
               arg,
               (LootPoolEntry.Builder<?>)applyExplosionDecay(
                  arg,
      ...
      this.addDrop(
         Blocks.COBWEB, arg -> dropsWithSilkTouchOrShears(arg, (LootPoolEntry.Builder<?>)addSurvivesExplosionCondition(arg, ItemEntry.builder(Items.STRING)))
      );
      this.addDrop(
         Blocks.DEAD_BUSH,
         arg -> dropsWithShears(
               arg,
               (LootPoolEntry.Builder<?>)applyExplosionDecay(
                  arg, ItemEntry.builder(Items.STICK).apply(SetCountLootFunction.builder(UniformLootTableRange.between(0.0F, 2.0F)))
               )
            )
      );
      ...
      this.addDrop(Blocks.LARGE_FERN, arg -> method_30158(arg, Blocks.FERN));
      this.addDrop(Blocks.TALL_GRASS, arg -> method_30158(arg, Blocks.GRASS));
      this.addDrop(Blocks.MELON_STEM, arg -> cropStemDrops(arg, Items.MELON_SEEDS));
      this.addDrop(Blocks.ATTACHED_MELON_STEM, arg -> attachedCropStemDrops(arg, Items.MELON_SEEDS));
      this.addDrop(Blocks.PUMPKIN_STEM, arg -> cropStemDrops(arg, Items.PUMPKIN_SEEDS));
      this.addDrop(Blocks.ATTACHED_PUMPKIN_STEM, arg -> attachedCropStemDrops(arg, Items.PUMPKIN_SEEDS));
      this.addDrop(
         ...
         arg -> LootTable.builder()
               .pool(
                  LootPool.builder()
                     .rolls(ConstantLootTableRange.create(1))
                     .with(
                        ((LeafEntry.Builder)addSurvivesExplosionCondition(arg, ItemEntry.builder(arg)))
                        ...
                        AlternativeEntry.builder(
                           AlternativeEntry.builder(
                                 ItemEntry.builder(Items.SNOWBALL)
                                    .conditionally(
                                       BlockStatePropertyLootCondition.builder(arg).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 1))
                                    ),
                                 ItemEntry.builder(Items.SNOWBALL)
                                    .conditionally(
                                       BlockStatePropertyLootCondition.builder(arg).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 2))
                                    )
                                    .apply(SetCountLootFunction.builder(ConstantLootTableRange.create(2))),
                                 ItemEntry.builder(Items.SNOWBALL)
                                    .conditionally(
                                       BlockStatePropertyLootCondition.builder(arg).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 3))
                                    )
                                    .apply(SetCountLootFunction.builder(ConstantLootTableRange.create(3))),
                                 ItemEntry.builder(Items.SNOWBALL)
                                    .conditionally(
                                       BlockStatePropertyLootCondition.builder(arg).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 4))
                                    )
                                    .apply(SetCountLootFunction.builder(ConstantLootTableRange.create(4))),
                                 ItemEntry.builder(Items.SNOWBALL)
                                    .conditionally(
                                       BlockStatePropertyLootCondition.builder(arg).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 5))
                                    )
                                    .apply(SetCountLootFunction.builder(ConstantLootTableRange.create(5))),
                                 ItemEntry.builder(Items.SNOWBALL)
                                    .conditionally(
                                       BlockStatePropertyLootCondition.builder(arg).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 6))
                                    )
                                    .apply(SetCountLootFunction.builder(ConstantLootTableRange.create(6))),
                                 ItemEntry.builder(Items.SNOWBALL)
                                    .conditionally(
                                       BlockStatePropertyLootCondition.builder(arg).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 7))
                                    )
         ...
         arg -> dropsWithSilkTouch(
               ...
               addSurvivesExplosionCondition(
                  ...
                  ItemEntry.builder(Items.FLINT)
                     ...
                     .alternatively(ItemEntry.builder(arg))
               )
            )
      );
      this.addDrop(
         ...
         arg -> dropsWithSilkTouch(
               ...
               (LootPoolEntry.Builder<?>)addSurvivesExplosionCondition(
                  arg, ItemEntry.builder(Items.CHARCOAL).apply(SetCountLootFunction.builder(ConstantLootTableRange.create(2)))
               )
            )
      );
      this.addDrop(
      ...
      this.addDrop(
         ...
         arg -> dropsWithSilkTouch(
               arg,
               (LootPoolEntry.Builder<?>)addSurvivesExplosionCondition(
                  arg, ItemEntry.builder(Items.SOUL_SOIL).apply(SetCountLootFunction.builder(ConstantLootTableRange.create(1)))
               )
            )
      );
   ...
   private void addVinePlantDrop(Block block, Block drop) {
      LootTable.Builder lv = dropsWithSilkTouchOrShears(
   ...
   public static LootTable.Builder addDoorDrop(Block arg) {
      return dropsWithProperty(arg, DoorBlock.HALF, DoubleBlockHalf.LOWER);
   }

   public void addPottedPlantDrop(Block arg) {
      this.addDrop(arg, argx -> pottedPlantDrops(((FlowerPotBlock)argx).getContent()));
   }
   ...
   public void addDrop(Block arg, ItemConvertible drop) {
      this.addDrop(arg, drops(drop));
   }
   ...
   private void addDrop(Block arg, LootTable.Builder lootTable) {
      this.lootTables.put(arg.getLootTableId(), lootTable);
   }
}
