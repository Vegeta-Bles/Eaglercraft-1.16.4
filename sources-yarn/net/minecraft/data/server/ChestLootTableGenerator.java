...
public class ChestLootTableGenerator implements Consumer<BiConsumer<Identifier, LootTable.Builder>> {
   public ChestLootTableGenerator() {
   }
         ...
         LootTable.builder()
            .pool(
               LootPool.builder()
                  ...
                  .with(ItemEntry.builder(Items.DIAMOND_HORSE_ARMOR))
                  .with(
                     ItemEntry.builder(Items.BOOK).apply(EnchantWithLevelsLootFunction.builder(ConstantLootTableRange.create(30)).allowTreasureEnchantments())
                  )
            )
      );
      biConsumer.accept(
         ...
         LootTable.builder()
            .pool(
               LootPool.builder()
                  ...
                  .with(
                     ItemEntry.builder(Items.GLISTERING_MELON_SLICE).weight(5).apply(SetCountLootFunction.builder(UniformLootTableRange.between(4.0F, 12.0F)))
                  )
