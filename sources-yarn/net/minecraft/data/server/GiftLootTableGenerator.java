               ...
               LootPool.builder()
                  ...
                  .with(
                     ItemEntry.builder(Items.TIPPED_ARROW)
                        ...
                        .apply(SetNbtLootFunction.builder(Util.make(new CompoundTag(), arg -> arg.putString("Potion", "minecraft:swiftness"))))
                  )
                  .with(
                     ItemEntry.builder(Items.TIPPED_ARROW)
                        .apply(SetCountLootFunction.builder(UniformLootTableRange.between(0.0F, 1.0F)))
                        .apply(SetNbtLootFunction.builder(Util.make(new CompoundTag(), arg -> arg.putString("Potion", "minecraft:slowness"))))
                  )
                  .with(
                     ItemEntry.builder(Items.TIPPED_ARROW)
                        .apply(SetCountLootFunction.builder(UniformLootTableRange.between(0.0F, 1.0F)))
                        .apply(SetNbtLootFunction.builder(Util.make(new CompoundTag(), arg -> arg.putString("Potion", "minecraft:strength"))))
                  )
                  .with(
                     ItemEntry.builder(Items.TIPPED_ARROW)
                        .apply(SetCountLootFunction.builder(UniformLootTableRange.between(0.0F, 1.0F)))
                        .apply(SetNbtLootFunction.builder(Util.make(new CompoundTag(), arg -> arg.putString("Potion", "minecraft:healing"))))
                  )
                  .with(
                     ItemEntry.builder(Items.TIPPED_ARROW)
                        .apply(SetCountLootFunction.builder(UniformLootTableRange.between(0.0F, 1.0F)))
                        .apply(SetNbtLootFunction.builder(Util.make(new CompoundTag(), arg -> arg.putString("Potion", "minecraft:harming"))))
                  )
                  .with(
                     ItemEntry.builder(Items.TIPPED_ARROW)
                        .apply(SetCountLootFunction.builder(UniformLootTableRange.between(0.0F, 1.0F)))
                        .apply(SetNbtLootFunction.builder(Util.make(new CompoundTag(), arg -> arg.putString("Potion", "minecraft:leaping"))))
                  )
                  .with(
                     ItemEntry.builder(Items.TIPPED_ARROW)
                        .apply(SetCountLootFunction.builder(UniformLootTableRange.between(0.0F, 1.0F)))
                        .apply(SetNbtLootFunction.builder(Util.make(new CompoundTag(), arg -> arg.putString("Potion", "minecraft:regeneration"))))
                  )
                  .with(
                     ItemEntry.builder(Items.TIPPED_ARROW)
                        .apply(SetCountLootFunction.builder(UniformLootTableRange.between(0.0F, 1.0F)))
                        .apply(SetNbtLootFunction.builder(Util.make(new CompoundTag(), arg -> arg.putString("Potion", "minecraft:fire_resistance"))))
                  )
                  .with(
                     ItemEntry.builder(Items.TIPPED_ARROW)
                        .apply(SetCountLootFunction.builder(UniformLootTableRange.between(0.0F, 1.0F)))
                        .apply(SetNbtLootFunction.builder(Util.make(new CompoundTag(), arg -> arg.putString("Potion", "minecraft:water_breathing"))))
                  )
                  .with(
                     ItemEntry.builder(Items.TIPPED_ARROW)
                        .apply(SetCountLootFunction.builder(UniformLootTableRange.between(0.0F, 1.0F)))
                        .apply(SetNbtLootFunction.builder(Util.make(new CompoundTag(), arg -> arg.putString("Potion", "minecraft:invisibility"))))
                  )
                  .with(
                     ItemEntry.builder(Items.TIPPED_ARROW)
                        .apply(SetCountLootFunction.builder(UniformLootTableRange.between(0.0F, 1.0F)))
                        .apply(SetNbtLootFunction.builder(Util.make(new CompoundTag(), arg -> arg.putString("Potion", "minecraft:night_vision"))))
                  )
                  .with(
                     ItemEntry.builder(Items.TIPPED_ARROW)
                        .apply(SetCountLootFunction.builder(UniformLootTableRange.between(0.0F, 1.0F)))
                        .apply(SetNbtLootFunction.builder(Util.make(new CompoundTag(), arg -> arg.putString("Potion", "minecraft:weakness"))))
                  )
                  .with(
                     ItemEntry.builder(Items.TIPPED_ARROW)
                        .apply(SetCountLootFunction.builder(UniformLootTableRange.between(0.0F, 1.0F)))
                        .apply(SetNbtLootFunction.builder(Util.make(new CompoundTag(), arg -> arg.putString("Potion", "minecraft:poison"))))
                  )
            )
      );
      biConsumer.accept(
