...
public class ItemTagsProvider extends AbstractTagProvider<Item> {
   ...
   public ItemTagsProvider(DataGenerator arg, BlockTagsProvider arg2) {
      super(arg, Registry.ITEM);
      this.field_23783 = arg2::method_27169;
   }
   ...
   protected void copy(Tag.Identified<Block> arg, Tag.Identified<Item> arg2) {
      Tag.Builder lv = this.method_27169(arg2);
      Tag.Builder lv2 = this.field_23783.apply(arg);
      lv2.streamEntries().forEach(lv::add);
   }

   @Override
   protected Path getOutput(Identifier arg) {
      return this.root.getOutput().resolve("data/" + arg.getNamespace() + "/tags/items/" + arg.getPath() + ".json");
   }
