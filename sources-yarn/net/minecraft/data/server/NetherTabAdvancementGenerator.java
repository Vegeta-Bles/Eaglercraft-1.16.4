...
public class NetherTabAdvancementGenerator implements Consumer<Consumer<Advancement>> {
   ...
   public void accept(Consumer<Advancement> consumer) {
      ...
      Advancement lv4 = Advancement.Task.create()
         .parent(lv3)
         .display(
      ...
      Advancement lv9 = Advancement.Task.create()
         .parent(lv8)
         .display(
            Items.MILK_BUCKET,
      ...
      Advancement lv10 = Advancement.Task.create()
         .parent(lv)
         .display(
      ...
      Advancement lv11 = Advancement.Task.create()
         .parent(lv)
         .display(
      ...
      Advancement lv12 = Advancement.Task.create()
         .parent(lv)
         .display(
      ...
      Advancement lv13 = Advancement.Task.create()
         .parent(lv)
         .display(
