                        ...
                        typedx -> {
                           ...
                           if (!optional.isPresent()) {
                              ...
                              for (Typed<?> typed2 : list) {
                                 AddTrappedChestFix.ListFixer lv = new AddTrappedChestFix.ListFixer(typed2, this.getInputSchema());
                                 if (!lv.isFixed()) {
                              ...
                              return typedx.updateTyped(
                                 ...
                                 typedxx -> typedxx.updateTyped(
                                       ...
                                       typedxxx -> {
                                          ...
                                          return intSet.contains(LeavesFix.method_5051(kx, lx, m))
                                             ? typedxxx.update(taggedChoiceType.finder(), pair -> pair.mapFirst(string -> {
