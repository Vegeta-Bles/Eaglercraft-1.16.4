            ...
            this.fixTypeEverywhere(
               ...
               dynamicOps -> pair -> {
                     ...
                     while (true) {
                        ...
                        Pair<Either<OldEntityTree, Unit>, Entity> pair3 = pair2.getSecond();
                        Entity entity = pair3.getSecond();
                        optional = Optional.of(Pair.of(TypeReferences.ENTITY_TREE.typeName(), Pair.of(either, entity)));
                        Optional<OldEntityTree> optional2 = pair3.getFirst().left();
