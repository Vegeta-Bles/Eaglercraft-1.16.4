   ...
   public TypeRewriteRule makeRule() {
      ...
      TypeRewriteRule typeRewriteRule = this.fixTypeEverywhereTyped(
         ...
         typed -> typed.updateTyped(
               opticFinder, type, typedx -> typedx.update(DSL.remainderFinder(), dynamic -> this.fixDecorationPosition(dynamic, true, false))
            )
      );
      TypeRewriteRule typeRewriteRule2 = this.fixTypeEverywhereTyped(
         ...
         type3,
         typed -> typed.updateTyped(
               opticFinder2, type2, typedx -> typedx.update(DSL.remainderFinder(), dynamic -> this.fixDecorationPosition(dynamic, false, true))
            )
      );
