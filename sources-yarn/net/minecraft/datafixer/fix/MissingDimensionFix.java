      ...
      TaggedChoiceType<String> taggedChoiceType = new TaggedChoiceType(
         ...
         ImmutableMap.of(
            ...
            method_29914(
               ...
               DSL.or(
                  DSL.string(),
                  method_29914("default_block", schema.getType(TypeReferences.BLOCK_NAME), "default_fluid", schema.getType(TypeReferences.BLOCK_NAME))
               )
            )
         )
      );
      CompoundListType<String, ?> compoundListType = DSL.compoundList(
         IdentifierNormalizingSchema.getIdentifierType(), method_29913("generator", taggedChoiceType)
      );
