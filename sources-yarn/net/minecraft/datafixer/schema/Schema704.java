...
public class Schema704 extends Schema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema schema) {
      ...
      schema.register(
         map, "minecraft:flower_pot", string -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), TypeReferences.ITEM_NAME.in(schema)))
      );
   ...
   public void registerTypes(Schema schema, Map<String, Supplier<TypeTemplate>> entityTypes, Map<String, Supplier<TypeTemplate>> blockEntityTypes) {
      ...
      schema.registerType(
         false, TypeReferences.BLOCK_ENTITY, () -> DSL.taggedChoiceLazy("id", IdentifierNormalizingSchema.getIdentifierType(), blockEntityTypes)
      );
      schema.registerType(
         true,
