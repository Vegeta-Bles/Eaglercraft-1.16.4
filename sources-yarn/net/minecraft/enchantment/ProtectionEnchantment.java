...
public class ProtectionEnchantment extends Enchantment {
   ...
   public ProtectionEnchantment(Enchantment.Rarity weight, ProtectionEnchantment.Type arg2, EquipmentSlot... args) {
      super(weight, arg2 == ProtectionEnchantment.Type.FALL ? EnchantmentTarget.ARMOR_FEET : EnchantmentTarget.ARMOR, args);
   ...
   public boolean canAccept(Enchantment other) {
      if (other instanceof ProtectionEnchantment) {
         ...
         return this.protectionType == lv.protectionType
            ? false
            : this.protectionType == ProtectionEnchantment.Type.FALL || lv.protectionType == ProtectionEnchantment.Type.FALL;
      } else {
