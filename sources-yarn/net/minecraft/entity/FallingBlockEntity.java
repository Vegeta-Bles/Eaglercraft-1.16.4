      ...
      if (this.block.isAir()) {
         ...
         if (!this.world.isClient) {
            ...
            if (bl && d > 1.0) {
               ...
               if (lv4.getType() != HitResult.Type.MISS && this.world.getFluidState(lv4.getBlockPos()).isIn(FluidTags.WATER)) {
                  lv3 = lv4.getBlockPos();
                  bl2 = true;
               }
            }
                     ...
                     if (bl3 && bl5) {
                        ...
                        if (this.world.setBlockState(lv3, this.block, 3)) {
                           ...
                           if (this.blockEntityData != null && lv instanceof BlockEntityProvider) {
                              BlockEntity lv6 = this.world.getBlockEntity(lv3);
                              if (lv6 != null) {
   ...
   public boolean handleFallDamage(float fallDistance, float damageMultiplier) {
      if (this.hurtEntities) {
         ...
         if (i > 0) {
            ...
            for (Entity lv2 : list) {
               lv2.damage(lv, (float)Math.min(MathHelper.floor((float)i * this.fallHurtAmount), this.fallHurtMax));
            }
