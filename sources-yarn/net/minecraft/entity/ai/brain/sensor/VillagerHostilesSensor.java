...
public class VillagerHostilesSensor extends Sensor<LivingEntity> {
   private static final ImmutableMap<EntityType<?>, Float> SQUARED_DISTANCES_FOR_DANGER = ImmutableMap
      .<EntityType<?>, Float>builder()
      ...
      return this.getVisibleMobs(entity)
         .flatMap(
            list -> list.stream()
                  ...
                  .filter(arg2 -> this.isCloseEnoughForDanger(entity, arg2))
                  .min((arg2, arg3) -> this.compareDistances(entity, arg2, arg3))
         );
   }
