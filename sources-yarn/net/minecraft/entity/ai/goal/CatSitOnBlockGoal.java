   ...
   protected boolean isTargetPos(WorldView world, BlockPos pos) {
      if (!world.isAir(pos.up())) {
         ...
         if (lv.isOf(Blocks.CHEST)) {
            ...
            return lv.isOf(Blocks.FURNACE) && lv.get(FurnaceBlock.LIT)
               ? true
               : lv.method_27851(BlockTags.BEDS, arg -> arg.method_28500(BedBlock.PART).map(argx -> argx != BedPart.HEAD).orElse(true));
         }
      }
   }
}
