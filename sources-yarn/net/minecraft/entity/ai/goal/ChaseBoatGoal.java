...
public class ChaseBoatGoal extends Goal {
   ...
   @Override
   public void start() {
      for (BoatEntity lv : this.mob.world.getNonSpectatingEntities(BoatEntity.class, this.mob.getBoundingBox().expand(5.0))) {
         if (lv.getPrimaryPassenger() != null && lv.getPrimaryPassenger() instanceof PlayerEntity) {
