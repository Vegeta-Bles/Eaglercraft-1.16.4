...
public class MeleeAttackGoal extends Goal {
   ...
   public boolean canStart() {
      ...
      if (l - this.lastUpdateTime < 20L) {
         ...
         if (lv == null) {
            ...
            return this.path != null ? true : this.getSquaredMaxAttackDistance(lv) >= this.mob.squaredDistanceTo(lv.getX(), lv.getY(), lv.getZ());
         }
      }
   }
   ...
   public boolean shouldContinue() {
      ...
      if (lv == null) {
         ...
         return !this.mob.isInWalkTargetRange(lv.getBlockPos())
            ? false
            : !(lv instanceof PlayerEntity) || !lv.isSpectator() && !((PlayerEntity)lv).isCreative();
      }
   }
   ...
   public void tick() {
      ...
      if ((this.pauseWhenMobIdle || this.mob.getVisibilityCache().canSee(lv))
         && this.updateCountdownTicks <= 0
         && (
