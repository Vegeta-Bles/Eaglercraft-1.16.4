...
public class RevengeGoal extends TrackTargetGoal {
   ...
   protected void callSameTypeForRevenge() {
      ...
      List<MobEntity> list = this.mob.world.getEntitiesIncludingUngeneratedChunks((Class<? extends MobEntity>)this.mob.getClass(), lv);
      ...
      while (true) {
         ...
         while (true) {
            ...
            if (this.mob != lv2
               && lv2.getTarget() == null
               && (!(this.mob instanceof TameableEntity) || ((TameableEntity)this.mob).getOwner() == ((TameableEntity)lv2).getOwner())
               && !lv2.isTeammate(this.mob.getAttacker())) {
