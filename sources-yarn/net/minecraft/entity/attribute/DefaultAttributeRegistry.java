...
public class DefaultAttributeRegistry {
   ...
   private static final Map<EntityType<? extends LivingEntity>, DefaultAttributeContainer> DEFAULT_ATTRIBUTE_REGISTRY = ImmutableMap
      .<EntityType<? extends LivingEntity>, DefaultAttributeContainer>builder()
   ...
   public static void checkMissing() {
      Registry.ENTITY_TYPE
         .stream()
         .filter(arg -> arg.getSpawnGroup() != SpawnGroup.MISC)
         .filter(arg -> !hasDefinitionFor((EntityType<?>)arg))
