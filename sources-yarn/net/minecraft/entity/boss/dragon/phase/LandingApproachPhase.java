...
public class LandingApproachPhase extends AbstractPhase {
   ...
   private void method_6844() {
      if (this.field_7047 == null || this.field_7047.isFinished()) {
         ...
         PlayerEntity lv2 = this.dragon.world.getClosestPlayer(PLAYERS_IN_RANGE_PREDICATE, (double)lv.getX(), (double)lv.getY(), (double)lv.getZ());
         int j;
         if (lv2 != null) {
         ...
         this.field_7047 = this.dragon.findPath(i, j, lv4);
   ...
   private void method_6845() {
      if (this.field_7047 != null && !this.field_7047.isFinished()) {
         Vec3i lv = this.field_7047.method_31032();
         this.field_7047.next();
