   ...
   public void clientTick() {
      ...
      if (this.ticks % 2 == 0 && this.ticks < 10) {
         ...
         for (int i = 0; i < 8; i++) {
            ...
            for (int k = 0; k < 6; k++) {
               this.dragon.world.addParticle(ParticleTypes.DRAGON_BREATH, g, h, j, -lv.x * 0.08F * (double)k, -lv.y * 0.6F, -lv.z * 0.08F * (double)k);
            }

            lv.rotateY((float) (Math.PI / 16));
         }
      }
   }
