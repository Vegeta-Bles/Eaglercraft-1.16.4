...
public class ProjectileDamageSource extends EntityDamageSource {
   ...
   public Text getDeathMessage(LivingEntity entity) {
      ...
      return !lv2.isEmpty() && lv2.hasCustomName()
         ? new TranslatableText(string2, entity.getDisplayName(), lv, lv2.toHoverableText())
         : new TranslatableText(string, entity.getDisplayName(), lv);
   }
}
