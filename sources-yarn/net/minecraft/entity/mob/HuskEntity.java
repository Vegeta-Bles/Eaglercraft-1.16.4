...
public class HuskEntity extends ZombieEntity {
   ...
   public static boolean canSpawn(EntityType<HuskEntity> type, ServerWorldAccess arg2, SpawnReason spawnReason, BlockPos pos, Random random) {
      return canSpawnInDark(type, arg2, spawnReason, pos, random) && (spawnReason == SpawnReason.SPAWNER || arg2.isSkyVisible(pos));
   }
