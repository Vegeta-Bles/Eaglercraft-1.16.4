...
public abstract class PatrolEntity extends HostileEntity {
   ...
   public static class PatrolGoal<T extends PatrolEntity> extends Goal {
      ...
      private List<PatrolEntity> findPatrolTargets() {
         return this.entity
            .world
            .getEntitiesByClass(PatrolEntity.class, this.entity.getBoundingBox().expand(16.0), arg -> arg.hasNoRaid() && !arg.isPartOf(this.entity));
      }

      private boolean wander() {
         Random random = this.entity.getRandom();
         BlockPos lv = this.entity
            .world
         ...
         return this.entity.getNavigation().startMovingTo((double)lv.getX(), (double)lv.getY(), (double)lv.getZ(), this.leaderSpeed);
      }
   }
}
