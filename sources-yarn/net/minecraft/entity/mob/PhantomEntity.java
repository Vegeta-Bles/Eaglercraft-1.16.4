...
public class PhantomEntity extends FlyingEntity implements Monster {
   ...
   class StartAttackGoal extends Goal {
      ...
      public boolean canStart() {
         LivingEntity lv = PhantomEntity.this.getTarget();
         return lv != null ? PhantomEntity.this.isTarget(PhantomEntity.this.getTarget(), TargetPredicate.DEFAULT) : false;
      }
   ...
   class SwoopMovementGoal extends PhantomEntity.MovementGoal {
      ...
      public boolean shouldContinue() {
         ...
         if (lv == null) {
            ...
            return false;
         } else if (!(lv instanceof PlayerEntity) || !((PlayerEntity)lv).isSpectator() && !((PlayerEntity)lv).isCreative()) {
            if (!this.canStart()) {
               return false;
            } else {
