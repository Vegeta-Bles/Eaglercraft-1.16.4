...
public class SlimeEntity extends MobEntity implements Monster {
   ...
   protected void initGoals() {
      ...
      this.targetSelector.add(1, new FollowTargetGoal<>(this, PlayerEntity.class, 10, true, false, arg -> Math.abs(arg.getY() - this.getY()) <= 4.0));
   ...
   static class FaceTowardTargetGoal extends Goal {
      ...
      public boolean canStart() {
         ...
         if (lv == null) {
            ...
            return lv instanceof PlayerEntity && ((PlayerEntity)lv).abilities.invulnerable
               ? false
      ...
      public boolean shouldContinue() {
         ...
         if (lv == null) {
            ...
            return lv instanceof PlayerEntity && ((PlayerEntity)lv).abilities.invulnerable ? false : --this.ticksLeft > 0;
         }
      }
