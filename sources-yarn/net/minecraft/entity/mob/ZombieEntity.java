...
public class ZombieEntity extends HostileEntity {
   ...
   protected void convertTo(EntityType<? extends ZombieEntity> entityType) {
      ZombieEntity lv = this.method_29243(entityType, true);
      if (lv != null) {
         ...
         if (lv2 != null
            ...
            for (int l = 0; l < 50; l++) {
               ...
               if (SpawnHelper.canSpawn(lv6, this.world, lv4, lv5) && SpawnRestriction.canSpawn(lv5, lv, SpawnReason.REINFORCEMENT, lv4, this.world.random)) {
                  lv3.updatePosition((double)m, (double)n, (double)o);
                  if (!this.world.isPlayerInRange((double)m, (double)n, (double)o, 7.0)
                     && this.world.intersectsEntities(lv3)
                     && this.world.isSpaceEmpty(lv3)
                     && !this.world.containsFluid(lv3.getBoundingBox())) {
                     lv3.setTarget(lv2);
                     ...
                     lv3.getAttributeInstance(EntityAttributes.ZOMBIE_SPAWN_REINFORCEMENTS)
                        .addPersistentModifier(
   ...
   public void onKilledOther(ServerWorld arg, LivingEntity arg2) {
      ...
      if ((arg.getDifficulty() == Difficulty.NORMAL || arg.getDifficulty() == Difficulty.HARD) && arg2 instanceof VillagerEntity) {
         ...
         ZombieVillagerEntity lv2 = lv.method_29243(EntityType.ZOMBIE_VILLAGER, false);
         lv2.initialize(arg, arg.getLocalDifficulty(lv2.getBlockPos()), SpawnReason.CONVERSION, new ZombieEntity.ZombieData(false, true), null);
   ...
   public EntityData initialize(
      ...
      if (entityData instanceof ZombieEntity.ZombieData) {
         ZombieEntity.ZombieData lv = (ZombieEntity.ZombieData)entityData;
         if (lv.baby) {
            this.setBaby(true);
            if (lv.field_25607) {
               if ((double)world.getRandom().nextFloat() < 0.05) {
                  ...
                  lv3.initialize(world, difficulty, SpawnReason.JOCKEY, null, null);
