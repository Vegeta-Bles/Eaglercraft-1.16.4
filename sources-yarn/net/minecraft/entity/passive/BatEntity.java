...
public class BatEntity extends AmbientEntity {
   ...
   protected void mobTick() {
      ...
      if (this.isRoosting()) {
         ...
         Vec3d lv4 = lv3.add((Math.signum(d) * 0.5 - lv3.x) * 0.1F, (Math.signum(e) * 0.7F - lv3.y) * 0.1F, (Math.signum(f) * 0.5 - lv3.z) * 0.1F);
         this.setVelocity(lv4);
         float g = (float)(MathHelper.atan2(lv4.z, lv4.x) * 180.0F / (float)Math.PI) - 90.0F;
