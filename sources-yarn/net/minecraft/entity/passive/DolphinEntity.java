...
public class DolphinEntity extends WaterCreatureEntity {
            ...
            for (int i = 0; i < 2; i++) {
               this.world
                  .addParticle(
                     ...
                     this.getX() - lv.x * (double)h + (double)f,
                     this.getY() - lv.y,
                     this.getZ() - lv.z * (double)h + (double)g,
                     0.0,
                     0.0,
                     0.0
                  );
   ...
   static class LeadToNearbyTreasureGoal extends Goal {
      ...
      public boolean shouldContinue() {
         ...
         return !new BlockPos((double)lv.getX(), this.dolphin.getY(), (double)lv.getZ()).isWithinDistance(this.dolphin.getPos(), 4.0)
      ...
      public void start() {
         if (this.dolphin.world instanceof ServerWorld) {
            ...
            StructureFeature<?> lv3 = (double)lv.random.nextFloat() >= 0.5 ? StructureFeature.OCEAN_RUIN : StructureFeature.SHIPWRECK;
            BlockPos lv4 = lv.locateStructure(lv3, lv2, 50, false);
            if (lv4 == null) {
               StructureFeature<?> lv5 = lv3.equals(StructureFeature.OCEAN_RUIN) ? StructureFeature.SHIPWRECK : StructureFeature.OCEAN_RUIN;
               BlockPos lv6 = lv.locateStructure(lv5, lv2, 50, false);
               if (lv6 == null) {
      ...
      public void tick() {
         ...
         if (this.dolphin.isNearTarget() || this.dolphin.getNavigation().isIdle()) {
            ...
            Vec3d lv3 = TargetFinder.findTargetTowards(this.dolphin, 16, 1, lv2, (float) (Math.PI / 8));
            if (lv3 == null) {
            ...
            this.dolphin.getLookControl().lookAt(lv3.x, lv3.y, lv3.z, (float)(this.dolphin.getBodyYawSpeed() + 20), (float)this.dolphin.getLookPitchSpeed());
