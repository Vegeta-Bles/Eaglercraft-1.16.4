...
public class IronGolemEntity extends GolemEntity implements Angerable {
   ...
   protected void initGoals() {
      ...
      this.targetSelector
         .add(3, new FollowTargetGoal<>(this, MobEntity.class, 5, false, false, arg -> arg instanceof Monster && !(arg instanceof CreeperEntity)));
   ...
   public boolean damage(DamageSource source, float amount) {
      IronGolemEntity.Crack lv = this.getCrack();
   ...
   public boolean canSpawn(WorldView world) {
      ...
      if (!lv3.hasSolidTopSurface(world, lv2, this)) {
         ...
         return SpawnHelper.isClearForSpawn(world, lv, world.getBlockState(lv), Fluids.EMPTY.getDefaultState(), EntityType.IRON_GOLEM)
   ...
   public static enum Crack {
      ...
      private static final List<IronGolemEntity.Crack> VALUES = Stream.of(values())
         .sorted(Comparator.comparingDouble(arg -> (double)arg.maxHealthFraction))
      ...
      public static IronGolemEntity.Crack from(float healthFraction) {
         for (IronGolemEntity.Crack lv : VALUES) {
            if (healthFraction < lv.maxHealthFraction) {
               return lv;
            }
         }
