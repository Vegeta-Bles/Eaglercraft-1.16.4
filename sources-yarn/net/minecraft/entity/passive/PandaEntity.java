...
public class PandaEntity extends AnimalEntity {
   ...
   public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
      ...
      if (entity instanceof PandaEntity) {
         lv.initGenes(this, (PandaEntity)entity);
      }
   ...
   private void playEatingAnimation() {
      if (this.getEatingTicks() % 5 == 0) {
         ...
         for (int i = 0; i < 6; i++) {
            ...
            lv2 = lv2.rotateY(-this.bodyYaw * (float) (Math.PI / 180.0));
            lv2 = lv2.add(this.getX(), this.getEyeY() + 1.0, this.getZ());
            this.world
               .addParticle(
                  new ItemStackParticleEffect(ParticleTypes.ITEM, this.getEquippedStack(EquipmentSlot.MAINHAND)), lv2.x, lv2.y, lv2.z, lv.x, lv.y + 0.05, lv.z
               );
         }
      }
   }
   ...
   private void sneeze() {
      ...
      for (PandaEntity lv2 : this.world.getNonSpectatingEntities(PandaEntity.class, this.getBoundingBox().expand(10.0))) {
   ...
   public ActionResult interactMob(PlayerEntity player, Hand hand) {
      ...
      if (this.isScaredByThunderstorm()) {
         ...
         if (this.isBaby()) {
            ...
            if (!lv2.isEmpty() && !player.abilities.creativeMode) {
               this.dropStack(lv2);
            }
   ...
   public static enum Gene {
      ...
      public static PandaEntity.Gene byName(String name) {
         for (PandaEntity.Gene lv : values()) {
