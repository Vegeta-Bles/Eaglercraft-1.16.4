...
public class StriderEntity extends AnimalEntity implements ItemSteerable, Saddleable {
   ...
   public Vec3d updatePassengerForDismount(LivingEntity passenger) {
      ...
      for (BlockPos lv3 : set) {
         if (!this.world.getFluidState(lv3).isIn(FluidTags.LAVA)) {
   ...
   public EntityData initialize(
      ...
      if (this.isBaby()) {
         ...
         if (this.random.nextInt(30) == 0) {
            MobEntity lv = EntityType.ZOMBIFIED_PIGLIN.create(world.toServerWorld());
            var7 = this.method_30336(world, difficulty, lv, new ZombieEntity.ZombieData(ZombieEntity.method_29936(this.random), false));
            lv.equipStack(EquipmentSlot.MAINHAND, new ItemStack(Items.WARPED_FUNGUS_ON_A_STICK));
            this.saddle(null);
         } else if (this.random.nextInt(10) == 0) {
            PassiveEntity lv2 = EntityType.STRIDER.create(world.toServerWorld());
            lv2.setBreedingAge(-24000);
            var7 = this.method_30336(world, difficulty, lv2, null);
         } else {
   ...
   private EntityData method_30336(ServerWorldAccess arg, LocalDifficulty arg2, MobEntity arg3, @Nullable EntityData arg4) {
