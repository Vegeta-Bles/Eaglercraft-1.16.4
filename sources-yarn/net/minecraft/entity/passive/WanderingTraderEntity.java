...
public class WanderingTraderEntity extends MerchantEntity {
      ...
      this.goalSelector
         .add(
            ...
            new HoldInHandsGoal<>(
               ...
               arg -> this.world.isNight() && !arg.isInvisible()
            )
         );
      this.goalSelector
         .add(
            0,
            new HoldInHandsGoal<>(
               this, new ItemStack(Items.MILK_BUCKET), SoundEvents.ENTITY_WANDERING_TRADER_REAPPEARED, arg -> this.world.isDay() && arg.isInvisible()
            )
         );
   ...
   protected SoundEvent getDrinkSound(ItemStack stack) {
      ...
      return lv == Items.MILK_BUCKET ? SoundEvents.ENTITY_WANDERING_TRADER_DRINK_MILK : SoundEvents.ENTITY_WANDERING_TRADER_DRINK_POTION;
   }
      ...
      public void tick() {
         ...
         if (lv != null && WanderingTraderEntity.this.navigation.isIdle()) {
            if (this.isTooFarFrom(lv, 10.0)) {
               Vec3d lv2 = new Vec3d((double)lv.getX() - this.trader.getX(), (double)lv.getY() - this.trader.getY(), (double)lv.getZ() - this.trader.getZ())
                  .normalize();
