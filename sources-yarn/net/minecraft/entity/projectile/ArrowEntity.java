...
public class ArrowEntity extends PersistentProjectileEntity {
   ...
   public static int getCustomPotionColor(ItemStack stack) {
      ...
      return lv != null && lv.contains("CustomPotionColor", 99) ? lv.getInt("CustomPotionColor") : -1;
   }
   ...
   protected void onHit(LivingEntity target) {
      ...
      for (StatusEffectInstance lv : this.potion.getEffects()) {
         target.addStatusEffect(
            new StatusEffectInstance(lv.getEffectType(), Math.max(lv.getDuration() / 8, 1), lv.getAmplifier(), lv.isAmbient(), lv.shouldShowParticles())
         );
      }
