...
public class BlockItem extends Item {
   ...
   public ActionResult useOnBlock(ItemUsageContext context) {
      ...
      return !lv.isAccepted() && this.isFood() ? this.use(context.getWorld(), context.getPlayer(), context.getHand()).getResult() : lv;
   }
   ...
   private BlockState placeFromTag(BlockPos pos, World world, ItemStack stack, BlockState state) {
      ...
      if (lv2 != null) {
         ...
         StateManager<Block, BlockState> lv4 = state.getBlock().getStateManager();
   ...
   protected boolean canPlace(ItemPlacementContext context, BlockState state) {
      ...
      return (!this.checkStatePlacement() || state.canPlaceAt(context.getWorld(), context.getBlockPos()))
         && context.getWorld().canPlace(state, context.getBlockPos(), lv2);
   }
