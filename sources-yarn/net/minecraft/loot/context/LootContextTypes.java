...
public class LootContextTypes {
   ...
   public static final LootContextType COMMAND = register("command", arg -> arg.require(LootContextParameters.ORIGIN).allow(LootContextParameters.THIS_ENTITY));
   public static final LootContextType SELECTOR = register(
      "selector", arg -> arg.require(LootContextParameters.ORIGIN).require(LootContextParameters.THIS_ENTITY)
   );
   ...
   public static final LootContextType BARTER = register("barter", arg -> arg.require(LootContextParameters.THIS_ENTITY));
   ...
   public static final LootContextType ADVANCEMENT_ENTITY = register(
      "advancement_entity", arg -> arg.require(LootContextParameters.THIS_ENTITY).require(LootContextParameters.ORIGIN)
   );
