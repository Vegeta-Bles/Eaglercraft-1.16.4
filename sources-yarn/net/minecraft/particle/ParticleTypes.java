...
public class ParticleTypes {
   ...
   public static final ParticleType<DustParticleEffect> DUST = register("dust", DustParticleEffect.PARAMETERS_FACTORY, arg -> DustParticleEffect.CODEC);
   ...
   private static <T extends ParticleEffect> ParticleType<T> register(
      String name, ParticleEffect.Factory<T> factory, final Function<ParticleType<T>, Codec<T>> function
   ) {
