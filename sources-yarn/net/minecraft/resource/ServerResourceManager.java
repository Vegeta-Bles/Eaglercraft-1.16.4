...
public class ServerResourceManager implements AutoCloseable {
   ...
   public static CompletableFuture<ServerResourceManager> reload(
      List<ResourcePack> list, CommandManager.RegistrationEnvironment arg, int i, Executor executor, Executor executor2
   ) {
      ...
      return completableFuture.whenComplete((arg2, throwable) -> {
         if (throwable != null) {
            lv.close();
         }
      }).thenApply(arg2 -> lv);
