...
public class ScoreboardCriterion {
   ...
   protected ScoreboardCriterion(String name, boolean readOnly, ScoreboardCriterion.RenderType arg) {
      this.name = name;
      ...
      if (OBJECTIVES.containsKey(name)) {
         ...
         return i < 0
            ...
            : Registry.STAT_TYPE
               ...
               .flatMap(arg -> createStatCriterion((StatType<?>)arg, Identifier.splitOn(name.substring(i + 1), '.')));
      }
   }
   ...
   public static enum RenderType {
      ...
      static {
         ...
         for (ScoreboardCriterion.RenderType lv : values()) {
            builder.put(lv.name, lv);
         }
