...
public class AnvilScreenHandler extends ForgingScreenHandler {
   ...
   protected ItemStack onTakeOutput(PlayerEntity player, ItemStack stack) {
      ...
      this.context.run((arg2, arg3) -> {
         BlockState lvx = arg2.getBlockState(arg3);
         if (!player.abilities.creativeMode && lvx.isIn(BlockTags.ANVIL) && player.getRandom().nextFloat() < 0.12F) {
            BlockState lv2 = AnvilBlock.getLandingState(lvx);
            if (lv2 == null) {
               arg2.removeBlock(arg3, false);
               arg2.syncWorldEvent(1029, arg3, 0);
            } else {
               arg2.setBlockState(arg3, lv2, 2);
               arg2.syncWorldEvent(1030, arg3, 0);
            }
         } else {
            arg2.syncWorldEvent(1030, arg3, 0);
         }
   ...
   public void updateResult() {
      ...
      if (lv.isEmpty()) {
         ...
         if (!lv3.isEmpty()) {
            boolean bl = lv3.getItem() == Items.ENCHANTED_BOOK && !EnchantedBookItem.getEnchantmentTag(lv3).isEmpty();
