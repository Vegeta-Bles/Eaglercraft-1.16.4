...
public class BossBarCommand {
                                             ...
                                             ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandManager.literal(
                                                ...
                                                .then(
                                                   CommandManager.literal("white")
                                                      .executes(
                                                         commandContext -> setColor(
                                                               (ServerCommandSource)commandContext.getSource(), getBossBar(commandContext), BossBar.Color.WHITE
                                                            )
                                                      )
                                                )
                                          ))
                                       ...
                                       CommandManager.argument("visible", BoolArgumentType.bool())
                                          .executes(
                                             commandContext -> setVisible(
                                                   (ServerCommandSource)commandContext.getSource(),
                                                   getBossBar(commandContext),
                                                   BoolArgumentType.getBool(commandContext, "visible")
                                                )
                                          )
                                    )
                              ))
                              ...
                              ((LiteralArgumentBuilder)CommandManager.literal("players")
                                    .executes(
                                       commandContext -> setPlayers(
                                             (ServerCommandSource)commandContext.getSource(), getBossBar(commandContext), Collections.emptyList()
                                          )
                                    ))
                                 .then(
               ...
               CommandManager.literal("get")
                  .then(
                     ((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)CommandManager.argument(
                                 ...
                                 .then(
                                    CommandManager.literal("value")
                                       .executes(commandContext -> getValue((ServerCommandSource)commandContext.getSource(), getBossBar(commandContext)))
                                 ))
                              .then(
                                 CommandManager.literal("max")
                                    .executes(commandContext -> getMaxValue((ServerCommandSource)commandContext.getSource(), getBossBar(commandContext)))
                              ))
                           .then(
                              CommandManager.literal("visible")
                                 .executes(commandContext -> isVisible((ServerCommandSource)commandContext.getSource(), getBossBar(commandContext)))
                           ))
                        .then(
                           CommandManager.literal("players")
                              .executes(commandContext -> getPlayers((ServerCommandSource)commandContext.getSource(), getBossBar(commandContext)))
                        )
                  )
            )
      );
   ...
   private static int setName(ServerCommandSource source, CommandBossBar bossBar, Text name) throws CommandSyntaxException {
      Text lv = Texts.parse(source, name, null, 0);
