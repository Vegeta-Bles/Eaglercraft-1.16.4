...
public class FillCommand {
   ...
   public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
      dispatcher.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandManager.literal("fill").requires(arg -> arg.hasPermissionLevel(2)))
            .then(
                           ...
                           ((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)CommandManager.argument(
                                             ...
                                             .executes(
                                                commandContext -> execute(
                                                      ...
                                                      new BlockBox(
                                                         BlockPosArgumentType.getLoadedBlockPos(commandContext, "from"),
                                                         BlockPosArgumentType.getLoadedBlockPos(commandContext, "to")
                                                      ),
   ...
   static enum Mode {
      ...
      OUTLINE(
         (arg, arg2, arg3, arg4) -> arg2.getX() != arg.minX
                  && arg2.getX() != arg.maxX
                  && arg2.getY() != arg.minY
                  && arg2.getY() != arg.maxY
                  && arg2.getZ() != arg.minZ
