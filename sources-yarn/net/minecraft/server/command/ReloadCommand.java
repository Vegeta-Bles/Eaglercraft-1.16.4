...
public class ReloadCommand {
   ...
   private static Collection<String> method_29478(ResourcePackManager arg, SaveProperties arg2, Collection<String> collection) {
      ...
      Collection<String> collection3 = arg2.getDataPackSettings().getDisabled();

      for (String string : arg.getNames()) {
   ...
   public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
      dispatcher.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandManager.literal("reload").requires(arg -> arg.hasPermissionLevel(2)))
            .executes(commandContext -> {
               ...
               Collection<String> collection2 = method_29478(lv2, lv3, collection);
               lv.sendFeedback(new TranslatableText("commands.reload.success"), true);
               method_29480(collection2, lv);
               return 0;
            })
      );
   }
