                                 ...
                                 ((LiteralArgumentBuilder)CommandManager.literal("list")
                                    ...
                                    .then(
                                       CommandManager.argument("team", TeamArgumentType.team())
                                          .executes(
                                             commandContext -> executeListMembers(
                                                   (ServerCommandSource)commandContext.getSource(), TeamArgumentType.getTeam(commandContext, "team")
                                                )
                                          )
                                    )
                              ))
                                    ...
                                    ((RequiredArgumentBuilder)CommandManager.argument("team", StringArgumentType.word())
                                          .executes(
                                             commandContext -> executeAdd(
                                                   (ServerCommandSource)commandContext.getSource(), StringArgumentType.getString(commandContext, "team")
                                                )
                                          ))
                                       .then(
