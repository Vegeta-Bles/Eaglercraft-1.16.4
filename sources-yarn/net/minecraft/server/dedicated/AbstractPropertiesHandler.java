...
public abstract class AbstractPropertiesHandler<T extends AbstractPropertiesHandler<T>> {
   ...
   protected <V> V get(String key, Function<String, V> parser, Function<V, String> stringifier, V fallback) {
      String string2 = this.getStringValue(key);
      V object2 = (V)MoreObjects.firstNonNull(string2 != null ? parser.apply(string2) : null, fallback);
   ...
   protected <V> AbstractPropertiesHandler<T>.PropertyAccessor<V> accessor(String key, Function<String, V> parser, Function<V, String> stringifier, V fallback) {
      ...
      V object2 = (V)MoreObjects.firstNonNull(string2 != null ? parser.apply(string2) : null, fallback);
      this.properties.put(key, stringifier.apply(object2));
      return new AbstractPropertiesHandler.PropertyAccessor<>(key, object2, stringifier);
   }
   ...
   protected abstract T create(DynamicRegistryManager arg, Properties properties);
