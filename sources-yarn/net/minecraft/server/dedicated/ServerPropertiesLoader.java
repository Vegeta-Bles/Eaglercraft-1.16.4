...
public class ServerPropertiesLoader {
   ...
   public ServerPropertiesLoader(DynamicRegistryManager arg, Path path) {
      this.path = path;
      this.propertiesHandler = ServerPropertiesHandler.load(arg, path);
   }
   ...
   public ServerPropertiesLoader apply(UnaryOperator<ServerPropertiesHandler> unaryOperator) {
      (this.propertiesHandler = unaryOperator.apply(this.propertiesHandler)).saveProperties(this.path);
      return this;
   }
}
