                              ...
                              .suggests(
                                 (commandContext, suggestionsBuilder) -> {
                                    ...
                                    return CommandSource.suggestMatching(
                                       lv.getPlayerList()
                                          .stream()
                                          .filter(arg2 -> !lv.getWhitelist().isAllowed(arg2.getGameProfile()))
                                          .map(arg -> arg.getGameProfile().getName()),
                                       suggestionsBuilder
                                    );
                                 }
                              )
                        ...
                        CommandManager.argument("targets", GameProfileArgumentType.gameProfile())
                           .suggests(
                              (commandContext, suggestionsBuilder) -> CommandSource.suggestMatching(
                                    ((ServerCommandSource)commandContext.getSource()).getMinecraftServer().getPlayerManager().getWhitelistedNames(),
                                    suggestionsBuilder
                                 )
                           )
                           .executes(
