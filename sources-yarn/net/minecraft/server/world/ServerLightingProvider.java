...
public class ServerLightingProvider extends LightingProvider implements AutoCloseable {
   ...
   public void checkBlock(BlockPos pos) {
      ...
      this.enqueue(
         pos.getX() >> 4, pos.getZ() >> 4, ServerLightingProvider.Stage.POST_UPDATE, Util.debugRunnable(() -> super.checkBlock(lv), () -> "checkBlock " + lv)
      );
   }
   ...
   public CompletableFuture<Chunk> light(Chunk chunk, boolean excludeBlocks) {
      ...
      this.enqueue(lv.x, lv.z, ServerLightingProvider.Stage.PRE_UPDATE, Util.debugRunnable(() -> {
         ...
         if (!excludeBlocks) {
            chunk.getLightSourcesStream().forEach(arg2 -> super.addLightSource(arg2, chunk.getLuminance(arg2)));
         }
      ...
      return CompletableFuture.supplyAsync(() -> {
         ...
         return chunk;
      }, runnable -> this.enqueue(lv.x, lv.z, ServerLightingProvider.Stage.POST_UPDATE, runnable));
   }
