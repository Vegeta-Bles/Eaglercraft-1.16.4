...
public class MusicSound {
   public static final Codec<MusicSound> CODEC = RecordCodecBuilder.create(
      instance -> instance.group(
               ...
               Codec.INT.fieldOf("min_delay").forGetter(arg -> arg.minDelay),
               Codec.INT.fieldOf("max_delay").forGetter(arg -> arg.maxDelay),
               Codec.BOOL.fieldOf("replace_current_music").forGetter(arg -> arg.replaceCurrentMusic)
            )
