...
public class Stats {
   ...
   private static Identifier register(String string, StatFormatter arg) {
      Identifier lv = new Identifier(string);
      Registry.register(Registry.CUSTOM_STAT, string, lv);
      CUSTOM.getOrCreateStat(lv, arg);
      return lv;
   }

   private static <T> StatType<T> registerType(String string, Registry<T> arg) {
      return Registry.register(Registry.STAT_TYPE, string, new StatType<>(arg));
   }
}
