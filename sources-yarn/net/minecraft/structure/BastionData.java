   ...
   static {
      ...
      StructurePools.register(
         new StructurePool(
            ...
            new Identifier("empty"),
            ImmutableList.of(
               Pair.of(StructurePoolElement.method_30434("bastion/mobs/hoglin"), 2), Pair.of(StructurePoolElement.method_30434("bastion/mobs/empty"), 1)
            ),
            StructurePool.Projection.RIGID
         )
      );
      StructurePools.register(
         new StructurePool(
            ...
            new Identifier("empty"),
            ImmutableList.of(
               Pair.of(StructurePoolElement.method_30434("bastion/blocks/air"), 3), Pair.of(StructurePoolElement.method_30434("bastion/blocks/gold"), 1)
            ),
            StructurePool.Projection.RIGID
         )
      );
