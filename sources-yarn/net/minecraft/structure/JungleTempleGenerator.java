...
public class JungleTempleGenerator extends StructurePieceWithDimensions {
   ...
   public boolean generate(
      ...
      if (!this.method_14839(arg, boundingBox, 0)) {
         ...
         this.addBlock(arg, Blocks.VINE.getDefaultState().with(VineBlock.SOUTH, Boolean.valueOf(true)), 3, -2, 2, boundingBox);
         this.addBlock(
            arg,
         ...
         this.addBlock(arg, Blocks.VINE.getDefaultState().with(VineBlock.EAST, Boolean.valueOf(true)), 8, -1, 3, boundingBox);
         this.addBlock(arg, Blocks.VINE.getDefaultState().with(VineBlock.EAST, Boolean.valueOf(true)), 8, -2, 3, boundingBox);
         ...
         BlockState lv6 = Blocks.LEVER.getDefaultState().with(LeverBlock.FACING, Direction.NORTH).with(LeverBlock.FACE, WallMountLocation.WALL);
         ...
         this.addBlock(arg, Blocks.STICKY_PISTON.getDefaultState().with(PistonBlock.FACING, Direction.UP), 9, -2, 8, boundingBox);
         this.addBlock(arg, Blocks.STICKY_PISTON.getDefaultState().with(PistonBlock.FACING, Direction.WEST), 10, -2, 8, boundingBox);
         this.addBlock(arg, Blocks.STICKY_PISTON.getDefaultState().with(PistonBlock.FACING, Direction.WEST), 10, -1, 8, boundingBox);
         this.addBlock(arg, Blocks.REPEATER.getDefaultState().with(RepeaterBlock.FACING, Direction.NORTH), 10, -2, 10, boundingBox);
