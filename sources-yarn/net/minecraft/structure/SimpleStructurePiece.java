...
public abstract class SimpleStructurePiece extends StructurePiece {
   ...
   public boolean generate(
      ...
      if (this.structure.place(arg, this.pos, arg6, this.placementData, random, 2)) {
         for (Structure.StructureBlockInfo lv : this.structure.getInfosForBlock(this.pos, this.placementData, Blocks.STRUCTURE_BLOCK)) {
            if (lv.tag != null) {
               StructureBlockMode lv2 = StructureBlockMode.valueOf(lv.tag.getString("mode"));
         ...
         for (Structure.StructureBlockInfo lv3 : this.structure.getInfosForBlock(this.pos, this.placementData, Blocks.JIGSAW)) {
            if (lv3.tag != null) {
   ...
   protected abstract void handleMetadata(String metadata, BlockPos pos, ServerWorldAccess arg2, Random random, BlockBox boundingBox);
