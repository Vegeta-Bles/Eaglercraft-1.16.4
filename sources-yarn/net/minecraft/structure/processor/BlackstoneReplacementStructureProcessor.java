   ...
   public Structure.StructureBlockInfo process(
      ...
      if (lv == null) {
         ...
         if (lv2.contains(StairsBlock.FACING)) {
            lv3 = lv3.with(StairsBlock.FACING, lv2.get(StairsBlock.FACING));
         }

         if (lv2.contains(StairsBlock.HALF)) {
            lv3 = lv3.with(StairsBlock.HALF, lv2.get(StairsBlock.HALF));
         }

         if (lv2.contains(SlabBlock.TYPE)) {
            lv3 = lv3.with(SlabBlock.TYPE, lv2.get(SlabBlock.TYPE));
         }
