...
public class BlockAgeStructureProcessor extends StructureProcessor {
   public static final Codec<BlockAgeStructureProcessor> CODEC = Codec.FLOAT
      .fieldOf("mossiness")
      .xmap(BlockAgeStructureProcessor::new, arg -> arg.mossiness)
      .codec();
   ...
   public Structure.StructureBlockInfo process(
      ...
      return lv3 != null ? new Structure.StructureBlockInfo(lv2, lv3, arg5.tag) : arg5;
   }
   ...
   private BlockState processStairs(Random random, BlockState state) {
      ...
      if (random.nextFloat() >= 0.5F) {
         ...
         BlockState[] lvs2 = new BlockState[]{
            Blocks.MOSSY_STONE_BRICK_STAIRS.getDefaultState().with(StairsBlock.FACING, lv).with(StairsBlock.HALF, lv2),
