...
public interface TagManager {
   ...
   static TagManager fromPacket(PacketByteBuf buf) {
      ...
      return create(lv, lv2, lv3, lv4);
   }

   static TagManager create(final TagGroup<Block> blocks, final TagGroup<Item> items, final TagGroup<Fluid> fluids, final TagGroup<EntityType<?>> entityTypes) {
