...
public class GameTest {
   ...
   public void init(BlockPos arg, int i) {
      StructureBlockBlockEntity lv = StructureTestUtil.method_22250(this.getStructureName(), arg, this.method_29402(), i, this.world, false);
      ...
      this.listeners.forEach(argx -> argx.onStarted(this));
   }
