...
public class HoverEvent {
   ...
   public static HoverEvent fromJson(JsonObject json) {
      ...
      if (string == null) {
         ...
         HoverEvent.Action<?> lv = HoverEvent.Action.byName(string);
         if (lv == null) {
            return null;
         } else {
            ...
            if (jsonElement != null) {
               ...
               return lv2 != null ? lv.buildHoverEvent(lv2) : null;
            }
         }
      }
   }
   ...
   public static class Action<T> {
      ...
      public static final HoverEvent.Action<HoverEvent.ItemStackContent> SHOW_ITEM = new HoverEvent.Action<>(
         ...
         arg -> HoverEvent.ItemStackContent.parse(arg)
      );
      ...
      private static final Map<String, HoverEvent.Action> BY_NAME = Stream.of(SHOW_TEXT, SHOW_ITEM, SHOW_ENTITY)
         .collect(ImmutableMap.toImmutableMap(HoverEvent.Action::getName, arg -> arg));
   ...
   public static class EntityContent {
      ...
      public static HoverEvent.EntityContent parse(JsonElement json) {
         if (!json.isJsonObject()) {
            ...
            return new HoverEvent.EntityContent(lv, uUID, lv2);
         }
      }
      ...
      public static HoverEvent.EntityContent parse(Text text) {
         try {
            ...
            return new HoverEvent.EntityContent(lv3, uUID, lv2);
      ...
      public boolean equals(Object object) {
         if (this == object) {
            ...
            HoverEvent.EntityContent lv = (HoverEvent.EntityContent)object;
   ...
   public static class ItemStackContent {
      ...
      public boolean equals(Object object) {
         if (this == object) {
            ...
            HoverEvent.ItemStackContent lv = (HoverEvent.ItemStackContent)object;
         ...
         if (json.isJsonPrimitive()) {
            ...
            if (jsonObject.has("tag")) {
               ...
               try {
                  ...
                  return new HoverEvent.ItemStackContent(lv, i, lv2);
               } catch (CommandSyntaxException var6) {
                  HoverEvent.LOGGER.warn("Failed to parse tag: {}", string, var6);
               }
            }

            return new HoverEvent.ItemStackContent(lv, i, null);
         }
      }
      ...
      private static HoverEvent.ItemStackContent parse(Text text) {
         try {
            CompoundTag lv = StringNbtReader.parse(text.getString());
            return new HoverEvent.ItemStackContent(ItemStack.fromTag(lv));
