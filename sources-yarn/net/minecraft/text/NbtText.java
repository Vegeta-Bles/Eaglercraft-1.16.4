...
public abstract class NbtText extends BaseText implements ParsableText {
   ...
   public MutableText parse(@Nullable ServerCommandSource source, @Nullable Entity sender, int depth) throws CommandSyntaxException {
      if (source != null && this.path != null) {
         ...
         return (MutableText)(this.interpret ? stream.flatMap(text -> {
            try {
   ...
   public static class BlockNbtText extends NbtText {
      ...
      public boolean equals(Object object) {
         if (this == object) {
            ...
            NbtText.BlockNbtText lv = (NbtText.BlockNbtText)object;
   ...
   public static class EntityNbtText extends NbtText {
      ...
      public boolean equals(Object object) {
         if (this == object) {
            ...
            NbtText.EntityNbtText lv = (NbtText.EntityNbtText)object;
   ...
   public static class StorageNbtText extends NbtText {
      ...
      public boolean equals(Object object) {
         if (this == object) {
            ...
            NbtText.StorageNbtText lv = (NbtText.StorageNbtText)object;
