...
public class ItemScatterer {
   ...
   public static void spawn(World arg, BlockPos arg2, Inventory arg3) {
      spawn(arg, (double)arg2.getX(), (double)arg2.getY(), (double)arg2.getZ(), arg3);
   }

   public static void spawn(World arg, Entity arg2, Inventory arg3) {
      spawn(arg, arg2.getX(), arg2.getY(), arg2.getZ(), arg3);
   }
   ...
   public static void spawn(World world, BlockPos pos, DefaultedList<ItemStack> items) {
      items.forEach(arg3 -> spawn(world, (double)pos.getX(), (double)pos.getY(), (double)pos.getZ(), arg3));
   }
   ...
   public static void spawn(World arg, double x, double y, double z, ItemStack item) {
      ...
      while (!item.isEmpty()) {
         ...
         float m = 0.05F;
         lv.setVelocity(RANDOM.nextGaussian() * 0.05F, RANDOM.nextGaussian() * 0.05F + 0.2F, RANDOM.nextGaussian() * 0.05F);
         arg.spawnEntity(lv);
      }
   }
}
