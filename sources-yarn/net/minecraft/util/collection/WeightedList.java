   ...
   public static class Entry<T> {
      ...
      public static <E> Codec<WeightedList.Entry<E>> createCodec(final Codec<E> codec) {
         return new Codec<WeightedList.Entry<E>>() {
            ...
            public <T> DataResult<T> encode(WeightedList.Entry<E> arg, DynamicOps<T> dynamicOps, T object) {
               return dynamicOps.mapBuilder()
                  .add("weight", dynamicOps.createInt(arg.weight))
                  .add("data", codec.encodeStart(dynamicOps, arg.item))
                  .build(object);
            }
         };
      }
