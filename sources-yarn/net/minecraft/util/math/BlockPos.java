...
public class BlockPos extends Vec3i {
      ...
      return () -> new AbstractIterator<BlockPos>() {
            ...
            protected BlockPos computeNext() {
               if (this.remaining <= 0) {
                  ...
                  BlockPos lv = this.pos.set(minX + random.nextInt(p), minY + random.nextInt(q), minZ + random.nextInt(r));
                  this.remaining--;
                  return lv;
               }
            }
   ...
   public static Iterable<BlockPos.Mutable> method_30512(BlockPos arg, int i, Direction arg2, Direction arg3) {
      Validate.validState(arg2.getAxis() != arg3.getAxis(), "The two directions cannot be on the same axis", new Object[0]);
      return () -> new AbstractIterator<BlockPos.Mutable>() {
            private final Direction[] directions = new Direction[]{arg2, arg3, arg2.getOpposite(), arg3.getOpposite()};
            private final BlockPos.Mutable pos = arg.mutableCopy().move(arg3);
