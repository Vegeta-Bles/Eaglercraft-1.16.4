...
public class Vec3i implements Comparable<Vec3i> {
   public static final Codec<Vec3i> CODEC = Codec.INT_STREAM
      .comapFlatMap(
         intStream -> Util.toIntArray(intStream, 3).map(is -> new Vec3i(is[0], is[1], is[2])), arg -> IntStream.of(arg.getX(), arg.getY(), arg.getZ())
      );
   ...
   public boolean equals(Object object) {
      if (this == object) {
         ...
         if (this.getX() != lv.getX()) {
            ...
            return this.getY() != lv.getY() ? false : this.getZ() == lv.getZ();
         }
      }
   }
   ...
   public int getComponentAlongAxis(Direction.Axis arg) {
