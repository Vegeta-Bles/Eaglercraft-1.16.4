...
public class DoublePerlinNoiseSampler {
   ...
   public static DoublePerlinNoiseSampler method_30846(ChunkRandom arg, int i, DoubleList doubleList) {
      return new DoublePerlinNoiseSampler(arg, i, doubleList);
   }

   private DoublePerlinNoiseSampler(ChunkRandom arg, int i, DoubleList doubleList) {
      this.firstSampler = OctavePerlinNoiseSampler.method_30847(arg, i, doubleList);
      this.secondSampler = OctavePerlinNoiseSampler.method_30847(arg, i, doubleList);
