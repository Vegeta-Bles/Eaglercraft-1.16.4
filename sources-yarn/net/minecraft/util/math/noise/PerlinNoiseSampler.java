...
public final class PerlinNoiseSampler {
   ...
   public double sample(
      ...
      double s = grad(this.getGradient(n), localX, localY, localZ);
      double t = grad(this.getGradient(q), localX - 1.0, localY, localZ);
      double u = grad(this.getGradient(o), localX, localY - 1.0, localZ);
      double v = grad(this.getGradient(r), localX - 1.0, localY - 1.0, localZ);
      double w = grad(this.getGradient(n + 1), localX, localY, localZ - 1.0);
      double x = grad(this.getGradient(q + 1), localX - 1.0, localY, localZ - 1.0);
      double y = grad(this.getGradient(o + 1), localX, localY - 1.0, localZ - 1.0);
      double z = grad(this.getGradient(r + 1), localX - 1.0, localY - 1.0, localZ - 1.0);
