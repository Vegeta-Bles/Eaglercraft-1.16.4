...
public class ProfilerSystem implements ReadableProfiler {
   ...
   public void pop() {
      if (!this.tickStarted) {
         ...
         long n = l - m;
         ProfilerSystem.LocatedInfo lv = this.getCurrentInfo();
         lv.time = lv.time + n;
   ...
   private ProfilerSystem.LocatedInfo getCurrentInfo() {
      if (this.currentInfo == null) {
         this.currentInfo = this.locationInfos.computeIfAbsent(this.location, string -> new ProfilerSystem.LocatedInfo());
      }
