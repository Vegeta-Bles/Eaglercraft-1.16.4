      ...
      if (player.isSpectator()) {
         ...
         if (!lv.hasRaids()) {
            ...
            List<PointOfInterest> list = this.world
               ...
               .getInCircle(PointOfInterestType.ALWAYS_TRUE, lv2, 64, PointOfInterestStorage.OccupationStatus.IS_OCCUPIED)
            ...
            if (i > 0) {
               ...
               lv6 = new BlockPos(lv3);
            } else {
               lv6 = lv2;
            }

            Raid lv8 = this.getOrCreateRaid(player.getServerWorld(), lv6);
            boolean bl = false;
            if (!lv8.hasStarted()) {
