...
public class BlockCollisionSpliterator extends AbstractSpliterator<VoxelShape> {
   ...
   public BlockCollisionSpliterator(CollisionView arg, @Nullable Entity arg2, Box arg3, BiPredicate<BlockState, BlockPos> blockPredicate) {
      ...
      while (this.blockIterator.step()) {
         ...
         if (l != 3) {
            ...
            if (lv != null) {
               ...
               if (this.blockPredicate.test(lv2, this.pos) && (l != 1 || lv2.exceedsCube()) && (l != 2 || lv2.isOf(Blocks.MOVING_PISTON))) {
                  ...
                  if (lv3 == VoxelShapes.fullCube()) {
                     if (this.box.intersects((double)i, (double)j, (double)k, (double)i + 1.0, (double)j + 1.0, (double)k + 1.0)) {
                        consumer.accept(lv3.offset((double)i, (double)j, (double)k));
                        return true;
                     }
                  } else {
   ...
   boolean offerEntityShape(Consumer<? super VoxelShape> consumer) {
      ...
      if (!isInWorldBorder(lv, lv2)) {
         VoxelShape lv3 = lv.asVoxelShape();
         if (!method_30131(lv3, lv2) && method_30130(lv3, lv2)) {
            consumer.accept(lv3);
            return true;
         }
      }
