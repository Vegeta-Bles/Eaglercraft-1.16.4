...
public interface BlockView {
   ...
   default Stream<BlockState> method_29546(Box arg) {
      return BlockPos.stream(arg).map(this::getBlockState);
   }

   default BlockHitResult raycast(RaycastContext context) {
      return raycast(context, (arg, arg2) -> {
         BlockState lv = this.getBlockState(arg2);
         FluidState lv2 = this.getFluidState(arg2);
         Vec3d lv3 = arg.getStart();
         Vec3d lv4 = arg.getEnd();
         VoxelShape lv5 = arg.getBlockShape(lv, this, arg2);
         BlockHitResult lv6 = this.raycastBlock(lv3, lv4, arg2, lv5, lv);
         VoxelShape lv7 = arg.getFluidShape(lv2, this, arg2);
         BlockHitResult lv8 = lv7.raycast(lv3, lv4, arg2);
   ...
   static <T> T raycast(RaycastContext arg, BiFunction<RaycastContext, BlockPos, T> context, Function<RaycastContext, T> blockRaycaster) {
      Vec3d lv = arg.getStart();
      Vec3d lv2 = arg.getEnd();
      if (lv.equals(lv2)) {
         return blockRaycaster.apply(arg);
      } else {
         ...
         BlockPos.Mutable lv3 = new BlockPos.Mutable(j, k, l);
         ...
         if (object != null) {
            ...
            while (v <= 1.0 || w <= 1.0 || x <= 1.0) {
               ...
               T object2 = context.apply(arg, lv3.set(j, k, l));
               if (object2 != null) {
                  return object2;
               }
            }
