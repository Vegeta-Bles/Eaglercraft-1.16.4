...
public interface WorldView extends BlockRenderView, CollisionView, BiomeAccess.Storage {
   ...
   default Stream<BlockState> method_29556(Box arg) {
      ...
      return this.isRegionLoaded(i, k, m, j, l, n) ? this.method_29546(arg) : Stream.empty();
   }
   ...
   default Biome getBiomeForNoiseGen(int biomeX, int biomeY, int biomeZ) {
      ...
      return lv != null && lv.getBiomeArray() != null
         ? lv.getBiomeArray().getBiomeForNoiseGen(biomeX, biomeY, biomeZ)
   ...
   default boolean isSkyVisibleAllowingSea(BlockPos pos) {
      if (pos.getY() >= this.getSeaLevel()) {
         ...
         if (!this.isSkyVisible(lv)) {
            ...
            for (BlockPos var4 = lv.down(); var4.getY() > pos.getY(); var4 = var4.down()) {
