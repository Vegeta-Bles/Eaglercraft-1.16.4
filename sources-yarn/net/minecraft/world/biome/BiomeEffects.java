...
public class BiomeEffects {
   public static final Codec<BiomeEffects> CODEC = RecordCodecBuilder.create(
      instance -> instance.group(
               Codec.INT.fieldOf("fog_color").forGetter(arg -> arg.fogColor),
               Codec.INT.fieldOf("water_color").forGetter(arg -> arg.waterColor),
               Codec.INT.fieldOf("water_fog_color").forGetter(arg -> arg.waterFogColor),
               Codec.INT.fieldOf("sky_color").forGetter(arg -> arg.skyColor),
               Codec.INT.optionalFieldOf("foliage_color").forGetter(arg -> arg.foliageColor),
               Codec.INT.optionalFieldOf("grass_color").forGetter(arg -> arg.grassColor),
               BiomeEffects.GrassColorModifier.CODEC
                  .optionalFieldOf("grass_color_modifier", BiomeEffects.GrassColorModifier.NONE)
                  .forGetter(arg -> arg.grassColorModifier),
               BiomeParticleConfig.CODEC.optionalFieldOf("particle").forGetter(arg -> arg.particleConfig),
               SoundEvent.CODEC.optionalFieldOf("ambient_sound").forGetter(arg -> arg.loopSound),
               BiomeMoodSound.CODEC.optionalFieldOf("mood_sound").forGetter(arg -> arg.moodSound),
               BiomeAdditionsSound.CODEC.optionalFieldOf("additions_sound").forGetter(arg -> arg.additionsSound),
               MusicSound.CODEC.optionalFieldOf("music").forGetter(arg -> arg.music)
            )
