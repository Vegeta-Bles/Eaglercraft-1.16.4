...
public class FixedBiomeSource extends BiomeSource {
   public static final Codec<FixedBiomeSource> CODEC = Biome.REGISTRY_CODEC.fieldOf("biome").xmap(FixedBiomeSource::new, arg -> arg.biome).stable().codec();
   ...
   @Nullable
   @Override
   public BlockPos locateBiome(int x, int y, int z, int radius, int m, Predicate<Biome> predicate, Random random, boolean bl) {
