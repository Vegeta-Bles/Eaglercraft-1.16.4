...
public class PalettedContainer<T> implements PaletteResizeListener<T> {
   ...
   public T setSync(int x, int y, int z, T value) {
      this.lock();
      T object2 = this.setAndGetOldValue(toIndex(x, y, z), value);
      this.unlock();
      return object2;
   }
   ...
   public void read(ListTag paletteTag, long[] data) {
      ...
      if (this.palette == this.fallbackPalette) {
         Palette<T> lv = new BiMapPalette<>(this.idList, i, this.noOpPaletteResizeHandler, this.elementDeserializer, this.elementSerializer);
   ...
   public void write(CompoundTag arg, String string, String string2) {
      this.lock();
      BiMapPalette<T> lv = new BiMapPalette<>(this.idList, this.paletteSize, this.noOpPaletteResizeHandler, this.elementDeserializer, this.elementSerializer);
