...
public class StructuresConfig {
   ...
   static {
      for (StructureFeature<?> lv : Registry.STRUCTURE_FEATURE) {
         if (!DEFAULT_STRUCTURES.containsKey(lv)) {
            throw new IllegalStateException("Structure feature without default settings: " + Registry.STRUCTURE_FEATURE.getId(lv));
         }
      }
