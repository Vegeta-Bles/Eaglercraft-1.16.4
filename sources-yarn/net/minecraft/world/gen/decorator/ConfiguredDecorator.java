...
public class ConfiguredDecorator<DC extends DecoratorConfig> implements Decoratable<ConfiguredDecorator<?>> {
   public static final Codec<ConfiguredDecorator<?>> CODEC = Registry.DECORATOR.dispatch("type", arg -> arg.decorator, Decorator::getCodec);
   ...
   public ConfiguredDecorator<?> decorate(ConfiguredDecorator<?> arg) {
      return new ConfiguredDecorator<>(Decorator.DECORATED, new DecoratedDecoratorConfig(arg, this));
   }
