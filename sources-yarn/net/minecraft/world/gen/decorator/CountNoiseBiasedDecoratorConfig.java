...
public class CountNoiseBiasedDecoratorConfig implements DecoratorConfig {
   public static final Codec<CountNoiseBiasedDecoratorConfig> CODEC = RecordCodecBuilder.create(
      instance -> instance.group(
               Codec.INT.fieldOf("noise_to_count_ratio").forGetter(arg -> arg.noiseToCountRatio),
               Codec.DOUBLE.fieldOf("noise_factor").forGetter(arg -> arg.noiseFactor),
               Codec.DOUBLE.fieldOf("noise_offset").orElse(0.0).forGetter(arg -> arg.noiseOffset)
            )
