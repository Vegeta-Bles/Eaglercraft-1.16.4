...
public class RangeDecoratorConfig implements DecoratorConfig {
   public static final Codec<RangeDecoratorConfig> CODEC = RecordCodecBuilder.create(
      instance -> instance.group(
               Codec.INT.fieldOf("bottom_offset").orElse(0).forGetter(arg -> arg.bottomOffset),
               Codec.INT.fieldOf("top_offset").orElse(0).forGetter(arg -> arg.topOffset),
               Codec.INT.fieldOf("maximum").orElse(0).forGetter(arg -> arg.maximum)
            )
