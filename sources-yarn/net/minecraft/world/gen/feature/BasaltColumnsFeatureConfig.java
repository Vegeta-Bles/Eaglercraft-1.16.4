...
public class BasaltColumnsFeatureConfig implements FeatureConfig {
   public static final Codec<BasaltColumnsFeatureConfig> CODEC = RecordCodecBuilder.create(
      instance -> instance.group(
               UniformIntDistribution.createValidatedCodec(0, 2, 1).fieldOf("reach").forGetter(arg -> arg.reach),
               UniformIntDistribution.createValidatedCodec(1, 5, 5).fieldOf("height").forGetter(arg -> arg.height)
            )
