...
public class BuriedTreasureFeature extends StructureFeature<ProbabilityConfig> {
   ...
   protected boolean shouldStartAt(
      ChunkGenerator arg, BiomeSource arg2, long l, ChunkRandom arg3, int i, int j, Biome arg4, ChunkPos arg5, ProbabilityConfig arg6
   ) {
   ...
   public static class Start extends StructureStart<ProbabilityConfig> {
      ...
      public void init(DynamicRegistryManager arg, ChunkGenerator arg2, StructureManager arg3, int i, int j, Biome arg4, ProbabilityConfig arg5) {
         int k = i * 16;
         int l = j * 16;
