...
public class ConfiguredFeatures {
   ...
   public static final ConfiguredFeature<?, ?> BASALT_BLOBS = register(
      ...
      Feature.NETHERRACK_REPLACE_BLOBS
         .configure(
            new NetherrackReplaceBlobsFeatureConfig(ConfiguredFeatures.States.NETHERRACK, ConfiguredFeatures.States.BASALT, UniformIntDistribution.of(3, 4))
         )
         .rangeOf(128)
         .spreadHorizontally()
         .repeat(75)
   ...
   public static final ConfiguredFeature<?, ?> WARPED_FOREST_VEGETATION = register(
      ...
      Feature.NETHER_FOREST_VEGETATION
         .configure(ConfiguredFeatures.Configs.WARPED_ROOTS_CONFIG)
   ...
   public static final ConfiguredFeature<?, ?> SEAGRASS_DEEP_COLD = register(
      "seagrass_deep_cold",
      Feature.SEAGRASS.configure(new ProbabilityConfig(0.8F)).repeat(40).decorate(ConfiguredFeatures.Decorators.SQUARE_TOP_SOLID_HEIGHTMAP)
   );
   ...
   public static final ConfiguredFeature<?, ?> SEAGRASS_DEEP_WARM = register(
      "seagrass_deep_warm",
      Feature.SEAGRASS.configure(new ProbabilityConfig(0.8F)).repeat(80).decorate(ConfiguredFeatures.Decorators.SQUARE_TOP_SOLID_HEIGHTMAP)
   );
      ...
      Feature.DISK
         .configure(
            new DiskFeatureConfig(
               ...
               UniformIntDistribution.of(2, 1),
               1,
               ImmutableList.of(ConfiguredFeatures.States.DIRT, ConfiguredFeatures.States.CLAY)
            )
         )
   ...
   public static final ConfiguredFeature<?, ?> SPRING_WATER = register(
      ...
      Feature.SPRING_FEATURE
         .configure(
            new SpringFeatureConfig(
               ConfiguredFeatures.States.WATER_FLUID, true, 4, 1, ImmutableSet.of(Blocks.STONE, Blocks.GRANITE, Blocks.DIORITE, Blocks.ANDESITE)
            )
         )
   ...
   public static final ConfiguredFeature<?, ?> PATCH_WATERLILLY = register(
      ...
      Feature.RANDOM_PATCH
         .configure(
            new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(ConfiguredFeatures.States.LILY_PAD), SimpleBlockPlacer.INSTANCE)
               .tries(10)
               .build()
         )
         .decorate(ConfiguredFeatures.Decorators.SQUARE_HEIGHTMAP_SPREAD_DOUBLE)
      ...
      Feature.HUGE_BROWN_MUSHROOM
         .configure(
            new HugeMushroomFeatureConfig(
               new SimpleBlockStateProvider(ConfiguredFeatures.States.BROWN_MUSHROOM_BLOCK),
               new SimpleBlockStateProvider(ConfiguredFeatures.States.MUSHROOM_STEM),
               3
            )
         )
   );
   public static final ConfiguredFeature<?, ?> HUGE_RED_MUSHROOM = register(
      ...
      Feature.HUGE_RED_MUSHROOM
         .configure(
            new HugeMushroomFeatureConfig(
               new SimpleBlockStateProvider(ConfiguredFeatures.States.RED_MUSHROOM_BLOCK),
               new SimpleBlockStateProvider(ConfiguredFeatures.States.MUSHROOM_STEM),
               2
            )
         )
   ...
   public static final ConfiguredFeature<TreeFeatureConfig, ?> FANCY_OAK_BEES_002 = register(
      "fancy_oak_bees_002",
      Feature.TREE.configure(FANCY_OAK.getConfig().setTreeDecorators(ImmutableList.of(ConfiguredFeatures.Decorators.REGULAR_BEEHIVES_TREES)))
   );
   public static final ConfiguredFeature<TreeFeatureConfig, ?> FANCY_OAK_BEES_005 = register(
      "fancy_oak_bees_005",
      Feature.TREE.configure(FANCY_OAK.getConfig().setTreeDecorators(ImmutableList.of(ConfiguredFeatures.Decorators.MORE_BEEHIVES_TREES)))
   );
   ...
   public static final ConfiguredFeature<?, ?> FLOWER_SWAMP = register(
      ...
      Feature.FLOWER
         .configure(
            new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(ConfiguredFeatures.States.BLUE_ORCHID), SimpleBlockPlacer.INSTANCE)
               .tries(64)
               .build()
         )
         .decorate(ConfiguredFeatures.Decorators.SPREAD_32_ABOVE)
   ...
   private static final ImmutableList<Supplier<ConfiguredFeature<?, ?>>> FOREST_FLOWER_VEGETATION_CONFIGS = ImmutableList.<Supplier<ConfiguredFeature<?, ?>>>of(
      ...
      () -> (ConfiguredFeature<?, ?>)Feature.NO_BONEMEAL_FLOWER
            .configure(
      ...
      Feature.SIMPLE_RANDOM_SELECTOR
         .configure(
            new SimpleRandomFeatureConfig(
               ImmutableList.<Supplier<ConfiguredFeature<?, ?>>>of(
                  (Supplier<ConfiguredFeature<?, ?>>)(() -> (ConfiguredFeature<?, ?>)Feature.CORAL_TREE.configure(FeatureConfig.DEFAULT)),
                  (Supplier<ConfiguredFeature<?, ?>>)(() -> (ConfiguredFeature<?, ?>)Feature.CORAL_CLAW.configure(FeatureConfig.DEFAULT)),
                  (Supplier<ConfiguredFeature<?, ?>>)(() -> (ConfiguredFeature<?, ?>)Feature.CORAL_MUSHROOM.configure(FeatureConfig.DEFAULT))
               )
            )
         )
         .decorate(ConfiguredFeatures.Decorators.TOP_SOLID_HEIGHTMAP)
   ...
   public static final ConfiguredFeature<?, ?> TREES_GIANT = register(
      ...
      Feature.RANDOM_SELECTOR
         .configure(
            new RandomFeatureConfig(
               ImmutableList.of(MEGA_SPRUCE.withChance(0.025641026F), MEGA_PINE.withChance(0.30769232F), PINE.withChance(0.33333334F)), SPRUCE
            )
         )
         .decorate(ConfiguredFeatures.Decorators.SQUARE_HEIGHTMAP)
         .decorate(Decorator.COUNT_EXTRA.configure(new CountExtraDecoratorConfig(10, 0.1F, 1)))
   ...
   public static final ConfiguredFeature<?, ?> TREES_JUNGLE = register(
      ...
      Feature.RANDOM_SELECTOR
         .configure(
            new RandomFeatureConfig(
               ImmutableList.of(FANCY_OAK.withChance(0.1F), JUNGLE_BUSH.withChance(0.5F), MEGA_JUNGLE_TREE.withChance(0.33333334F)), JUNGLE_TREE
            )
         )
         .decorate(ConfiguredFeatures.Decorators.SQUARE_HEIGHTMAP)
   ...
   public static final class Configs {
      ...
      public static final RandomPatchFeatureConfig TAIGA_GRASS_CONFIG = new RandomPatchFeatureConfig.Builder(
            new WeightedBlockStateProvider().addState(ConfiguredFeatures.States.GRASS, 1).addState(ConfiguredFeatures.States.FERN, 4),
            SimpleBlockPlacer.INSTANCE
         )
         .tries(32)
         .build();
      public static final RandomPatchFeatureConfig LUSH_GRASS_CONFIG = new RandomPatchFeatureConfig.Builder(
            new WeightedBlockStateProvider().addState(ConfiguredFeatures.States.GRASS, 3).addState(ConfiguredFeatures.States.FERN, 1),
            SimpleBlockPlacer.INSTANCE
         )
      ...
      public static final RandomPatchFeatureConfig DEFAULT_FLOWER_CONFIG = new RandomPatchFeatureConfig.Builder(
            new WeightedBlockStateProvider().addState(ConfiguredFeatures.States.POPPY, 2).addState(ConfiguredFeatures.States.DANDELION, 1),
            SimpleBlockPlacer.INSTANCE
         )
         .tries(64)
         .build();
   ...
   public static final class Decorators {
      ...
      public static final ConfiguredDecorator<NopeDecoratorConfig> HEIGHTMAP_WORLD_SURFACE = Decorator.HEIGHTMAP_WORLD_SURFACE
         .configure(DecoratorConfig.DEFAULT);
      public static final ConfiguredDecorator<NopeDecoratorConfig> HEIGHTMAP_SPREAD_DOUBLE = Decorator.HEIGHTMAP_SPREAD_DOUBLE
         .configure(DecoratorConfig.DEFAULT);
