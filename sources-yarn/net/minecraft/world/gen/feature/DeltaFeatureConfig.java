...
public class DeltaFeatureConfig implements FeatureConfig {
   public static final Codec<DeltaFeatureConfig> CODEC = RecordCodecBuilder.create(
      instance -> instance.group(
               BlockState.CODEC.fieldOf("contents").forGetter(arg -> arg.contents),
               BlockState.CODEC.fieldOf("rim").forGetter(arg -> arg.rim),
               UniformIntDistribution.createValidatedCodec(0, 8, 8).fieldOf("size").forGetter(arg -> arg.size),
               UniformIntDistribution.createValidatedCodec(0, 8, 8).fieldOf("rim_size").forGetter(arg -> arg.rimSize)
            )
