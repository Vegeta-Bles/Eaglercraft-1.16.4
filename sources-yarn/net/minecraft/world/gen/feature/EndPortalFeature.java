...
public class EndPortalFeature extends Feature<DefaultFeatureConfig> {
   ...
   public boolean generate(StructureWorldAccess arg, ChunkGenerator arg2, Random random, BlockPos arg3, DefaultFeatureConfig arg4) {
      for (BlockPos lv : BlockPos.iterate(
         new BlockPos(arg3.getX() - 4, arg3.getY() - 1, arg3.getZ() - 4), new BlockPos(arg3.getX() + 4, arg3.getY() + 32, arg3.getZ() + 4)
      )) {
         boolean bl = lv.isWithinDistance(arg3, 2.5);
         if (bl || lv.isWithinDistance(arg3, 3.5)) {
            if (lv.getY() < arg3.getY()) {
               if (bl) {
                  this.setBlockState(arg, lv, Blocks.BEDROCK.getDefaultState());
               } else if (lv.getY() < arg3.getY()) {
      ...
      for (Direction lv3 : Direction.Type.HORIZONTAL) {
         this.setBlockState(arg, lv2.offset(lv3), Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, lv3));
      }
