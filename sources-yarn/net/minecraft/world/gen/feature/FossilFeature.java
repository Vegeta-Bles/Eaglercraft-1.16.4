...
public class FossilFeature extends Feature<DefaultFeatureConfig> {
   ...
   public boolean generate(StructureWorldAccess arg, ChunkGenerator arg2, Random random, BlockPos arg3, DefaultFeatureConfig arg4) {
      ...
      StructureManager lv2 = arg.toServerWorld().getServer().getStructureManager();
      ...
      StructurePlacementData lv7 = new StructurePlacementData()
         .setRotation(lv)
         .setBoundingBox(lv6)
         .setRandom(random)
         .addProcessor(BlockIgnoreStructureProcessor.IGNORE_AIR_AND_STRUCTURE_BLOCKS);
      BlockPos lv8 = lv3.getRotatedSize(lv);
      int j = random.nextInt(16 - lv8.getX());
      int k = random.nextInt(16 - lv8.getZ());
      int l = 256;
      ...
      lv4.place(arg, lv9, lv9, lv7, random, 4);
      return true;
   }
}
