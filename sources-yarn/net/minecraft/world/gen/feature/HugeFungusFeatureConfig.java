...
public class HugeFungusFeatureConfig implements FeatureConfig {
   public static final Codec<HugeFungusFeatureConfig> CODEC = RecordCodecBuilder.create(
      instance -> instance.group(
               BlockState.CODEC.fieldOf("valid_base_block").forGetter(arg -> arg.validBaseBlock),
               BlockState.CODEC.fieldOf("stem_state").forGetter(arg -> arg.stemState),
               BlockState.CODEC.fieldOf("hat_state").forGetter(arg -> arg.hatState),
               BlockState.CODEC.fieldOf("decor_state").forGetter(arg -> arg.decorationState),
               Codec.BOOL.fieldOf("planted").orElse(false).forGetter(arg -> arg.planted)
            )
