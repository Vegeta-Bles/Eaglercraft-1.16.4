...
public class JigsawFeature extends StructureFeature<StructurePoolFeatureConfig> {
   ...
   public static class Start extends MarginedStructureStart<StructurePoolFeatureConfig> {
      ...
      public void init(DynamicRegistryManager arg, ChunkGenerator arg2, StructureManager arg3, int i, int j, Biome arg4, StructurePoolFeatureConfig arg5) {
         BlockPos lv = new BlockPos(i * 16, this.jigsawFeature.structureStartY, j * 16);
         StructurePools.initDefaultPools();
         StructurePoolBasedGenerator.method_30419(
            arg, arg5, PoolStructurePiece::new, arg2, arg3, lv, this.children, this.random, this.jigsawFeature.field_25836, this.jigsawFeature.surface
         );
