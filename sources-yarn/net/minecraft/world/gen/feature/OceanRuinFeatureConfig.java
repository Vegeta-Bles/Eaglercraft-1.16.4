...
public class OceanRuinFeatureConfig implements FeatureConfig {
   public static final Codec<OceanRuinFeatureConfig> CODEC = RecordCodecBuilder.create(
      instance -> instance.group(
               OceanRuinFeature.BiomeType.CODEC.fieldOf("biome_temp").forGetter(arg -> arg.biomeType),
               Codec.floatRange(0.0F, 1.0F).fieldOf("large_probability").forGetter(arg -> arg.largeProbability),
               Codec.floatRange(0.0F, 1.0F).fieldOf("cluster_probability").forGetter(arg -> arg.clusterProbability)
            )
