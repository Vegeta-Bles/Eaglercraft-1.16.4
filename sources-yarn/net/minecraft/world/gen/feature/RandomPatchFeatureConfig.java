...
public class RandomPatchFeatureConfig implements FeatureConfig {
   public static final Codec<RandomPatchFeatureConfig> CODEC = RecordCodecBuilder.create(
      instance -> instance.group(
               BlockStateProvider.TYPE_CODEC.fieldOf("state_provider").forGetter(arg -> arg.stateProvider),
               BlockPlacer.TYPE_CODEC.fieldOf("block_placer").forGetter(arg -> arg.blockPlacer),
               BlockState.CODEC.listOf().fieldOf("whitelist").forGetter(arg -> arg.whitelist.stream().map(Block::getDefaultState).collect(Collectors.toList())),
               BlockState.CODEC.listOf().fieldOf("blacklist").forGetter(arg -> ImmutableList.copyOf(arg.blacklist)),
               Codec.INT.fieldOf("tries").orElse(128).forGetter(arg -> arg.tries),
               Codec.INT.fieldOf("xspread").orElse(7).forGetter(arg -> arg.spreadX),
               Codec.INT.fieldOf("yspread").orElse(3).forGetter(arg -> arg.spreadY),
               Codec.INT.fieldOf("zspread").orElse(7).forGetter(arg -> arg.spreadZ),
               Codec.BOOL.fieldOf("can_replace").orElse(false).forGetter(arg -> arg.canReplace),
               Codec.BOOL.fieldOf("project").orElse(true).forGetter(arg -> arg.project),
               Codec.BOOL.fieldOf("need_water").orElse(false).forGetter(arg -> arg.needsWater)
            )
