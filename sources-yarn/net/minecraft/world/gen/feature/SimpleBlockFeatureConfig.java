...
public class SimpleBlockFeatureConfig implements FeatureConfig {
   public static final Codec<SimpleBlockFeatureConfig> CODEC = RecordCodecBuilder.create(
      instance -> instance.group(
               BlockState.CODEC.fieldOf("to_place").forGetter(arg -> arg.toPlace),
               BlockState.CODEC.listOf().fieldOf("place_on").forGetter(arg -> arg.placeOn),
               BlockState.CODEC.listOf().fieldOf("place_in").forGetter(arg -> arg.placeIn),
               BlockState.CODEC.listOf().fieldOf("place_under").forGetter(arg -> arg.placeUnder)
            )
