...
public class TreeFeatureConfig implements FeatureConfig {
   public static final Codec<TreeFeatureConfig> CODEC = RecordCodecBuilder.create(
      instance -> instance.group(
               BlockStateProvider.TYPE_CODEC.fieldOf("trunk_provider").forGetter(arg -> arg.trunkProvider),
               BlockStateProvider.TYPE_CODEC.fieldOf("leaves_provider").forGetter(arg -> arg.leavesProvider),
               FoliagePlacer.TYPE_CODEC.fieldOf("foliage_placer").forGetter(arg -> arg.foliagePlacer),
               TrunkPlacer.CODEC.fieldOf("trunk_placer").forGetter(arg -> arg.trunkPlacer),
               FeatureSize.TYPE_CODEC.fieldOf("minimum_size").forGetter(arg -> arg.minimumSize),
               TreeDecorator.TYPE_CODEC.listOf().fieldOf("decorators").forGetter(arg -> arg.decorators),
               Codec.INT.fieldOf("max_water_depth").orElse(0).forGetter(arg -> arg.maxWaterDepth),
               Codec.BOOL.fieldOf("ignore_vines").orElse(false).forGetter(arg -> arg.ignoreVines),
