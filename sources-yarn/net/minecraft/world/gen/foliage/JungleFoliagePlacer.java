...
public class JungleFoliagePlacer extends FoliagePlacer {
   public static final Codec<JungleFoliagePlacer> CODEC = RecordCodecBuilder.create(
      instance -> fillFoliagePlacerFields(instance)
            .and(Codec.intRange(0, 16).fieldOf("height").forGetter(arg -> arg.height))
   ...
   protected void generate(
      ...
      for (int n = offset; n >= offset - m; n--) {
         ...
         this.generateSquare(world, random, config, treeNode.getCenter(), o, leaves, n, treeNode.isGiantTrunk(), box);
      }
   }
