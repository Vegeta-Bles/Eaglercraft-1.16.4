...
public class PineFoliagePlacer extends FoliagePlacer {
   public static final Codec<PineFoliagePlacer> CODEC = RecordCodecBuilder.create(
      instance -> fillFoliagePlacerFields(instance)
            .and(UniformIntDistribution.createValidatedCodec(0, 16, 8).fieldOf("height").forGetter(arg -> arg.height))
   ...
   protected void generate(
      ...
      for (int n = offset; n >= offset - foliageHeight; n--) {
         this.generateSquare(world, random, config, treeNode.getCenter(), m, leaves, n, treeNode.isGiantTrunk(), box);
