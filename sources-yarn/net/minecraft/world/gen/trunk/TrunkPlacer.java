...
public abstract class TrunkPlacer {
   ...
   protected static <P extends TrunkPlacer> P3<Mu<P>, Integer, Integer, Integer> method_28904(Instance<P> instance) {
      return instance.group(
         ...
         Codec.intRange(0, 24).fieldOf("height_rand_a").forGetter(arg -> arg.firstRandomHeight),
         Codec.intRange(0, 24).fieldOf("height_rand_b").forGetter(arg -> arg.secondRandomHeight)
      );
   }
   ...
   private static boolean canGenerate(TestableWorld world, BlockPos pos) {
      return world.testBlockState(pos, state -> {
         ...
         return Feature.isSoil(lv) && !state.isOf(Blocks.GRASS_BLOCK) && !state.isOf(Blocks.MYCELIUM);
      });
   }
