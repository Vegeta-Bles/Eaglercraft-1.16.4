...
public final class LevelInfo {
   ...
   public static LevelInfo fromDynamic(Dynamic<?> dynamic, DataPackSettings arg) {
      ...
      return new LevelInfo(
         ...
         dynamic.get("Difficulty").asNumber().map(number -> Difficulty.byOrdinal(number.byteValue())).result().orElse(Difficulty.NORMAL),
         dynamic.get("allowCommands").asBoolean(lv == GameMode.CREATIVE),
