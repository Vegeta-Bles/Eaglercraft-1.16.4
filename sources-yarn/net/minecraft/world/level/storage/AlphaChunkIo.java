...
public class AlphaChunkIo {
   public static AlphaChunkIo.AlphaChunk readAlphaChunk(CompoundTag tag) {
      ...
      AlphaChunkIo.AlphaChunk lv = new AlphaChunkIo.AlphaChunk(i, j);
      ...
      try {
         ...
         lv.lastUpdate = (long)tag.getInt("LastUpdate");
      }

      return lv;
   }

   public static void convertAlphaChunk(DynamicRegistryManager.Impl arg, AlphaChunkIo.AlphaChunk arg2, CompoundTag arg3, BiomeSource arg4) {
      ...
      arg3.putIntArray("Biomes", new BiomeArray(arg.get(Registry.BIOME_KEY), new ChunkPos(arg2.x, arg2.z), arg4).toIntArray());
