   ...
   public static Codec<PointOfInterest> createCodec(Runnable updateListener) {
      return RecordCodecBuilder.create(
         instance -> instance.group(
                  BlockPos.CODEC.fieldOf("pos").forGetter(arg -> arg.pos),
                  Registry.POINT_OF_INTEREST_TYPE.fieldOf("type").forGetter(arg -> arg.type),
                  Codec.INT.fieldOf("free_tickets").orElse(0).forGetter(arg -> arg.freeTickets),
